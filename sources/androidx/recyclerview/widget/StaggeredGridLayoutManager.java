...
public class StaggeredGridLayoutManager extends i implements androidx.recyclerview.widget.RecyclerView.r.b {
    ...
    class a {
        ...
        /* access modifiers changed from: 0000 */
        public final void b() {
            this.b = this.c ? StaggeredGridLayoutManager.this.b.c() : StaggeredGridLayoutManager.this.b.b();
        }
    }
    ...
    class d {
        ...
        public final void a(boolean z, int i) {
            ...
            if (b2 != Integer.MIN_VALUE) {
                if ((!z || b2 >= StaggeredGridLayoutManager.this.b.c()) && (z || b2 <= StaggeredGridLayoutManager.this.b.b())) {
                    if (i != Integer.MIN_VALUE) {
                        b2 += i;
                    }
                    this.e = b2;
    ...
    private int a(o oVar, oh ohVar, s sVar) {
        d dVar;
        int i;
        int i2;
        int i3;
        ...
        int i5 = this.x.i ? ohVar.e == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : ohVar.e == 1 ? ohVar.g + ohVar.b : ohVar.f - ohVar.b;
        a(ohVar.e, i5);
        int c2 = this.y ? this.b.c() : this.b.b();
        boolean z2 = false;
        while (ohVar.a(sVar) && (this.x.i || !this.z.isEmpty())) {
            View a2 = ohVar.a(oVar);
            ...
            a(a2, layoutParams, ohVar);
            if (!l() || this.g != 1) {
                i3 = this.f.b() + (dVar.c * this.h);
                i4 = this.f.e(a2) + i3;
            } else {
                i4 = this.f.c() - (((this.e - 1) - dVar.c) * this.h);
                i3 = i4 - this.f.e(a2);
            }
            if (this.g == 1) {
                b(a2, i3, i2, i4, i);
        ...
        if (b2 > 0) {
            return Math.min(ohVar.b, b2);
        }
        return 0;
    }

    private d a(oh ohVar) {
        int i;
        int i2;
        int i3 = -1;
        if (p(ohVar.e)) {
    ...
    private void a(View view, int i, int i2, boolean z2) {
        ...
        if (z2 ? a(view, b2, b3, (androidx.recyclerview.widget.RecyclerView.LayoutParams) layoutParams) : b(view, b2, b3, layoutParams)) {
            view.measure(b2, b3);
        }
    }

    private void a(View view, LayoutParams layoutParams, oh ohVar) {
        if (ohVar.e == 1) {
    ...
    private void a(View view, LayoutParams layoutParams, boolean z2) {
        if (this.g == 1) {
            a(view, a(this.h, this.t, 0, layoutParams.width, false), a(this.w, this.u, getPaddingTop() + getPaddingBottom(), layoutParams.height, true), false);
        } else {
            a(view, a(this.v, this.t, getPaddingLeft() + getPaddingRight(), layoutParams.width, true), a(this.h, this.u, 0, layoutParams.height, false), false);
        }
    }
    ...
    private void a(o oVar, oh ohVar) {
        if (ohVar.a && !ohVar.i) {
            if (ohVar.b == 0) {
                if (ohVar.e == -1) {
                    b(oVar, ohVar.g);
                ...
                int l = ohVar.f - l(ohVar.f);
                b(oVar, l < 0 ? ohVar.g : ohVar.g - Math.min(l, ohVar.b));
            } else {
                int o = o(ohVar.g) - ohVar.g;
                a(oVar, o < 0 ? ohVar.f : Math.min(o, ohVar.b) + ohVar.f);
            }
        }
    }
    ...
    private boolean b(s sVar, a aVar) {
        aVar.a = this.D ? s(sVar.a()) : r(sVar.a());
    ...
    private int h(s sVar) {
        ...
        return op.a(sVar, this.b, b(!this.K), c(!this.K), this, this.K, this.y);
    }

    private void h() {
        this.b = om.a(this, this.g);
        this.f = om.a(this, 1 - this.g);
    }
    ...
    private int i(s sVar) {
        ...
        return op.a(sVar, this.b, b(!this.K), c(!this.K), this, this.K);
    }
    ...
    private int j(s sVar) {
        ...
        return op.b(sVar, this.b, b(!this.K), c(!this.K), this, this.K);
    }
        ...
        if (this.f.g() != 1073741824) {
            ...
            if (this.h != i2) {
                for (int i3 = 0; i3 < r; i3++) {
                    ...
                    if (!l() || this.g != 1) {
                        int i4 = layoutParams2.a.c * this.h;
                        ...
                        g3.offsetLeftAndRight(((-((this.e - 1) - layoutParams2.a.c)) * this.h) - ((-((this.e - 1) - layoutParams2.a.c)) * i2));
                    }
                }
            }
        }
    ...
    public final int a(o oVar, s sVar) {
        return this.g == 0 ? this.e : super.a(oVar, sVar);
    }
    ...
    public final void a(Rect rect, int i, int i2) {
        ...
        if (this.g == 1) {
            ...
            i3 = a(i, (this.h * this.e) + paddingLeft, ip.l(this.i));
        } else {
            i3 = a(i, rect.width() + paddingLeft, ip.l(this.i));
            i4 = a(i2, (this.h * this.e) + paddingTop, ip.m(this.i));
        }
        d(i3, i4);
    }
    ...
    public final void a(o oVar, s sVar, View view, ja jaVar) {
        ...
        if (this.g == 0) {
            jaVar.b((Object) defpackage.ja.c.a(layoutParams2.a(), 1, -1, -1, false, false));
        } else {
            jaVar.b((Object) defpackage.ja.c.a(-1, -1, layoutParams2.a(), 1, false, false));
        }
    }
    ...
    public final int b(o oVar, s sVar) {
        return this.g == 1 ? this.e : super.b(oVar, sVar);
    }
    ...
    public final Parcelable d() {
        ...
        if (r() > 0) {
            ...
            for (int i5 = 0; i5 < this.e; i5++) {
                if (this.D) {
                    i = this.a[i5].b(Integer.MIN_VALUE);
                    if (i != Integer.MIN_VALUE) {
                        i2 = this.b.c();
                    } else {
                        cVar2.d[i5] = i;
                    ...
                    i = this.a[i5].a(Integer.MIN_VALUE);
                    if (i != Integer.MIN_VALUE) {
                        i2 = this.b.b();
                    } else {
                        cVar2.d[i5] = i;
