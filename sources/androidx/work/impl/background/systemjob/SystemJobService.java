...
public class SystemJobService extends JobService implements tc {
    private static final String a = su.a("SystemJobService");
    private tj b;
    ...
    public void onCreate() {
        super.onCreate();
        try {
            this.b = tj.a(getApplicationContext());
            this.b.f.a((tc) this);
    ...
    public boolean onStartJob(android.app.job.JobParameters r7) {
        ...
        L_0x003b:
            ...
            defpackage.su.a()     // Catch:{ all -> 0x00a4 }
    ...
    public boolean onStopJob(JobParameters jobParameters) {
        ...
        if (extras == null) {
            su.a().a(a, "No extras in JobParameters.", new Throwable[0]);
            return false;
        }
        String string = extras.getString("EXTRA_WORK_SPEC_ID");
        if (TextUtils.isEmpty(string)) {
            su.a().a(a, "WorkSpec id not found!", new Throwable[0]);
            return false;
        }
        su.a();
