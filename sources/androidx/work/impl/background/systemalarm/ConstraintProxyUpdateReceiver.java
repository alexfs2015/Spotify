...
public class ConstraintProxyUpdateReceiver extends BroadcastReceiver {
    static final String a = su.a("ConstrntProxyUpdtRecvr");
        ...
        tj.a(context).d.a(new Runnable() {
            public final void run() {
                try {
                    ...
                    vh.a(context, BatteryNotLowProxy.class, booleanExtra);
                    vh.a(context, BatteryChargingProxy.class, booleanExtra2);
                    vh.a(context, StorageNotLowProxy.class, booleanExtra3);
                    vh.a(context, NetworkStateProxy.class, booleanExtra4);
                } finally {
                    goAsync.finish();
                }
            }
