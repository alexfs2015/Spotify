...
public class ConstraintProxyUpdateReceiver extends BroadcastReceiver {
    static final String a = sg.a("ConstrntProxyUpdtRecvr");
        ...
        sv.a(context).d.a(new Runnable() {
            public final void run() {
                try {
                    ...
                    ut.a(context, BatteryNotLowProxy.class, booleanExtra);
                    ut.a(context, BatteryChargingProxy.class, booleanExtra2);
                    ut.a(context, StorageNotLowProxy.class, booleanExtra3);
                    ut.a(context, NetworkStateProxy.class, booleanExtra4);
                } finally {
                    goAsync.finish();
                }
            }
