...
public class ChangeImageTransform extends Transition {
    ...
    private static final Property<ImageView, Matrix> n = new Property<ImageView, Matrix>(Matrix.class, "animatedTransform") {
        ...
        public final /* synthetic */ void set(Object obj, Object obj2) {
            ...
            if (qh.a != null) {
                try {
                    qh.a.invoke(imageView, new Object[]{matrix});
    ...
    public final Animator a(ViewGroup viewGroup, qu quVar, qu quVar2) {
        ...
        if (!(quVar == null || quVar2 == null)) {
            ...
            if (!(rect == null || rect2 == null)) {
                ...
                Matrix matrix = (Matrix) quVar.a.get(str2);
                Matrix matrix2 = (Matrix) quVar2.a.get(str2);
                boolean z = (matrix == null && matrix2 == null) || (matrix != null && matrix.equals(matrix2));
                if (rect.equals(rect2) && z) {
                    return null;
                }
                ImageView imageView = (ImageView) quVar2.b;
                Drawable drawable = imageView.getDrawable();
