...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public final boolean c(View view) {
        ...
        return this.j && ((LayoutParams) view.getLayoutParams()).c && this.c > 0.0f;
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int i14 = layoutParams.width == -2 ? MeasureSpec.makeMeasureSpec(paddingLeft - i13, Integer.MIN_VALUE) : layoutParams.width == -1 ? MeasureSpec.makeMeasureSpec(paddingLeft - i13, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                int i15 = layoutParams.height == -2 ? MeasureSpec.makeMeasureSpec(i4, Integer.MIN_VALUE) : layoutParams.height == -1 ? MeasureSpec.makeMeasureSpec(i4, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                    ...
                    if (childAt2.getVisibility() != i6) {
                        ...
                        if (!z2 || childAt2 == this.b) {
                            if (layoutParams2.a > 0.0f) {
                                int i18 = layoutParams2.width == 0 ? layoutParams2.height == -2 ? MeasureSpec.makeMeasureSpec(i4, Integer.MIN_VALUE) : layoutParams2.height == -1 ? MeasureSpec.makeMeasureSpec(i4, 1073741824) : MeasureSpec.makeMeasureSpec(layoutParams2.height, 1073741824) : MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
                                if (z2) {
                                    ...
                                    if (measuredWidth2 != i19) {
                                        childAt2.measure(makeMeasureSpec, i18);
                                    }
                                    i17++;
                                    i16 = i7;
                                    i6 = 8;
                                    ...
                                    i7 = i16;
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(measuredWidth2 + ((int) ((layoutParams2.a * ((float) Math.max(0, i11))) / f2)), 1073741824), i18);
                                    i17++;
                                    i16 = i7;
                                    i6 = 8;
                                }
                            }
                        } else if (layoutParams2.width < 0 && (measuredWidth2 > i16 || layoutParams2.a > 0.0f)) {
                            if (!z5) {
                                i8 = 1073741824;
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec(i16, i8), i9);
                        }
                    }
                }
                i7 = i16;
