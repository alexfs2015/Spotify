...
public class SwipeRefreshLayout extends ViewGroup implements id, ih {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.c = new py(getContext(), -328966);
        this.g = new pz(getContext());
        pz pzVar = this.g;
        a aVar = pzVar.a;
        float f2 = pzVar.b.getDisplayMetrics().density;
        aVar.a(2.5f * f2);
        aVar.p = 7.5f * f2;
        aVar.a(0);
        float f3 = 10.0f * f2;
    ...
    public final void a(AnimationListener animationListener) {
        ...
        py pyVar = this.c;
        pyVar.a = animationListener;
        pyVar.clearAnimation();
    ...
    private Animation a(final int i2, final int i3) {
        AnonymousClass3 r0 = new Animation() {
            public final void applyTransformation(float f, Transformation transformation) {
                pz pzVar = SwipeRefreshLayout.this.g;
                int i = i2;
                pzVar.setAlpha((int) (((float) i) + (((float) (i3 - i)) * f)));
            }
        };
        r0.setDuration(300);
        py pyVar = this.c;
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (getChildCount() != 0) {
            ...
            if (view != null) {
                ...
                int i8 = i6 - i7;
                int i9 = this.b;
                pyVar.layout(i8, i9, i6 + i7, measuredHeight2 + i9);
            }
        }
    }
