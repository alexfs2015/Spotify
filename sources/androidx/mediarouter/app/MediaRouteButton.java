...
public class MediaRouteButton extends View {
    ...
    final class b extends defpackage.nd.a {
        b() {
        }
    ...
    public MediaRouteButton(Context context, AttributeSet attributeSet, int i2) {
        super(mw.g(context), attributeSet, i2);
        this.c = nc.c;
        this.d = ms.a();
        this.j = 0;
        Context context2 = getContext();
        TypedArray obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, defpackage.mn.a.a, i2, 0);
        if (isInEditMode()) {
            this.a = null;
            this.b = null;
            this.k = getResources().getDrawable(obtainStyledAttributes.getResourceId(defpackage.mn.a.e, 0));
            return;
        }
        this.a = nd.a(context2);
        this.b = new b();
        if (i == null) {
            i = new a(context2.getApplicationContext());
        }
        this.n = obtainStyledAttributes.getColorStateList(defpackage.mn.a.f);
        this.o = obtainStyledAttributes.getDimensionPixelSize(defpackage.mn.a.b, 0);
        this.p = obtainStyledAttributes.getDimensionPixelSize(defpackage.mn.a.c, 0);
        int resourceId = obtainStyledAttributes.getResourceId(defpackage.mn.a.e, 0);
        this.l = obtainStyledAttributes.getResourceId(defpackage.mn.a.d, 0);
