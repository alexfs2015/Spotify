...
public class PagerTitleStrip extends ViewGroup {
    ...
    class a extends DataSetObserver implements d, e {
        ...
        public final void a(ViewPager viewPager, sa saVar, sa saVar2) {
            PagerTitleStrip.this.a(saVar, saVar2);
        }
    ...
    public void onAttachedToWindow() {
        ...
        if (parent instanceof ViewPager) {
            ...
            this.a = viewPager;
            WeakReference<sa> weakReference = this.m;
            a(weakReference != null ? (sa) weakReference.get() : null, saVar);
            return;
        }
    ...
    public final void a(int i2, sa saVar) {
        int b2 = saVar != null ? saVar.b() : 0;
        this.j = true;
        CharSequence charSequence = null;
        this.b.setText((i2 <= 0 || saVar == null) ? null : saVar.b(i2 - 1));
        this.c.setText((saVar == null || i2 >= b2) ? null : saVar.b(i2));
        int i3 = i2 + 1;
        if (i3 < b2 && saVar != null) {
            charSequence = saVar.b(i3);
        }
    ...
    public final void a(sa saVar, sa saVar2) {
        if (saVar != null) {
            saVar.b((DataSetObserver) this.l);
            this.m = null;
        }
        if (saVar2 != null) {
            saVar2.a((DataSetObserver) this.l);
            this.m = new WeakReference<>(saVar2);
        }
        ViewPager viewPager = this.a;
        if (viewPager != null) {
            this.h = -1;
            this.e = -1.0f;
            a(viewPager.c, saVar2);
            requestLayout();
        }
    }
