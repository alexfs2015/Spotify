...
public class ViewPager extends ViewGroup {
    ...
    public interface d {
        void a(ViewPager viewPager, sf sfVar, sf sfVar2);
    }
    ...
    private void a(int i2, int i3, int i4) {
        ...
        int abs = Math.abs(i4);
        int min = Math.min(abs > 0 ? Math.round(Math.abs(a2 / ((float) abs)) * 1000.0f) * 4 : (int) (((((float) Math.abs(i7)) / ((f2 * this.b.k_(this.c)) + ((float) this.r))) + 1.0f) * 100.0f), 600);
        this.p = false;
        this.o.startScroll(i6, scrollY, i7, i8, min);
        ip.d(this);
    }
    ...
    private boolean i() {
        sf sfVar = this.b;
        if (sfVar == null || this.c >= sfVar.b() - 1) {
            return false;
        }
        a(this.c + 1, true);
        return true;
    ...
    public final void a(sf sfVar) {
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ((d) this.ab.get(i4)).a(this, sfVar3, sfVar);
            }
        }
    }
    ...
    public boolean canScrollHorizontally(int i2) {
        ...
        int d2 = d();
        int scrollX = getScrollX();
        return i2 < 0 ? scrollX > ((int) (((float) d2) * this.u)) : i2 > 0 && scrollX < ((int) (((float) d2) * this.v));
    }
