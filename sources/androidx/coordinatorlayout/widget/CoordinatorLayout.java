...
public class CoordinatorLayout extends ViewGroup implements ii {
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.m = new int[2];
        this.w = new ik();
        TypedArray obtainStyledAttributes = i2 == 0 ? context.obtainStyledAttributes(attributeSet, defpackage.ev.a.a, 0, 2132018073) : context.obtainStyledAttributes(attributeSet, defpackage.ev.a.a, i2, 0);
        int resourceId = obtainStyledAttributes.getResourceId(defpackage.ev.a.b, 0);
        if (resourceId != 0) {
        ...
        this.u = obtainStyledAttributes.getDrawable(defpackage.ev.a.c);
        obtainStyledAttributes.recycle();
        c();
    ...
    private static void a(int i2, Rect rect, Rect rect2, d dVar, int i3, int i4) {
        ...
        int i5 = a2 & 7;
        int i6 = a2 & ContentType.LONG_FORM_ON_DEMAND;
        int i7 = a3 & 7;
        int i8 = a3 & ContentType.LONG_FORM_ON_DEMAND;
        int i9 = i7 != 1 ? i7 != 5 ? rect.left : rect.right : rect.left + (rect.width() / 2);
        int i10 = i8 != 16 ? i8 != 80 ? rect.top : rect.bottom : rect.top + (rect.height() / 2);
        if (i5 == 1) {
            i9 -= i3 / 2;
        } else if (i5 != 5) {
            i9 -= i3;
    ...
    public final void a(int r25) {
        ...
        L_0x00a9:
            ...
            defpackage.ip.h(r15, r3)
        L_0x00bb:
            if (r4 == 0) goto L_0x00c0
            defpackage.ip.g(r15, r4)
        L_0x00c0:
