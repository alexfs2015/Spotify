...
public class AudioAttributesCompat implements rz {
    static boolean a;
    private static final SparseIntArray c;
    public md b;

    public static class a {
        public final defpackage.md.a a;
    ...
    public AudioAttributesCompat(md mdVar) {
        this.b = mdVar;
    }
    ...
    public boolean equals(Object obj) {
        ...
        md mdVar = this.b;
        if (mdVar != null) {
            return mdVar.equals(audioAttributesCompat.b);
        }
