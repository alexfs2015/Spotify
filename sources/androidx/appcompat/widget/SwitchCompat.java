...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (g2 != 0) {
            ...
            int a6 = a5.a(a.cO, -1);
            int a7 = a5.a(a.cP, -1);
            Typeface typeface2 = a6 != 1 ? a6 != 2 ? a6 != 3 ? null : Typeface.MONOSPACE : Typeface.SERIF : Typeface.SANS_SERIF;
            float f3 = 0.0f;
            if (a7 > 0) {
                if (typeface2 == null) {
                    typeface = Typeface.defaultFromStyle(a7);
                } else {
                    typeface = Typeface.create(typeface2, a7);
                }
                a(typeface);
                int style = (-1 ^ (typeface != null ? typeface.getStyle() : 0)) & a7;
