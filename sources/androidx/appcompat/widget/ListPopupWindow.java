...
public class ListPopupWindow implements bg {
    ...
    public final void d_() {
        ...
        if (this.r == -1) {
            ...
            int i5 = this.f;
            int makeMeasureSpec = i5 != -2 ? i5 != -1 ? MeasureSpec.makeMeasureSpec(i5, 1073741824) : MeasureSpec.makeMeasureSpec(this.d.getResources().getDisplayMetrics().widthPixels - (this.F.left + this.F.right), 1073741824) : MeasureSpec.makeMeasureSpec(this.d.getResources().getDisplayMetrics().widthPixels - (this.F.left + this.F.right), Integer.MIN_VALUE);
