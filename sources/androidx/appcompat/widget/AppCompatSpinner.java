    ...
    class c extends ListPopupWindow implements e {
        ...
        public final void h() {
            ...
            if (background != null) {
                ...
                i2 = cv.a(AppCompatSpinner.this) ? AppCompatSpinner.this.c.right : -AppCompatSpinner.this.c.left;
            } else {
            ...
            if (cv.a(AppCompatSpinner.this)) {
                i = i2 + (((width - paddingRight) - this.f) - this.q);
            } else {
                i = i2 + paddingLeft + this.q;
            }
            this.g = i;
        }
