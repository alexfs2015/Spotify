...
public class AppCompatViewInflater {
    ...
    private static final Map<String, Constructor<? extends View>> sConstructorMap = new dp();
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT < 15 || ip.F(view)) {
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.o.a.dH, 0, 0);
        int resourceId = z ? obtainStyledAttributes.getResourceId(defpackage.o.a.dI, 0) : 0;
        if (z2 && resourceId == 0) {
            resourceId = obtainStyledAttributes.getResourceId(defpackage.o.a.dJ, 0);
        }
        obtainStyledAttributes.recycle();
        return resourceId != 0 ? (!(context instanceof al) || ((al) context).a != resourceId) ? new al(context, resourceId) : context : context;
    }
