...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [kk, android.content.Context] */
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r0v1, types: [kk, android.content.Context]
      assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY]]
      uses: [kk, android.content.Context]
      mth insns count: 33
    ...
    private defpackage.kr a(java.lang.String r4, defpackage.kr r5) {
        /*
            r3 = this;
        ...
        L_0x0050:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.fragment.app.FragmentTabHost.a(java.lang.String, kr):kr");
    }

    /* JADX WARNING: type inference failed for: r2v0, types: [kk] */
    /* JADX WARNING: type inference failed for: r4v0 */
    /* JADX WARNING: type inference failed for: r4v1, types: [kr] */
    /* JADX WARNING: type inference failed for: r4v2 */
    /* JADX WARNING: type inference failed for: r4v3, types: [kr] */
    /* JADX WARNING: type inference failed for: r4v4, types: [kr] */
