...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        vgk.a(SlidingTabLayout.class, this);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.vfi.a.f, i, 0);
        this.a = obtainStyledAttributes.getResourceId(defpackage.vfi.a.m, 0);
        this.b = obtainStyledAttributes.getDimensionPixelSize(defpackage.vfi.a.n, 24);
        this.c = obtainStyledAttributes.getDimensionPixelSize(defpackage.vfi.a.o, 16);
        this.d = obtainStyledAttributes.getDimensionPixelSize(defpackage.vfi.a.p, 24);
    ...
    public final void a(ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            sf sfVar = (sf) fbp.a(this.e.b);
            b bVar = new b(this, 0);
            for (int i = 0; i < sfVar.b(); i++) {
