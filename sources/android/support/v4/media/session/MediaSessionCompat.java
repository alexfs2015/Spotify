...
public class MediaSessionCompat {
    ...
    public static final class Token implements Parcelable {
        ...
        Token(Object obj, defpackage.g gVar, se seVar) {
            this.a = obj;
            this.b = gVar;
            this.c = seVar;
        }
        ...
        class C0002a extends Handler {
            ...
            public final void handleMessage(Message message) {
                if (message.what == 1) {
                    ...
                    if (bVar != null) {
                        bVar.a((defpackage.ml.a) message.obj);
                        a.this.a();
                        bVar.a((defpackage.ml.a) null);
                    }
                }
            }
        }
            ...
            private void a() {
                if (VERSION.SDK_INT < 28) {
                    ...
                    if (bVar != null) {
                        ...
                        bVar.a(new defpackage.ml.a(e, -1, -1));
                    }
                }
            }
                ...
                try {
                    if (str.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                        ...
                        if (eVar != null) {
                            ...
                            sb.a(bundle2, "android.support.v4.media.session.SESSION_TOKEN2", token.c);
    ...
    static class e implements b {
        ...
        class a extends defpackage.g.a {
            ...
            public final void a(defpackage.f fVar) {
                if (!e.this.d) {
                    e.this.e.register(fVar, new defpackage.ml.a("android.media.session.MediaController", getCallingPid(), getCallingUid()));
                }
            }
        ...
        e(Context context, String str, se seVar, Bundle bundle) {
            this.a = new MediaSession(context, str);
            this.b = new Token(this.a.getSessionToken(), new a(), seVar);
            this.c = bundle;
            a(3);
        }
        ...
        public void a(defpackage.ml.a aVar) {
            synchronized (this.l) {
                this.m = aVar;
            }
        }
        ...
        public final void a(mp mpVar) {
            this.a.setPlaybackToRemote((VolumeProvider) mpVar.a());
        }
        ...
        public defpackage.ml.a f() {
            defpackage.ml.a aVar;
            synchronized (this.l) {
                aVar = this.m;
            }
            return aVar;
    ...
    static class f extends e {
        f(Context context, String str, se seVar, Bundle bundle) {
            super(context, str, seVar, bundle);
        }

        public final void a(defpackage.ml.a aVar) {
        }

        public final defpackage.ml.a f() {
            return new defpackage.ml.a(this.a.getCurrentControllerInfo());
        }
    }
    ...
    static class g implements b {
        ...
        private defpackage.ml.a D;
        private defpackage.mp.a E = new defpackage.mp.a() {
            public final void a(mp mpVar) {
                if (g.this.v == mpVar) {
                    ParcelableVolumeInfo parcelableVolumeInfo = new ParcelableVolumeInfo(g.this.t, g.this.u, mpVar.a, mpVar.b, mpVar.c);
        ...
        class b extends defpackage.g.a {
            ...
            public final void a(defpackage.f fVar) {
                ...
                g.this.g.register(fVar, new defpackage.ml.a(g.this.f(getCallingUid()), getCallingPid(), getCallingUid()));
            }
        ...
        class c extends Handler {
            ...
            public final void handleMessage(Message message) {
                ...
                if (aVar != null) {
                    ...
                    g.this.a(new defpackage.ml.a(data.getString("data_calling_pkg"), data.getInt("data_calling_pid"), data.getInt("data_calling_uid")));
        ...
        public final void a(MediaMetadataCompat mediaMetadataCompat) {
            ...
            this.g.finishBroadcast();
            if (this.C) {
                b(mediaMetadataCompat == null ? null : new Bundle(mediaMetadataCompat.b)).apply();
            }
        }
    ...
    private MediaSessionCompat(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, Bundle bundle, se seVar) {
        this.c = new ArrayList<>();
        if (context == null) {
            throw new IllegalArgumentException("context must not be null");
        } else if (!TextUtils.isEmpty(str)) {
            if (componentName == null) {
                componentName = mr.a(context);
            }
