...
public final class OperatorReplay<T> extends wzj<T> implements wuk {
    private static wus d = new wus() {
    ...
    static final class InnerProducer<T> extends AtomicLong implements wuf, wuk {
        ...
        public InnerProducer(b<T> bVar, wuj<? super T> wuj) {
            this.parent = bVar;
            this.child = wuj;
        }
        ...
        public final void unsubscribe() {
            if (get() != Long.MIN_VALUE && getAndSet(Long.MIN_VALUE) != Long.MIN_VALUE) {
                ...
                if (!bVar.c) {
                    synchronized (bVar.d) {
                        if (!bVar.c) {
                            wxq<InnerProducer<T>> wxq = bVar.d;
                            T[] tArr = wxq.e;
                            int i = wxq.b;
                            int a = wxq.a(hashCode()) & i;
                            T t = tArr[a];
                            boolean z = true;
                            if (t != null) {
                                if (!t.equals(this)) {
    ...
    static final class b<T> extends wuj<T> implements wuk {
        static final InnerProducer[] b = new InnerProducer[0];
        final a<T> a;
        volatile boolean c;
        final wxq<InnerProducer<T>> d = new wxq<>();
        InnerProducer<T>[] e = b;
        volatile long f;
        ...
        /* access modifiers changed from: 0000 */
        public final void a() {
            add(xaj.a((wum) new wum() {
                public final void call() {
                    if (!b.this.c) {
                        synchronized (b.this.d) {
                            if (!b.this.c) {
                                wxq<InnerProducer<T>> wxq = b.this.d;
                                wxq.c = 0;
                                wxq.e = (Object[]) new Object[0];
                                b.this.f++;
                                b.this.c = true;
                            }
                        }
        ...
        public final boolean a(InnerProducer<T> innerProducer) {
            ...
            synchronized (this.d) {
                ...
                wxq<InnerProducer<T>> wxq = this.d;
                T[] tArr = wxq.e;
                int i2 = wxq.b;
                int a2 = wxq.a(innerProducer.hashCode()) & i2;
                T t = tArr[a2];
                if (t != null) {
                ...
                if (i3 >= wxq.d) {
                    ...
                    while (true) {
                        ...
                        int a3 = wxq.a(tArr2[length].hashCode()) & i5;
                        if (tArr3[a3] != null) {
                            do {
                                a3 = (a3 + 1) & i5;
                            } while (tArr3[a3] != null);
    ...
    public static <T> wzj<T> d(wud<? extends T> wud) {
        return a(wud, d);
    }

    private static <T> wzj<T> a(wud<? extends T> wud, final wus<? extends a<T>> wus) {
        final AtomicReference atomicReference = new AtomicReference();
        return new OperatorReplay(new defpackage.wud.a<T>() {
            public final /* synthetic */ void call(Object obj) {
                ...
                InnerProducer innerProducer = new InnerProducer(bVar, wuj);
                bVar.a(innerProducer);
                wuj.add(innerProducer);
                bVar.a.a(innerProducer);
                wuj.setProducer(innerProducer);
            }
        }, wud, atomicReference, wus);
    }

    private OperatorReplay(defpackage.wud.a<T> aVar, wud<? extends T> wud, AtomicReference<b<T>> atomicReference, wus<? extends a<T>> wus) {
        super(aVar);
        this.a = wud;
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void c(defpackage.wun<? super defpackage.wuk> r5) {
        /*
            r4 = this;
        L_0x0000:
        ...
        L_0x0010:
            ...
            wus<? extends rx.internal.operators.OperatorReplay$a<T>> r2 = r4.c
        ...
        L_0x003d:
            ...
            wud<? extends T> r5 = r4.a
            r5.a(r0)
        L_0x0047:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorReplay.c(wun):void");
    }

    public static <T> wzj<T> a(wud<? extends T> wud, final int i) {
        return i == Integer.MAX_VALUE ? a(wud, d) : a(wud, (wus<? extends a<T>>) new wus<a<T>>() {
