...
public final class OperatorMerge<T> implements defpackage.wud.b<T, wud<? extends T>> {
    private boolean a;
    private int b;

    static final class MergeProducer<T> extends AtomicLong implements wuf {
    ...
    static final class c<T> extends wuj<T> {
        private static int f = (wxs.b / 4);
        final long a;
        volatile boolean b;
        volatile wxs c;
        private d<T> d;
    ...
    static final class d<T> extends wuj<wud<? extends T>> {
        private static c<?>[] p = new c[0];
        MergeProducer<T> a;
        private wuj<? super T> b;
        private boolean c;
        private int d;
        private volatile Queue<Object> e;
        private volatile xag f;
        ...
        public final /* synthetic */ void onNext(Object obj) {
            ...
            if (wud != null) {
                boolean z = false;
                if (wud == EmptyObservableHolder.a()) {
                    int i2 = this.r + 1;
                    if (i2 == this.q) {
                        this.r = 0;
                        request((long) i2);
                ...
                } else if (wud instanceof ScalarSynchronousObservable) {
                    T t = ((ScalarSynchronousObservable) wud).a;
                    long j2 = this.a.get();
                    if (j2 != 0) {
                        synchronized (this) {
                            j2 = this.a.get();
                    ...
                    wud.a((wuj<? super T>) cVar);
                    b();
                }
            }
        }

        public d(wuj<? super T> wuj, boolean z, int i2) {
            this.b = wuj;
            this.c = z;
            this.d = i2;
        ...
        public final void a(rx.internal.operators.OperatorMerge.c<T> r8, T r9) {
            ...
            L_0x0035:
                ...
                goto L_0x0077
            L_0x003c:
                wuj<? super T> r2 = r7.b     // Catch:{ all -> 0x0042 }
            ...
            L_0x0042:
                ...
                defpackage.wul.b(r9)     // Catch:{ all -> 0x0082 }
        ...
        private void a(T t) {
            ...
            if (queue2 == null) {
                int i2 = this.d;
                if (i2 == Integer.MAX_VALUE) {
                    queue2 = new wyb<>(wxs.b);
                } else {
                    if (!wyk.b(i2)) {
                        queue = new SpscExactAtomicArrayQueue<>(i2);
                    } else if (wzh.a()) {
                        queue = new wyt<>(i2);
                    } else {
                        queue = new wxy<>(i2);
            ...
            if (!queue2.offer(NotificationLite.a(t))) {
                unsubscribe();
        ...
        private void e() {
            /*
                r22 = this;
                r1 = r22
                wuj<? super T> r4 = r1.b     // Catch:{ all -> 0x01c7 }
            L_0x0004:
            ...
            L_0x0043:
                ...
                defpackage.wul.b(r18)     // Catch:{ all -> 0x01c7 }
            ...
            L_0x0129:
                r0 = move-exception
                r2 = r0
                defpackage.wul.b(r2)     // Catch:{ all -> 0x0056 }
    ...
    public final /* synthetic */ Object call(Object obj) {
        wuj wuj = (wuj) obj;
        d dVar = new d(wuj, this.a, this.b);
        MergeProducer<T> mergeProducer = new MergeProducer<>(dVar);
        dVar.a = mergeProducer;
        wuj.add(dVar);
        wuj.setProducer(mergeProducer);
        return dVar;
    }
    ...
    public static <T> OperatorMerge<T> a(boolean z, int i) {
        if (i <= 0) {
            ...
            return new OperatorMerge<>(false, i);
        }
    }
