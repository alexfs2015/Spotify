...
public final class CachedObservable<T> extends xii<T> {
    private final a<T> a;

    static final class CachedSubscribe<T> extends AtomicBoolean implements defpackage.xii.a<T> {
        ...
        public final /* synthetic */ void call(Object obj) {
            xio xio = (xio) obj;
            ReplayProducer<?> replayProducer = new ReplayProducer<>(xio, this.state);
            a<T> aVar = this.state;
            synchronized (aVar.b) {
            ...
            xio.add(replayProducer);
            xio.setProducer(replayProducer);
            if (!get() && compareAndSet(false, true)) {
                ...
                aVar2.b.a(r1);
                aVar2.a.a((xio<? super T>) r1);
                aVar2.e = true;
            }
        }
    }

    static final class ReplayProducer<T> extends AtomicLong implements xik, xip {
        ...
        public ReplayProducer(xio<? super T> xio, a<T> aVar) {
            this.child = xio;
            this.state = aVar;
        }
        ...
        public final void a() {
            ...
            L_0x000a:
                ...
                monitor-exit(r15)     // Catch:{ all -> 0x00e5 }
                r0 = 0
                xio<? super T> r2 = r15.child     // Catch:{ all -> 0x00d8 }
            L_0x0010:
            ...
            L_0x008c:
                ...
                r4 = 0
            L_0x008e:
                defpackage.xiq.b(r3)     // Catch:{ all -> 0x00ac }
                r15.unsubscribe()     // Catch:{ all -> 0x0044 }
    ...
    static final class a<T> extends xlt implements xij<T> {
        ...
        public a(xii<? extends T> xii, int i) {
            super(i);
            this.a = xii;
        }
    ...
    private CachedObservable(defpackage.xii.a<T> aVar, a<T> aVar2) {
        super(aVar);
        this.a = aVar2;
    }

    public static <T> CachedObservable<T> a(xii<? extends T> xii, int i) {
        if (i > 0) {
            a aVar = new a(xii, i);
