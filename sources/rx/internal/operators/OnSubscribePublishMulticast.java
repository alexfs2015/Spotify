...
public final class OnSubscribePublishMulticast<T> extends AtomicInteger implements defpackage.xii.a<T>, xij<T>, xip {
    ...
    final a<T> parent;
    final int prefetch;
    volatile xik producer;
    final Queue<T> queue;
    volatile PublishProducer<T>[] subscribers;

    static final class PublishProducer<T> extends AtomicLong implements xik, xip {
        private static final long serialVersionUID = 960704844171597367L;
        final xio<? super T> actual;
        final AtomicBoolean once = new AtomicBoolean();
        final OnSubscribePublishMulticast<T> parent;

        public PublishProducer(xio<? super T> xio, OnSubscribePublishMulticast<T> onSubscribePublishMulticast) {
            this.actual = xio;
    ...
    static final class a<T> extends xio<T> {
        ...
        public final void setProducer(xik xik) {
            ...
            onSubscribePublishMulticast.producer = xik;
            xik.a((long) onSubscribePublishMulticast.prefetch);
        }
    }
    ...
    public OnSubscribePublishMulticast(int i, boolean z) {
        if (i > 0) {
            ...
            this.delayError = z;
            if (xnm.a()) {
                this.queue = new xmy(i);
            } else {
                this.queue = new xmd(i);
            }
    ...
    public final /* synthetic */ void call(Object obj) {
        xio xio = (xio) obj;
        PublishProducer publishProducer = new PublishProducer(xio, this);
        xio.add(publishProducer);
        xio.setProducer(publishProducer);
