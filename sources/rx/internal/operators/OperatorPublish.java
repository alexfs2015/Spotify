...
public final class OperatorPublish<T> extends wzj<T> {
    ...
    static final class InnerProducer<T> extends AtomicLong implements wuf, wuk {
        ...
        public InnerProducer(a<T> aVar, wuj<? super T> wuj) {
            this.parent = aVar;
            this.child = wuj;
    ...
    static final class a<T> extends wuj<T> implements wuk {
        ...
        public a(AtomicReference<a<T>> atomicReference) {
            this.f = wzh.a() ? new wyt<>(wxs.b) : new wxy<>(wxs.b);
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:56:0x00a9, code lost:
            r2.unsubscribe();
            defpackage.wul.a(r0, r2.child, r6);
         */
        ...
        public final void b() {
            ...
            L_0x0093:
                ...
                wuj<? super T> r0 = r2.child     // Catch:{ all -> 0x00a8 }
            ...
            L_0x00a8:
                ...
                wuj<? super T> r2 = r2.child     // Catch:{ all -> 0x00e0 }
                defpackage.wul.a(r0, r2, r6)     // Catch:{ all -> 0x00e0 }
            L_0x00b1:
                int r8 = r8 + 1
                r2 = 1
                goto L_0x0093
    ...
    public static <T, R> wud<R> a(final wud<? extends T> wud, final wut<? super wud<T>, ? extends wud<R>> wut, boolean z) {
        return b((defpackage.wud.a<T>) new defpackage.wud.a<R>(false) {
            public final /* synthetic */ void call(Object obj) {
                final wuj wuj = (wuj) obj;
                final OnSubscribePublishMulticast onSubscribePublishMulticast = new OnSubscribePublishMulticast(wxs.b, false);
                AnonymousClass1 r1 = new wuj<R>() {
                ...
                wuj.add(onSubscribePublishMulticast);
                wuj.add(r1);
                ((wud) wut.call(wud.b((defpackage.wud.a<T>) onSubscribePublishMulticast))).a((wuj<? super T>) r1);
                wud.a((wuj<? super T>) onSubscribePublishMulticast.parent);
            }
        });
    }

    public OperatorPublish(defpackage.wud.a<T> aVar, wud<? extends T> wud, AtomicReference<a<T>> atomicReference) {
        super(aVar);
        this.a = wud;
    ...
    public final void c(defpackage.wun<? super defpackage.wuk> r5) {
        ...
        L_0x0041:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: rx.internal.operators.OperatorPublish.c(wun):void");
    }
}
