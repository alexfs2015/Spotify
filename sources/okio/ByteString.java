...
public class ByteString implements Serializable, Comparable<ByteString> {
    ...
    public static ByteString a(String str) {
        if (str != null) {
            ByteString byteString = new ByteString(str.getBytes(wpc.a));
            byteString.d = str;
            return byteString;
        }
    ...
    public String a() {
        ...
        String str2 = new String(this.data, wpc.a);
        this.d = str2;
        return str2;
    }

    public String b() {
        return woj.a(this.data);
    }
    ...
    public void a(wok wok) {
        byte[] bArr = this.data;
        wok.c(bArr, 0, bArr.length);
    }
    ...
    public boolean a(int i, byte[] bArr, int i2, int i3) {
        if (i >= 0) {
            ...
            if (i <= bArr2.length - i3 && i2 >= 0 && i2 <= bArr.length - i3 && wpc.a(bArr2, i, bArr, i2, i3)) {
                return true;
            }
        }
        return false;
