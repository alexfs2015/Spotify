...
public final class CodedOutputStream implements Flushable {
    ...
    public static int b(int i, aih aih) {
        return a(i) + c(aih.a.length) + aih.a.length;
    }
    ...
    public final void a(int i, aih aih) {
        f(i, 2);
        b(aih.a.length);
        int length = aih.a.length;
        int i2 = this.b;
        int i3 = this.c;
        if (i2 - i3 >= length) {
            aih.a(this.a, 0, i3, length);
            this.c += length;
            return;
        }
        int i4 = i2 - i3;
        aih.a(this.a, 0, i3, i4);
        int i5 = i4 + 0;
        int i6 = length - i4;
        this.c = this.b;
        a();
        if (i6 <= this.b) {
            aih.a(this.a, i5, 0, i6);
            this.c = i6;
            return;
        }
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(aih.a);
        long j = (long) i5;
