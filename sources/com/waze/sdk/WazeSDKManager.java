...
public final class WazeSDKManager {
    ...
    public ServiceConnection m = new ServiceConnection() {
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            WazeSDKManager.this.q = defpackage.whl.a.a(iBinder);
        ...
        public final void handleMessage(Message message) {
            ...
            if (WazeSDKManager.s.a) {
                switch (message.what) {
                    case 0:
                        String str2 = "GeoJson";
                        String a2 = whm.a(message.getData().getByteArray(str2), this.a);
                        if (a2 != null) {
                    ...
                    case 1:
                        ...
                        String a3 = whm.a(message.getData().getByteArray(str3), this.a);
                        if (a3 != null) {
                            String str4 = "DISTANCE_DISPLAY";
                            String a4 = whm.a(message.getData().getByteArray(str4), this.a);
                            if (a4 != null) {
                    ...
                    case 2:
                        ...
                        String a5 = whm.a(message.getData().getByteArray(str5), this.a);
                        if (a5 != null) {
                    ...
                    case 3:
                        ...
                        String a6 = whm.a(message.getData().getByteArray(str6), this.a);
                        if (a6 != null) {
                        ...
                        break;
                    case 4:
                        if (whm.a(message.getData().getByteArray("NEXT_TURN"), this.a) == null) {
                            return;
                        }
                        break;
                    case 6:
                        String str7 = "INSTRUCTION_EXIT";
                        String a7 = whm.a(message.getData().getByteArray(str7), this.a);
                        if (a7 != null) {
                        ...
                        break;
                    case 7:
                        String a8 = whm.a(message.getData().getByteArray("AGREEMENT"), this.a);
                        if (a8 != null && Boolean.valueOf(a8).booleanValue()) {
                            WazeSDKManager.f(WazeSDKManager.s);
                            return;
                        }
                    case 9:
                        String a9 = whm.a(message.getData().getByteArray("CONNECTION"), this.a);
                    ...
                    case 10:
                        ...
                        String a10 = whm.a(message.getData().getByteArray(str8), this.a);
                        if (a10 != null) {
                    ...
                    case 11:
                        ...
                        String a11 = whm.a(message.getData().getByteArray(str9), this.a);
                        if (a11 != null) {
                    ...
                    case 12:
                        try {
                            WazeSDKManager.s.r = Boolean.valueOf(whm.a(message.getData().getByteArray(str), this.a)).booleanValue();
    ...
    static /* synthetic */ void d(WazeSDKManager wazeSDKManager) {
        try {
            ...
            whn whn = wazeSDKManager.c;
            Bundle bundle = new Bundle();
            if (whn.a != null) {
                bundle.putParcelable("Intent", whn.a);
            }
            if (whn.b) {
            ...
            if (whn.e != null) {
                bundle.putString("CarId", whn.e);
            }
            if (whn.f != null) {
                bundle.putString("VoiceId", whn.f);
            }
            if (whn.g != null) {
                bundle.putString("VehicleType", whn.g);
            }
            obtain.setData(bundle);
