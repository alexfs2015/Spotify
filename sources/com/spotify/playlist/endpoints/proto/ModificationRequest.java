...
public final class ModificationRequest extends Message<ModificationRequest, Builder> {
    ...
    public static final class Attributes extends Message<Attributes, Builder> {
        ...
        static final class a extends ProtoAdapter<Attributes> {
            ...
            public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
                ...
                if (attributes.published != null) {
                    ProtoAdapter.a.a(vtb, 1, attributes.published);
                }
                if (attributes.collaborative != null) {
                    ProtoAdapter.a.a(vtb, 2, attributes.collaborative);
                }
                if (attributes.name != null) {
                    ProtoAdapter.i.a(vtb, 3, attributes.name);
                }
                if (attributes.description != null) {
                    ProtoAdapter.i.a(vtb, 4, attributes.description);
                }
                if (attributes.imageUri != null) {
                    ProtoAdapter.i.a(vtb, 5, attributes.imageUri);
                }
                vtb.a(attributes.a());
            }
            ...
            public final /* synthetic */ Object a(vta vta) {
                ...
                while (true) {
                    ...
                    if (b == -1) {
                        ...
                        builder.imageUri((String) ProtoAdapter.i.a(vta));
                    }
                }
            }
        }
        ...
        public final boolean equals(Object obj) {
            ...
            Attributes attributes = (Attributes) obj;
            return a().equals(attributes.a()) && vte.a((Object) this.published, (Object) attributes.published) && vte.a((Object) this.collaborative, (Object) attributes.collaborative) && vte.a((Object) this.name, (Object) attributes.name) && vte.a((Object) this.description, (Object) attributes.description) && vte.a((Object) this.imageUri, (Object) attributes.imageUri);
        }
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ModificationRequest, Builder> {
        ...
        public List<String> rows = vte.a();
        public List<String> uris = vte.a();
    ...
    static final class a extends ProtoAdapter<ModificationRequest> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (modificationRequest.operation != null) {
                ProtoAdapter.i.a(vtb, 1, modificationRequest.operation);
            }
            if (modificationRequest.before != null) {
                ProtoAdapter.i.a(vtb, 2, modificationRequest.before);
            }
            if (modificationRequest.after != null) {
                ProtoAdapter.i.a(vtb, 3, modificationRequest.after);
            }
            if (modificationRequest.name != null) {
                ProtoAdapter.i.a(vtb, 4, modificationRequest.name);
            }
            if (modificationRequest.playlist != null) {
                ProtoAdapter.a.a(vtb, 5, modificationRequest.playlist);
            }
            if (modificationRequest.attributes != null) {
                Attributes.ADAPTER.a(vtb, 6, modificationRequest.attributes);
            }
            ProtoAdapter.i.a().a(vtb, 7, modificationRequest.uris);
            ProtoAdapter.i.a().a(vtb, 8, modificationRequest.rows);
            if (modificationRequest.contents != null) {
                ProtoAdapter.a.a(vtb, 9, modificationRequest.contents);
            }
            vtb.a(modificationRequest.a());
        }
        ...
        public final /* synthetic */ Object a(vta vta) {
            ...
            while (true) {
                ...
                if (b != -1) {
                    switch (b) {
                        case 1:
                            builder.operation((String) ProtoAdapter.i.a(vta));
                            break;
                        case 2:
                            builder.before((String) ProtoAdapter.i.a(vta));
                            break;
                        case 3:
                            builder.after((String) ProtoAdapter.i.a(vta));
                            break;
                        case 4:
                            builder.name((String) ProtoAdapter.i.a(vta));
                            break;
                        case 5:
                            builder.playlist((Boolean) ProtoAdapter.a.a(vta));
                            break;
                        case 6:
                            builder.attributes((Attributes) Attributes.ADAPTER.a(vta));
                            break;
                        case 7:
                            builder.uris.add(ProtoAdapter.i.a(vta));
                            break;
                        case 8:
                            builder.rows.add(ProtoAdapter.i.a(vta));
                            break;
                        case 9:
                            builder.contents((Boolean) ProtoAdapter.a.a(vta));
                            break;
                        default:
                            FieldEncoding fieldEncoding = vta.b;
                            builder.addUnknownField(b, fieldEncoding, fieldEncoding.a().a(vta));
    ...
    public ModificationRequest(String str, String str2, String str3, String str4, Boolean bool, Attributes attributes2, List<String> list, List<String> list2, Boolean bool2, ByteString byteString) {
        ...
        this.playlist = bool;
        this.attributes = attributes2;
        this.uris = vte.a("uris", list);
        this.rows = vte.a("rows", list2);
        this.contents = bool2;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ModificationRequest modificationRequest = (ModificationRequest) obj;
        return a().equals(modificationRequest.a()) && vte.a((Object) this.operation, (Object) modificationRequest.operation) && vte.a((Object) this.before, (Object) modificationRequest.before) && vte.a((Object) this.after, (Object) modificationRequest.after) && vte.a((Object) this.name, (Object) modificationRequest.name) && vte.a((Object) this.playlist, (Object) modificationRequest.playlist) && vte.a((Object) this.attributes, (Object) modificationRequest.attributes) && this.uris.equals(modificationRequest.uris) && this.rows.equals(modificationRequest.rows) && vte.a((Object) this.contents, (Object) modificationRequest.contents);
    }
