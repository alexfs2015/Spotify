...
public final class VoiceAdLog extends GeneratedMessageLite<VoiceAdLog, b> implements grr {
    ...
    static final class a {
        static final flh<String, String> a;

        static {
            String str = "";
            a = flh.a(FieldType.STRING, str, FieldType.STRING, str);
        }
    }

    public static final class b extends com.google.protobuf.GeneratedMessageLite.a<VoiceAdLog, b> implements grr {
        private b() {
            super(VoiceAdLog.k);
        }
                    ...
                    try {
                        ...
                        if (a2 != 0) {
                            if (a2 == 10) {
                                ...
                                c.a.a(this.h, fkw, fky);
                            } else if (a2 == 42) {
                                if (!this.i.isMutable) {
                                    this.i = this.i.b();
                                }
                                a.a.a(this.i, fkw, fky);
                            } else if (a2 == 49) {
                                this.d |= 8;
                                this.j = Double.longBitsToDouble(fkw.j());
                            } else if (!a(a2, fkw)) {
                            }
                        }
                        z = true;
