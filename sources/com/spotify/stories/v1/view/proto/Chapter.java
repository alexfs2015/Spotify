...
public final class Chapter extends GeneratedMessageLite<Chapter, a> implements vnv {
    /* access modifiers changed from: private */
    public static final Chapter f;
    private static volatile fkr<Chapter> g;
    public int d = 0;
    public Object e;
    ...
    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<Chapter, a> implements vnv {
        /* synthetic */ a(byte b) {
            this();
        }
    ...
    public final TrackChapter k() {
        if (this.d == 1) {
            return (TrackChapter) this.e;
        }
        return TrackChapter.l();
    }

    public final void a(CodedOutputStream codedOutputStream) {
        if (this.d == 1) {
            codedOutputStream.a(1, (fko) (TrackChapter) this.e);
        }
        if (this.d == 2) {
            codedOutputStream.a(2, (fko) (VideoChapter) this.e);
        }
    }
    ...
    public final int j() {
        ...
        int i2 = 0;
        if (this.d == 1) {
            i2 = 0 + CodedOutputStream.b(1, (fko) (TrackChapter) this.e);
        }
        if (this.d == 2) {
            i2 += CodedOutputStream.b(2, (fko) (VideoChapter) this.e);
        }
        this.c = i2;
        return i2;
    }
                    ...
                    try {
                        ...
                        if (a2 != 0) {
                            if (a2 == 10) {
                                ...
                                this.e = fkc.a(TrackChapter.parser(), fke);
                                if (aVar != null) {
                                ...
                                this.e = fkc.a(VideoChapter.parser(), fke);
                                if (aVar2 != null) {
    ...
    public static fkr<Chapter> parser() {
        return f.c();
    }
}
