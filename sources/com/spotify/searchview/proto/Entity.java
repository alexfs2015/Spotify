...
public final class Entity extends GeneratedMessageLite<Entity, a> implements vjf {
    /* access modifiers changed from: private */
    public static final Entity i;
    private static volatile fkr<Entity> j;
    public int d = 0;
    public String e;
    public String f;
    public String g;
    ...
    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<Entity, a> implements vjf {
        /* synthetic */ a(byte b) {
            this();
        }
    ...
    public final AudioEpisode n() {
        if (this.d == 10) {
            return (AudioEpisode) this.h;
        }
        return AudioEpisode.k();
    }
    ...
    public final void a(CodedOutputStream codedOutputStream) {
        ...
        if (this.d == 4) {
            codedOutputStream.a(4, (fko) (Artist) this.h);
        }
        if (this.d == 5) {
            codedOutputStream.a(5, (fko) (Track) this.h);
        }
        if (this.d == 6) {
            codedOutputStream.a(6, (fko) (Album) this.h);
        }
        if (this.d == 7) {
            codedOutputStream.a(7, (fko) (Playlist) this.h);
        }
        if (this.d == 8) {
            codedOutputStream.a(8, (fko) (Genre) this.h);
        }
        if (this.d == 9) {
            codedOutputStream.a(9, (fko) (AudioShow) this.h);
        }
        if (this.d == 10) {
            codedOutputStream.a(10, (fko) (AudioEpisode) this.h);
        }
        if (this.d == 11) {
            codedOutputStream.a(11, (fko) (Profile) this.h);
        }
    }
    ...
    public final int j() {
        ...
        if (this.d == 4) {
            i3 += CodedOutputStream.b(4, (fko) (Artist) this.h);
        }
        if (this.d == 5) {
            i3 += CodedOutputStream.b(5, (fko) (Track) this.h);
        }
        if (this.d == 6) {
            i3 += CodedOutputStream.b(6, (fko) (Album) this.h);
        }
        if (this.d == 7) {
            i3 += CodedOutputStream.b(7, (fko) (Playlist) this.h);
        }
        if (this.d == 8) {
            i3 += CodedOutputStream.b(8, (fko) (Genre) this.h);
        }
        if (this.d == 9) {
            i3 += CodedOutputStream.b(9, (fko) (AudioShow) this.h);
        }
        if (this.d == 10) {
            i3 += CodedOutputStream.b(10, (fko) (AudioEpisode) this.h);
        }
        if (this.d == 11) {
            i3 += CodedOutputStream.b(11, (fko) (Profile) this.h);
        }
        this.c = i3;
        return i3;
    }
                    ...
                    try {
                        ...
                        switch (a2) {
                            ...
                            case 34:
                                ...
                                this.h = fkc.a(Artist.parser(), fke);
                                if (aVar != null) {
                            ...
                            case 58:
                                ...
                                this.h = fkc.a(Playlist.parser(), fke);
                                if (aVar4 != null) {
                            ...
                            case b.bC /*74*/:
                                ...
                                this.h = fkc.a(AudioShow.parser(), fke);
                                if (aVar6 != null) {
                            ...
                            case 82:
                                ...
                                this.h = fkc.a(AudioEpisode.parser(), fke);
                                if (aVar7 != null) {
                            ...
                            case 90:
                                ...
                                this.h = fkc.a(Profile.parser(), fke);
                                if (aVar8 != null) {
    ...
    public static fkr<Entity> parser() {
        return i.c();
    }
}
