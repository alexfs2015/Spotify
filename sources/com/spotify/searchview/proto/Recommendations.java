...
public final class Recommendations extends GeneratedMessageLite<Recommendations, a> implements vjk {
    /* access modifiers changed from: private */
    public static final Recommendations g;
    private static volatile fkr<Recommendations> h;
    public e<Entity> d = fks.d();
    private int e;
    private int f;

    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<Recommendations, a> implements vjk {
        /* synthetic */ a(byte b) {
            this();
        }
    ...
    public final int j() {
        ...
        for (int i2 = 0; i2 < this.d.size(); i2++) {
            j += CodedOutputStream.b(2, (fko) this.d.get(i2));
        }
        this.c = j;
        return j;
    }
    ...
    public static fkr<Recommendations> parser() {
        return g.c();
    }
}
