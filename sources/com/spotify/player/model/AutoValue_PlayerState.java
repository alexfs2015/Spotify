...
final class AutoValue_PlayerState extends PlayerState {
    ...
    private final Optional<String> contextUri;
    private final Optional<String> contextUrl;
    ...
    static final class Builder extends com.spotify.player.model.PlayerState.Builder {
        ...
        private Optional<String> contextUri;
        private Optional<String> contextUrl;
        ...
        Builder() {
            this.contextUri = Optional.e();
            this.contextUrl = Optional.e();
        ...
        public final PlayerState build() {
            ...
            if (this.contextRestrictions == null) {
                ...
                sb2.append(str);
                sb2.append(" contextRestrictions");
                str = sb2.toString();
            }
    ...
    private AutoValue_PlayerState(long j, Optional<String> optional, Optional<String> optional2, Restrictions restrictions2, Optional<PlayOrigin> optional3, Optional<ContextIndex> optional4, Optional<ContextTrack> optional5, Optional<String> optional6, Optional<Double> optional7, Optional<Long> optional8, Optional<Long> optional9, boolean z, boolean z2, boolean z3, boolean z4, PlayerOptions playerOptions, Restrictions restrictions3, Suppressions suppressions2, ImmutableList<ContextTrack> immutableList, ImmutableList<ContextTrack> immutableList2, ImmutableMap<String, String> immutableMap, ImmutableMap<String, String> immutableMap2, String str, String str2, AudioStream audioStream2) {
        this.timestamp = j;
        this.contextUri = optional;
        this.contextUrl = optional2;
        this.contextRestrictions = restrictions2;
        this.playOrigin = optional3;
        this.index = optional4;
        this.track = optional5;
        this.playbackId = optional6;
        this.playbackSpeed = optional7;
        this.positionAsOfTimestamp = optional8;
        this.duration = optional9;
        this.isPlaying = z;
        this.isPaused = z2;
        this.isBuffering = z3;
    ...
    public final Optional<String> contextUri() {
        return this.contextUri;
    }

    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("context_url")
    public final Optional<String> contextUrl() {
