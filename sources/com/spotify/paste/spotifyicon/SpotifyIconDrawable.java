...
public final class SpotifyIconDrawable extends Drawable {
    ...
    class b implements d {
        ...
        public final void a(Canvas canvas) {
            ...
            float width = f / f2 > ((float) bounds.width()) / ((float) bounds.height()) ? f / ((float) bounds.width()) : f2 / ((float) bounds.height());
    ...
    public SpotifyIconDrawable(Context context, SpotifyIcon spotifyIcon) {
        this(context, spotifyIcon, (float) vfj.b((float) spotifyIcon.mDefaultSize, context.getResources()));
    }
    ...
    private SpotifyIconDrawable(Context context, SpotifyIconV2 spotifyIconV2, float f2, Float f3) {
        ...
        c();
        Typeface a2 = vfn.a(context, "spoticon.ttf");
        this.a = new Paint();
    ...
    /* access modifiers changed from: private */
    public boolean f() {
        return this.s == LayoutDirectionOverride.RTL || (this.s == LayoutDirectionOverride.DEVICE && gm.h(this) == 1);
    }

    public String a() {
        return this.d.c ? this.d.a : f() ? this.d.b : this.d.a;
    }
