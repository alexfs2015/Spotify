...
public final class CardAccessoryDrawable extends Drawable {
    ...
    private CardAccessoryDrawable(Context context, int i2, SpotifyIconV2 spotifyIconV2, Size size, float f2, float f3) {
        this.d = (float) vfj.b((float) (size.mInnerCircleRadiusDp + 1), context.getResources());
        this.c = (float) vfj.b((float) size.mInnerCircleRadiusDp, context.getResources());
        this.e = i2;
        float b2 = (float) vfj.b((float) size.mIconSizeDp, context.getResources());
        ...
        this.k = 1.0f;
        this.l = f3;
        this.a = vfj.b((float) size.mCardPaddingDp, context.getResources());
    }
