...
public class EmptyView extends LinearLayout {
    ...
    public EmptyView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f = obtainStyledAttributes2.getDimensionPixelSize(a.t, uts.b(96.0f, getResources()));
        ...
        if (((float) displayMetrics.widthPixels) / displayMetrics.density < 321.0f) {
            i3 = uts.a(32.0f, getResources());
            i2 = uts.a(16.0f, getResources());
        } else {
            i3 = uts.a(48.0f, getResources());
            i2 = uts.a(32.0f, getResources());
        }
        setPadding(i3, i2, i3, i2);
        if (resourceId != 0) {
            uuu.a(context2, this.a, resourceId);
        }
        if (resourceId2 != 0) {
            uuu.a(context2, this.b, resourceId2);
        }
