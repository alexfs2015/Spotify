...
public class CarouselLayoutManager extends i implements uwd {
    private boolean A;
    ...
    public final void a(defpackage.uwd.a aVar) {
        this.J = aVar;
    }
        ...
        for (int i4 = 0; i4 < 3; i4++) {
            ...
            if (view == null) {
                ...
                if (view.getTag(R.id.paste_carousel_tag) == null) {
                    view.setTag(R.id.paste_carousel_tag, new uvz());
                }
                d(view, i4);
                this.H.add(view);
                f(view);
    ...
    private void d(View view, int i) {
        uvz uvz = (uvz) view.getTag(R.id.paste_carousel_tag);
        uwc uwc = this.a;
        boolean z2 = true;
        if (uwc == null) {
            uvz.b = 0;
        } else if (i == 0 && uwc.a() > 0 && this.b != 0) {
            uvz.b = -1;
            uvz.c = this.a.a();
    ...
    private void a(boolean z2) {
        View view = (View) fay.a(r() > 1 ? g(1) : g(0));
