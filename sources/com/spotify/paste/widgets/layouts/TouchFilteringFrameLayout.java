...
public class TouchFilteringFrameLayout extends FrameLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if ((uuo.d ^ -1) != 0) {
            ...
            uuo.b(pointerCount);
            PointerProperties[] pointerPropertiesArr2 = uuo.a;
            int[] iArr2 = uuo.c;
            ...
            for (int i4 = 0; i4 < pointerCount; i4++) {
                ...
                if (!uuo.a(pointerPropertiesArr2[i3].id)) {
                    if (i4 == actionIndex) {
                        i2 = i3;
                    }
                    iArr2[i3] = i4;
            ...
            if (i3 != 0) {
                PointerCoords[] pointerCoordsArr = uuo.b;
                ...
                while (i6 <= historySize) {
                    if (i6 == historySize) {
                        ...
                        j = motionEvent2.getHistoricalEventTime(i6);
                    }
                    long j2 = j;
                    ...
                    if (i6 == 0) {
                        ...
                        motionEvent4 = MotionEvent.obtain(motionEvent.getDownTime(), j2, i5, i3, pointerPropertiesArr2, pointerCoordsArr, motionEvent.getMetaState(), motionEvent.getButtonState(), motionEvent.getXPrecision(), motionEvent.getYPrecision(), motionEvent.getDeviceId(), motionEvent.getEdgeFlags(), motionEvent.getSource(), motionEvent.getFlags());
                    } else {
                        i = i3;
                        iArr = iArr2;
                        pointerPropertiesArr = pointerPropertiesArr2;
                        motionEvent4.addBatch(j2, pointerCoordsArr, 0);
                    }
                    i6++;
                    i3 = i;
                    iArr2 = iArr;
