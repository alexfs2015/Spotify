...
public class RecyclerViewFastScroller extends View {
    ...
    public RecyclerViewFastScroller(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.o = new Rect();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.vho.a.S, i2, 0);
        this.d = obtainStyledAttributes.getDrawable(defpackage.vho.a.V);
        this.e = obtainStyledAttributes.getDimensionPixelSize(defpackage.vho.a.W, vfj.b(72.0f, getResources()));
        this.f = obtainStyledAttributes.getDimensionPixelSize(defpackage.vho.a.X, vfj.b(32.0f, getResources()));
        this.g = obtainStyledAttributes.getInt(defpackage.vho.a.T, 1000);
        int color = obtainStyledAttributes.getColor(defpackage.vho.a.U, 0);
    ...
    static /* synthetic */ void b(RecyclerViewFastScroller recyclerViewFastScroller) {
        if (!recyclerViewFastScroller.k) {
            ...
            recyclerViewFastScroller.setTranslationX((float) (vgi.a((View) recyclerViewFastScroller) ? -recyclerViewFastScroller.getMeasuredWidth() : recyclerViewFastScroller.getMeasuredWidth()));
            ...
            recyclerViewFastScroller.getViewTreeObserver().addOnPreDrawListener(new OnPreDrawListener() {
                public final boolean onPreDraw() {
                    ...
                    ofPropertyValuesHolder.setInterpolator(vft.a(RecyclerViewFastScroller.this.c.getContext()));
    ...
    /* access modifiers changed from: private */
    public void d() {
        this.p = ObjectAnimator.ofPropertyValuesHolder(this, new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat(View.ALPHA, new float[]{1.0f, 0.0f}), PropertyValuesHolder.ofFloat(View.TRANSLATION_X, new float[]{(float) (vgi.a((View) this) ? -getMeasuredWidth() : getMeasuredWidth())})});
        this.p.setDuration(200);
        this.p.setInterpolator(vft.a(this.c.getContext()));
    ...
    static /* synthetic */ void e(RecyclerViewFastScroller recyclerViewFastScroller) {
        if (!recyclerViewFastScroller.a) {
            ...
            recyclerViewFastScroller.i.a(((float) m2) / ((float) (((androidx.recyclerview.widget.RecyclerView.a) fbp.a(recyclerViewFastScroller.c.c())).b() - i2)));
