...
public final class SeekForwardButton extends AppCompatImageButton implements utc {
    private a a;
    ...
    public SeekForwardButton(Context context, AttributeSet attributeSet, int i) {
        ...
        setImageDrawable(ury.a((Context) fay.a(getContext()), SpotifyIconV2.SKIPFORWARD15));
