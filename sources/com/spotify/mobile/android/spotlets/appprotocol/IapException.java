...
public class IapException extends RuntimeException {
    ...
    public static IapException a(BuiltInAuthException builtInAuthException) {
        ...
        String str3 = "w srUrt hukrEon:nAn";
        String str4 = "Unknown AuthError: ";
        if (i == 1) {
            str = ErrorMessage.NEEDS_AUTHORIZATION_ERROR.mMessage;
        } else if (i == 2) {
            String str5 = "iUgloe g doo insntser";
            str = "User is not logged in";
        } else if (i == 3) {
            str = ErrorMessage.d.mMessage;
        } else if (i == 4) {
            String str6 = " tamutnctehhCitdeon. uiwtndl s o ia";
        ...
        if (i2 == 1) {
            String str7 = "aeimo.otfo.zrt_trrpdthsrusorocuiey_n.";
            str2 = "com.spotify.error.user_not_authorized";
        } else if (i2 == 2) {
            String str8 = "ooimfebisncogtylrn.__rdotr.ogp.";
            str2 = "com.spotify.error.not_logged_in";
        } else if (i2 == 3) {
            String str9 = "traeybpfooic_eirocemi_nrdoems.ofvf..l";
