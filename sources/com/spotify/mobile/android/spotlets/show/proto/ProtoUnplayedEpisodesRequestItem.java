...
public final class ProtoUnplayedEpisodesRequestItem extends Message<ProtoUnplayedEpisodesRequestItem, Builder> {
    ...
    static final class a extends ProtoAdapter<ProtoUnplayedEpisodesRequestItem> {
        ...
        public final /* synthetic */ int a(Object obj) {
            ...
            int i2 = 0;
            int a = (protoUnplayedEpisodesRequestItem.header != null ? ProtoAdapter.i.a(1, protoUnplayedEpisodesRequestItem.header) : 0) + (protoUnplayedEpisodesRequestItem.episode_metadata != null ? ProtoEpisodeMetadata.ADAPTER.a(2, protoUnplayedEpisodesRequestItem.episode_metadata) : 0);
            if (protoUnplayedEpisodesRequestItem.episode_collection_state != null) {
                boolean z = false | true;
                i = ProtoEpisodeCollectionState.ADAPTER.a(3, protoUnplayedEpisodesRequestItem.episode_collection_state);
            } else {
                i = 0;
            }
            int a2 = a + i + (protoUnplayedEpisodesRequestItem.episode_offline_state != null ? ProtoEpisodeOfflineState.ADAPTER.a(4, protoUnplayedEpisodesRequestItem.episode_offline_state) : 0);
            if (protoUnplayedEpisodesRequestItem.episode_play_state != null) {
                int i3 = 3 >> 5;
                i2 = ProtoEpisodePlayState.ADAPTER.a(5, protoUnplayedEpisodesRequestItem.episode_play_state);
            }
            return a2 + i2 + protoUnplayedEpisodesRequestItem.a().h();
        }
        ...
        public final /* bridge */ /* synthetic */ void a(whh whh, Object obj) {
            ...
            if (protoUnplayedEpisodesRequestItem.header != null) {
                ProtoAdapter.i.a(whh, 1, protoUnplayedEpisodesRequestItem.header);
            }
            if (protoUnplayedEpisodesRequestItem.episode_metadata != null) {
                ProtoEpisodeMetadata.ADAPTER.a(whh, 2, protoUnplayedEpisodesRequestItem.episode_metadata);
            }
            if (protoUnplayedEpisodesRequestItem.episode_collection_state != null) {
                ProtoEpisodeCollectionState.ADAPTER.a(whh, 3, protoUnplayedEpisodesRequestItem.episode_collection_state);
            }
            if (protoUnplayedEpisodesRequestItem.episode_offline_state != null) {
                ProtoEpisodeOfflineState.ADAPTER.a(whh, 4, protoUnplayedEpisodesRequestItem.episode_offline_state);
            }
            if (protoUnplayedEpisodesRequestItem.episode_play_state != null) {
                boolean z = true & true;
                ProtoEpisodePlayState.ADAPTER.a(whh, 5, protoUnplayedEpisodesRequestItem.episode_play_state);
            }
            whh.a(protoUnplayedEpisodesRequestItem.a());
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoUnplayedEpisodesRequestItem protoUnplayedEpisodesRequestItem = (ProtoUnplayedEpisodesRequestItem) obj;
        return a().equals(protoUnplayedEpisodesRequestItem.a()) && whk.a((Object) this.header, (Object) protoUnplayedEpisodesRequestItem.header) && whk.a((Object) this.episode_metadata, (Object) protoUnplayedEpisodesRequestItem.episode_metadata) && whk.a((Object) this.episode_collection_state, (Object) protoUnplayedEpisodesRequestItem.episode_collection_state) && whk.a((Object) this.episode_offline_state, (Object) protoUnplayedEpisodesRequestItem.episode_offline_state) && whk.a((Object) this.episode_play_state, (Object) protoUnplayedEpisodesRequestItem.episode_play_state);
    }
    ...
    public final String toString() {
        ...
        if (this.episode_play_state != null) {
            String str4 = "spttdbse,i o_pa=lea_e";
            sb.append(", episode_play_state=");
            sb.append(this.episode_play_state);
        }
        String str5 = "suedUnbosRptlaoPrieedes{eItEoqptm";
