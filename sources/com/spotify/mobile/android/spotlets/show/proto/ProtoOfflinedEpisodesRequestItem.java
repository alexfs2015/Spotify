...
public final class ProtoOfflinedEpisodesRequestItem extends Message<ProtoOfflinedEpisodesRequestItem, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ProtoOfflinedEpisodesRequestItem, Builder> {
        ...
        public final ProtoOfflinedEpisodesRequestItem build() {
            ProtoOfflinedEpisodesRequestItem protoOfflinedEpisodesRequestItem = new ProtoOfflinedEpisodesRequestItem(this.header, this.episode_metadata, this.episode_collection_state, this.episode_offline_state, this.episode_play_state, super.buildUnknownFields());
            return protoOfflinedEpisodesRequestItem;
        }
    }
    ...
    static final class a extends ProtoAdapter<ProtoOfflinedEpisodesRequestItem> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (protoOfflinedEpisodesRequestItem.header != null) {
                ProtoAdapter.i.a(vtb, 1, protoOfflinedEpisodesRequestItem.header);
            }
            if (protoOfflinedEpisodesRequestItem.episode_metadata != null) {
                ProtoEpisodeMetadata.ADAPTER.a(vtb, 2, protoOfflinedEpisodesRequestItem.episode_metadata);
            }
            if (protoOfflinedEpisodesRequestItem.episode_collection_state != null) {
                ProtoEpisodeCollectionState.ADAPTER.a(vtb, 3, protoOfflinedEpisodesRequestItem.episode_collection_state);
            }
            if (protoOfflinedEpisodesRequestItem.episode_offline_state != null) {
                ProtoEpisodeOfflineState.ADAPTER.a(vtb, 4, protoOfflinedEpisodesRequestItem.episode_offline_state);
            }
            if (protoOfflinedEpisodesRequestItem.episode_play_state != null) {
                ProtoEpisodePlayState.ADAPTER.a(vtb, 5, protoOfflinedEpisodesRequestItem.episode_play_state);
            }
            vtb.a(protoOfflinedEpisodesRequestItem.a());
        }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoOfflinedEpisodesRequestItem protoOfflinedEpisodesRequestItem = (ProtoOfflinedEpisodesRequestItem) obj;
        return a().equals(protoOfflinedEpisodesRequestItem.a()) && vte.a((Object) this.header, (Object) protoOfflinedEpisodesRequestItem.header) && vte.a((Object) this.episode_metadata, (Object) protoOfflinedEpisodesRequestItem.episode_metadata) && vte.a((Object) this.episode_collection_state, (Object) protoOfflinedEpisodesRequestItem.episode_collection_state) && vte.a((Object) this.episode_offline_state, (Object) protoOfflinedEpisodesRequestItem.episode_offline_state) && vte.a((Object) this.episode_play_state, (Object) protoOfflinedEpisodesRequestItem.episode_play_state);
    }
