...
public final class Show extends Message<Show, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<Show, Builder> {
        ...
        public final Show build() {
            Show show = new Show(this.show_metadata, this.show_collection_state, this.show_play_state, this.link, super.buildUnknownFields());
            return show;
        }
    }
    ...
    static final class a extends ProtoAdapter<Show> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (show.show_metadata != null) {
                ProtoShowMetadata.ADAPTER.a(vtb, 1, show.show_metadata);
            }
            if (show.show_collection_state != null) {
                ProtoShowCollectionState.ADAPTER.a(vtb, 2, show.show_collection_state);
            }
            if (show.show_play_state != null) {
                ProtoShowPlayState.ADAPTER.a(vtb, 3, show.show_play_state);
            }
            if (show.link != null) {
                ProtoAdapter.i.a(vtb, 4, show.link);
            }
            vtb.a(show.a());
        }
    ...
    public final boolean equals(Object obj) {
        ...
        Show show = (Show) obj;
        return a().equals(show.a()) && vte.a((Object) this.show_metadata, (Object) show.show_metadata) && vte.a((Object) this.show_collection_state, (Object) show.show_collection_state) && vte.a((Object) this.show_play_state, (Object) show.show_play_state) && vte.a((Object) this.link, (Object) show.link);
    }
