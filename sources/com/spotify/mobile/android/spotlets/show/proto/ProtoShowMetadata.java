...
public final class ProtoShowMetadata extends Message<ProtoShowMetadata, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ProtoShowMetadata, Builder> {
        ...
        public List<String> copyright = whk.a();
    ...
    static final class a extends ProtoAdapter<ProtoShowMetadata> {
                ...
                if (b != -1) {
                    switch (b) {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            builder.popularity((Integer) ProtoAdapter.c.a(whg));
                            break;
                        case 5:
                        ...
                        case 8:
                            ...
                            break;
                        case 9:
                            builder.num_episodes((Integer) ProtoAdapter.c.a(whg));
                            break;
                        case 10:
                            builder.consumption_order((String) ProtoAdapter.i.a(whg));
                            break;
                        case 11:
                            builder.media_type_enum((Integer) ProtoAdapter.b.a(whg));
                            break;
                        case 12:
                            builder.copyright.add(ProtoAdapter.i.a(whg));
                            break;
                        default:
        ...
        public final /* bridge */ /* synthetic */ void a(whh whh, Object obj) {
            ...
            if (protoShowMetadata.link != null) {
                ProtoAdapter.i.a(whh, 1, protoShowMetadata.link);
            }
            if (protoShowMetadata.name != null) {
                ProtoAdapter.i.a(whh, 2, protoShowMetadata.name);
            }
            if (protoShowMetadata.description != null) {
                ProtoAdapter.i.a(whh, 3, protoShowMetadata.description);
            }
            if (protoShowMetadata.popularity != null) {
                ProtoAdapter.c.a(whh, 4, protoShowMetadata.popularity);
            }
            if (protoShowMetadata.publisher != null) {
                ProtoAdapter.i.a(whh, 5, protoShowMetadata.publisher);
            }
            if (protoShowMetadata.language != null) {
                ProtoAdapter.i.a(whh, 6, protoShowMetadata.language);
            }
            if (protoShowMetadata.is_explicit != null) {
                ProtoAdapter.a.a(whh, 7, protoShowMetadata.is_explicit);
            }
            if (protoShowMetadata.covers != null) {
                ProtoImageGroup.ADAPTER.a(whh, 8, protoShowMetadata.covers);
            }
            if (protoShowMetadata.num_episodes != null) {
                ProtoAdapter.c.a(whh, 9, protoShowMetadata.num_episodes);
            }
            if (protoShowMetadata.consumption_order != null) {
                ProtoAdapter.i.a(whh, 10, protoShowMetadata.consumption_order);
            }
            if (protoShowMetadata.media_type_enum != null) {
                ProtoAdapter.b.a(whh, 11, protoShowMetadata.media_type_enum);
            }
            ProtoAdapter.i.a().a(whh, 12, protoShowMetadata.copyright);
            whh.a(protoShowMetadata.a());
        }
    }
    ...
    public ProtoShowMetadata(String str, String str2, String str3, Integer num, String str4, String str5, Boolean bool, ProtoImageGroup protoImageGroup, Integer num2, String str6, Integer num3, List<String> list, ByteString byteString) {
        ...
        this.copyright = whk.a("copyright", list);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoShowMetadata protoShowMetadata = (ProtoShowMetadata) obj;
        return a().equals(protoShowMetadata.a()) && whk.a((Object) this.link, (Object) protoShowMetadata.link) && whk.a((Object) this.name, (Object) protoShowMetadata.name) && whk.a((Object) this.description, (Object) protoShowMetadata.description) && whk.a((Object) this.popularity, (Object) protoShowMetadata.popularity) && whk.a((Object) this.publisher, (Object) protoShowMetadata.publisher) && whk.a((Object) this.language, (Object) protoShowMetadata.language) && whk.a((Object) this.is_explicit, (Object) protoShowMetadata.is_explicit) && whk.a((Object) this.covers, (Object) protoShowMetadata.covers) && whk.a((Object) this.num_episodes, (Object) protoShowMetadata.num_episodes) && whk.a((Object) this.consumption_order, (Object) protoShowMetadata.consumption_order) && whk.a((Object) this.media_type_enum, (Object) protoShowMetadata.media_type_enum) && this.copyright.equals(protoShowMetadata.copyright);
    }
    ...
    public final int hashCode() {
        ...
        if (i == 0) {
            ...
            i = ((hashCode11 + i2) * 37) + this.copyright.hashCode();
            this.hashCode = i;
        }
        return i;
    }
    ...
    public final String toString() {
        ...
        if (this.popularity != null) {
            String str2 = "=l,my tpiruao";
            sb.append(", popularity=");
            sb.append(this.popularity);
        }
        if (this.publisher != null) {
            String str3 = "pureosbi=l,h";
            sb.append(", publisher=");
            sb.append(this.publisher);
        }
        if (this.language != null) {
            String str4 = "uagn=bga, e";
            sb.append(", language=");
            sb.append(this.language);
        }
        if (this.is_explicit != null) {
            String str5 = ",c=ieibxi lpts";
