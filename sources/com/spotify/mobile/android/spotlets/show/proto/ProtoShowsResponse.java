...
public final class ProtoShowsResponse extends Message<ProtoShowsResponse, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ProtoShowsResponse, Builder> {
        public List<ProtoShowsRequestItem> item = whk.a();
    ...
    static final class a extends ProtoAdapter<ProtoShowsResponse> {
        ...
        public final /* synthetic */ Object a(whg whg) {
            ...
            while (true) {
                ...
                if (b == -1) {
                    ...
                    builder.item.add(ProtoShowsRequestItem.ADAPTER.a(whg));
                } else if (b == 2) {
                    builder.num_offlined_episodes((Integer) ProtoAdapter.c.a(whg));
                } else if (b == 3) {
        ...
        public final /* bridge */ /* synthetic */ void a(whh whh, Object obj) {
            ProtoShowsResponse protoShowsResponse = (ProtoShowsResponse) obj;
            ProtoShowsRequestItem.ADAPTER.a().a(whh, 1, protoShowsResponse.item);
            if (protoShowsResponse.num_offlined_episodes != null) {
                ProtoAdapter.c.a(whh, 2, protoShowsResponse.num_offlined_episodes);
            }
            if (protoShowsResponse.unfiltered_length != null) {
                ProtoAdapter.c.a(whh, 3, protoShowsResponse.unfiltered_length);
            }
            if (protoShowsResponse.unranged_length != null) {
                ProtoAdapter.c.a(whh, 4, protoShowsResponse.unranged_length);
            }
            if (protoShowsResponse.loading_contents != null) {
                ProtoAdapter.a.a(whh, 5, protoShowsResponse.loading_contents);
            }
            whh.a(protoShowsResponse.a());
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoShowsResponse protoShowsResponse = (ProtoShowsResponse) obj;
        return a().equals(protoShowsResponse.a()) && this.item.equals(protoShowsResponse.item) && whk.a((Object) this.num_offlined_episodes, (Object) protoShowsResponse.num_offlined_episodes) && whk.a((Object) this.unfiltered_length, (Object) protoShowsResponse.unfiltered_length) && whk.a((Object) this.unranged_length, (Object) protoShowsResponse.unranged_length) && whk.a((Object) this.loading_contents, (Object) protoShowsResponse.loading_contents);
    }
    ...
    public final String toString() {
        ...
        String str5 = "sRpsPebhnrwoo{otsSe";
