...
public class FacebookFeedShareActivity extends kyd {
    public ixg g;

    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView((int) R.layout.story_share_loader_layout);
        ixg.a(this, Uri.parse(((ixe) getIntent().getParcelableExtra("share.extra.UNIQUE_SHARE")).a()));
        finish();
    }
    ...
    public final rdh af() {
        return rdh.a(PageIdentifiers.SHARE_FACEBOOKFEED, null);
    }
}
