...
public final class ProtoDecorateArtistItem extends Message<ProtoDecorateArtistItem, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ProtoDecorateArtistItem, Builder> {
        ...
        public final ProtoDecorateArtistItem build() {
            ProtoDecorateArtistItem protoDecorateArtistItem = new ProtoDecorateArtistItem(this.artist_metadata, this.collection_state, this.offline_state, this.link, super.buildUnknownFields());
            return protoDecorateArtistItem;
        }
    }
    ...
    static final class a extends ProtoAdapter<ProtoDecorateArtistItem> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (protoDecorateArtistItem.artist_metadata != null) {
                ProtoArtistMetadata.ADAPTER.a(vtb, 1, protoDecorateArtistItem.artist_metadata);
            }
            if (protoDecorateArtistItem.collection_state != null) {
                ProtoArtistCollectionState.ADAPTER.a(vtb, 2, protoDecorateArtistItem.collection_state);
            }
            if (protoDecorateArtistItem.offline_state != null) {
                ProtoArtistOfflineState.ADAPTER.a(vtb, 3, protoDecorateArtistItem.offline_state);
            }
            if (protoDecorateArtistItem.link != null) {
                ProtoAdapter.i.a(vtb, 4, protoDecorateArtistItem.link);
            }
            vtb.a(protoDecorateArtistItem.a());
        }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoDecorateArtistItem protoDecorateArtistItem = (ProtoDecorateArtistItem) obj;
        return a().equals(protoDecorateArtistItem.a()) && vte.a((Object) this.artist_metadata, (Object) protoDecorateArtistItem.artist_metadata) && vte.a((Object) this.collection_state, (Object) protoDecorateArtistItem.collection_state) && vte.a((Object) this.offline_state, (Object) protoDecorateArtistItem.offline_state) && vte.a((Object) this.link, (Object) protoDecorateArtistItem.link);
    }
