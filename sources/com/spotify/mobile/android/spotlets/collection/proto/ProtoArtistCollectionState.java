...
public final class ProtoArtistCollectionState extends Message<ProtoArtistCollectionState, Builder> {
    ...
    static final class a extends ProtoAdapter<ProtoArtistCollectionState> {
        ...
        public final /* synthetic */ int a(Object obj) {
            ...
            int i2 = 0;
            int a = protoArtistCollectionState.collection_link != null ? ProtoAdapter.i.a(1, protoArtistCollectionState.collection_link) : 0;
            if (protoArtistCollectionState.followed != null) {
                boolean z = false | true;
                i = ProtoAdapter.a.a(2, protoArtistCollectionState.followed);
            } else {
                i = 0;
            }
            int a2 = a + i + (protoArtistCollectionState.num_tracks_in_collection != null ? ProtoAdapter.c.a(3, protoArtistCollectionState.num_tracks_in_collection) : 0) + (protoArtistCollectionState.num_albums_in_collection != null ? ProtoAdapter.c.a(4, protoArtistCollectionState.num_albums_in_collection) : 0);
            if (protoArtistCollectionState.is_banned != null) {
                i2 = ProtoAdapter.a.a(5, protoArtistCollectionState.is_banned);
            }
            return a2 + i2 + protoArtistCollectionState.a().h();
        }
        ...
        public final /* synthetic */ Object a(whg whg) {
            ...
            while (true) {
                ...
                if (b == -1) {
                    ...
                    builder.num_albums_in_collection((Integer) ProtoAdapter.c.a(whg));
                } else if (b != 5) {
        ...
        public final /* bridge */ /* synthetic */ void a(whh whh, Object obj) {
            ...
            if (protoArtistCollectionState.collection_link != null) {
                ProtoAdapter.i.a(whh, 1, protoArtistCollectionState.collection_link);
            }
            if (protoArtistCollectionState.followed != null) {
                ProtoAdapter.a.a(whh, 2, protoArtistCollectionState.followed);
            }
            if (protoArtistCollectionState.num_tracks_in_collection != null) {
                ProtoAdapter.c.a(whh, 3, protoArtistCollectionState.num_tracks_in_collection);
            }
            if (protoArtistCollectionState.num_albums_in_collection != null) {
                ProtoAdapter.c.a(whh, 4, protoArtistCollectionState.num_albums_in_collection);
            }
            if (protoArtistCollectionState.is_banned != null) {
                ProtoAdapter.a.a(whh, 5, protoArtistCollectionState.is_banned);
            }
            whh.a(protoArtistCollectionState.a());
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoArtistCollectionState protoArtistCollectionState = (ProtoArtistCollectionState) obj;
        return a().equals(protoArtistCollectionState.a()) && whk.a((Object) this.collection_link, (Object) protoArtistCollectionState.collection_link) && whk.a((Object) this.followed, (Object) protoArtistCollectionState.followed) && whk.a((Object) this.num_tracks_in_collection, (Object) protoArtistCollectionState.num_tracks_in_collection) && whk.a((Object) this.num_albums_in_collection, (Object) protoArtistCollectionState.num_albums_in_collection) && whk.a((Object) this.is_banned, (Object) protoArtistCollectionState.is_banned);
    }
    ...
    public final String toString() {
        ...
        if (this.is_banned != null) {
            String str2 = "nnbm=isea ,_";
            sb.append(", is_banned=");
            sb.append(this.is_banned);
        }
        String str3 = "ltatooon{ectiCAstoPtlSireot";
