...
public final class ProtoCollectionTracksItem extends Message<ProtoCollectionTracksItem, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ProtoCollectionTracksItem, Builder> {
        ...
        public final ProtoCollectionTracksItem build() {
            ProtoCollectionTracksItem protoCollectionTracksItem = new ProtoCollectionTracksItem(this.header_field, this.headerless_index, this.add_time, this.track_metadata, this.offline_state, this.play_state, this.collection_state, super.buildUnknownFields());
    ...
    static final class a extends ProtoAdapter<ProtoCollectionTracksItem> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (protoCollectionTracksItem.header_field != null) {
                ProtoAdapter.i.a(vtb, 1, protoCollectionTracksItem.header_field);
            }
            if (protoCollectionTracksItem.headerless_index != null) {
                ProtoAdapter.c.a(vtb, 2, protoCollectionTracksItem.headerless_index);
            }
            if (protoCollectionTracksItem.add_time != null) {
                ProtoAdapter.c.a(vtb, 3, protoCollectionTracksItem.add_time);
            }
            if (protoCollectionTracksItem.track_metadata != null) {
                ProtoTrackMetadata.ADAPTER.a(vtb, 4, protoCollectionTracksItem.track_metadata);
            }
            if (protoCollectionTracksItem.offline_state != null) {
                ProtoTrackOfflineState.ADAPTER.a(vtb, 5, protoCollectionTracksItem.offline_state);
            }
            if (protoCollectionTracksItem.play_state != null) {
                ProtoTrackPlayState.ADAPTER.a(vtb, 6, protoCollectionTracksItem.play_state);
            }
            if (protoCollectionTracksItem.collection_state != null) {
                ProtoTrackCollectionState.ADAPTER.a(vtb, 7, protoCollectionTracksItem.collection_state);
            }
            vtb.a(protoCollectionTracksItem.a());
        }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoCollectionTracksItem protoCollectionTracksItem = (ProtoCollectionTracksItem) obj;
        return a().equals(protoCollectionTracksItem.a()) && vte.a((Object) this.header_field, (Object) protoCollectionTracksItem.header_field) && vte.a((Object) this.headerless_index, (Object) protoCollectionTracksItem.headerless_index) && vte.a((Object) this.add_time, (Object) protoCollectionTracksItem.add_time) && vte.a((Object) this.track_metadata, (Object) protoCollectionTracksItem.track_metadata) && vte.a((Object) this.offline_state, (Object) protoCollectionTracksItem.offline_state) && vte.a((Object) this.play_state, (Object) protoCollectionTracksItem.play_state) && vte.a((Object) this.collection_state, (Object) protoCollectionTracksItem.collection_state);
    }
