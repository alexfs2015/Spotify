...
public final class ProtoTrackCollectionState extends Message<ProtoTrackCollectionState, Builder> {
    ...
    public static final class Builder extends com.squareup.wire.Message.a<ProtoTrackCollectionState, Builder> {
        ...
        public final ProtoTrackCollectionState build() {
            ProtoTrackCollectionState protoTrackCollectionState = new ProtoTrackCollectionState(this.is_in_collection, this.can_add_to_collection, this.is_banned, this.can_ban, super.buildUnknownFields());
    ...
    static final class a extends ProtoAdapter<ProtoTrackCollectionState> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (protoTrackCollectionState.is_in_collection != null) {
                ProtoAdapter.a.a(vtb, 1, protoTrackCollectionState.is_in_collection);
            }
            if (protoTrackCollectionState.can_add_to_collection != null) {
                ProtoAdapter.a.a(vtb, 2, protoTrackCollectionState.can_add_to_collection);
            }
            if (protoTrackCollectionState.is_banned != null) {
                ProtoAdapter.a.a(vtb, 3, protoTrackCollectionState.is_banned);
            }
            if (protoTrackCollectionState.can_ban != null) {
                ProtoAdapter.a.a(vtb, 4, protoTrackCollectionState.can_ban);
            }
            vtb.a(protoTrackCollectionState.a());
        }
        ...
        public final /* synthetic */ Object a(vta vta) {
            ...
            while (true) {
                ...
                if (b == -1) {
                    ...
                    builder.can_add_to_collection((Boolean) ProtoAdapter.a.a(vta));
                } else if (b == 3) {
                    ...
                    builder.can_ban((Boolean) ProtoAdapter.a.a(vta));
                }
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ProtoTrackCollectionState protoTrackCollectionState = (ProtoTrackCollectionState) obj;
        return a().equals(protoTrackCollectionState.a()) && vte.a((Object) this.is_in_collection, (Object) protoTrackCollectionState.is_in_collection) && vte.a((Object) this.can_add_to_collection, (Object) protoTrackCollectionState.can_add_to_collection) && vte.a((Object) this.is_banned, (Object) protoTrackCollectionState.is_banned) && vte.a((Object) this.can_ban, (Object) protoTrackCollectionState.can_ban);
    }
