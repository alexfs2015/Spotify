...
public class FrameLayoutManager extends i {
    ...
    public final void c(o oVar, s sVar) {
        ...
        for (int i = 0; i < t; i++) {
            ...
            int a = i.a(this.u, this.s, getPaddingLeft() + getPaddingRight() + h.left + h.right + 0, layoutParams.width, e());
            int a2 = i.a(this.v, this.t, getPaddingTop() + getPaddingBottom() + i2, layoutParams.height, f());
