...
public class SkippableAdTextView extends AppCompatTextView implements OnClickListener, ifd {
    private int a;
    private a b;
    ...
    public final void a(long j) {
        ...
        uuu.a(getContext(), this, 2132017665);
        spannableString.setSpan(new ForegroundColorSpan(fr.c(getContext(), R.color.white_40)), 0, spannableString.length() - 1, 17);
        spannableString.setSpan(new TextAppearanceSpan(getContext(), 2132017666), spannableString.length() - 1, spannableString.length(), 17);
    ...
    public final void c() {
        ...
        setVisibility(0);
        uuu.a(getContext(), this, 2132017666);
    }
