...
abstract class C$AutoValue_AdSlotEvent extends AdSlotEvent {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AdSlotEvent) {
            ...
            if (this.eventString.equals(adSlotEvent.getEventString()) && this.formatString.equals(adSlotEvent.getFormatString()) && this.ad.equals(adSlotEvent.getAd())) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        String str = "desAovntSEtneetin=gSvr{t";
