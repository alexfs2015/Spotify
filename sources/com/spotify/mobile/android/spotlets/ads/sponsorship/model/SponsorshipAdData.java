...
public abstract class SponsorshipAdData implements JacksonModel {
    ...
    public static SponsorshipAdData create(@JsonProperty("thirdPartyImpression") String str, @JsonProperty("creativeId") String str2, @JsonProperty("lineItemId") String str3, @JsonProperty("impression") String str4, @JsonProperty("logoUrl") String str5, @JsonProperty("clickThrough") String str6, @JsonProperty("clickTracking") String str7, @JsonProperty("advertiserName") String str8) {
        AutoValue_SponsorshipAdData autoValue_SponsorshipAdData = r0;
        String str9 = str7;
        String str10 = str8;
        AutoValue_SponsorshipAdData autoValue_SponsorshipAdData2 = new AutoValue_SponsorshipAdData(str, str2, str3, str4, str5, str6, str7, str8);
        return autoValue_SponsorshipAdData2;
    }

    public static SponsorshipAdData fromPreviewAd(Ad ad) {
        Assertion.a("Unable to extract sponsorship data from non sponsorship ad", ad.isSponsorship());
        JSONObject parseJsonDataFromCreativeMedia = parseJsonDataFromCreativeMedia(((Display) ad.getDisplays().get(0)).getMedia());
        String str = "risdniPkaTrhtgyctr";
        String str2 = "aIrmctivee";
        String str3 = "dteioImnIe";
        String str4 = "olgo";
        String str5 = "kiclcbiankgrc";
        String str6 = "earriebamsdNve";
        String str7 = "";
    ...
    public static JSONObject parseJsonDataFromCreativeMedia(String str) {
        ...
        if (matcher.find()) {
            ...
            String str2 = "sdPiopytslonrasle";
            return jSONObject.getJSONObject("sponsoredPlaylist");
        }
