...
final class AutoValue_SettingsState extends SettingsState {
    ...
    static final class a extends com.spotify.mobile.android.util.loader.SettingsState.a {
        ...
        public final SettingsState a() {
            ...
            if (this.b == null) {
                ...
                sb2.append(str);
                String str3 = "p emnlpiaictltECntxy";
            ...
            if (this.i == null) {
                ...
                sb9.append(str);
                String str6 = "OixEoib npfrsseTfnoycde";
            ...
            if (this.m == null) {
                ...
                sb13.append(str);
                String str8 = "stne orspnevoEunnlid";
            ...
            if (this.o == null) {
                ...
                sb15.append(str);
                String str10 = "disoaosefsd ccrTenems";
            ...
            if (this.q == null) {
                ...
                sb17.append(str);
                String str11 = "ODcmnciyalollev e";
            ...
            if (this.r == null) {
                ...
                sb18.append(str);
                String str12 = " regobleawt";
                sb18.append(" webgateUrl");
                str = sb18.toString();
            }
            if (str.isEmpty()) {
                AutoValue_SettingsState autoValue_SettingsState = r3;
                AutoValue_SettingsState autoValue_SettingsState2 = new AutoValue_SettingsState(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d.booleanValue(), this.e.intValue(), this.f.intValue(), this.g, this.h.booleanValue(), this.i.intValue(), this.j.booleanValue(), this.k.booleanValue(), this.l.booleanValue(), this.m.intValue(), this.n.booleanValue(), this.o.intValue(), this.p.booleanValue(), this.q.booleanValue(), this.r);
                return autoValue_SettingsState2;
            }
    ...
    public final String toString() {
        String str = "etsgtSlotoffesndtMai{eSein";
        ...
        String str2 = "oldmodwOa v,g=3re";
        sb.append(", downloadOver3g=");
        sb.append(this.downloadOver3g);
        String str3 = "=id,oooanaQ wytlud";
