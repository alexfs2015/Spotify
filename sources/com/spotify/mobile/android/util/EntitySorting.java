...
public abstract class EntitySorting {
    ...
    private SortingModel b() {
        ...
        if (!TextUtils.isEmpty(a2)) {
            try {
                ...
                String str2 = "sasn go rlem Feotrscdftftiihi.et  ";
    ...
    public final SortOption a(String str, SortOption sortOption, List<SortOption> list) {
        return (SortOption) jvi.a(SortOption.a((String) b().getMap().get(str), list), sortOption);
    }
    ...
    public final void a(String str, String str2) {
        ...
        try {
            ...
            String str4 = "i tmtieerwimldt sFeo ogosiat rf :nr";
