...
public class ParallaxView extends ConstraintLayout {
    ...
    private void b() {
        ...
        this.b = ip.d((View) this, (int) R.id.view_front);
        this.c = ip.d((View) this, (int) R.id.view_mid_front);
        this.d = ip.d((View) this, (int) R.id.view_mid_back);
        this.e = ip.d((View) this, (int) R.id.view_back);
