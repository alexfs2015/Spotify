...
public class PlayerTrack implements Parcelable, JacksonModel {
    ...
    public static PlayerTrack create(String str) {
        String str2 = str;
        PlayerTrack playerTrack = new PlayerTrack(str2, "", null, null, null, Collections.EMPTY_MAP);
        return playerTrack;
    }

    public static PlayerTrack create(String str, Map<String, String> map) {
        PlayerTrack playerTrack = new PlayerTrack(str, "", null, null, null, map);
        return playerTrack;
    }

    public static PlayerTrack create(String str, String str2, String str3) {
        String str4 = str;
        PlayerTrack playerTrack = new PlayerTrack(str4, "", str2, str3, null, Collections.EMPTY_MAP);
        return playerTrack;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return faw.a(this.mProvider, playerTrack.mProvider) && faw.a(this.mUri, playerTrack.mUri) && faw.a(this.mUid, playerTrack.mUid) && MapUtils.areMapsEqual(this.mMetadata, playerTrack.mMetadata);
    }
