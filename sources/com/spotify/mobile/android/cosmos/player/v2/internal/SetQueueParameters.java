...
public class SetQueueParameters implements JacksonModel {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.mRevision.equals(setQueueParameters.mRevision)) {
            return false;
        }
        if (!Arrays.equals(this.mNextTracks, setQueueParameters.mNextTracks)) {
            return false;
        }
        if (!fbn.a(this.mPlayOptions, setQueueParameters.mPlayOptions)) {
            return false;
        }
