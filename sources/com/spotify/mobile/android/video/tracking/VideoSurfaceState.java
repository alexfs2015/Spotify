...
public enum VideoSurfaceState {
    ...
    public static VideoSurfaceState a(boolean z, boolean z2, int i) {
        return z ? BACKGROUND : (!z2 || i != 0) ? (!z2 || i != 1) ? (z2 || i != 0) ? (z2 || i != 1) ? z2 ? FOREGROUND_FULLSCREEN_UNKNOWN_ORIENTATION : FOREGROUND_NON_FULLSCREEN_UNKNOWN_ORIENTATION : FOREGROUND_NON_FULLSCREEN_LANDSCAPE : FOREGROUND_NON_FULLSCREEN_PORTRAIT : FOREGROUND_FULLSCREEN_LANDSCAPE : FOREGROUND_FULLSCREEN_PORTRAIT;
    }
}
