...
final class HubsJsonComponentImages extends had implements JacksonModel {
    ...
    private HubsJsonComponentImages(HubsJsonImage hubsJsonImage, HubsJsonImage hubsJsonImage2, Map<String, ? extends hag> map, String str) {
        super(hubsJsonImage, hubsJsonImage2, hap.a(map), str);
    }
