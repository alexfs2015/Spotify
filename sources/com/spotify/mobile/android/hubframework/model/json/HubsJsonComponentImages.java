...
final class HubsJsonComponentImages extends hcw implements JacksonModel {
    ...
    private HubsJsonComponentImages(HubsJsonImage hubsJsonImage, HubsJsonImage hubsJsonImage2, Map<String, ? extends hcz> map, String str) {
        super(hubsJsonImage, hubsJsonImage2, hdi.a(map), str);
    }
