...
public final class WebApiSearchModel {
    ...
    public static class Response implements JacksonModel {
        ...
        public Albums getAlbums() {
            return (Albums) fay.a(this.mAlbums);
        }

        @JsonGetter("artists")
        public Artists getArtists() {
            return (Artists) fay.a(this.mArtists);
        }

        @JsonGetter("playlists")
        public Playlists getPlaylists() {
            return (Playlists) fay.a(this.mPlaylists);
        }

        @JsonGetter("tracks")
        public Tracks getTracks() {
            return (Tracks) fay.a(this.mTracks);
        }
