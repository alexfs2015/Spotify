...
public class CancellableSeekBar extends AppCompatSeekBar {
    ...
    public CancellableSeekBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.e = new Object();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.jtf.a.k);
        this.g = obtainStyledAttributes.getDimension(defpackage.jtf.a.l, 0.0f);
