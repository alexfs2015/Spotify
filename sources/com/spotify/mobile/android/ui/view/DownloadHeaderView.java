...
public class DownloadHeaderView extends LinearLayout implements defpackage.jst.a {
    public boolean a;
    public a b;
    private boolean c;
    private jtt d;
    ...
    public /* synthetic */ void a(CompoundButton compoundButton, boolean z) {
        if (!this.a || this.j.isChecked()) {
            ...
            this.o.a((defpackage.jss.a) new defpackage.jss.a() {
    ...
    /* access modifiers changed from: private */
    public /* synthetic */ void a(defpackage.vli.a aVar) {
    ...
    public /* synthetic */ void a(h hVar) {
        ...
        State state = i2 != 1 ? i2 != 2 ? i2 != 3 ? i2 != 4 ? State.WAITING : State.SYNC_NOT_ALLOWED : State.OFFLINE_MODE : State.NO_INTERNET : State.WAITING;
        a(state, hVar.b);
    }
    ...
    public void onFinishInflate() {
        ...
        if (!isInEditMode()) {
            ...
            c();
            vgl.a(getContext(), this.l, 2132017669);
            this.l.setTextColor(fr.c(getContext(), R.color.white));
            SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(getContext(), SpotifyIconV2.DOWNLOAD, (float) vfj.b(16.0f, getContext().getResources()));
