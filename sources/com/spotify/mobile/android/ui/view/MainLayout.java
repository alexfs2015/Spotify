...
public class MainLayout extends ConstraintLayout {
    ...
    public b f;
    public final Set<defpackage.kyi.a> g = new HashSet();
    ...
    class d implements c {
        ...
        public final void a(int i, int i2) {
            ...
            if (MainLayout.this.b.b > 0 && gaa.b(MainLayout.this.getContext())) {
                measuredHeight += gaa.a(MainLayout.this.getContext().getResources());
            }
        ...
        public final void a(boolean z, int i, int i2, int i3, int i4) {
            ...
            int a2 = (!gaa.b(MainLayout.this.getContext()) || i6 == 0) ? 0 : gaa.a(MainLayout.this.getContext().getResources());
            int i8 = i6 - a2;
            int i9 = i7 - a2;
    ...
    public void onFinishInflate() {
        ...
        this.h = gab.b(getContext());
        this.b.c = (com.spotify.mobile.android.ui.view.snackbar.SnackBar.b) fav.a(new com.spotify.mobile.android.ui.view.snackbar.SnackBar.b() {
    ...
    public void a(View view, float f2) {
        ...
        if (gaa.b(getContext())) {
            measuredHeight -= (float) gaa.a(getContext().getResources());
    ...
    private static int d(View view) {
        ...
        return childAt != null ? childAt.getId() : id;
    }

    public final void a(ConnectAccessViewModel connectAccessViewModel) {
        this.m = (ConnectAccessViewModel) fay.a(connectAccessViewModel);
        ...
        if (connectAccessViewModel3 != null) {
            ...
            connectAccessViewModel3.e = Optional.b(new rom(connectAccessButton, connectAccessViewModel3.a));
            connectAccessViewModel3.f = Optional.b(new rot(connectAccessButton));
    ...
    public final void b() {
        for (defpackage.kyi.a an : this.g) {
            an.an();
        }
    }
