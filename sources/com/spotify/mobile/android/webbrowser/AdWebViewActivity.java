...
public class AdWebViewActivity extends lbm {
    public gfk<fli> g;
    public jtz h;
    ...
    public void c(int i2) {
        String str = "atsi-ge dshCdna   %t%g>";
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.j.setWebViewClient(new WebViewClient() {
            public final void onPageFinished(WebView webView, String str) {
                String str2 = "d srsenP]Br aAiode[dolhs:fgew i";
                Logger.b("[AdBrowser]: Page load finished", new Object[0]);
                String str3 = "";
                AdWebViewActivity.this.g.a(InAppBrowserEvent.k().a(InAppBrowserLogEvent.PAGE_LOADED.a()).a(AdWebViewActivity.this.h.a()).b("").g());
            ...
            public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
                String str2 = " remasra[osoA:ddw etBe dPla]tg";
            ...
            public final void onReceivedError(WebView webView, int i, String str, String str2) {
                ...
                try {
                    ...
                    String str3 = "soreoanRero";
                    jSONObject.put("errorReason", String.valueOf(str));
                } catch (JSONException e) {
                    String str4 = " toeeb bnoasratUala dnect ";
                    Logger.e(e, "Unable to create json data", new Object[0]);
                }
                AdWebViewActivity.this.g.a(InAppBrowserEvent.k().a(InAppBrowserLogEvent.ERROR.a()).a(AdWebViewActivity.this.h.a()).b(jSONObject.toString()).g());
        ...
        this.g.a(InAppBrowserEvent.k().a(InAppBrowserLogEvent.OPENED.a()).a(this.h.a()).b(jSONObject.toString()).g());
    }
    ...
    public void onDestroy() {
        ...
        String str = "";
        this.g.a(InAppBrowserEvent.k().a(InAppBrowserLogEvent.CLOSED.a()).a(this.h.a()).b("").g());
        WebView webView = this.j;
        if (webView != null) {
