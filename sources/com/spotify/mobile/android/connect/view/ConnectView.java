...
public class ConnectView extends LinearLayout implements uue {
    ...
    private boolean i;
    private boolean j;
    private final uud k = new uud(this);
    ...
    public void onFinishInflate() {
        ...
        gsl gsl = new gsl(getContext(), uts.b(20.0f, getResources()), R.color.btn_now_playing_connect);
        this.h = new gsc(imageView2, gsl);
        this.f = new gsf(imageView, gsl);
        this.g = new gsi(imageView3, gsl);
        this.f.b();
        this.h.b();
        this.g.b();
        refreshDrawableState();
        uui.b(this).a(this.b).b(imageView, imageView2).a();
    }
