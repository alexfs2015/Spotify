...
public class StorylinesView extends CardView implements a, StorylinesCardView.a, jip {
    public jin i;
    ...
    private void d() {
        ...
        this.l = (StoriesProgressView) ip.c((View) this, (int) R.id.progress_view);
        this.j = (CarouselView) ip.c((View) this, (int) R.id.carousel);
        this.m = ip.c((View) this, (int) R.id.artist_attribution);
        this.n = (TextView) ip.c((View) this, (int) R.id.storylines_by);
        this.o = (ImageView) ip.c((View) this, (int) R.id.artist_avatar);
        this.q = (ToggleButton) ip.c((View) this, (int) R.id.follow_button);
        this.r = (TextView) ip.c((View) this, (int) R.id.error_title);
        this.s = (TextView) ip.c((View) this, (int) R.id.error_message);
        this.t = ip.c((View) this, (int) R.id.loading_view);
        ...
        ip.c((View) this, (int) R.id.reverse).setOnTouchListener(new OnTouchListener() {
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return StorylinesView.this.b(view, motionEvent);
            }
        });
        ip.c((View) this, (int) R.id.skip).setOnTouchListener(new OnTouchListener() {
            public final boolean onTouch(View view, MotionEvent motionEvent) {
    ...
    public final void a(List<StorylinesCardImageModel> list, jil jil) {
        jin jin = this.i;
        jin.d = this;
        jin.e = jil;
        jin.a.clear();
