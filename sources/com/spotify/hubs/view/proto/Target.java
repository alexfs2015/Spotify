...
public final class Target extends GeneratedMessageLite<Target, a> implements giv {
    /* access modifiers changed from: private */
    public static final Target i;
    private static volatile fkr<Target> j;
    private int d;
    private String e = "";
    ...
    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<Target, a> implements giv {
        /* synthetic */ a(byte b) {
            this();
        }
    ...
    public final int j() {
        ...
        if (this.g != null) {
            size += CodedOutputStream.b(3, (fko) m());
        }
        if (this.h != null) {
            size += CodedOutputStream.b(4, (fko) n());
        }
        this.c = size;
        return size;
    }
                    ...
                    try {
                        ...
                        if (a2 != 0) {
                            if (a2 == 10) {
                                ...
                                this.g = (View) fkc.a(View.parser(), fke);
                                if (aVar != null) {
                                    aVar.a(this.g);
                                    this.g = (View) aVar.e();
                                }
                                ...
                                this.h = (Struct) fkc.a(Struct.parser(), fke);
                                if (aVar2 != null) {
                                    aVar2.a(this.h);
    ...
    public static fkr<Target> parser() {
        return i.c();
    }
}
