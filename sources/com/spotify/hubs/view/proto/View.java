...
public final class View extends GeneratedMessageLite<View, a> implements giy {
    /* access modifiers changed from: private */
    public static final View l;
    private static volatile fkr<View> m;
    public String d;
    public String e;
    public e<Component> f = fks.d();
    public String g;
    private int h;
    private Component i;
    private e<Component> j = fks.d();
    private Struct k;

    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<View, a> implements giy {
        /* synthetic */ a(byte b) {
            this();
        }
    ...
    public final void a(CodedOutputStream codedOutputStream) {
        ...
        for (int i3 = 0; i3 < this.j.size(); i3++) {
            codedOutputStream.a(5, (fko) this.j.get(i3));
        }
        if (!this.g.isEmpty()) {
            codedOutputStream.a(6, this.g);
        }
        if (this.k != null) {
            codedOutputStream.a(7, (fko) l());
        }
    }
    ...
    public final int j() {
        ...
        for (int i5 = 0; i5 < this.j.size(); i5++) {
            i3 += CodedOutputStream.b(5, (fko) this.j.get(i5));
        }
        if (!this.g.isEmpty()) {
            i3 += CodedOutputStream.b(6, this.g);
        }
        if (this.k != null) {
            i3 += CodedOutputStream.b(7, (fko) l());
        }
        this.c = i3;
        return i3;
    }
                    ...
                    try {
                        ...
                        if (a2 != 0) {
                            if (a2 == 10) {
                                ...
                                this.i = (Component) fkc.a(Component.parser(), fke);
                                if (aVar != null) {
                                    aVar.a(this.i);
                                ...
                                this.f.add(fkc.a(Component.parser(), fke));
                            } else if (a2 == 42) {
                                if (!this.j.a()) {
                                    this.j = GeneratedMessageLite.a(this.j);
                                }
                                this.j.add(fkc.a(Component.parser(), fke));
                            } else if (a2 == 50) {
                                this.g = fkc.d();
                            } else if (a2 == 58) {
                                com.google.protobuf.Struct.a aVar2 = this.k != null ? (com.google.protobuf.Struct.a) this.k.h() : null;
                                this.k = (Struct) fkc.a(Struct.parser(), fke);
                                if (aVar2 != null) {
                                    aVar2.a(this.k);
