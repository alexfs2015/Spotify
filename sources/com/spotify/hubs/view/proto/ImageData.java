...
public final class ImageData extends GeneratedMessageLite<ImageData, a> implements gke {
    /* access modifiers changed from: private */
    public static final ImageData h;
    private static volatile fll<ImageData> i;
    public String d;
    public String e;
    private String f;
    private Struct g;

    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<ImageData, a> implements gke {
        private a() {
            super(ImageData.h);
        }
    ...
    public static fll<ImageData> parser() {
        return h.c();
    }
                    ...
                    try {
                        ...
                        if (a2 != 0) {
                            if (a2 == 10) {
                                ...
                                this.g = (Struct) fkw.a(Struct.parser(), fky);
                                if (aVar != null) {
                                    aVar.a(this.g);
    ...
    public final int j() {
        ...
        if (this.g != null) {
            i3 += CodedOutputStream.b(4, (fli) k());
        }
        this.c = i3;
        return i3;
    }
