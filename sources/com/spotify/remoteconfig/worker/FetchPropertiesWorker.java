...
public class FetchPropertiesWorker extends Worker {
    ...
    public final a g() {
        if (!(this.a instanceof vhv)) {
            xal.c("Cannot fetch configuration. Application class does not implement RemoteConfigurationProvider.", new Object[0]);
            return new C0004a();
        }
        vhl b = ((vhv) this.a).b();
        ...
        if (b2 == null) {
            xal.b("Configuration successfully fetched.", new Object[0]);
            return new c();
        }
        xal.a(b2, "Cannot fetch configuration. Retrying soon.", new Object[0]);
        return new b();
    }
}
