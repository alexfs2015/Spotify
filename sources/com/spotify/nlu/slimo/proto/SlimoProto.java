...
public final class SlimoProto {
    ...
    public static final class ParsedQuery extends GeneratedMessageLite<ParsedQuery, a> implements vcj {
        /* access modifiers changed from: private */
        public static final ParsedQuery j;
        private static volatile fll<ParsedQuery> k;
        private int d;
        private int e;
        private Slots f;
        private String g;
        ...
        public static final class a extends com.google.protobuf.GeneratedMessageLite.a<ParsedQuery, a> implements vcj {
            private a() {
                super(ParsedQuery.j);
            }
        ...
        public static fll<ParsedQuery> parser() {
            return j.c();
        }
                        ...
                        try {
                            ...
                            if (a2 != 0) {
                                if (a2 == 8) {
                                    ...
                                    this.f = (Slots) fkw.a(Slots.parser(), fky);
                                    if (aVar != null) {
                                        aVar.a(this.f);
                                        this.f = (Slots) aVar.e();
                                    }
    ...
    public static final class Slots extends GeneratedMessageLite<Slots, a> implements vck {
        /* access modifiers changed from: private */
        public static final Slots O;
        private static volatile fll<Slots> P;
        private e<String> A = flm.d();
        private e<String> B = flm.d();
        private e<String> C = flm.d();
        private e<String> D = flm.d();
        private e<String> E = flm.d();
        private e<String> F = flm.d();
        private e<String> G = flm.d();
        private e<String> H = flm.d();
        ...
        private e<String> m = flm.d();
        private e<String> n = flm.d();
        private e<String> o = flm.d();
        private e<String> p = flm.d();
        private e<String> q = flm.d();
        private e<String> r = flm.d();
        private e<String> s = flm.d();
        private e<String> t = flm.d();
        private e<String> u = flm.d();
        private e<String> v = flm.d();
        private e<String> w = flm.d();
        private e<String> x = flm.d();
        private e<String> y = flm.d();
        private e<String> z = flm.d();

        public static final class a extends com.google.protobuf.GeneratedMessageLite.a<Slots, a> implements vck {
            private a() {
                super(Slots.O);
            }
        ...
        public static fll<Slots> parser() {
            return O.c();
        }
