...
public final class ParsedQuery extends Message<ParsedQuery, Builder> {
    ...
    public enum Intent implements vtd {
        WTF(0),
        PLAY(1),
        UNSUPPORTED(31),
        NO_INTENT(32),
    ...
    static final class a extends ProtoAdapter<ParsedQuery> {
        ...
        public final /* bridge */ /* synthetic */ void a(vtb vtb, Object obj) {
            ...
            if (parsedQuery.intent != null) {
                Intent.b.a(vtb, 1, parsedQuery.intent);
            }
            if (parsedQuery.slots != null) {
                Slots.ADAPTER.a(vtb, 2, parsedQuery.slots);
            }
            if (parsedQuery.utterance != null) {
                ProtoAdapter.i.a(vtb, 3, parsedQuery.utterance);
            }
            if (parsedQuery.user_id != null) {
                ProtoAdapter.i.a(vtb, 4, parsedQuery.user_id);
            }
            if (parsedQuery.score != null) {
                ProtoAdapter.h.a(vtb, 5, parsedQuery.score);
            }
            vtb.a(parsedQuery.a());
        }
        ...
        private static ParsedQuery b(vta vta) {
            ...
            while (true) {
                ...
                if (b == -1) {
                    ...
                    try {
                        builder.intent((Intent) Intent.b.a(vta));
                    } catch (EnumConstantNotFoundException e) {
                        builder.addUnknownField(b, FieldEncoding.VARINT, Long.valueOf((long) e.value));
                    }
                } else if (b == 2) {
                    builder.slots((Slots) Slots.ADAPTER.a(vta));
                } else if (b == 3) {
                    builder.utterance((String) ProtoAdapter.i.a(vta));
                } else if (b == 4) {
                    builder.user_id((String) ProtoAdapter.i.a(vta));
                } else if (b != 5) {
                    FieldEncoding fieldEncoding = vta.b;
                    builder.addUnknownField(b, fieldEncoding, fieldEncoding.a().a(vta));
                } else {
                    builder.score((Float) ProtoAdapter.h.a(vta));
                }
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        ...
        ParsedQuery parsedQuery = (ParsedQuery) obj;
        return a().equals(parsedQuery.a()) && vte.a((Object) this.intent, (Object) parsedQuery.intent) && vte.a((Object) this.slots, (Object) parsedQuery.slots) && vte.a((Object) this.utterance, (Object) parsedQuery.utterance) && vte.a((Object) this.user_id, (Object) parsedQuery.user_id) && vte.a((Object) this.score, (Object) parsedQuery.score);
    }
