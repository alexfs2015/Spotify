...
public class PreviewSubmissionView extends LinearLayout {
    ...
    private void b() {
        ...
        this.a = (EditText) ip.d((View) this, (int) R.id.creative_id);
        this.b = (Spinner) ip.d((View) this, (int) R.id.trigger_type);
        ...
        this.d = (Button) ip.d((View) this, (int) R.id.button_positive);
        this.c = (Button) ip.d((View) this, (int) R.id.button_negative);
    }
