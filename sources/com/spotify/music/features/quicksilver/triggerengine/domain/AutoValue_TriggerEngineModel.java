...
final class AutoValue_TriggerEngineModel extends TriggerEngineModel {
    ...
    private final ImmutableList<prk> triggerList;
    ...
    static final class a implements com.spotify.music.features.quicksilver.triggerengine.domain.TriggerEngineModel.a {
        ...
        public final com.spotify.music.features.quicksilver.triggerengine.domain.TriggerEngineModel.a b(ImmutableList<prk> immutableList) {
            if (immutableList != null) {
    ...
    private AutoValue_TriggerEngineModel(ImmutableList<OutboundRequest> immutableList, ImmutableList<prk> immutableList2, boolean z, boolean z2, boolean z3) {
    ...
    public final ImmutableList<prk> b() {
