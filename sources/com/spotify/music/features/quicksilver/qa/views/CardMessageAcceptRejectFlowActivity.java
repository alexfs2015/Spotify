...
public class CardMessageAcceptRejectFlowActivity extends kyd implements a {
    ...
    private void a(QuicksilverAdminCardMessage quicksilverAdminCardMessage) {
        ...
        prv a = prv.a((prk) UriTrigger.create("qa pattern", false, "fake"), content);
    ...
    private void m() {
        prv a = prv.a((prk) UriTrigger.create("qa pattern", false, "fake"), this.n);
        this.k.setVisibility(8);
        this.l = a;
        i().a().b(R.id.child_fragment_container, a, null).b();
    }
