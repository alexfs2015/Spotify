...
public class ItemsFragment extends jor {
    public Scheduler T;
    ...
    public static ItemsFragment a(fpt fpt, Type type) {
        ItemsFragment itemsFragment = new ItemsFragment();
        fpu.a((Fragment) itemsFragment, (fpt) fay.a(fpt));
        itemsFragment.i.putSerializable(MoatAdEvent.EVENT_TYPE, (Serializable) fay.a(type));
        return itemsFragment;
    }

    private Observable<? extends nrh<? extends LocalItem>> c() {
        Optional optional;
        Optional c = Optional.c(this.aj);
        if (c.b()) {
            optional = Optional.b(jsr.a((SortOption) c.c()));
        } else {
            optional = Optional.e();
        }
        nrd a2 = nrd.h().a(this.ak).a(optional).a(true).a();
    ...
    public final void b(Bundle bundle) {
        ...
        c(false);
        if (this.aa == null) {
            this.aa = ((LocalFilesImportActivity) fay.a(p())).o;
        }
        this.aa.a((C0064a) new C0064a() {
            public final void a() {
                ItemsFragment.this.ae();
            }
        });
        this.am = (Type) fay.a(((Bundle) fay.a(this.i)).getSerializable(MoatAdEvent.EVENT_TYPE));
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.ab.setOnClickListener(new OnClickListener() {
            public final void onClick(View view) {
                if (ItemsFragment.this.af()) {
                    ItemsFragment.this.aa.a(ImmutableList.a((Collection<? extends E>) ItemsFragment.this.Z.a), false, (C0064a) null);
                } else {
                    ItemsFragment.this.aa.a(ImmutableList.a((Collection<? extends E>) ItemsFragment.this.Z.a), true, (C0064a) null);
                }
            }
        });
        if (this.af == null) {
        ...
        ka kaVar = (ka) fay.a(p());
        this.af.setBackgroundColor(fr.c(kaVar, R.color.bg_filter));
        this.af.a(this.ai, (gjf) PageIdentifiers.LOCALFILESIMPORT);
        this.af.a((int) R.string.header_filter_hint);
        fxq a2 = fxq.c(kaVar).b().a(null, 0).c((View) this.af).b(true).c(true).a(false).a((Fragment) this);
        this.ah = (fxe) a2.b();
        this.ah.a().b(true);
        fqb.f();
        fuj a3 = fum.a(kaVar, null);
        a3.a(false);
        a3.b().setSingleLine(false);
        a3.b().setEllipsize(null);
        a3.c().setSingleLine(false);
        a3.c().setEllipsize(null);
        a3.a((CharSequence) kaVar.getString(R.string.placeholder_no_result_title, new Object[]{""}));
        a3.b((CharSequence) kaVar.getString(R.string.placeholder_no_result_body));
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable((Context) kaVar, SpotifyIcon.FLAG_32, (float) kaVar.getResources().getDimensionPixelSize(R.dimen.empty_view_icon_size));
        spotifyIconDrawable.a(uuu.b(kaVar, R.attr.pasteColorPlaceholder));
        a3.a().a((Drawable) spotifyIconDrawable);
        this.ae = a3;
        this.Y = new uwh();
        Context context = (Context) fay.a(n());
        this.Z = new nqv(context, this.aa, this.a);
        this.Y.a((RecyclerView.a<H>) this.Z, 0);
        this.Y.a((RecyclerView.a<H>) new jlu<H>(this.ae.getView(), false), 1);
        this.Y.h(0);
        this.Y.a(false, 1);
        this.ag = a2.f();
        ...
        fqb.f();
        this.ad = fum.a(kaVar, viewGroup3);
        ...
        this.ac = LoadingView.a(layoutInflater, kaVar, viewGroup3);
    ...
    /* access modifiers changed from: private */
    public void a(nrh<? extends LocalItem> nrh) {
        Logger.b("Local files: Got %d items. isAdded() %s", Integer.valueOf(((LocalItem[]) nrh.getItems()).length), Boolean.valueOf(u()));
        if (u()) {
            nqv nqv = this.Z;
            nqv.a = new ArrayList(Arrays.asList((LocalItem[]) nrh.getItems()));
            nqv.e();
            this.ac.b();
            boolean z = ((LocalItem[]) nrh.getItems()).length == 0;
            boolean z2 = nrh.getUnfilteredLength() > 0;
