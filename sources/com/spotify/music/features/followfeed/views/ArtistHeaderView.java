...
public class ArtistHeaderView extends ConstraintLayout {
    ...
    private void b() {
        ...
        this.c = (TextView) ip.d(this.b, (int) R.id.feed_item_artist_name);
        this.d = (ImageView) ip.d(this.b, (int) R.id.feed_item_artist_avatar);
        this.e = (TextView) ip.d(this.b, (int) R.id.feed_item_release_date);
    }
    ...
    public final void a(String str, Picasso picasso) {
        SpotifyIconDrawable a = mxh.a(getContext(), 24, SpotifyIconV2.ARTIST);
        picasso.a(str).a((wgz) new vgz()).a((Drawable) a).b((Drawable) a).a(this.d);
    }
