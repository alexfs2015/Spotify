...
public class ItemEntityCardView extends CardView {
    ...
    private void c() {
        ...
        View d = ip.d(this.j, (int) R.id.entity_root);
        a(getResources().getColor(R.color.gray_25));
        a(getResources().getDimension(R.dimen.feed_item_release_corner_radius));
        new vhu((ViewGroup) ip.d(d, (int) R.id.accessory)).a(jqq.a(getContext()));
        this.i = (ViewGroup) ip.d(d, (int) R.id.entity_metadata_view);
        this.k = (ImageView) ip.d(d, (int) R.id.entity_image);
        this.l = (TextView) ip.d(d, (int) R.id.entity_title);
        this.m = (TextView) ip.d(d, (int) R.id.entity_subtitle);
        this.n = (ImageView) ip.d(d, (int) R.id.entity_play_button);
    }

    public final void a(String str, Picasso picasso) {
        SpotifyIconDrawable a = mxh.a(getContext(), 72, SpotifyIconV2.ALBUM);
    ...
    public final void b() {
        this.n.setImageDrawable(mxh.a(getContext()));
    }
}
