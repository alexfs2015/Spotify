...
public class ExpandableReleaseView extends LinearLayout {
    ...
    private void a() {
        ...
        this.e = (ViewGroup) ip.c((View) this.j, (int) R.id.expandable_footer);
        this.f = (ViewGroup) ip.c((View) this.e, (int) R.id.footer_layout);
        this.k = (TextView) ip.c((View) this.j, (int) R.id.item_footer_label);
        this.d = (LinearLayout) ip.c((View) this.e, (int) R.id.item_track_holder);
        ViewGroup viewGroup = (ViewGroup) ip.c((View) this.j, (int) R.id.static_entity_layout);
        this.b = (ArtistHeaderView) ip.c((View) viewGroup, (int) R.id.feed_artist_header_view);
        this.c = (ItemEntityCardView) ip.c((View) viewGroup, (int) R.id.feed_entity_card_view);
    }

    public final void a(int i2, boolean z) {
        String str;
        if (z) {
            str = getContext().getString(R.string.follow_feed_item_footer_text_hide);
        } else {
            str = getContext().getString(R.string.follow_feed_item_footer_text_view);
        }
        this.k.setText(String.format(str, new Object[]{String.valueOf(i2)}));
    }
