...
public class PageIndicator extends View implements a, b {
    ...
    private static boolean a(ShelfGridRecyclerView shelfGridRecyclerView) {
        return shelfGridRecyclerView != null && ShelfGridRecyclerView.o() == 0;
    }
    ...
    private int c() {
        ...
        return (int) Math.ceil((double) (((float) ((RecyclerView.a) fbp.a(this.a.c())).b()) / ((float) ShelfGridRecyclerView.o())));
    }
    ...
    public final void a() {
        this.g = ((GridLayoutManager) fbp.a((GridLayoutManager) this.a.d())).k() / ShelfGridRecyclerView.o();
        postInvalidate();
    }

    public final void a(int i) {
        if (this.b != null) {
            this.g = i / ShelfGridRecyclerView.o();
            postInvalidate();
        }
    }
