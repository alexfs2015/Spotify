...
abstract class C$AutoValue_TasteOnboardingItem extends TasteOnboardingItem {
    ...
    private final qmj logging;
    private final String moreUri;
    private final String name;
    private final List<TasteOnboardingItem> relatedItems;

    C$AutoValue_TasteOnboardingItem(String str, String str2, String str3, List<TasteOnboardingItem> list, List<TasteOnboardingImage> list2, qmj qmj, String str4, boolean z, boolean z2, boolean z3, boolean z4, String str5) {
        if (str != null) {
            this.id = str;
            if (str2 != null) {
                this.name = str2;
            ...
            if (this.id.equals(tasteOnboardingItem.id()) && this.name.equals(tasteOnboardingItem.name())) {
                ...
                if (str != null ? str.equals(tasteOnboardingItem.image()) : tasteOnboardingItem.image() == null) {
                    if (this.relatedItems.equals(tasteOnboardingItem.relatedItems()) && this.imagesWithSize.equals(tasteOnboardingItem.imagesWithSize())) {
                        qmj qmj = this.logging;
                        if (qmj != null ? qmj.equals(tasteOnboardingItem.logging()) : tasteOnboardingItem.logging() == null) {
    ...
    public int hashCode() {
        ...
        qmj qmj = this.logging;
        int hashCode3 = (hashCode2 ^ (qmj == null ? 0 : qmj.hashCode())) * 1000003;
        String str2 = this.moreUri;
        int i2 = 1231;
