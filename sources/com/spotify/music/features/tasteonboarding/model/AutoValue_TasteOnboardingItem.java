...
final class AutoValue_TasteOnboardingItem extends C$AutoValue_TasteOnboardingItem {
    public static final Creator<AutoValue_TasteOnboardingItem> CREATOR = new Creator<AutoValue_TasteOnboardingItem>() {
        ...
        public final /* synthetic */ Object createFromParcel(Parcel parcel) {
            ...
            qmj qmj = (qmj) parcel2.readParcelable(TasteOnboardingItem.class.getClassLoader());
            ...
            AutoValue_TasteOnboardingItem autoValue_TasteOnboardingItem = new AutoValue_TasteOnboardingItem(readString, readString2, readString3, createTypedArrayList, createTypedArrayList2, qmj, readString4, z2, z3, z4, z, parcel.readInt() == 0 ? parcel.readString() : null);
    ...
    AutoValue_TasteOnboardingItem(String str, String str2, String str3, List<TasteOnboardingItem> list, List<TasteOnboardingImage> list2, qmj qmj, String str4, boolean z, boolean z2, boolean z3, boolean z4, String str5) {
        super(str, str2, str3, list, list2, qmj, str4, z, z2, z3, z4, str5);
    }
