...
public abstract class HomeMixTuningButton extends LinearLayout implements fva {
    ...
    private Drawable e() {
        ...
        uvv uvv = new uvv(getContext(), b(), (float) a((int) R.dimen.mix_tuning_icon_size), (float) a((int) R.dimen.mix_tuning_button_size), b(R.color.mix_tuning_default_bg), b(R.color.whiteAlpha60));
        uvv uvv2 = new uvv(getContext(), b(), (float) a((int) R.dimen.mix_tuning_icon_size), (float) a((int) R.dimen.mix_tuning_button_size), b(R.color.white), b(R.color.textBlack));
        stateListDrawable.addState(new int[]{16842913}, uvv2);
        stateListDrawable.addState(new int[0], uvv);
