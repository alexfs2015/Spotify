...
public class RecyclerViewItemIndicator extends View {
    ...
    class a extends m {
        ...
        public final void a(RecyclerView recyclerView, int i) {
            if (i == 0 && RecyclerViewItemIndicator.this.c != null) {
                ...
                recyclerViewItemIndicator.f = (float) RecyclerView.f((View) fbp.a(recyclerViewItemIndicator.c.a(recyclerView.d())));
    ...
    public RecyclerViewItemIndicator(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.pnf.a.a, i, 0);
        this.d = obtainStyledAttributes.getDimensionPixelSize(defpackage.pnf.a.d, b2);
        this.e = obtainStyledAttributes.getDimensionPixelOffset(defpackage.pnf.a.e, a2);
        int color = obtainStyledAttributes.getColor(defpackage.pnf.a.c, -7829368);
        int color2 = obtainStyledAttributes.getColor(defpackage.pnf.a.b, -1);
    ...
    public void onDraw(Canvas canvas) {
        ...
        androidx.recyclerview.widget.RecyclerView.a c2 = recyclerView == null ? null : recyclerView.c();
