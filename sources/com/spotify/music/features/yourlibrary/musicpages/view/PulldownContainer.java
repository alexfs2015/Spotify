...
public class PulldownContainer extends LinearLayout implements ii {
    ...
    public final void a(View view, int i, int i2, int[] iArr, int i3) {
        int i4;
        b();
        if ((view instanceof RecyclerView) && ((LinearLayoutManager) fay.a(((RecyclerView) view).d())).k() == 0 && !this.c) {
            this.f = i2;
            int i5 = i2 - iArr[1];
            if (i2 > 0) {
                i4 = Math.min(i5, this.d.getTop() + this.b);
            } else {
                i4 = Math.max(i5, this.d.getTop());
            }
            iArr[1] = iArr[1] + i4;
            a(-i4);
