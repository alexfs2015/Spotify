...
public final class RecsLoaderImpl implements qzc {
    private final gkz a;
    ...
    public RecsLoaderImpl(gkz gkz, rnf rnf) {
        this.a = gkz;
        this.b = rnf.a().a();
    }
    ...
    public final Observable<RecsResponse> a(int i, Set<String> set, Set<String> set2) {
        try {
            return vun.b(this.a.a(RecsResponse.class).resolve(new Request(Request.POST, "hm://playlistextender/ft/v2/assist-curation", null, this.b.writeValueAsBytes(new RecsRequest(i, set2, set, null)))));
