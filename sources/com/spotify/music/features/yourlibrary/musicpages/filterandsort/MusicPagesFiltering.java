...
public final class MusicPagesFiltering {
    ...
    static class FilteringModel implements JacksonModel {
        ...
        public ImmutableMap<String, Boolean> getFilterState(String str) {
            return ImmutableMap.a((Map) fbm.a(this.mFilterMap.get(str), ImmutableMap.f()));
        }
    ...
    private MusicPagesFiltering(rfl rfl, rwl rwl, Observable<String> observable, Scheduler scheduler, int i2) {
    ...
    public MusicPagesFiltering(rfm rfm, rwl rwl, hxx hxx, Scheduler scheduler) {
        this(new rfl() {
            public final String a(String str) {
                return (String) fbp.a(rfm.this.c.a(rfm.this.b, str).a(rfm.a, ""));
            }

            public final void a(String str, String str2) {
                rfm.this.c.a(rfm.this.b, str).a().a(rfm.a, str2).b();
            }
        }, rwl, hxx.a.c((Function<? super T, ? extends R>) $$Lambda$DtEvfn0Icv19eGJW_fHdFkt5y4.INSTANCE).j(), scheduler, 100);
    }
