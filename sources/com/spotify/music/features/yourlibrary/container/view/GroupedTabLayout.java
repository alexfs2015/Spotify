...
public class GroupedTabLayout extends LinearLayout implements com.spotify.music.features.yourlibrary.container.view.ListenableScrollingViewBehavior.a {
    ...
    public class a implements androidx.viewpager.widget.ViewPager.d {
        ...
        public final void a(ViewPager viewPager, sa saVar, sa saVar2) {
            if (GroupedTabLayout.this.a == viewPager) {
                GroupedTabLayout.this.a(saVar2);
            }
        }
    }
    ...
    public /* synthetic */ void a(int i2, float f2) {
        ...
        if (this.m) {
            i3 = this.l.getMeasuredWidth() - childAt.getRight();
        } else {
            i3 = childAt.getLeft();
        }
        float f3 = -(d2 + ((float) i3));
        if (this.m) {
    ...
    public final void a(View view) {
        int top = view.getTop() - gaa.c(getContext());
    ...
    public /* synthetic */ void a(int i2, int i3, int i4, View view) {
        if (this.e != null) {
            qsi qsi = this.f;
            Optional c2 = qsi.c(qsi.d(i3));
            String str = (String) c2.a((Function<? super T, V>) $$Lambda$GroupedTabLayout$_As03VNwU3TzzE8gldRqixPzTc.INSTANCE).d();
    ...
    public /* synthetic */ void a(int i2, int i3, View view) {
        if (this.e != null) {
            qsi qsi = this.f;
            Optional c2 = qsi.c(qsi.d(i3));
            String str = (String) c2.a((Function<? super T, V>) $$Lambda$GroupedTabLayout$6pUsTVKwnOkyRzIjJ1BNo828_6A.INSTANCE).d();
