...
public class QueueService extends vto {
    public pmz a;
    ...
    public void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            if ("add_tracks_or_episodes".equals(action)) {
                this.a.a((List) fay.a(intent.getParcelableArrayListExtra("items")), intent.getBooleanExtra("show_toast", true));
            } else if ("add_album".equals(action)) {
                this.a.a((String) fay.a(intent.getStringExtra("album_uri")));
            }
        }
    }
}
