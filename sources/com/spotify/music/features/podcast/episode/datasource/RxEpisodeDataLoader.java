...
public final class RxEpisodeDataLoader {
    ...
    public RxEpisodeDataLoader(RxResolver rxResolver, rwl rwl) {
        this.a = rxResolver;
        this.b = rwl.a().a(Include.NON_NULL).a();
    }

    /* access modifiers changed from: private */
    /* renamed from: a */
    public phz b(String str, Response response) {
        try {
            if (response.getStatus() != 200) {
                ...
                return phz.a(sb.toString());
            }
            Map a2 = vmn.a(ProtoDecorateResponse.a(response.getBody()));
            if (a2 != null && !a2.isEmpty()) {
                vkv vkv = (vkv) a2.get(str);
                if (vkv != null) {
                    return phz.a(vkv, Optional.e(), Optional.e());
                }
            }
            return phz.a(String.format("Episode not found [%s]", new Object[]{str}));
        } catch (IOException e) {
    ...
    public final xii<phz> a(String str) {
        ...
        try {
            ...
            return wit.a((ObservableSource<T>) this.a.resolve(build), BackpressureStrategy.BUFFER).e((xiy<? super T, ? extends R>) new xiy(str) {
