...
public class AgeGenderView extends LinearLayout implements b, a {
    ...
    private void n() {
        ...
        this.d = (View) fbp.a(findViewById(R.id.sign_up_age_gender_inputs_container));
        this.a = (TextView) fbp.a(findViewById(R.id.sign_up_age_text));
        this.e = (TextView) fbp.a(findViewById(R.id.sign_up_age_error_message));
        this.h = (TextView) fbp.a(findViewById(R.id.sign_up_gender_text));
        this.k = (TextView) fbp.a(findViewById(R.id.sign_up_gender_error_message));
        this.c = (Button) fbp.a(findViewById(R.id.sign_up_create_button));
        ...
        this.m = (TermsAndConditionsView) fbp.a(findViewById(R.id.sign_up_terms));
    }
    ...
    public final void a(Gender gender) {
        this.j = gender;
        this.h.setText(ohu.a(gender));
        this.g.onNext(this.j);
    }

    public final void a(ftm ftm) {
        ftm.a(getResources().getString(R.string.signup_age_requirement_error)).a(getResources().getString(R.string.signup_action_close), null).a().a();
    }
    ...
    public final void g() {
        ...
        termsAndConditionsView.a.a(termsAndConditionsView, termsAndConditionsView.getResources().getString(wbn.terms_and_conditions_text_privacy_policy));
    }
