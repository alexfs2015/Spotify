...
public abstract class PlaylistDataSourceConfiguration {
    public static final PlaylistDataSourceConfiguration a = new defpackage.ony.a().a(false).b(false).c(false).a(Optional.e()).b(Optional.e()).c(Optional.e()).d(Optional.e()).d(false).e(false).f(false).a(DecorationPolicy.LARGE_WITHOUT_VIEWPORT).a();
