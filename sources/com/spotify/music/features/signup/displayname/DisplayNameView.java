...
public class DisplayNameView extends LinearLayout implements b {
    ...
    private void b() {
        ...
        this.e = (View) fay.a(findViewById(R.id.sign_up_display_name_input_field_container));
        this.b = (EditText) fay.a(findViewById(R.id.sign_up_display_name));
        this.c = (Button) fay.a(findViewById(R.id.sign_up_save_button));
        this.c.setEnabled(false);
        this.d = Position.RIGHT;
    }

    public final void a() {
        a aVar = new a(getContext(), 2132017711);
