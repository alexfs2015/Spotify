...
public final class FindFriendsViewManager {
    ...
    public FindFriendsViewManager(View view, fqn fqn, FindFriendsLogger findFriendsLogger, ViewLoadingTracker viewLoadingTracker, jyx jyx, FollowManager followManager, szp szp) {
        View view2 = view;
        ...
        this.q = new a() {
            ...
            public final void a(String str) {
                ...
                FindFriendsViewManager.this.f.a = !fbo.a(str);
            }
        };
        ...
        mtv mtv = new mtv(context2, new ArrayList(), this.m, this.b, findFriendsLogger, jyx, followManager, szp);
        this.f = mtv;
        mtu mtu = new mtu(context2, new ArrayList(), this.m, findFriendsLogger, jyx, followManager, szp);
        this.l = mtu;
