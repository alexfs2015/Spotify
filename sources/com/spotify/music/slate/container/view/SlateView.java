...
public class SlateView extends PercentRelativeLayout implements com.spotify.music.slate.container.view.card.CardInteractionHandler.a {
    ...
    private void a(AttributeSet attributeSet) {
        if (attributeSet != null) {
            TypedArray obtainStyledAttributes = getContext().getTheme().obtainStyledAttributes(attributeSet, defpackage.tyf.a.a, 0, 0);
            try {
                this.j = obtainStyledAttributes.getBoolean(defpackage.tyf.a.b, false) ? DisplayMode.FULL_SCREEN : DisplayMode.CARD;
            } finally {
    ...
    public final void a(tyl tyl) {
        this.d.removeAllViews();
        this.d.addView(tyl.getView(LayoutInflater.from(getContext()), this.d));
    }

    public final void b(tyl tyl) {
        this.e.removeAllViews();
        this.e.addView(tyl.getView(LayoutInflater.from(getContext()), this.e));
    }

    public void onMeasure(int i2, int i3) {
        int size = MeasureSpec.getSize(i2);
        int size2 = MeasureSpec.getSize(i3);
        defpackage.tym.a aVar = this.h;
        boolean z = true;
        if (aVar == null) {
        ...
        if (z) {
            ...
            defpackage.tym.a aVar2 = new defpackage.tym.a();
    ...
    public void a(tyk tyk) {
        this.c.removeAllViews();
        LayoutInflater from = LayoutInflater.from(getContext());
        CardView cardView = this.c;
        cardView.addView(tyk.getSlateContentView(from, cardView));
