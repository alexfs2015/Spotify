...
public class ArtistModel implements Parcelable, JacksonModel {
    ...
    public static class ArtistGallery implements Parcelable, JacksonModel {
        ...
        private ArtistGallery(Parcel parcel) {
            this.images = (List) fbp.a(ArtistModel.readImmutableList(parcel, Image.CREATOR));
        }

        @JsonCreator
        public ArtistGallery(@JsonProperty("images") List<Image> list) {
            this.images = gcn.a(list);
        }
    ...
    public static class ArtistInfo implements Parcelable, JacksonModel {
        ...
        private ArtistInfo(Parcel parcel) {
            ...
            this.verified = juo.a(parcel);
            this.portraits = (List) fbp.a(ArtistModel.readImmutableList(parcel, Image.CREATOR));
        }
    ...
    public static class CustomMessage implements Parcelable, JacksonModel {
        ...
        public CustomMessage(@JsonProperty("body_text") String str) {
            this.bodyText = (String) fbp.a(str);
        }
    ...
    public static class Track implements Parcelable, JacksonModel {
        ...
        private Track(Parcel parcel) {
            ...
            this.explicit = juo.a(parcel);
            this.name = parcel.readString();
            this.release = (Release) juo.b(parcel, Release.CREATOR);
        }
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            juo.a(parcel, this.explicit);
            parcel.writeString(this.name);
            juo.a(parcel, (Parcelable) this.release, i);
        }
    }
    ...
    private ArtistModel(Parcel parcel) {
        ...
        this.headerImage = (HeaderImage) juo.b(parcel, HeaderImage.CREATOR);
        this.gallery = Optional.c(juo.b(parcel, ArtistGallery.CREATOR));
        this.topTracks = (List) fbp.a(readImmutableList(parcel, Track.CREATOR));
        this.upcomingConcerts = (List) fbp.a(readImmutableList(parcel, Concert.CREATOR));
        this.merchandise = (List) fbp.a(readImmutableList(parcel, MerchandiseItem.CREATOR));
        this.relatedArtists = (List) fbp.a(readImmutableList(parcel, ArtistInfo.CREATOR));
        this.biography = Optional.c(parcel.readString());
        this.releases = (Releases) Releases.CREATOR.createFromParcel(parcel);
        this.latestRelease = Optional.c(juo.b(parcel, Release.CREATOR));
        this.playlists = (List) fbp.a(readImmutableList(parcel, Playlist.CREATOR));
        this.customMessage = Optional.c(juo.b(parcel, CustomMessage.CREATOR));
        this.monthlyListeners = Optional.c(juo.b(parcel, MonthlyListeners.CREATOR));
        this.creatorAbout = Optional.c(juo.b(parcel, CreatorAbout.CREATOR));
        this.artistsPick = Optional.c(juo.b(parcel, ArtistsPick.CREATOR));
    }
    ...
    public ArtistModel(@JsonProperty("uri") String str, @JsonProperty("info") ArtistInfo artistInfo, @JsonProperty("header_image") HeaderImage headerImage2, @JsonProperty("gallery") ArtistGallery artistGallery, @JsonProperty("top_tracks") Map<String, List<Track>> map, @JsonProperty("upcoming_concerts") Map<String, List<Concert>> map2, @JsonProperty("merch") Map<String, List<MerchandiseItem>> map3, @JsonProperty("related_artists") Map<String, List<ArtistInfo>> map4, @JsonProperty("biography") Map<String, String> map5, @JsonProperty("releases") Releases releases2, @JsonProperty("latest_release") Release release, @JsonProperty("published_playlists") Map<String, List<Playlist>> map6, @JsonProperty("custom_message") CustomMessage customMessage2, @JsonProperty("monthly_listeners") MonthlyListeners monthlyListeners2, @JsonProperty("creator_about") CreatorAbout creatorAbout2, @JsonProperty("pinned_item") ArtistsPick artistsPick2) {
        ...
        this.uri = (String) fbp.a(str);
        this.info = (ArtistInfo) fbp.a(artistInfo);
        ...
        this.biography = Optional.c(map7 == null ? null : (String) map5.get("text"));
    ...
    static <T> List<T> extractListFromMap(String str, Map<String, List<T>> map) {
        return (map == null || !map.containsKey(str)) ? ImmutableList.d() : ImmutableList.a((Collection) map.get(str));
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        juo.a(parcel, (Parcelable) this.headerImage, 0);
        juo.a(parcel, (Parcelable) this.gallery.d(), 0);
        ...
        juo.a(parcel, (Parcelable) this.latestRelease.d(), 0);
        parcel.writeTypedList(this.playlists);
        juo.a(parcel, (Parcelable) this.customMessage.d(), 0);
        juo.a(parcel, (Parcelable) this.monthlyListeners.d(), 0);
        juo.a(parcel, (Parcelable) this.creatorAbout.d(), 0);
        juo.a(parcel, (Parcelable) this.artistsPick.d(), 0);
    }
}
