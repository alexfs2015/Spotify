...
public class Releases implements Parcelable, JacksonModel {
    ...
    public Releases(@JsonProperty("albums") ReleasesWithTotalCount releasesWithTotalCount, @JsonProperty("singles") ReleasesWithTotalCount releasesWithTotalCount2, @JsonProperty("appears_on") ReleasesWithTotalCount releasesWithTotalCount3, @JsonProperty("compilations") ReleasesWithTotalCount releasesWithTotalCount4) {
        ...
        this.albums = (ReleasesWithTotalCount) jvi.a(releasesWithTotalCount, releasesWithTotalCount5);
        this.singles = (ReleasesWithTotalCount) jvi.a(releasesWithTotalCount2, releasesWithTotalCount5);
        this.appearsOn = (ReleasesWithTotalCount) jvi.a(releasesWithTotalCount3, releasesWithTotalCount5);
        this.compilations = (ReleasesWithTotalCount) jvi.a(releasesWithTotalCount4, releasesWithTotalCount5);
    }
