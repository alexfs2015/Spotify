...
public class BehindTheLyricsCard extends FrameLayout implements OnClickListener, kst {
    protected float a;
    ...
    private Intent g;
    private final ksr h = new ksr(fr.c(getContext(), R.color.genius_yellow));
    ...
    public void onFinishInflate() {
        ...
        ksn ksn = new ksn();
        ksl ksl = new ksl(this, ksn);
        BehindTheLyricsViewStateManager behindTheLyricsViewStateManager = new BehindTheLyricsViewStateManager(g2.b(), new ksq(this, ksn), ksl, ksn, this.h, getContext().getResources());
