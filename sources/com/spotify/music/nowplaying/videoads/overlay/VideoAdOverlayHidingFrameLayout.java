...
public class VideoAdOverlayHidingFrameLayout extends OverlayHidingFrameLayout implements tsj {
    private final Set<defpackage.tks.a> c;
    ...
    static /* synthetic */ void a(VideoAdOverlayHidingFrameLayout videoAdOverlayHidingFrameLayout, boolean z) {
        for (defpackage.tks.a d2 : videoAdOverlayHidingFrameLayout.c) {
            d2.d();
        }
    }
    ...
    public final void a(defpackage.tks.a aVar) {
        this.c.add(fbp.a(aVar));
    }
