...
public class ContextMenuButton extends AppCompatImageView implements tjk {
    private a a;
    ...
    public ContextMenuButton(Context context, AttributeSet attributeSet) {
        ...
        Context context2 = (Context) fbp.a(getContext());
        float b = (float) vfj.b(24.0f, ((Context) fbp.a(context2)).getResources());
