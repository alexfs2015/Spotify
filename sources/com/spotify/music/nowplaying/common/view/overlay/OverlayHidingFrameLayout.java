...
public class OverlayHidingFrameLayout extends FrameLayout implements OnHierarchyChangeListener, tal {
    protected int a;
    public int b;
    private final GestureDetector c;
    private final it d;
    private final it e;
    private final Set<defpackage.tal.b> f;
    /* access modifiers changed from: private */
    public final Set<defpackage.tal.a> g;
    ...
    public final void a(View view) {
        ViewParent parent = ((View) fay.a(view)).getParent();
        while (parent != this) {
    ...
    public final void a(defpackage.tal.b bVar) {
        this.f.add(fay.a(bVar));
    }

    public void a(defpackage.tal.a aVar) {
        this.g.add(fay.a(aVar));
    }
    ...
    public final void c(boolean z) {
        ...
        if (!a(z, 4)) {
            ...
            ip.n(this.l).a((long) this.a).a(ftn.c).a(this.e).a(0.0f).c();
        }
    }
    ...
    /* access modifiers changed from: private */
    public void d() {
        for (defpackage.tal.b a2 : this.f) {
            a2.a();
        }
    }
    ...
    /* access modifiers changed from: private */
    public void e() {
        for (defpackage.tal.b b2 : this.f) {
            b2.b();
        }
    }
    ...
    public void a(boolean z, boolean z2) {
        ...
        if (!a(z, 0)) {
            ...
            ip.n(this.l).a((long) this.a).a(ftn.c).a(this.d).a(1.0f).c();
        }
    }
    ...
    static /* synthetic */ void b(OverlayHidingFrameLayout overlayHidingFrameLayout, boolean z) {
        for (defpackage.tal.a d2 : overlayHidingFrameLayout.g) {
            d2.d();
        }
    }
