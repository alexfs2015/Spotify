...
public class CanvasArtistWidgetView extends FrameLayout implements tic {
    public Picasso a;
    ...
    public CanvasArtistWidgetView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.d = ip.d((View) this, (int) R.id.gradient_background);
        this.e = ip.d((View) this, (int) R.id.artist_attribution);
        this.f = (TextView) ip.d((View) this, (int) R.id.canvas_uploaded_by_artist_text);
        this.g = (ImageView) ip.d((View) this, (int) R.id.canvas_artist_avatar);
    ...
    public final void a() {
        animate().cancel();
        ip.n(this).a(200).a(fuh.b).a(1.0f).b(this.c).c();
    }
    ...
    public final void a(String str) {
        this.a.a(str).a(gaa.g(getContext())).b(gaa.g(getContext())).a(vhj.a(this.g));
    }
    ...
    public final void b() {
        animate().cancel();
        ip.n(this).a(200).a(fuh.a).a(0.0f).a(this.b).c();
    }
