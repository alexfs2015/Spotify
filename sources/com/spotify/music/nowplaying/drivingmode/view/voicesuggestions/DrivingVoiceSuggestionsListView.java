...
public class DrivingVoiceSuggestionsListView extends LinearLayoutCompat implements a<tfv> {
    private tfz a;
    ...
    private void a() {
        ...
        recyclerView.q = true;
        recyclerView.a((h) new tfy(fr.a(getContext(), (int) R.drawable.driving_voice_suggestions_divider)), -1);
        this.a = new tfz(this);
