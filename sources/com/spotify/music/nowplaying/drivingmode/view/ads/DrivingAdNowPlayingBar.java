...
public class DrivingAdNowPlayingBar extends ConstraintLayout implements tep {
    private final Interpolator b = new kt();
    private View c;
    ...
    private void d() {
        ...
        uuu.a(getContext(), this.e, 2132017610);
        uuu.a(getContext(), (TextView) findViewById(R.id.driving_ad_up_next_title), 2132017610);
        this.f = (TextView) findViewById(R.id.driving_ad_next_context);
        uuu.a(getContext(), this.f, 2132017609);
        ImageView imageView = (ImageView) findViewById(R.id.driving_up_next_icon);
        Drawable d2 = tek.d(getContext());
