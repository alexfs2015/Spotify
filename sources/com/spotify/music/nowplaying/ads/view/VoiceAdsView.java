...
public class VoiceAdsView extends RelativeLayout implements sxg {
    private a a;
    private View b;
    private View c;
    private View d;
    ...
    public VoiceAdsView(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (VERSION.SDK_INT >= 17) {
            this.b.setBackground(new jqf(color2, color2, 0));
            this.c.setBackground(new jqf(color, color, 0));
            this.d.setBackground(new jqf(color, color, 0));
        }
