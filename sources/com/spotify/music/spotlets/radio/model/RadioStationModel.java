...
public class RadioStationModel implements Parcelable, JacksonModel {
    public static final Creator<RadioStationModel> CREATOR = new Creator<RadioStationModel>() {
        ...
        public final /* synthetic */ Object createFromParcel(Parcel parcel) {
            ...
            RadioStationModel radioStationModel = new RadioStationModel(readString, readString2, readString3, readString4, readString5, readString6, readString7, createStringArray, relatedArtistModelArr, playerTrackArr, parcel.readString(), jse.a(parcel));
    ...
    public RadioStationModel(@JsonProperty("uri") String str, @JsonProperty("title") String str2, @JsonProperty("titleUri") String str3, @JsonProperty("imageUri") String str4, @JsonProperty("playlistUri") String str5, @JsonProperty("subtitle") String str6, @JsonProperty("subtitleUri") String str7, @JsonProperty("seeds") String[] strArr, @JsonProperty("related_artists") RelatedArtistModel[] relatedArtistModelArr, @JsonProperty("tracks") PlayerTrack[] playerTrackArr, @JsonProperty("next_page_url") String str8, @JsonProperty("explicitSave") boolean z) {
        ...
        this.uri = str;
        this.stationUri = ViewUris.aj.a(this.uri);
        this.title = str2;
        this.titleUri = str3;
        this.imageUri = str4;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        jse.a(parcel, this.explicitSave);
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof RadioStationModel) {
            ...
            if (faw.a(this.uri, radioStationModel.uri) && faw.a(this.title, radioStationModel.title) && faw.a(this.titleUri, radioStationModel.titleUri) && faw.a(this.imageUri, radioStationModel.imageUri) && faw.a(this.playlistUri, radioStationModel.playlistUri) && faw.a(this.subtitle, radioStationModel.subtitle) && faw.a(this.subtitleUri, radioStationModel.subtitleUri) && Arrays.equals(this.seeds, radioStationModel.seeds) && Arrays.equals(this.tracks, radioStationModel.tracks) && faw.a(this.nextPageUrl, radioStationModel.nextPageUrl) && faw.a(Boolean.valueOf(this.explicitSave), Boolean.valueOf(radioStationModel.explicitSave))) {
                return true;
            }
        }
        return false;
    ...
    public Uri getPlayableUri() {
        return uhq.a(getStationSeed());
    }

    @JsonIgnore
    public String getPlayerContextUri() {
        return (String) fay.a(uhq.b(getStationSeed()));
    }
    ...
    public boolean isMyContext(String str) {
        ...
        if (faw.a(str, getPlayerContextUri()) || Arrays.asList(this.seeds).contains(str)) {
            return true;
        }
        return false;
    }
