...
public final class RemoteCosmosCollectionApiImpl implements ufw {
    ...
    private void a(String str, String str2, String str3, boolean z) {
        try {
            this.a.resolve(new Request(z ? Request.POST : Request.DELETE, "sp://core-collection/v1/items", Collections.emptyMap(), this.b.writeValueAsString(new Items(new String[]{str}, str2, str3)).getBytes(far.c)));
