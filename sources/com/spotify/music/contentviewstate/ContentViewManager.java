...
public final class ContentViewManager {
    ...
    public static class a {
        ...
        public a(Context context, fvd fvd, View view) {
    ...
    public interface b {
        void a(fvd fvd, ContentState contentState);
    }
    ...
    static class c {
        ...
        public final Drawable a(Context context) {
            ...
            Drawable b2 = gaa.b(context, this.d, Float.NaN, true, true, (float) vfj.b(32.0f, context.getResources()));
    ...
    private ContentViewManager(Context context, fvd fvd, View view, b bVar) {
    ...
    /* synthetic */ ContentViewManager(Context context, fvd fvd, View view, b bVar, byte b2) {
        this(context, fvd, view, bVar);
    }
