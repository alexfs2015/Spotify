...
public final class NotAvailableViewManager {
    ...
    private static fuj a(Context context, ViewGroup viewGroup, int i) {
        if (i == -1) {
            i = R.string.error_no_connection_body;
        }
        fuj a2 = kyu.a(context, context.getString(i));
        viewGroup.addView(a2.getView());
        return a2;
    }

    private static fuj a(Context context, ViewGroup viewGroup) {
        fqb.f();
        fuj a2 = fum.a(context, viewGroup);
        Resources resources = context.getResources();
        a2.a().a(fzg.b(context, SpotifyIcon.WARNING_32));
