...
public final class Rows {
    ...
    public interface a extends fqe {
    ...
    public interface e extends h, fri {
    }

    public interface f extends fri {
    ...
    public interface h extends a, frh {
    }
    ...
    private static f c(Context context, ViewGroup viewGroup) {
        ...
        fqb.b();
        final fri b2 = frq.b(context2, viewGroup, false);
        int b3 = uts.b(86.0f, resources);
        int b4 = uts.b(64.0f, resources);
        ...
        a((View) c2, uts.b(4.0f, resources));
        uuu.a(context2, b2.b(), 2132017666);
        ...
        uuu.a(context2, textView, 2132017674);
        ...
        uui.b(b2.getView().findViewById(R.id.row_view)).a(b2.b(), b2.d(), textView2, textView, textView3).b(c2).a();
        RelativeLayout relativeLayout = new RelativeLayout(context2);
        relativeLayout.setGravity(80);
        LayoutParams layoutParams2 = new LayoutParams(-1, -2);
        int b5 = uts.b(16.0f, resources);
        ...
        relativeLayout2.setPadding(uts.b(12.0f, resources), uts.b(8.0f, resources), uts.b(16.0f, resources), uts.b(8.0f, resources));
        relativeLayout2.setLayoutParams(layoutParams3);
        TextView textView4 = new TextView(context2);
        uuu.a(context2, textView4, 2132017674);
        textView4.setTextColor(fr.c(context2, R.color.gray_70));
        ImageView imageView = new ImageView(context2);
        imageView.setId(R.id.row_preview_footer_icon_view);
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(context2, SpotifyIconV2.HELPCIRCLE, (float) uts.b(24.0f, resources));
        ...
        AnonymousClass4 r3 = new f() {
            ...
            public final void f() {
                ...
                qr.a(frameLayout2, transitionSet2);
            ...
            public final void h() {
                ...
                qr.a(relativeLayout4, transitionSet);
    ...
    private static void a(TextView textView) {
        ...
        marginLayoutParams.topMargin = uts.b(6.0f, textView.getResources());
        textView.setLayoutParams(marginLayoutParams);
        uuu.a(textView.getContext(), textView, 2132017674);
    ...
    public static e a(Context context, ViewGroup viewGroup) {
        ...
        final tkf tkf = new tkf((ViewGroup) b2.getView().findViewById(R.id.accessory));
    ...
    public static g b(Context context, ViewGroup viewGroup) {
        ...
        final tkf tkf = new tkf((ViewGroup) c2.getView().findViewById(R.id.accessory));
