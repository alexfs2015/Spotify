...
public abstract class ItemConfiguration {
    ...
    public static a r() {
        return new defpackage.tvt.a().a(false).b(false).c(false).a(HeartAndBan.NO_HEART_OR_BAN).a(LongClickAction.DO_NOTHING).d(false).e(false).f(false).g(false).h(false).i(false).j(false).k(false).l(false).m(false).n(false);
    }
