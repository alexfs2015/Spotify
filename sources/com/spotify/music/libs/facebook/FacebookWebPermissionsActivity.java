...
public class FacebookWebPermissionsActivity extends lbm {
    public sal g;
    ...
    public static class b extends ssu {
        private boolean T;
        a a;
        private String b;
        ...
        public static b c() {
            b bVar = new b();
            fqo.a((Fragment) bVar, (fqn) new fqr("NoFlags, external web view"));
            return bVar;
        }
    ...
    public final boolean a(Uri uri) {
        ...
        serialDisposable.a(sal.a(str3).a((Action) $$Lambda$FacebookWebPermissionsActivity$Vtbm9BDQ4JriId7eHvX8gJfw6wc.INSTANCE, (Consumer<? super Throwable>) $$Lambda$FacebookWebPermissionsActivity$RpYLT1gVNSMAxIIdkyo0KKPApyU.INSTANCE));
    ...
    public final rmf af() {
        return rmf.a(PageIdentifiers.FACEBOOK_WEBVIEWPERMISSIONS, null);
    }
    ...
    public void onResume() {
        ...
        this.p = true;
        if (this.n) {
            this.h.a(this.g.a(PermissionsRequest.builder().permissions(saf.c).build()).a(AndroidSchedulers.a()).a((Consumer<? super T>) new Consumer() {
