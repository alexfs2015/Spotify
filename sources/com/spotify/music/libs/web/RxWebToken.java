...
public final class RxWebToken {
    private final gmm<TokenResponse> a;
    ...
    public RxWebToken(RxResolver rxResolver, Scheduler scheduler, Scheduler scheduler2, rwl rwl) {
        this((gmm<TokenResponse>) new gmp<TokenResponse>(TokenResponse.class, rwl.b(), rxResolver, scheduler2), scheduler);
    }

    private RxWebToken(gmm<TokenResponse> gmm, Scheduler scheduler) {
        this.a = gmm;
        this.b = scheduler;
    }

    public RxWebToken(gmn gmn, Scheduler scheduler) {
        this(gmn.a(TokenResponse.class), scheduler);
    }
    ...
    public final Observable<Uri> a(Uri uri) {
        Observable c = wit.b(this.a.resolve(new Request(Request.GET, String.format("sp://auth/v2/web_token?uri=%s", new Object[]{Uri.encode(uri.toString())})))).c((Function<? super T, ? extends R>) new Function(uri) {
