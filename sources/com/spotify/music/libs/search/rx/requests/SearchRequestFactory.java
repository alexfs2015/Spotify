...
public final class SearchRequestFactory {
    ...
    public SearchRequestFactory(SearchRequestType searchRequestType, sbb sbb) {
        this.a = (SearchRequestType) fay.a(searchRequestType);
        this.b = sbb;
    }

    public static sgl a(sgd sgd, sbb sbb, boolean z, boolean z2) {
        if (!z) {
            sbb = sbb.a(sgd.a());
        }
        return new sgl(sgd, sbb.a(), z2);
    }
}
