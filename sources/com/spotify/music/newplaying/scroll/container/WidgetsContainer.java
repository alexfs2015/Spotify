...
public class WidgetsContainer extends LinearLayout implements ssg {
    private Flowable<ssd> a;
    private int b;
    ...
    public WidgetsContainer(Context context, AttributeSet attributeSet, int i) {
        super(new ContextThemeWrapper(context, 2132017726), attributeSet, i);
        setOrientation(1);
        setVisibility(8);
        this.b = getResources().getDimensionPixelSize(R.dimen.widgets_vertical_margin);
        this.a = new sse(this).a().a(1).c();
    }
    ...
    public final Flowable<ssd> a(float f) {
        return this.a.a((Predicate<? super T>) new Predicate(1.0f) {
            ...
            public final boolean test(Object obj) {
                return WidgetsContainer.a(this.f$0, (ssd) obj);
            }
        });
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ boolean a(float f, ssd ssd) {
        return ssd.c() >= f;
    }
