...
public class FeedbackService extends whu {
    public rkc a;
        ...
        if (intent != null) {
            ...
            if (action != null) {
                ...
                if (c == 0) {
                    ...
                    rkc rkc = this.a;
                    serialDisposable.a(rkc.a.a(stringExtra, stringExtra2, stringExtra, ViewUris.U.toString(), stringExtra3).a((Action) $$Lambda$FeedbackService$B_SvXblcLUtb9nbqv4asZ8K2n4.INSTANCE, (Consumer<? super Throwable>) $$Lambda$FeedbackService$YBj2QwTRKMQSdCg3ODftyGu8ZrQ.INSTANCE));
                } else if (c == 1) {
