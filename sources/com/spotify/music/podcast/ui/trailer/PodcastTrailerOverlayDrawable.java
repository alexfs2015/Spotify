...
public final class PodcastTrailerOverlayDrawable extends Drawable implements Runnable, a {
    ...
    public PodcastTrailerOverlayDrawable(Bitmap bitmap, int i2, int i3, int i4, SpotifyIconDrawable spotifyIconDrawable, SpotifyIconDrawable spotifyIconDrawable2, float f2, tsi tsi, jrp jrp) {
        this.a = bitmap;
        this.b = i2;
        this.c = i3;
        this.d = i4;
    ...
    public final void a(defpackage.tsj r12) {
        /*
            r11 = this;
            jrp r0 = r11.A
            long r0 = r0.d()
        ...
        L_0x0098:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.spotify.music.podcast.ui.trailer.PodcastTrailerOverlayDrawable.a(tsj):void");
    }
