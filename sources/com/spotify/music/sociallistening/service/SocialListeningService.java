...
public class SocialListeningService extends whu {
    public unp a;
    ...
    public void onHandleIntent(Intent intent) {
        if ("com.spotify.music.sociallistening.service.join".equals((String) fbp.a(intent.getAction()))) {
            if (this.a.a((String) fbp.a(intent.getStringExtra("session_uri"))).a(5000, TimeUnit.MILLISECONDS)) {
