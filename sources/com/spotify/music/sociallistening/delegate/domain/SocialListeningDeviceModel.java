...
public abstract class SocialListeningDeviceModel {
    public static final SocialListeningDeviceModel a = new defpackage.unx.a().a(false).a(Optional.e()).b(Optional.e()).a(ScannableImageLoadState.NOT_LOADED).a(b.a).a();
    ...
    public static abstract class a {
        public abstract a a(Optional<uns> optional);
    ...
    public static abstract class b {
        public static final b a = new defpackage.uny.a().a(false).a(ImmutableList.d()).b(false).a(Optional.e()).b(Optional.e()).c(false).d(false).e(false).f(false).g(false).h(false).a();
    ...
    public final SocialListeningDeviceModel a(uns uns) {
        return f().a(Optional.b(uns)).a();
    }

    public abstract boolean a();

    public abstract Optional<uns> b();
