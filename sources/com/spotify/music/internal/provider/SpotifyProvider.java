...
public class SpotifyProvider extends wht {
    public rtw a;
    public hjg b;
    ...
    public android.os.ParcelFileDescriptor openFile(android.net.Uri r6, java.lang.String r7) {
        ...
        L_0x0034:
            hjg r2 = r5.b     // Catch:{ all -> 0x0068 }
            boolean r2 = r2.a()     // Catch:{ all -> 0x0068 }
            if (r2 == 0) goto L_0x0062
            if (r1 != 0) goto L_0x003f
            goto L_0x0062
        L_0x003f:
            boolean r0 = defpackage.hfw.a(r1)     // Catch:{ all -> 0x0068 }
            if (r0 == 0) goto L_0x0051
            hjg r6 = r5.b     // Catch:{ all -> 0x0068 }
            android.os.ParcelFileDescriptor r6 = defpackage.hfw.a(r1, r6)     // Catch:{ all -> 0x0068 }
        L_0x004b:
            hjg r7 = r5.b
            r7.c()
            return r6
        L_0x0051:
            hjg r0 = r5.b     // Catch:{ all -> 0x0068 }
            hpl r0 = r0.d()     // Catch:{ all -> 0x0068 }
