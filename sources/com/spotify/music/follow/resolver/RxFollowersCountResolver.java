...
public final class RxFollowersCountResolver {
    ...
    public final Observable<Counts> a(List<String> list) {
        ...
        fay.a(!list.isEmpty());
        int size = list.size();
        return this.a.resolve(new Request(Request.GET, "hm://socialgraph/v2/counts?format=json", null, String.format("{\"target_uris\": [%s]}", new Object[]{TextUtils.join(",", fcl.a((Iterable<F>) list, (com.google.common.base.Function<? super F, ? extends T>) $$Lambda$RxFollowersCountResolver$WsGNs2wONC11MOHLI9m4YDSTdfI.INSTANCE))}).getBytes(far.c))).a((ObservableTransformer<? super T, ? extends R>) JacksonResponseParser.forClass(Counts.class, this.b, this.c)).a((Function<? super T, ? extends ObservableSource<? extends R>>) new Function(size) {
