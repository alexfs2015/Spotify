...
public class LyricsFullscreenHeaderView extends FrameLayout {
    ...
    public LyricsFullscreenHeaderView(Context context, AttributeSet attributeSet, int i) {
        ...
        vhl vhl = new vhl(getContext(), SpotifyIconV2.X, (float) vfj.b(16.0f, getContext().getResources()), (float) vfj.b(32.0f, getContext().getResources()), fr.c(getContext(), R.color.black_40), fr.c(getContext(), R.color.white));
