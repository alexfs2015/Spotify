...
public class LyricsView extends LinearLayout {
    ...
    private int b(int i2) {
        ...
        int i3 = 0;
        if (childAt instanceof svt) {
            svt svt = (svt) childAt;
            int i4 = svt.b;
            if (i4 == 0) {
                return 0;
            }
            i3 = (svt.getHeight() / i4) * (i4 - 1);
        }
        return i3;
    }

    private static svq b(TrackLyrics trackLyrics, Activity activity, LyricsAppearance lyricsAppearance) {
        return new svq(activity, trackLyrics.getLines(), lyricsAppearance);
    }
