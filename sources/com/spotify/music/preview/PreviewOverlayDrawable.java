...
public final class PreviewOverlayDrawable extends Drawable implements Runnable, a {
    ...
    public PreviewOverlayDrawable(Bitmap bitmap, int i2, int i3, int i4, SpotifyIconDrawable spotifyIconDrawable, SpotifyIconDrawable spotifyIconDrawable2, float f2, Drawable drawable, String str, String str2, boolean z2, ujc ujc, jtz jtz, boolean z3) {
        this.a = bitmap;
        this.b = i2;
        this.c = i3;
    ...
    public final void a(ujk ujk) {
        State state;
        long d2 = this.B.d();
        if (!ujk.a().equals(this.e)) {
            state = State.IDLE;
        } else if (TextUtils.isEmpty(this.f) || this.f.equals(ujk.b())) {
            if (ujk.h()) {
                if (!(!TextUtils.isEmpty(ujk.a()) && ujk.e().longValue() > 0 && ujk.d().equals(ujk.e()))) {
                    state = ujk.c() ? State.LOADING : State.PROGRESS;
                }
            }
            state = State.IDLE;
        } else {
