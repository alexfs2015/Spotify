...
public class FilterHeaderView extends RelativeLayout {
    ...
    /* access modifiers changed from: private */
    public vav k;
    private final defpackage.vav.a l = new defpackage.vav.a() {
    ...
    private final TextWatcher o = new jzg() {
    ...
    private Drawable a(SpotifyIcon spotifyIcon) {
        ...
        spotifyIconDrawable.a((float) vfj.b(24.0f, getResources()));
    ...
    public static FilterHeaderView a(LayoutInflater layoutInflater, String str, List<SortOption> list, SortOption sortOption, List<vau> list2, a aVar) {
        FilterHeaderView filterHeaderView = (FilterHeaderView) layoutInflater.inflate(R.layout.header_filter, null);
        filterHeaderView.a(str);
    ...
    private void c() {
        this.k = new vav(getContext(), LayoutInflater.from(getContext()), this.l);
    ...
    public final void a(sso sso, gkq gkq) {
        this.j = new InteractionLogger((jlr) gih.a(jls.class), sso, gkq);
    }
