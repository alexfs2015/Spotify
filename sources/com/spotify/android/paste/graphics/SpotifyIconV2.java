...
public enum SpotifyIconV2 {
    ADD_TO_PLAYLIST(new int[]{16, 24, 32, 48}, new String[]{r0, r1, r2, r5}, new String[]{r0, r1, r2, r5}, new boolean[]{false, false, false, false}),
    ADD_TO_QUEUE(new int[]{16, 24, 32, 48, 64}, new String[]{r4, r5, r6, r7, ""}, new String[]{r4, r5, r6, r7, ""}, new boolean[]{false, false, false, false, false}),
    ...
    FOLLOW_ACTIVE(new int[]{16, 24, 32, 48, 64}, new String[]{"", "", "", "", ""}, new String[]{"", "", "", "", ""}, new boolean[]{false, false, false, false, false}),
    ...
    public static final SpotifyIconV2[] cS = null;
    ...
    private SpotifyIconV2(int[] iArr, String[] strArr, String[] strArr2, boolean[] zArr) {
        this.mSizes = iArr;
    ...
    public final a a(int i) {
        ...
        a aVar = new a(this.mSizes[i4], this.mUnicodeCodes[i4], this.mUnicodeCodesRtl[i4], this.mAutoMirror[i4], 0);
        return aVar;
    }
}
