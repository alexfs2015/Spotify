...
public class GlueToolbarLayout extends ViewGroup {
    ...
    public GlueToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        vgl.b(context, this.c, R.attr.pasteTextAppearanceBodyMediumBold);
        this.c.setLayoutParams(new LayoutParams(-2, -2));
        addView(this.c);
        this.d = new ftb(context);
    }

    /* access modifiers changed from: private */
    public /* synthetic */ void a(View view) {
        ftb ftb = this.d;
        ftb.d = new ListPopupWindow(ftb.a, null);
        ftb.d.a((OnDismissListener) ftb);
        ftb.d.l = ftb;
        ftb.d.a((ListAdapter) ftb.f);
        boolean z = true;
        ftb.d.a(true);
        View view2 = (View) fbp.a(ftb.c);
        if (ftb.e != null) {
            z = false;
        }
        ftb.e = view2.getViewTreeObserver();
        if (z) {
            ftb.e.addOnGlobalLayoutListener(ftb);
        }
        ftb.d.k = view2;
        ftb.d.h = 8388613;
        ftb.d.d(vfj.a(220.0f, ftb.a.getResources()));
        ftb.d.e(2);
        ftb.d.d_();
        ((ListView) fbp.a(ftb.d.e)).setOnKeyListener(ftb);
        this.f.onClick(view);
    }
    ...
    public void onMeasure(int i, int i2) {
        Collection<View> collection;
        Collection<View> collection2;
        Assertion.a(!jum.b(i), "GlueToolbarLayout does not support UNSPECIFIED width measure spec");
        Assertion.a(!jum.b(i2), "GlueToolbarLayout does not support UNSPECIFIED height measure spec");
        int size = MeasureSpec.getSize(i);
        int size2 = MeasureSpec.getSize(i2);
        int b2 = vfj.b(40.0f, getResources());
