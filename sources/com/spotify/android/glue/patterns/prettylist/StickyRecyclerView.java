...
public class StickyRecyclerView extends ViewGroup implements fxm {
    ...
    private final int[] o;
    private boolean p;
    private final Set<defpackage.fxm.a> q;
    private final b r;
    private boolean s;
    private boolean t;
    ...
    public static class DynamicBottomPaddingLinearLayoutManager extends LinearLayoutManager implements a {
        ...
        public final void c(o oVar, s sVar) {
            ...
            for (int i2 = 0; i2 < r(); i2++) {
                i += ((View) fay.a(g(i2))).getMeasuredHeight();
            }
            if (this.a != i) {
                this.a = i;
                super.c(oVar, sVar);
        ...
        public final int b(int i, o oVar, s sVar) {
            ...
            boolean z2 = ((RecyclerView.LayoutParams) g.getLayoutParams()).c.e() == t() - 1;
            ...
            return super.b(Math.max(0, Math.min(i, n(g) - this.v)), oVar, sVar);
        }
        ...
        public final void a(Rect rect, View view, RecyclerView recyclerView, s sVar) {
            ...
            if (!(iVar instanceof LinearLayoutManager)) {
                ...
                if (iVar instanceof GridLayoutManager) {
                    ...
                    e = gridLayoutManager.b.c(e, gridLayoutManager.a);
                }
    ...
    class c extends RecyclerView {
        /* access modifiers changed from: private */
        public androidx.recyclerview.widget.RecyclerView.a<?> M;
        /* access modifiers changed from: private */
        public boolean N;
        private final androidx.recyclerview.widget.RecyclerView.c O = new androidx.recyclerview.widget.RecyclerView.c() {
            public final void a() {
                if (c.this.M.b() > 0) {
                    c cVar = c.this;
                    c.super.a(cVar.M);
                    c.this.M.b((androidx.recyclerview.widget.RecyclerView.c) this);
                    c.this.N = true;
                }
            }
        };
        ...
        public final void a(androidx.recyclerview.widget.RecyclerView.a aVar) {
            ...
            androidx.recyclerview.widget.RecyclerView.a<?> aVar2 = this.M;
            if (aVar2 != null) {
                aVar2.b(this.O);
            }
            if (aVar.b() == 0) {
    ...
    /* access modifiers changed from: private */
    public boolean d() {
        i iVar = (i) fay.a(this.a.d());
        return iVar.r() == 0 || RecyclerView.f((View) fay.a(iVar.g(0))) == 0;
    }
    ...
    private void c() {
        ...
        for (defpackage.fxm.a a2 : this.q) {
            a2.a(min, f2);
        }
    }
    ...
    public void onLayout(boolean r5, int r6, int r7, int r8, int r9) {
        ...
        L_0x008c:
            ...
            int r0 = r5 / 2
            int r7 = r7 + r0
            boolean r0 = defpackage.uur.a(r4)
        ...
        L_0x0146:
            ...
            java.lang.Object r6 = defpackage.fay.a(r6)
