...
public class GlueDialogLayout extends LinearLayout {
    ...
    public GlueDialogLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        try {
            this.a = obtainStyledAttributes.getDimensionPixelSize(a.h, vfj.b(312.0f, getResources()));
            this.b = obtainStyledAttributes.getDimensionPixelSize(a.g, vfj.b(520.0f, getResources()));
            this.c = obtainStyledAttributes.getDimensionPixelSize(a.f, vfj.b(24.0f, getResources()));
            this.d = obtainStyledAttributes.getDimensionPixelSize(a.j, vfj.b(24.0f, getResources()));
            this.e = obtainStyledAttributes.getDimensionPixelSize(a.e, vfj.b(48.0f, getResources()));
            this.g = obtainStyledAttributes.getDimensionPixelSize(a.b, vfj.b(48.0f, getResources()));
            this.h = obtainStyledAttributes.getDimensionPixelSize(a.c, vfj.b(32.0f, getResources()));
            this.f = obtainStyledAttributes.getDimensionPixelSize(a.i, vfj.b(40.0f, getResources()));
