...
public class StoriesProgressView extends LinearLayout {
    ...
    private void b(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, defpackage.uza.a.a);
        try {
            this.a = obtainStyledAttributes.getInt(defpackage.uza.a.d, 0);
            this.e = a(obtainStyledAttributes, defpackage.uza.a.c, R.color.default_progress_color);
            this.f = a(obtainStyledAttributes, defpackage.uza.a.b, R.color.default_background_progress_color);
        } finally {
    ...
    public final void a(int i, boolean z) {
        for (int i2 = 0; i2 < this.a; i2++) {
            ...
            if (i2 < i) {
                ...
                pausableProgressBar.c.setAnimationListener(new jzf() {
