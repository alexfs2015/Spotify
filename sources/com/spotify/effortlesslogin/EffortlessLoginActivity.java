...
public class EffortlessLoginActivity extends q implements b {
    ...
    public void onCreate(Bundle bundle) {
        ...
        b bVar = this.g;
        Application a = lv.a(this);
        if (bVar == null) {
            bVar = a.a(a);
        }
        this.m = (gda) new lu(ar_(), bVar).a(gda.class);
        this.m.a.a(this, new lo() {
    ...
    public /* synthetic */ void a(LoginState loginState) {
        ...
        if (i2 == 1) {
            this.h.a(ScreenIdentifier.SAMSUNG_EFFORTLESS_LOGIN_LOADING, EventIdentifier.SAMSUNG_EFFORTLESS_LOGIN_SUCCESS);
            c(-1);
        } else if (i2 != 2) {
            if (i2 == 3) {
                this.h.a(ScreenIdentifier.SAMSUNG_EFFORTLESS_LOGIN_LOADING, EventIdentifier.SAMSUNG_EFFORTLESS_LOGIN_FAILURE);
