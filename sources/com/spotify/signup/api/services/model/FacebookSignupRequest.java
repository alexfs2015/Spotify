...
public abstract class FacebookSignupRequest extends fcs<String, Object> {
    ...
    public Map<String, Object> delegate() {
        ...
        a b = ImmutableMap.g().b("fb", Integer.valueOf(1)).b(str, vxb.a).b("platform", "Android-ARM").b("facebook_name", "throwaway").b(str2, facebookUserId()).b(str3, facebookAccessToken());
