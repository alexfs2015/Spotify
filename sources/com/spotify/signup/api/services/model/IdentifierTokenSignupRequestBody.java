...
public abstract class IdentifierTokenSignupRequestBody extends fca<String, Object> {
    ...
    public Map<String, Object> delegate() {
        ...
        String str5 = "iagree";
        a b = ImmutableMap.g().b("key", vjv.a).b("platform", "Android-ARM").b(str, identifierToken()).b("gender", gender().toString().toLowerCase(Locale.ENGLISH)).b(str2, Integer.valueOf(birthDay())).b(str3, Integer.valueOf(birthMonth())).b(str4, Integer.valueOf(birthYear())).b(str5, Boolean.valueOf(iAgree()));
