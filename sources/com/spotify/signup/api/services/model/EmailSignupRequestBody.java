...
public abstract class EmailSignupRequestBody extends fcs<String, Object> {
    ...
    public Map<String, Object> delegate() {
        ...
        String str7 = "iagree";
        a b = ImmutableMap.g().b("key", vxb.a).b("platform", "Android-ARM").b(str, email()).b("gender", gender().toString().toLowerCase(Locale.ENGLISH)).b(str2, Integer.valueOf(birthDay())).b(str3, Integer.valueOf(birthMonth())).b(str4, Integer.valueOf(birthYear())).b(str5, password()).b(str6, passwordRepeat()).b(str7, Boolean.valueOf(iAgree()));
