...
public class RxResolverImpl implements RxResolver {
    ...
    private final Set<hhg> mSubscriptions = new HashSet();

    class PerformRequestOperator implements b<Response, RemoteNativeRouter> {
        private final StackTraceElement[] mObservableStackTrace = vvi.a();
        ...
        public xio<? super RemoteNativeRouter> call(final xio<? super Response> xio) {
            hhg hhg = new hhg(xio, vvj.a(this.mTag, this.mObservableStackTrace));
            RxResolverImpl.this.add(hhg);
            AnonymousClass1 r0 = new xio<RemoteNativeRouter>(xio) {
                ...
                public void onNext(RemoteNativeRouter remoteNativeRouter) {
                    ...
                    resolve.getClass();
                    add(xon.a((xir) new xir(resolve) {
                        private final /* synthetic */ Lifetime f$0;

                        public final 
/*
Method generation error in method: com.spotify.cosmos.android.-$$Lambda$1qEerEeh3Jd33cFhahj-hUP07uk.call():null, dex: classes.dex
...
*/
            ...
            r0.add(xon.a((xir) new xir(hhg) {
                private final /* synthetic */ hhg f$1;
        ...
        public /* synthetic */ void lambda$call$0$RxResolverImpl$PerformRequestOperator(hhg hhg) {
            RxResolverImpl.this.remove(hhg);
        }
    }
    ...
    /* access modifiers changed from: private */
    public synchronized void add(hhg hhg) {
        if (this.mSubscriptions.add(hhg)) {
            Logger.b("Added %s subscription. (#Active subscriptions: %d)", hhg.b.a, Integer.valueOf(this.mSubscriptions.size()));
        }
    }

    private String describeActiveSubscriptions() {
        StringBuilder sb = new StringBuilder();
        ArrayList<hhg> arrayList = new ArrayList<>(this.mSubscriptions);
        sb.append(String.format(Locale.getDefault(), "#Active subscriptions: %d", new Object[]{Integer.valueOf(arrayList.size())}));
        for (hhg hhg : arrayList) {
            sb.append(String.format(Locale.getDefault(), "\n%s", new Object[]{hhg.b.a}));
        }
        return sb.toString();
    }
    ...
    /* access modifiers changed from: private */
    public synchronized void remove(hhg hhg) {
        if (this.mSubscriptions.remove(hhg)) {
            Logger.b("Removed %s subscription. (#Active subscriptions: %d)", hhg.b.a, Integer.valueOf(this.mSubscriptions.size()));
        }
    }
    ...
    public Observable<Response> resolve(Request request, Scheduler scheduler) {
        ...
        AnonymousClass3 r4 = new FlowableOperator<R, T>(performRequestOperator) {
            ...
            public final xfl<? super T> a(xfl<? super R> xfl) {
                xio xio;
                a aVar = new a(xfl);
                xfl.a(new b(aVar));
                try {
                    xio = (xio) ObjectHelper.a(this.a.call(aVar), "The operator returned a null rx.Subscriber");
                } catch (Throwable th) {
                    Exceptions.b(th);
                    xiq.b(th);
                    xfl.onError(th);
    ...
    public synchronized java.util.List<defpackage.vvj> unsubscribeAndReturnLeaks() {
        /*
            r6 = this;
            monitor-enter(r6)
            java.util.ArrayList r0 = new java.util.ArrayList     // Catch:{ all -> 0x0056 }
            java.util.Set<hhg> r1 = r6.mSubscriptions     // Catch:{ all -> 0x0056 }
        ...
        L_0x002b:
            ...
            hhg r3 = (defpackage.hhg) r3     // Catch:{ all -> 0x0056 }
            xip r4 = r3.a     // Catch:{ all -> 0x0056 }
