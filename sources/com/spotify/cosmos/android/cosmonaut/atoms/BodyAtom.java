...
final class BodyAtom {
    ...
    private final Optional<gbt<Object[], byte[]>> mArgumentTransformation;

    static class BodyPartTransformation implements gbt<Object[], byte[]> {
        ...
        public byte[] apply(Object[] objArr) {
            ...
            ImmutableMap b = g.b();
            try {
                return (byte[]) fay.a(this.mConverter.convert(b.getClass(), b));
            } catch (IOException e) {
    ...
    static class BodyTransformation implements gbt<Object[], byte[]> {
        private final Converter<Object, byte[]> mConverter;
        ...
        public byte[] apply(Object[] objArr) {
            try {
                return (byte[]) fay.a(this.mConverter.convert(this.mType, objArr[this.mIndex]));
            } catch (IOException e) {
                Logger.e(e, "Unexpected IO exception", new Object[0]);
                return BodyAtom.DEFAULT_VALUE;
            }
    ...
    public final byte[] call(Object[] objArr) {
        return (byte[]) this.mArgumentTransformation.a((Function<? super T, V>) new Function(objArr) {
            ...
            public final Object apply(Object obj) {
                return BodyAtom.lambda$call$0(this.f$0, (gbt) obj);
            }
        }).a(DEFAULT_VALUE);
    }

    static /* synthetic */ byte[] lambda$call$0(Object[] objArr, gbt gbt) {
        return (byte[]) gbt.apply(objArr);
    }

    private static Optional<gbt<Object[], byte[]>> createOptionalArgumentTransformer(Method method, RequestTransformers requestTransformers) {
        ...
        return Optional.b(new BodyPartTransformation(arrayList, requestTransformers.find(Map.class)));
    }
}
