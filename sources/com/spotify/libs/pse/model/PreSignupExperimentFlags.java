...
public class PreSignupExperimentFlags implements JacksonModel {
    ...
    public static PreSignupExperimentFlags loadPreference(SpSharedPreferences<Object> spSharedPreferences) {
        ...
        for (String put : ((String) fbp.a(spSharedPreferences.c(PREFS_KEY_PRE_SIGNUP_EXPERIMENT_FEATURE_FLAGS))).split(FLAG_SPLITTER)) {
    ...
    public String activeFlagsAsString() {
        return fbl.a(FLAG_SPLITTER).a((Iterable<?>) ImmutableList.a((Comparator<? super E>) fdl.a(fdl.b()), fcp.a((Iterable<E>) this.mActiveFlags).a()));
    }
