...
public final class ViewLoadingTracker {
    ...
    public ViewLoadingTracker(View view, gnk gnk, gnd gnd, String str, Bundle bundle, Handler handler, Context context) {
        this.g = view;
        this.k = gnk;
        this.l = gnd;
        this.h = handler;
