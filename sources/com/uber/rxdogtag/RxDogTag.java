...
public final class RxDogTag {
    ...
    static class Configuration {
        ...
        private static final ObserverHandler e = new ObserverHandler() {
            ...
            public /* synthetic */ wrg a(wrg wrg) {
                return CC.$default$a((ObserverHandler) this, wrg);
            }
        };
    ...
    private static synchronized void a(Configuration configuration) {
        synchronized (RxDogTag.class) {
            ...
            RxJavaPlugins.b((BiFunction<? super Flowable, ? super wrg, ? extends wrg>) new BiFunction() {
                public final Object apply(Object obj, Object obj2) {
                    return RxDogTag.a(Configuration.this, (Flowable) obj, (wrg) obj2);
                }
            });
    ...
    public static /* synthetic */ Observer a(Configuration configuration, Observable observable, Observer observer) {
        for (ObserverHandler a : configuration.b) {
            ...
            if ((a2 instanceof LambdaConsumerIntrospection) && !((LambdaConsumerIntrospection) a2).bb_()) {
    ...
    /* access modifiers changed from: private */
    public static /* synthetic */ wrg a(Configuration configuration, Flowable flowable, wrg wrg) {
        for (ObserverHandler a : configuration.b) {
            wrg a2 = a.a(wrg);
            if ((a2 instanceof LambdaConsumerIntrospection) && !((LambdaConsumerIntrospection) a2).bb_()) {
                return new DogTagSubscriber(configuration, wrg);
            }
        }
        return wrg;
    }
