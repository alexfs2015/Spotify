...
public final class FirebaseInstanceIdReceiver extends lb {
    ...
    private static int a(BroadcastReceiver broadcastReceiver, Context context, String str, Intent intent) {
        boolean z = true;
        boolean z2 = caf.i() && context.getApplicationInfo().targetSdkVersion >= 26;
        ...
        int b2 = fhi.a().b(context, str, intent);
        if (!caf.i() || b2 != 402) {
            return b2;
        }
    ...
    private static synchronized fhu a(Context context, String str) {
        synchronized (FirebaseInstanceIdReceiver.class) {
            if ("com.google.firebase.MESSAGING_EVENT".equals(str)) {
                if (b == null) {
                    b = new fhu(context, str);
                }
                fhu fhu = b;
                return fhu;
            }
            if (a == null) {
                a = new fhu(context, str);
            }
            fhu fhu2 = a;
            return fhu2;
        }
