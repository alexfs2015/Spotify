...
public class FirebaseMessagingService extends fhn {
    ...
    public final Intent a(Intent intent) {
        return (Intent) fhi.a().b.poll();
    }

    public void a(fir fir) {
    }
    ...
    public final void b(android.content.Intent r11) {
        ...
        L_0x0015:
            ...
            boolean r0 = defpackage.fiq.a(r11)
            if (r0 == 0) goto L_0x0054
            java.lang.String r0 = "_nd"
            defpackage.fiq.a(r0, r11)
            return
        L_0x0029:
        ...
        L_0x0055:
            ...
            r2 = 0
            exz r2 = defpackage.eyc.a(r2)
            goto L_0x0080
        L_0x0067:
            android.os.Bundle r2 = new android.os.Bundle
            r2.<init>()
            r2.putString(r0, r1)
            fgq r3 = defpackage.fgq.a(r10)
            fgx r4 = new fgx
            int r5 = r3.a()
            r4.<init>(r5, r2)
            exz r2 = r3.a(r4)
        ...
        L_0x0153:
            ...
            r0.remove(r1)
            boolean r1 = defpackage.fis.a(r0)
            if (r1 == 0) goto L_0x0174
            fis r1 = new fis
            r1.<init>(r10)
            boolean r1 = r1.b(r0)
            if (r1 != 0) goto L_0x017c
            boolean r1 = defpackage.fiq.a(r11)
            if (r1 == 0) goto L_0x0174
            java.lang.String r1 = "_nf"
            defpackage.fiq.a(r1, r11)
        L_0x0174:
            fir r11 = new fir
            r11.<init>(r0)
            r10.a(r11)
        L_0x017c:
            ...
            defpackage.eyc.a(r2, r0, r11)     // Catch:{ ExecutionException -> 0x0188, InterruptedException -> 0x0186, TimeoutException -> 0x0184 }
            return
        L_0x0184:
            r11 = move-exception
            goto L_0x0189
            ...
            if (intent != null) {
                if ("1".equals(intent.getStringExtra("google.c.a.tc"))) {
                    ...
                    if (ffm != null) {
                        ...
                        String str2 = "fcm";
                        ffm.a(str2, "_ln", (Object) stringExtra);
                        Bundle bundle = new Bundle();
                        bundle.putString("source", "Firebase");
                        bundle.putString("medium", "notification");
                        bundle.putString("campaign", stringExtra);
                        ffm.a(str2, "_cmp", bundle);
                    }
                } else {
                    Log.isLoggable(str, 3);
                }
