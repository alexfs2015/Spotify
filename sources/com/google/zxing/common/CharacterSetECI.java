...
public enum CharacterSetECI {
    ...
    private static final Map<Integer, CharacterSetECI> B = null;
    private static final Map<String, CharacterSetECI> C = null;
    ...
    public static CharacterSetECI a(String str) {
        return (CharacterSetECI) C.get(str);
    }
}
