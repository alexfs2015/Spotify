...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    public SignInButton(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            try {
                this.c = bxs.a(context2, this.a, this.b);
                ...
                signInButtonImpl.setTextColor((ColorStateList) bxo.a(resources.getColorStateList(SignInButtonImpl.a(i5, R.color.common_google_signin_btn_text_dark, R.color.common_google_signin_btn_text_light, R.color.common_google_signin_btn_text_light))));
                if (i4 == 0) {
                ...
                if (cab.a(signInButtonImpl.getContext())) {
