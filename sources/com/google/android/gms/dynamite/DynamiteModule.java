...
public final class DynamiteModule {
    public static final a a = new cbl();
    public static final a b = new cbo();
    private static Boolean d = null;
    private static cbs e = null;
    private static cbu f = null;
    private static String g = null;
    private static int h = -1;
    private static final ThreadLocal<b> i = new ThreadLocal<>();
    private static final C0006a j = new cbk();
    ...
    public static int a(android.content.Context r8, java.lang.String r9, boolean r10) {
        ...
        L_0x0052:
            ...
            goto L_0x007b
        L_0x0063:
            cbr r5 = new cbr     // Catch:{ LoadingException -> 0x007e }
    ...
    private static Context a(Context context, String str, int i2, Cursor cursor, cbu cbu) {
        try {
            cbj.a(null);
            return (Context) cbj.a(a().booleanValue() ? cbu.b(cbj.a(context), str, i2, cbj.a(cursor)) : cbu.a(cbj.a(context), str, i2, cbj.a(cursor)));
        } catch (Exception e2) {
    ...
    private static cbs a(Context context) {
        cbs cbs;
        synchronized (DynamiteModule.class) {
            if (e != null) {
                cbs cbs2 = e;
                return cbs2;
            } else if (bsp.b().a(context) != 0) {
                return null;
            } else {
                try {
                    ...
                    if (iBinder == null) {
                        ...
                        cbs = queryLocalInterface instanceof cbs ? (cbs) queryLocalInterface : new cbt(iBinder);
                    }
                    if (cbs != null) {
                        e = cbs;
                        return cbs;
    ...
    private static void a(ClassLoader classLoader) {
        ...
        try {
            ...
            if (iBinder == null) {
                ...
                cbu = queryLocalInterface instanceof cbu ? (cbu) queryLocalInterface : new cbv(iBinder);
            }
            f = cbu;
    ...
    private static int b(Context context, String str, boolean z) {
        ...
        try {
            return a2.a() >= 2 ? a2.b(cbj.a(context), str, z) : a2.a(cbj.a(context), str, z);
    ...
    private static DynamiteModule b(Context context, String str, int i2) {
        ...
        if (a2 != null) {
            try {
                cbi b2 = a2.a() >= 2 ? a2.b(cbj.a(context), str, i2) : a2.a(cbj.a(context), str, i2);
                if (cbj.a(b2) != null) {
                    return new DynamiteModule((Context) cbj.a(b2));
                }
    ...
    private static DynamiteModule c(Context context, String str, int i2) {
        ...
        if (cbu != null) {
            ...
            Context a2 = a(context.getApplicationContext(), str, i2, bVar.a, cbu);
            if (a2 != null) {
