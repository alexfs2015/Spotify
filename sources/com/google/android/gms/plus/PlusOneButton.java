...
public final class PlusOneButton extends FrameLayout {
    ...
    public PlusOneButton(Context context, AttributeSet attributeSet) {
        ...
        String a2 = bxe.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attributeSet, true, false, "PlusOneButton");
        int i = 2;
        int i2 = "SMALL".equalsIgnoreCase(a2) ? 0 : "MEDIUM".equalsIgnoreCase(a2) ? 1 : "TALL".equalsIgnoreCase(a2) ? 2 : 3;
        this.b = i2;
        String a3 = bxe.a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attributeSet, true, false, "PlusOneButton");
        ...
        this.a = ewl.a(context2, this.b, this.c, null, this.d);
        b bVar = this.e;
        this.e = bVar;
