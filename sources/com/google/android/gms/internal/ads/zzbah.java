...
public abstract class zzbah implements Serializable, Iterable<Byte> {
    public static final zzbah a = new zzbao(ddr.b);
    private static final dcs b = (dcl.a() ? new dcu(0) : new dcr(0));
    int zzdpa = 0;
    ...
    public static zzbah a(String str) {
        return new zzbao(str.getBytes(ddr.a));
    }
    ...
    public abstract void a(dcp dcp);
