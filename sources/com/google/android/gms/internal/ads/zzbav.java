...
public abstract class zzbav extends dcp {
    static final Logger a = Logger.getLogger(zzbav.class.getName());
    static final boolean b = dgh.a();
    public dcz c = this;
    ...
    static class a extends zzbav {
        ...
        public final void a(int i, deq deq) {
            a(1, 3);
            c(2, i);
            a(3, 2);
            a(deq);
        ...
        public final void a(int i, deq deq, dfj dfj) {
            a(i, 2);
            dcf dcf = (dcf) deq;
            int h = dcf.h();
            if (h == -1) {
        ...
        public final void a(long j) {
            if (!zzbav.b || h() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.g;
                    this.g = i3 + 1;
                    dgh.a(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.d;
                int i4 = this.g;
                this.g = i4 + 1;
                dgh.a(bArr4, (long) i4, (byte) ((int) j));
            }
        }
        ...
        public final void a(String str) {
            ...
            try {
                ...
                if (n2 == n) {
                    this.g = i + n2;
                    int a = dgj.a(str, this.d, this.g, h());
                    this.g = i;
                    b((a - i) - n2);
                    this.g = a;
                    return;
                }
                b(dgj.a((CharSequence) str));
                this.g = dgj.a(str, this.d, this.g, h());
            } catch (zzbep e2) {
                zzbep zzbep = e2;
                this.g = i;
        ...
        public final void b(int i) {
            if (!zzbav.b || h() < 10) {
                ...
                while ((i & -128) != 0) {
                    ...
                    int i4 = this.g;
                    this.g = i4 + 1;
                    dgh.a(bArr3, (long) i4, (byte) ((i & 127) | 128));
                    i >>>= 7;
                }
                byte[] bArr4 = this.d;
                int i5 = this.g;
                this.g = i5 + 1;
                dgh.a(bArr4, (long) i5, (byte) i);
            }
        }
    ...
    public static int a(int i, ddz ddz) {
        int n = n(i << 3);
        int b2 = ddz.b();
        return n + n(b2) + b2;
    }

    public static int a(ddz ddz) {
        int b2 = ddz.b();
        return n(b2) + b2;
    }

    public static int a(deq deq, dfj dfj) {
        dcf dcf = (dcf) deq;
        int h = dcf.h();
        if (h == -1) {
            h = dfj.b(dcf);
    ...
    public static int b(int i, ddz ddz) {
        return (n(8) << 1) + g(2, i) + a(3, ddz);
    }

    public static int b(int i, deq deq) {
        return (n(8) << 1) + g(2, i) + n(24) + b(deq);
    }

    public static int b(int i, deq deq, dfj dfj) {
        return n(i << 3) + a(deq, dfj);
    }
    ...
    public static int b(String str) {
        int i;
        try {
            i = dgj.a((CharSequence) str);
        } catch (zzbep unused) {
            i = str.getBytes(ddr.a).length;
        }
        return n(i) + i;
    }
    ...
    @Deprecated
    public static int c(int i, deq deq, dfj dfj) {
        int n = n(i << 3) << 1;
        dcf dcf = (dcf) deq;
        int h = dcf.h();
        if (h == -1) {
    ...
    public abstract void a(int i, deq deq);

    public abstract void a(int i, deq deq, dfj dfj);
    ...
    public abstract void a(deq deq);
