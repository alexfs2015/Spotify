...
@cfp
public class HttpClient implements bhc<dzx> {
    private final Context mContext;
    private final cpp zzyf;
    ...
    public HttpClient(Context context, cpp cpp) {
    ...
    private final com.google.android.gms.ads.internal.gmsg.HttpClient.c zza(com.google.android.gms.ads.internal.gmsg.HttpClient.b r13) {
        /*
            ...
            cmu r3 = defpackage.bkc.e()     // Catch:{ Exception -> 0x00d9 }
            android.content.Context r4 = r12.mContext     // Catch:{ Exception -> 0x00d9 }
            cpp r5 = r12.zzyf     // Catch:{ Exception -> 0x00d9 }
        ...
        L_0x0058:
            r3 = r1
        L_0x0059:
            cpg r5 = new cpg     // Catch:{ Exception -> 0x00d9 }
        ...
        L_0x00a9:
            ...
            defpackage.bkc.e()     // Catch:{ Exception -> 0x00d9 }
            ...
            java.lang.String r8 = defpackage.cmu.a(r8)     // Catch:{ Exception -> 0x00d9 }
    ...
    private static JSONObject zza(d dVar) {
        ...
        try {
            ...
            cml.a("Error constructing JSON for http response.", e);
        }
        return jSONObject;
    }
    ...
    private static b zzc(JSONObject jSONObject) {
        ...
        try {
            ...
            cml.a("Error constructing http request.", e);
        }
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        cms.a((Runnable) new bhd(this, map, (dzx) obj));
    }
}
