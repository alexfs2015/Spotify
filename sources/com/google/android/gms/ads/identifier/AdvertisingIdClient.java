...
public class AdvertisingIdClient {
    ...
    private static bsl zza(Context context, boolean z) {
        try {
            context.getPackageManager().getPackageInfo("com.android.vending", 0);
            int b = bsp.b().b(context, bsq.GOOGLE_PLAY_SERVICES_VERSION_CODE);
            if (b == 0 || b == 2) {
                ...
                try {
                    if (bzs.a().b(context, intent, bsl, 1)) {
                        return bsl;
                    }
    ...
    private static efo zza(Context context, bsl bsl) {
        try {
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            bxo.c("BlockingServiceConnection.getServiceWithTimeout() called on main thread");
            if (!bsl.a) {
                bsl.a = true;
                IBinder iBinder = (IBinder) bsl.b.poll(10000, timeUnit);
                if (iBinder != null) {
                    return efp.a(iBinder);
                }
    ...
    private final void zza(boolean z) {
        bxo.c("Calling this from your main thread can lead to deadlock");
        synchronized (this) {
            if (this.zzg) {
                finish();
            }
    ...
    private final boolean zzb() {
        ...
        L_0x003a:
            ...
            throw r1     // Catch:{ all -> 0x005a }
        L_0x003d:
            bsl r0 = r3.zze     // Catch:{ all -> 0x005a }
            defpackage.bxo.a(r0)     // Catch:{ all -> 0x005a }
            efo r0 = r3.zzf     // Catch:{ all -> 0x005a }
            defpackage.bxo.a(r0)     // Catch:{ all -> 0x005a }
            efo r0 = r3.zzf     // Catch:{ RemoteException -> 0x0052 }
    ...
    public final void finish() {
        /*
            ...
            bsl r0 = r2.zze     // Catch:{ all -> 0x0029 }
            if (r0 != 0) goto L_0x000f
            goto L_0x0027
        L_0x000f:
            boolean r0 = r2.zzg     // Catch:{ all -> 0x001d }
            if (r0 == 0) goto L_0x001d
            defpackage.bzs.a()     // Catch:{ all -> 0x001d }
            android.content.Context r0 = r2.mContext     // Catch:{ all -> 0x001d }
            bsl r1 = r2.zze     // Catch:{ all -> 0x001d }
            defpackage.bzs.a(r0, r1)     // Catch:{ all -> 0x001d }
        L_0x001d:
            r0 = 0
    ...
    public com.google.android.gms.ads.identifier.AdvertisingIdClient.Info getInfo() {
        ...
        L_0x003a:
            ...
            throw r1     // Catch:{ all -> 0x0065 }
        L_0x003d:
            bsl r0 = r3.zze     // Catch:{ all -> 0x0065 }
            defpackage.bxo.a(r0)     // Catch:{ all -> 0x0065 }
            efo r0 = r3.zzf     // Catch:{ all -> 0x0065 }
            defpackage.bxo.a(r0)     // Catch:{ all -> 0x0065 }
            ...
            efo r1 = r3.zzf     // Catch:{ RemoteException -> 0x005d }
            java.lang.String r1 = r1.a()     // Catch:{ RemoteException -> 0x005d }
            efo r2 = r3.zzf     // Catch:{ RemoteException -> 0x005d }
