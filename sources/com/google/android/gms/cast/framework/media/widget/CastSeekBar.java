...
public class CastSeekBar extends View {
    ...
    public CastSeekBar(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.a = new b();
        this.a.a = 1;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, defpackage.bot.a.a, R.attr.castExpandedControllerStyle, R.style.CastExpandedController);
        int resourceId = obtainStyledAttributes.getResourceId(defpackage.bot.a.c, 0);
        int resourceId2 = obtainStyledAttributes.getResourceId(defpackage.bot.a.d, 0);
        int resourceId3 = obtainStyledAttributes.getResourceId(defpackage.bot.a.e, 0);
        int resourceId4 = obtainStyledAttributes.getResourceId(defpackage.bot.a.b, 0);
