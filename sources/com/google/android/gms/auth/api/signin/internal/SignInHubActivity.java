...
public class SignInHubActivity extends kf {
    ...
    class a implements defpackage.md.a<Void> {
        private a() {
        }
        ...
        public final mg<Void> a() {
            return new bmv(SignInHubActivity.this, bsy.a());
        }
    ...
    private final void f() {
        md.a(this).a(0, null, new a(this, 0));
        g = false;
    }
            ...
            if (i2 == 40962) {
                if (intent != null) {
                    ...
                    if (signInAccount == null || signInAccount.a == null) {
                        ...
                        bnc.a(this).a(this.i.a, googleSignInAccount);
