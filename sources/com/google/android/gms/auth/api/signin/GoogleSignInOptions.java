...
public class GoogleSignInOptions extends bxw implements bsv, ReflectedParcelable {
    public static final Creator<GoogleSignInOptions> CREATOR = new bno();
    ...
    private static Comparator<Scope> p = new bnn();
    private final int f;
    ...
    public String m;
    /* access modifiers changed from: private */
    public ArrayList<bmq> n;
    private Map<Integer, bmq> o;
    ...
    public static final class a {
        ...
        private Account f;
        private String g;
        private Map<Integer, bmq> h = new HashMap();
        ...
        public a(GoogleSignInOptions googleSignInOptions) {
            ...
            this.h = GoogleSignInOptions.b((List<bmq>) googleSignInOptions.n);
        }
    ...
    public GoogleSignInOptions(int i2, ArrayList<Scope> arrayList, Account account, boolean z, boolean z2, boolean z3, String str, String str2, ArrayList<bmq> arrayList2) {
        this(i2, arrayList, account, z, z2, z3, str, str2, b((List<bmq>) arrayList2));
    }

    private GoogleSignInOptions(int i2, ArrayList<Scope> arrayList, Account account, boolean z, boolean z2, boolean z3, String str, String str2, Map<Integer, bmq> map) {
        this.f = i2;
        this.g = arrayList;
        this.h = account;
        this.i = z;
    ...
    public boolean equals(java.lang.Object r4) {
        ...
        L_0x0004:
            ...
            java.util.ArrayList<bmq> r1 = r3.n     // Catch:{ ClassCastException -> 0x0076 }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x0076 }
            if (r1 > 0) goto L_0x0076
            java.util.ArrayList<bmq> r1 = r4.n     // Catch:{ ClassCastException -> 0x0076 }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x0076 }
    ...
    public int hashCode() {
        ...
        return new bmr().a((Object) arrayList).a((Object) this.h).a((Object) this.l).a(this.k).a(this.i).a(this.j).a;
    }

    public void writeToParcel(Parcel parcel, int i2) {
        int a2 = bxx.a(parcel, 20293);
        bxx.b(parcel, 1, this.f);
        bxx.b(parcel, 2, a(), false);
        bxx.a(parcel, 3, (Parcelable) this.h, i2, false);
        bxx.a(parcel, 4, this.i);
        bxx.a(parcel, 5, this.j);
        bxx.a(parcel, 6, this.k);
        bxx.a(parcel, 7, this.l, false);
        bxx.a(parcel, 8, this.m, false);
        bxx.b(parcel, 9, this.n, false);
        bxx.b(parcel, a2);
    }
}
