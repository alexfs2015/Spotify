...
public class GoogleSignInAccount extends bxw implements ReflectedParcelable {
    public static final Creator<GoogleSignInAccount> CREATOR = new bnm();
    private static bzx b = caa.d();
    public String a;
    private final int c;
    private String d;
    private String e;
    ...
    public static GoogleSignInAccount a(String str) {
        ...
        GoogleSignInAccount googleSignInAccount2 = new GoogleSignInAccount(3, optString2, optString3, optString4, optString5, parse, null, valueOf.longValue(), bxo.a(string), new ArrayList((Collection) bxo.a(hashSet)), optString6, optString7);
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        bxx.a(parcel, 2, this.d, false);
        bxx.a(parcel, 3, this.e, false);
        bxx.a(parcel, 4, this.f, false);
        bxx.a(parcel, 5, this.g, false);
        bxx.a(parcel, 6, (Parcelable) this.h, i2, false);
        bxx.a(parcel, 7, this.i, false);
        bxx.a(parcel, 8, this.j);
        bxx.a(parcel, 9, this.a, false);
        bxx.b(parcel, 10, this.k, false);
        bxx.a(parcel, 11, this.l, false);
        bxx.a(parcel, 12, this.m, false);
        bxx.b(parcel, a2);
    }
}
