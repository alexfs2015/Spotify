...
public class FlexboxLayout extends ViewGroup implements bej {
    private int a;
    private int b;
    private int c;
    private int d;
    ...
    public static class LayoutParams extends MarginLayoutParams implements bek {
    ...
    private void a(int i2, int i3) {
        ...
        if (this.d == 3) {
            for (bel bel : this.p) {
                ...
                for (int i5 = 0; i5 < bel.h; i5++) {
                    View c2 = c(bel.o + i5);
                    if (!(c2 == null || c2.getVisibility() == 8)) {
                        LayoutParams layoutParams = (LayoutParams) c2.getLayoutParams();
                        if (this.b != 2) {
                            i4 = Math.max(i4, c2.getMeasuredHeight() + Math.max(bel.l - c2.getBaseline(), layoutParams.topMargin) + layoutParams.bottomMargin);
                        } else {
                            i4 = Math.max(i4, c2.getMeasuredHeight() + layoutParams.topMargin + Math.max((bel.l - c2.getMeasuredHeight()) + c2.getBaseline(), layoutParams.bottomMargin));
                        }
                    }
                }
                bel.g = i4;
    ...
    private void a(boolean r29, int r30, int r31, int r32, int r33) {
        ...
        L_0x0020:
            ...
            java.util.List<bel> r9 = r0.p
            java.lang.Object r9 = r9.get(r3)
            bel r9 = (defpackage.bel) r9
            boolean r10 = r0.d(r3)
    ...
    private void a(Canvas canvas, boolean z, boolean z2) {
        ...
        for (int i6 = 0; i6 < size; i6++) {
            bel bel = (bel) this.p.get(i6);
            for (int i7 = 0; i7 < bel.h; i7++) {
                int i8 = bel.o + i7;
                View c2 = c(i8);
                if (!(c2 == null || c2.getVisibility() == 8)) {
                    LayoutParams layoutParams = (LayoutParams) c2.getLayoutParams();
    ...
    public final void a(View view, int i2, int i3, bel bel) {
        if (b(i2, i3)) {
            if (j()) {
                bel.e += this.l;
                bel.f += this.l;
