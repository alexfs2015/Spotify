...
public class FlexboxLayoutManager extends i implements androidx.recyclerview.widget.RecyclerView.r.b, bfa {
    ...
    public static class LayoutParams extends androidx.recyclerview.widget.RecyclerView.LayoutParams implements bfb {
    ...
    class a {
        ...
        static /* synthetic */ void a(a aVar, View view) {
            ...
            if (h || FlexboxLayoutManager.this.x.a != null) {
                ...
                aVar.b = i2;
                if (FlexboxLayoutManager.this.h.size() > aVar.b) {
                    aVar.a = ((bfc) FlexboxLayoutManager.this.h.get(aVar.b)).o;
                    return;
                }
                return;
            }
        ...
        static /* synthetic */ void f(a aVar) {
            if (FlexboxLayoutManager.this.j() || !FlexboxLayoutManager.this.f) {
                ...
                aVar.c = aVar.e ? FlexboxLayoutManager.this.C.c() : FlexboxLayoutManager.this.v - FlexboxLayoutManager.this.C.b();
            }
        }
    ...
    private int a(o oVar, s sVar, b bVar) {
        ...
        while (true) {
            ...
            int i7 = 1;
            if (!(bVar2.d >= 0 && bVar2.d < sVar.a() && bVar2.c >= 0 && bVar2.c < this.h.size())) {
                break;
            }
            bfc bfc = (bfc) this.h.get(bVar2.c);
            bVar2.d = bfc.o;
            if (!j()) {
                i = a(bfc, bVar2);
                ...
                while (i13 < i11 + i12) {
                    ...
                    if (a2 != null) {
                        ...
                        if (this.f) {
                            i3 = i15;
                            i2 = i11;
                            this.x.a(a2, bfc, Math.round(r) - a2.getMeasuredWidth(), o, Math.round(r), o + a2.getMeasuredHeight());
                        } else {
                            i2 = i11;
                            i3 = i15;
                            this.x.a(a2, bfc, Math.round(q), o, Math.round(q) + a2.getMeasuredWidth(), o + a2.getMeasuredHeight());
                        }
                        i14 = i16;
            ...
            while (i11 < i8 + i10) {
                ...
                if (a2 != null) {
                    ...
                    if (!z2) {
                        ...
                        if (this.g) {
                            this.x.a(view, bfc, z2, q, Math.round(p) - view.getMeasuredHeight(), q + view.getMeasuredWidth(), Math.round(p));
                        } else {
                            this.x.a(view, bfc, z2, q, Math.round(o), q + view.getMeasuredWidth(), Math.round(o) + view.getMeasuredHeight());
                        }
                    } else if (this.g) {
                        i2 = i6;
                        layoutParams = layoutParams2;
                        ...
                        view = a2;
                        i = i11;
                        this.x.a(a2, bfc, z2, r - a2.getMeasuredWidth(), round, r, Math.round(p));
                    } else {
                        view = a2;
                        i = i11;
                        i2 = i6;
                        layoutParams = layoutParams2;
                        this.x.a(view, bfc, z2, r - view.getMeasuredWidth(), Math.round(o), r, Math.round(o) + view.getMeasuredHeight());
                    }
    ...
    private View a(View view, bfc bfc) {
        boolean j = j();
        int i = bfc.h;
    ...
    private void a(int i, int i2) {
        if (O || this.x.a != null) {
            this.A.i = i;
            boolean j = j();
            int makeMeasureSpec = MeasureSpec.makeMeasureSpec(this.v, this.t);
            int makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(this.w, this.u);
            int i3 = 0;
            boolean z2 = !j && this.f;
            if (i == 1) {
                View g2 = g(r() - 1);
                ...
                int c2 = c(g2);
                View b2 = b(g2, (bfc) this.h.get(this.x.a[c2]));
                b bVar = this.A;
                bVar.h = 1;
                bVar.d = c2 + bVar.h;
                ...
                if ((this.A.c == -1 || this.A.c > this.h.size() - 1) && this.A.d <= this.z.a()) {
                    int i4 = i2 - this.A.f;
                    this.N.a();
                    if (i4 > 0) {
                        if (j) {
                            this.x.a(this.N, makeMeasureSpec, makeMeasureSpec2, i4, this.A.d, this.h);
                        } else {
                            this.x.c(this.N, makeMeasureSpec, makeMeasureSpec2, i4, this.A.d, this.h);
                        }
                ...
                int c3 = c(g3);
                View a2 = a(g3, (bfc) this.h.get(this.x.a[c3]));
                this.A.h = 1;
                int i5 = this.x.a[c3];
                if (i5 == -1) {
                    i5 = 0;
                ...
                if (i5 > 0) {
                    this.A.d = c3 - ((bfc) this.h.get(i5 - 1)).h;
                } else {
                    this.A.d = -1;
                }
    ...
    private void a(a aVar, boolean z2, boolean z3) {
        ...
        bVar2.c = aVar.b;
        if (z2 && this.h.size() > 1 && aVar.b >= 0 && aVar.b < this.h.size() - 1) {
            bfc bfc = (bfc) this.h.get(aVar.b);
            this.A.c = this.A.c + 1;
            this.A.d += bfc.h;
        }
    }
    ...
    private View b(View view, bfc bfc) {
        boolean j = j();
        int r = (r() - bfc.h) - 1;
    ...
    private void b(a aVar, boolean z2, boolean z3) {
        ...
        bVar2.f = Integer.MIN_VALUE;
        bVar2.c = aVar.b;
        if (z2 && aVar.b > 0 && this.h.size() > aVar.b) {
            bfc bfc = (bfc) this.h.get(aVar.b);
            this.A.c = this.A.c - 1;
            this.A.d -= bfc.h;
        }
    ...
    private boolean c(View view, int i, int i2, androidx.recyclerview.widget.RecyclerView.LayoutParams layoutParams) {
        return view.isLayoutRequested() || !this.p || !d(view.getWidth(), i, layoutParams.width) || !d(view.getHeight(), i2, layoutParams.height);
    }
    ...
    private View o(int i) {
        if (O || this.x.a != null) {
            ...
            return b(c2, (bfc) this.h.get(this.x.a[c(c2)]));
        }
        throw new AssertionError();
    }
    ...
    public final void a(View view, int i, int i2, bfc bfc) {
        b(view, a);
        if (j()) {
            int q = q(view) + r(view);
            bfc.e += q;
    ...
    public final int a_(int i, int i2, int i3) {
        return a(this.v, this.t, i2, i3, e());
    }
    ...
    public final int b(int i, int i2, int i3) {
        return a(this.w, this.u, i2, i3, f());
    }
    ...
    public final PointF d(int i) {
        ...
        int i2 = i < c(g(0)) ? -1 : 1;
        return j() ? new PointF(0.0f, (float) i2) : new PointF((float) i2, 0.0f);
    }
    ...
    public final boolean e() {
        return !j() || this.v > this.L.getWidth();
    }
    ...
    public final boolean f() {
        return j() || this.w > this.L.getHeight();
    }
    ...
    public final int k() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            i = Math.max(i, ((bfc) this.h.get(i2)).e);
        }
        return i;
    }
