...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    protected final d c;
    int d;
    final defpackage.fax.a e = new defpackage.fax.a() {
        public final void a() {
    ...
    public static class d extends FrameLayout {
        ...
        protected d(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.eyt.a.bZ);
            if (obtainStyledAttributes.hasValue(defpackage.eyt.a.cb)) {
                ip.e((View) this, (float) obtainStyledAttributes.getDimensionPixelSize(defpackage.eyt.a.cb, 0));
            }
    ...
    protected BaseTransientBottomBar(ViewGroup viewGroup, View view, faw faw) {
        if (viewGroup == null) {
    ...
    public final void b(final int i2) {
        ...
        valueAnimator.setInterpolator(eyu.b);
        ...
        valueAnimator.addUpdateListener(new AnimatorUpdateListener() {
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                if (BaseTransientBottomBar.f) {
                    ip.g((View) BaseTransientBottomBar.this.c, intValue - this.a);
                } else {
    ...
    public void c() {
        ...
        synchronized (a2.a) {
            ...
            if (a2.h(aVar)) {
                ...
                a2.d = new defpackage.fax.b(a3, aVar);
            }
    ...
    public final void f() {
        if (this.c.getParent() == null) {
            ...
            if (layoutParams instanceof androidx.coordinatorlayout.widget.CoordinatorLayout.d) {
                ...
                behavior.b = new com.google.android.material.behavior.SwipeDismissBehavior.a() {
                    public final void a(int i) {
                        if (i == 0) {
                            fax.a().d(BaseTransientBottomBar.this.e);
                        } else if (i == 1 || i == 2) {
                            fax.a().c(BaseTransientBottomBar.this.e);
                        }
                    }
        ...
        this.c.b = new b() {
            public final void a() {
                if (fax.a().f(BaseTransientBottomBar.this.e)) {
