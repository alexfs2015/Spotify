...
public class AppBarLayout extends LinearLayout {
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void a(final CoordinatorLayout coordinatorLayout, final T t, int i2, float f2) {
            ...
            this.d.setDuration((long) Math.min(round, 600));
        ...
        public boolean a(CoordinatorLayout coordinatorLayout, T t, int i2) {
            ...
            if (i4 >= 0 && (i3 & 8) == 0) {
                ...
                a_(coordinatorLayout, t, (-childAt.getBottom()) + (this.f ? ip.m(childAt) + t.f() : Math.round(((float) childAt.getHeight()) * this.g)));
            } else if (i3 != 0) {
                boolean z = (i3 & 4) != 0;
                if ((i3 & 2) != 0) {
                    int i5 = -t.b();
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.eyt.a.h);
            this.a = obtainStyledAttributes.getInt(defpackage.eyt.a.i, 0);
            if (obtainStyledAttributes.hasValue(defpackage.eyt.a.j)) {
                this.b = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(defpackage.eyt.a.j, 0));
            }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.eyt.a.bX);
            this.c = obtainStyledAttributes.getDimensionPixelSize(defpackage.eyt.a.bY, 0);
            obtainStyledAttributes.recycle();
        }
        ...
        public boolean b(CoordinatorLayout coordinatorLayout, View view, View view2) {
            ...
            if (behavior instanceof BaseBehavior) {
                ip.g(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) behavior).b) + this.b) - c(view2));
            }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ezf.a(this);
            ezf.a(this, attributeSet, 0, 2132017902);
        }
        TypedArray a2 = faj.a(context, attributeSet, defpackage.eyt.a.a, 0, 2132017902, new int[0]);
        ip.a((View) this, a2.getDrawable(defpackage.eyt.a.b));
        if (a2.hasValue(defpackage.eyt.a.f)) {
            a(a2.getBoolean(defpackage.eyt.a.f, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && a2.hasValue(defpackage.eyt.a.e)) {
            ezf.a(this, (float) a2.getDimensionPixelSize(defpackage.eyt.a.e, 0));
        }
        if (VERSION.SDK_INT >= 26) {
            if (a2.hasValue(defpackage.eyt.a.d)) {
                setKeyboardNavigationCluster(a2.getBoolean(defpackage.eyt.a.d, false));
            }
            if (a2.hasValue(defpackage.eyt.a.c)) {
                setTouchscreenBlocksFocus(a2.getBoolean(defpackage.eyt.a.c, false));
            }
        }
        this.d = a2.getBoolean(defpackage.eyt.a.g, false);
        a2.recycle();
        ...
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if ((i4 & 5) != 5) {
                ...
                if ((i4 & 8) != 0) {
                    ...
                    i3 = i5 + (measuredHeight - ((i4 & 2) != 0 ? ip.m(childAt) : f()));
                }
            }
        }
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        iArr[0] = this.i ? R.attr.state_liftable : -2130969425;
        iArr[1] = (!this.i || !this.j) ? -2130969426 : R.attr.state_lifted;
        iArr[2] = this.i ? R.attr.state_collapsible : -2130969424;
        iArr[3] = (!this.i || !this.j) ? -2130969423 : R.attr.state_collapsed;
