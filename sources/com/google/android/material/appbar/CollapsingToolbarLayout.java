...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.eyc.a.aO);
            this.a = obtainStyledAttributes.getInt(defpackage.eyc.a.aP, 0);
            this.b = obtainStyledAttributes.getFloat(defpackage.eyc.a.aQ, 0.5f);
    ...
    class a implements b {
        ...
        public final void onOffsetChanged(AppBarLayout appBarLayout, int i) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                eyn a2 = CollapsingToolbarLayout.a(childAt);
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.a = new ezj(this);
        this.a.a(eyd.e);
        TypedArray a2 = ezs.a(context, attributeSet, defpackage.eyc.a.ax, i2, 2132017902, new int[0]);
        this.a.a(a2.getInt(defpackage.eyc.a.aB, 8388691));
        this.a.b(a2.getInt(defpackage.eyc.a.ay, 8388627));
        int dimensionPixelSize = a2.getDimensionPixelSize(defpackage.eyc.a.aC, 0);
        this.m = dimensionPixelSize;
        this.l = dimensionPixelSize;
        this.k = dimensionPixelSize;
        this.j = dimensionPixelSize;
        if (a2.hasValue(defpackage.eyc.a.aF)) {
            this.j = a2.getDimensionPixelSize(defpackage.eyc.a.aF, 0);
        }
        if (a2.hasValue(defpackage.eyc.a.aE)) {
            this.l = a2.getDimensionPixelSize(defpackage.eyc.a.aE, 0);
        }
        if (a2.hasValue(defpackage.eyc.a.aG)) {
            this.k = a2.getDimensionPixelSize(defpackage.eyc.a.aG, 0);
        }
        if (a2.hasValue(defpackage.eyc.a.aD)) {
            this.m = a2.getDimensionPixelSize(defpackage.eyc.a.aD, 0);
        }
        this.o = a2.getBoolean(defpackage.eyc.a.aM, true);
        a(a2.getText(defpackage.eyc.a.aL));
        this.a.d(2132017595);
        this.a.c((int) R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        if (a2.hasValue(defpackage.eyc.a.aH)) {
            this.a.d(a2.getResourceId(defpackage.eyc.a.aH, 0));
        }
        if (a2.hasValue(defpackage.eyc.a.az)) {
            this.a.c(a2.getResourceId(defpackage.eyc.a.az, 0));
        }
        this.v = a2.getDimensionPixelSize(defpackage.eyc.a.aJ, -1);
        this.u = (long) a2.getInt(defpackage.eyc.a.aI, 600);
        Drawable drawable = a2.getDrawable(defpackage.eyc.a.aA);
        ...
        Drawable drawable5 = a2.getDrawable(defpackage.eyc.a.aK);
        ...
        this.f = a2.getResourceId(defpackage.eyc.a.aN, -1);
        a2.recycle();
        ...
        if (this.o) {
            ...
            if (view != null) {
                ...
                if (this.p) {
                    ...
                    int b3 = b(view2);
                    ezk.a((ViewGroup) this, this.i, this.n);
                    ezj ezj = this.a;
                    int i9 = this.n.left;
                    if (z2) {
                        i6 = this.g.j;
                    ...
                    int i10 = i9 + i6;
                    int i11 = this.n.top + b3 + this.g.k;
                    ...
                    ezj.b(i10, i11, i12 + i7, (this.n.bottom + b3) - this.g.l);
    ...
    static eyn a(View view) {
        eyn eyn = (eyn) view.getTag(com.spotify.music.R.id.view_offset_helper);
        if (eyn != null) {
            return eyn;
        }
        eyn eyn2 = new eyn(view);
        view.setTag(com.spotify.music.R.id.view_offset_helper, eyn2);
        return eyn2;
    }
        ...
        if (this.s != z) {
            ...
            if (z2) {
                ...
                if (valueAnimator == null) {
                    ...
                    this.t.setInterpolator(i3 > this.r ? eyd.c : eyd.d);
    ...
    private int e() {
        ...
        int m2 = ip.m(this);
        if (m2 > 0) {
            return Math.min((m2 << 1) + b2, getHeight());
        }
        return getHeight() / 3;
    }
