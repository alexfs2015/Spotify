...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.eyt.a.C);
        TypedValue peekValue = obtainStyledAttributes.peekValue(defpackage.eyt.a.F);
        if (peekValue == null || peekValue.data != -1) {
            e(obtainStyledAttributes.getDimensionPixelSize(defpackage.eyt.a.F, -1));
        } else {
            e(peekValue.data);
        }
        this.d = obtainStyledAttributes.getBoolean(defpackage.eyt.a.E, false);
        boolean z2 = obtainStyledAttributes.getBoolean(defpackage.eyt.a.D, true);
        if (this.m != z2) {
            this.m = z2;
            if (this.h != null) {
                a();
        ...
        this.s = obtainStyledAttributes.getBoolean(defpackage.eyt.a.G, false);
    ...
    public final boolean a(View view, float f2) {
        ...
        return view.getTop() >= this.c && Math.abs((((float) view.getTop()) + (f2 * 0.1f)) - ((float) this.c)) / ((float) this.o) > 0.5f;
    }
