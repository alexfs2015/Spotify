...
public class BottomAppBar extends Toolbar implements androidx.coordinatorlayout.widget.CoordinatorLayout.a {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public final /* synthetic */ void a(View view) {
            ...
            if (d != null) {
                d.clearAnimation();
                d.animate().translationY(bottomAppBar.o()).setInterpolator(eyu.d).setDuration(225);
            }
        }
        ...
        public final /* synthetic */ void b(View view) {
            ...
            if (d != null) {
                ...
                d.clearAnimation();
                d.animate().translationY(((float) (-d.getPaddingBottom())) + measuredHeight).setInterpolator(eyu.c).setDuration(175);
            }
        }
    }
    ...
    public BottomAppBar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray a2 = faj.a(context, attributeSet, defpackage.eyt.a.k, i, 2132017984, new int[0]);
        ColorStateList a3 = fam.a(context, a2, defpackage.eyt.a.l);
        float dimensionPixelOffset = (float) a2.getDimensionPixelOffset(defpackage.eyt.a.n, 0);
        float dimensionPixelOffset2 = (float) a2.getDimensionPixelOffset(defpackage.eyt.a.o, 0);
        float dimensionPixelOffset3 = (float) a2.getDimensionPixelOffset(defpackage.eyt.a.p, 0);
        this.B = a2.getInt(defpackage.eyt.a.m, 0);
        this.x = a2.getBoolean(defpackage.eyt.a.q, false);
        a2.recycle();
        this.y = getResources().getDimensionPixelOffset(R.dimen.mtrl_bottomappbar_fabOffsetEndMode);
        this.w = new ezg(dimensionPixelOffset, dimensionPixelOffset2, dimensionPixelOffset3);
        fav fav = new fav();
        fav.e = this.w;
        this.v = new fat(fav);
        fat fat = this.v;
