...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    public final android.animation.AnimatorSet b(android.view.View r27, android.view.View r28, boolean r29, boolean r30) {
        ...
        L_0x010f:
            ...
            float r24 = r2.width()
            float r25 = r2.height()
            boolean r13 = r9 instanceof defpackage.eza
        ...
        L_0x012c:
            ...
            r3.setAlpha(r4)
        L_0x0144:
            android.util.Property<android.graphics.drawable.Drawable, java.lang.Integer> r4 = defpackage.eyh.a
            int[] r5 = new int[r15]
            r5[r7] = r7
            android.animation.ObjectAnimator r4 = android.animation.ObjectAnimator.ofInt(r3, r4, r5)
            goto L_0x0159
        L_0x014f:
            android.util.Property<android.graphics.drawable.Drawable, java.lang.Integer> r5 = defpackage.eyh.a
            int[] r6 = new int[r15]
            r6[r7] = r4
        ...
        L_0x01ec:
            ...
            r20 = r2
            r21 = r3
            float r4 = defpackage.ezu.a(r20, r21, r22, r23, r24, r25)
            android.animation.Animator r5 = defpackage.eyy.a(r8, r2, r3, r4)
        ...
        L_0x022a:
            ...
            eza$d r4 = r17.c()
            float r7 = r4.c
            android.animation.Animator r17 = defpackage.eyy.a(r8, r2, r3, r5)
            r6 = r5
            long r4 = r15.a
            int r2 = (int) r2
            int r3 = (int) r3
        ...
        L_0x02a6:
            ...
            r0.c_(r7)
        L_0x02b1:
            android.util.Property<eza, java.lang.Integer> r2 = defpackage.eza.c.a
            r3 = 1
            int[] r4 = new int[r3]
            r5 = 0
            r4[r5] = r1
        ...
        L_0x02be:
            r3 = 1
            r5 = 0
            android.util.Property<eza, java.lang.Integer> r1 = defpackage.eza.c.a
            int[] r2 = new int[r3]
            r2[r5] = r7
            android.animation.ObjectAnimator r0 = android.animation.ObjectAnimator.ofInt(r0, r1, r2)
        L_0x02ca:
            eyf r1 = defpackage.eyf.a()
            r0.setEvaluator(r1)
            r1 = r22
            eyk r2 = r1.a
        ...
        L_0x0316:
            ...
            android.util.Property<android.view.ViewGroup, java.lang.Float> r2 = defpackage.eyg.a
    ...
    private float a(View view, View view2, eym eym) {
        float f;
        float f2;
        float f3;
        RectF rectF = this.b;
    ...
    private float b(View view, View view2, eym eym) {
        float f;
        float f2;
        float f3;
        RectF rectF = this.b;
        ...
        a(view, rectF);
        a(view2, rectF2);
        int i = eym.a & ContentType.LONG_FORM_ON_DEMAND;
        if (i == 16) {
            f3 = rectF2.centerY();
            f2 = rectF.centerY();
        } else if (i == 48) {
    ...
    private static float a(a aVar, eyl eyl, float f, float f2) {
        long j = eyl.a;
        long j2 = eyl.b;
        eyl a2 = aVar.a.a("expansion");
        return eyd.a(f, f2, eyl.a().getInterpolation(((float) (((a2.a + a2.b) + 17) - j)) / ((float) j2)));
    }
}
