...
public class ChipGroup extends FlowLayout {
    ...
    public ChipGroup(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.i = -1;
        this.j = false;
        TypedArray a2 = faj.a(context, attributeSet, defpackage.eyt.a.aq, i2, 2132018004, new int[0]);
        int dimensionPixelOffset = a2.getDimensionPixelOffset(defpackage.eyt.a.as, 0);
        int dimensionPixelOffset2 = a2.getDimensionPixelOffset(defpackage.eyt.a.at, dimensionPixelOffset);
        if (this.d != dimensionPixelOffset2) {
            this.d = dimensionPixelOffset2;
            this.b = dimensionPixelOffset2;
            requestLayout();
        }
        int dimensionPixelOffset3 = a2.getDimensionPixelOffset(defpackage.eyt.a.au, dimensionPixelOffset);
        if (this.e != dimensionPixelOffset3) {
            this.e = dimensionPixelOffset3;
            this.a = dimensionPixelOffset3;
            requestLayout();
        }
        this.c = a2.getBoolean(defpackage.eyt.a.av, false);
        boolean z = a2.getBoolean(defpackage.eyt.a.aw, false);
        if (this.f != z) {
            this.f = z;
            this.j = true;
        ...
        int resourceId = a2.getResourceId(defpackage.eyt.a.ar, -1);
        if (resourceId != -1) {
            this.i = resourceId;
        }
        a2.recycle();
