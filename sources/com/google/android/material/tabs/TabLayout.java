...
public class TabLayout extends HorizontalScrollView {
    ...
    class a implements androidx.viewpager.widget.ViewPager.d {
        ...
        public final void a(ViewPager viewPager, sf sfVar, sf sfVar2) {
            if (TabLayout.this.v == viewPager) {
                TabLayout.this.a(sfVar2, this.a);
            }
        }
    }
    ...
    class d extends LinearLayout {
        ...
        public final void b(final int i2, int i3) {
            ...
            if (!(i6 == i4 && i7 == i5)) {
                ...
                valueAnimator2.setInterpolator(eyu.b);
                ...
                AnonymousClass1 r3 = new AnimatorUpdateListener() {
                    public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                        ...
                        d.this.a(eyu.a(i6, i4, animatedFraction), eyu.a(i7, i5, animatedFraction));
                    }
                };
    ...
    class g extends LinearLayout {
        ...
        public g(android.content.Context r10) {
            ...
            L_0x002f:
                ...
                android.content.res.ColorStateList r5 = defpackage.fao.a(r5)
    ...
    public static class h implements faz {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray a2 = faj.a(context, attributeSet, defpackage.eyt.a.ch, i2, 2132017910, defpackage.eyt.a.cE);
        d dVar = this.z;
        int dimensionPixelSize = a2.getDimensionPixelSize(defpackage.eyt.a.cs, -1);
        if (dVar.a != dimensionPixelSize) {
            dVar.a = dimensionPixelSize;
            ip.d(dVar);
        }
        d dVar2 = this.z;
        int color = a2.getColor(defpackage.eyt.a.cp, 0);
        if (dVar2.b.getColor() != color) {
            dVar2.b.setColor(color);
            ip.d(dVar2);
        }
        Drawable b2 = fam.b(context, a2, defpackage.eyt.a.cn);
        if (this.j != b2) {
            this.j = b2;
            ip.d(this.z);
        }
        int i3 = a2.getInt(defpackage.eyt.a.cr, 0);
        if (this.q != i3) {
            this.q = i3;
            ip.d(this.z);
        }
        this.t = a2.getBoolean(defpackage.eyt.a.cq, true);
        ip.d(this.z);
        int dimensionPixelSize2 = a2.getDimensionPixelSize(defpackage.eyt.a.cx, 0);
        this.e = dimensionPixelSize2;
        this.d = dimensionPixelSize2;
        this.c = dimensionPixelSize2;
        this.b = dimensionPixelSize2;
        this.b = a2.getDimensionPixelSize(defpackage.eyt.a.cA, this.b);
        this.c = a2.getDimensionPixelSize(defpackage.eyt.a.cB, this.c);
        this.d = a2.getDimensionPixelSize(defpackage.eyt.a.cz, this.d);
        this.e = a2.getDimensionPixelSize(defpackage.eyt.a.cy, this.e);
        this.f = a2.getResourceId(defpackage.eyt.a.cE, 2132017604);
        ...
        try {
            ...
            this.g = fam.a(context, obtainStyledAttributes, defpackage.o.a.cQ);
            obtainStyledAttributes.recycle();
            if (a2.hasValue(defpackage.eyt.a.cF)) {
                this.g = fam.a(context, a2, defpackage.eyt.a.cF);
            }
            if (a2.hasValue(defpackage.eyt.a.cD)) {
                this.g = new ColorStateList(new int[][]{SELECTED_STATE_SET, EMPTY_STATE_SET}, new int[]{a2.getColor(defpackage.eyt.a.cD, 0), this.g.getDefaultColor()});
            }
            this.h = fam.a(context, a2, defpackage.eyt.a.cl);
            this.k = fak.a(a2.getInt(defpackage.eyt.a.cm, -1), null);
            this.i = fam.a(context, a2, defpackage.eyt.a.cC);
            this.E = a2.getInt(defpackage.eyt.a.co, 300);
            this.A = a2.getDimensionPixelSize(defpackage.eyt.a.cv, -1);
            this.B = a2.getDimensionPixelSize(defpackage.eyt.a.cu, -1);
            this.n = a2.getResourceId(defpackage.eyt.a.ci, 0);
            this.D = a2.getDimensionPixelSize(defpackage.eyt.a.cj, 0);
            this.r = a2.getInt(defpackage.eyt.a.cw, 1);
            this.p = a2.getInt(defpackage.eyt.a.ck, 0);
            this.s = a2.getBoolean(defpackage.eyt.a.ct, false);
            this.u = a2.getBoolean(defpackage.eyt.a.cG, false);
            a2.recycle();
    ...
    /* access modifiers changed from: 0000 */
    public final void a(sf sfVar, boolean z2) {
        sf sfVar2 = this.I;
        if (sfVar2 != null) {
            DataSetObserver dataSetObserver = this.J;
            if (dataSetObserver != null) {
                sfVar2.b(dataSetObserver);
            }
        }
        this.I = sfVar;
        if (z2 && sfVar != null) {
