...
public abstract class MediaCodecRenderer extends apu {
    private static final byte[] k = bdw.h("0000016742C00BDA259000000168CE0F13200000016588840DCE7118A0002FBF1C31C3275D78");
    private float A;
    private float B;
    private boolean C;
    private ArrayDeque<avx> D;
    ...
    protected aru j;
    private final avy l;
    private final asd<ash> m;
    private final boolean n;
    private final float o;
    private final arv p;
    private final arv q;
    private final aqf r;
    private final bds<aqe> s;
    private final List<Long> t;
    private final BufferInfo u;
    private aqe v;
    private aqe w;
    private aqe x;
    private DrmSession<ash> y;
    private DrmSession<ash> z;
    ...
    public static class DecoderInitializationException extends Exception {
        ...
        public DecoderInitializationException(aqe aqe, Throwable th, boolean z, int i) {
        ...
        public DecoderInitializationException(aqe aqe, Throwable th, boolean z, String str) {
            StringBuilder sb = new StringBuilder("Decoder init failed: ");
            sb.append(str);
            sb.append(", ");
            sb.append(aqe);
            this(sb.toString(), th, aqe.f, z, str, (bdw.a < 21 || !(th instanceof CodecException)) ? null : ((CodecException) th).getDiagnosticInfo(), null);
        }
    ...
    public float a(float f, aqe[] aqeArr) {
        return -1.0f;
    }

    /* access modifiers changed from: protected */
    public int a(avx avx, aqe aqe, aqe aqe2) {
        return 0;
    }

    /* access modifiers changed from: protected */
    public abstract int a(avy avy, asd<ash> asd, aqe aqe);
    ...
    /* access modifiers changed from: protected */
    public void a(arv arv) {
    }

    /* access modifiers changed from: protected */
    public abstract void a(avx avx, MediaCodec mediaCodec, aqe aqe, MediaCrypto mediaCrypto, float f);
    ...
    /* access modifiers changed from: protected */
    public abstract boolean a(long j2, long j3, MediaCodec mediaCodec, ByteBuffer byteBuffer, int i2, int i3, long j4, boolean z2, aqe aqe);
    ...
    public MediaCodecRenderer(int i2, avy avy, asd<ash> asd, boolean z2, float f) {
        super(i2);
        bcu.b(bdw.a >= 16);
        this.l = (avy) bcu.a(avy);
        this.m = asd;
        this.n = z2;
        this.o = f;
        this.p = new arv(0);
    ...
    /* access modifiers changed from: protected */
    public List<avx> a(avy avy, aqe aqe, boolean z2) {
        return avy.a(aqe.f, z2);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0055, code lost:
        if ("AFTB".equals(defpackage.bdw.d) != false) goto L_0x0057;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:64:0x00f6, code lost:
        if ("tilapia".equals(defpackage.bdw.b) != false) goto L_0x00f8;
     */
    ...
    public final void t() {
        /*
            ...
            goto L_0x0231
        L_0x000a:
            com.google.android.exoplayer2.drm.DrmSession<ash> r1 = r11.z
            r11.y = r1
            java.lang.String r0 = r0.f
            r1 = 0
            com.google.android.exoplayer2.drm.DrmSession<ash> r2 = r11.y
            ...
            com.google.android.exoplayer2.drm.DrmSession<ash> r0 = r11.y
        ...
        L_0x002c:
            ...
            r0 = 1
        L_0x003b:
            java.lang.String r2 = defpackage.bdw.c
            boolean r2 = r3.equals(r2)
            if (r2 == 0) goto L_0x0059
            java.lang.String r2 = defpackage.bdw.d
        ...
        L_0x007d:
            ...
            java.lang.String r1 = defpackage.bdw.d
        ...
        L_0x00d0:
            java.lang.String r1 = defpackage.bdw.b
        ...
        L_0x01e2:
            java.lang.String r1 = defpackage.bdw.c
    ...
    /* access modifiers changed from: protected */
    public final aqe d(long j2) {
        aqe aqe = (aqe) this.s.a(j2);
        if (aqe != null) {
            this.x = aqe;
        }
        return aqe;
        ...
        if (this.h != null) {
            ...
            try {
                ...
                try {
                    this.h.release();
                    this.h = null;
                    DrmSession<ash> drmSession = this.y;
                    ...
                    this.h = null;
                    DrmSession<ash> drmSession2 = this.y;
                ...
                this.h = null;
                DrmSession<ash> drmSession3 = this.y;
    ...
    private boolean a(android.media.MediaCrypto r20, boolean r21) {
        /*
            ...
            r7 = r19
            r8 = r21
            java.util.ArrayDeque<avx> r0 = r7.D
            ...
            avy r1 = r7.l     // Catch:{ DecoderQueryException -> 0x0056 }
            aqe r2 = r7.v     // Catch:{ DecoderQueryException -> 0x0056 }
            ...
            aqe r3 = r7.v     // Catch:{ DecoderQueryException -> 0x0056 }
            ...
            defpackage.bdd.c(r9, r2)     // Catch:{ DecoderQueryException -> 0x0056 }
        L_0x004e:
        ...
        L_0x008b:
            ...
            defpackage.bdu.a(r1)     // Catch:{ Exception -> 0x0102 }
            android.media.MediaCodec r6 = android.media.MediaCodec.createByCodecName(r0)     // Catch:{ Exception -> 0x0102 }
            defpackage.bdu.a()     // Catch:{ Exception -> 0x00ff }
            java.lang.String r1 = "configureCodec"
            defpackage.bdu.a(r1)     // Catch:{ Exception -> 0x00ff }
            aqe r4 = r7.v     // Catch:{ Exception -> 0x00ff }
        ...
        L_0x010d:
            ...
            defpackage.bdd.a(r9, r1, r0)
            java.util.ArrayDeque<avx> r1 = r7.D
            r1.removeFirst()
            com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException r1 = new com.google.android.exoplayer2.mediacodec.MediaCodecRenderer$DecoderInitializationException
            aqe r2 = r7.v
    ...
    private boolean B() {
        ...
        L_0x0127:
            ...
            arv r0 = r13.p
            boolean r0 = r0.e()
            com.google.android.exoplayer2.drm.DrmSession<ash> r3 = r13.y
        ...
        L_0x013a:
            ...
            goto L_0x0155
        L_0x0147:
            com.google.android.exoplayer2.drm.DrmSession<ash> r0 = r13.y
            com.google.android.exoplayer2.drm.DrmSession$DrmSessionException r0 = r0.f()
            int r1 = r13.b
            com.google.android.exoplayer2.ExoPlaybackException r0 = com.google.android.exoplayer2.ExoPlaybackException.a(r0, r1)
            throw r0
        ...
        L_0x0174:
            r13.H = r1
        L_0x0176:
            arv r3 = r13.p     // Catch:{ CryptoException -> 0x01e7 }
        ...
        L_0x018b:
            aqe r3 = r13.w     // Catch:{ CryptoException -> 0x01e7 }
            if (r3 == 0) goto L_0x0199
            bds<aqe> r3 = r13.s     // Catch:{ CryptoException -> 0x01e7 }
            aqe r5 = r13.w     // Catch:{ CryptoException -> 0x01e7 }
        ...
        L_0x0199:
            ...
            arv r0 = r13.p     // Catch:{ CryptoException -> 0x01e7 }
            ars r0 = r0.b     // Catch:{ CryptoException -> 0x01e7 }
        ...
        L_0x01d8:
            ...
            aru r0 = r13.j     // Catch:{ CryptoException -> 0x01e7 }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void b(defpackage.aqe r5) {
        /*
            r4 = this;
            aqe r0 = r4.v
            r4.v = r5
        ...
        L_0x000f:
            asc r2 = r0.i
        L_0x0011:
            boolean r5 = defpackage.bdw.a(r5, r2)
            r2 = 1
            r5 = r5 ^ r2
            ...
            r4.z = r5
            com.google.android.exoplayer2.drm.DrmSession<ash> r5 = r4.z
            com.google.android.exoplayer2.drm.DrmSession<ash> r1 = r4.y
        ...
        L_0x0097:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.mediacodec.MediaCodecRenderer.b(aqe):void");
    }
    ...
    private boolean b(long j2, long j3) {
        ...
        if (!y()) {
            ...
            if (i2 < 0) {
                ...
                this.T = i2;
                if (bdw.a >= 21) {
                    byteBuffer = this.h.getOutputBuffer(i2);
                } else {
                    byteBuffer = this.Q[i2];
                }
                this.U = byteBuffer;
