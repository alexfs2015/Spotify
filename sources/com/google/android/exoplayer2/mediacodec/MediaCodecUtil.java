...
public final class MediaCodecUtil {
    ...
    private static final HashMap<a, List<awo>> c = new HashMap<>();
    ...
    static final class e implements Comparator<awo> {
        private e() {
        }
        ...
        private static int a(awo awo) {
            String str = awo.a;
            if (str.startsWith("OMX.google") || str.startsWith("c2.android")) {
                return -1;
            }
            return (ben.a >= 26 || !str.equals("OMX.MTK.AUDIO.DECODER.RAW")) ? 0 : 1;
        }

        public final /* synthetic */ int compare(Object obj, Object obj2) {
            return a((awo) obj) - a((awo) obj2);
        }
    }
    ...
    private static Pair<Integer, Integer> a(String str, String[] strArr) {
        ...
        try {
            ...
            sb4.append(num);
            bdu.c(str3, sb4.toString());
            return null;
        } catch (NumberFormatException unused) {
            StringBuilder sb5 = new StringBuilder(str2);
            sb5.append(str);
            bdu.c(str3, sb5.toString());
            return null;
        }
    }

    public static awo a() {
        awo b2 = b("audio/raw", false);
        if (b2 == null) {
            return null;
        }
        awo awo = new awo(b2.a, null, null, true, false, false);
        return awo;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.ArrayList<defpackage.awo> a(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.a r18, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.b r19, java.lang.String r20) {
        /*
            r1 = r18
            r2 = r19
        ...
        L_0x0014:
            ...
            goto L_0x0065
        L_0x002f:
            int r0 = defpackage.ben.a     // Catch:{ Exception -> 0x0347 }
            r13 = 21
        ...
        L_0x0078:
            ...
            java.lang.String r14 = defpackage.ben.d     // Catch:{ Exception -> 0x0347 }
        ...
        L_0x008b:
            ...
            java.lang.String r13 = defpackage.ben.b     // Catch:{ Exception -> 0x0347 }
            boolean r0 = r0.equals(r13)     // Catch:{ Exception -> 0x0347 }
            if (r0 != 0) goto L_0x0065
            java.lang.String r0 = "Xiaomi"
            java.lang.String r13 = defpackage.ben.c     // Catch:{ Exception -> 0x0347 }
            boolean r0 = r0.equals(r13)     // Catch:{ Exception -> 0x0347 }
            if (r0 == 0) goto L_0x00b6
            java.lang.String r0 = defpackage.ben.b     // Catch:{ Exception -> 0x0347 }
        ...
        L_0x00b6:
            ...
            java.lang.String r14 = defpackage.ben.b     // Catch:{ Exception -> 0x0347 }
            boolean r0 = r0.equals(r14)     // Catch:{ Exception -> 0x0347 }
            if (r0 != 0) goto L_0x0065
        ...
        L_0x018c:
            java.lang.String r0 = defpackage.ben.c     // Catch:{ Exception -> 0x0347 }
        ...
        L_0x0264:
            ...
            int r2 = defpackage.ben.a     // Catch:{ Exception -> 0x02e2 }
            r17 = r9
            r9 = 22
            if (r2 > r9) goto L_0x02a8
            java.lang.String r2 = "ODROID-XU3"
            java.lang.String r9 = defpackage.ben.d     // Catch:{ Exception -> 0x02a6 }
        ...
        L_0x02b2:
            ...
            goto L_0x02b0
        L_0x02b9:
            awo r0 = defpackage.awo.a(r10, r5, r0, r2, r6)     // Catch:{ Exception -> 0x02a6 }
        ...
        L_0x02c2:
            ...
            r9 = 1
            awo r0 = defpackage.awo.a(r6, r5, r0, r2, r9)     // Catch:{ Exception -> 0x02de }
        ...
        L_0x02e9:
            r9 = 1
        L_0x02ea:
            int r2 = defpackage.ben.a     // Catch:{ Exception -> 0x0347 }
            r6 = 23
            ...
            defpackage.bdu.d(r9, r0)     // Catch:{ Exception -> 0x0347 }
            goto L_0x0332
        L_0x030f:
            ...
            defpackage.bdu.d(r9, r1)     // Catch:{ Exception -> 0x0347 }
    ...
    public static synchronized List<awo> a(String str, boolean z) {
        synchronized (MediaCodecUtil.class) {
            a aVar = new a(str, z);
            List<awo> list = (List) c.get(aVar);
            if (list != null) {
                return list;
            }
            b dVar = ben.a >= 21 ? new d(z) : new c(0);
            ArrayList a2 = a(aVar, dVar, str);
            if (z && a2.isEmpty() && 21 <= ben.a && ben.a <= 23) {
                dVar = new c(0);
                a2 = a(aVar, dVar, str);
                if (!a2.isEmpty()) {
                    ...
                    sb.append(str);
                    sb.append(". Assuming: ");
                    sb.append(((awo) a2.get(0)).a);
                    bdu.c("MediaCodecUtil", sb.toString());
                }
            }
            ...
            List<awo> unmodifiableList = Collections.unmodifiableList(a2);
    ...
    public static int b() {
        ...
        if (h == -1) {
            ...
            if (b2 != null) {
                ...
                i2 = Math.max(i3, ben.a >= 21 ? 345600 : 172800);
            }
            h = i2;
        }
        return h;
    ...
    private static Pair<Integer, Integer> b(String str, String[] strArr) {
        ...
        try {
            if ("audio/mp4a-latm".equals(bdx.a(Integer.parseInt(strArr[1], 16)))) {
    ...
    private static awo b(String str, boolean z) {
        List a2 = a(str, false);
        if (a2.isEmpty()) {
            return null;
        }
