...
public final class Loader implements bbz {
    ...
    final class c<T extends d> extends Handler implements Runnable {
        ...
        public final void run() {
            ...
            try {
                ...
                bdd.b(str, "Unexpected exception loading stream", e3);
                if (!this.i) {
                    obtainMessage(3, new UnexpectedLoaderException(e3)).sendToTarget();
                }
            } catch (OutOfMemoryError e4) {
                bdd.b(str, "OutOfMemory error loading stream", e4);
                if (!this.i) {
                    obtainMessage(3, new UnexpectedLoaderException(e4)).sendToTarget();
                }
            } catch (Error e5) {
                bdd.b(str, "Unexpected error loading stream", e5);
                if (!this.i) {
                ...
                if (message.what == 0) {
                    ...
                    if (i2 == 1) {
                        ...
                        if (i2 == 3) {
                            ...
                            if (a2.a == 3) {
                                ...
                                if (a2.b != -9223372036854775807L) {
                                    ...
                                    j2 = (long) Math.min((this.f - 1) * 1000, CrashReportManager.TIME_WINDOW);
                                }
                                a(j2);
                            }
                        }
                        ...
                        try {
                            ...
                            bdd.b("LoadTask", "Unexpected exception handling load completed", e2);
