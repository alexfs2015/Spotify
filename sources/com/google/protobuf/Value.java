...
public final class Value extends GeneratedMessageLite<Value, a> implements flt {
    /* access modifiers changed from: private */
    public static final Value f;
    private static volatile fll<Value> g;
    public int d = 0;
    private Object e;
    ...
    public static final class a extends com.google.protobuf.GeneratedMessageLite.a<Value, a> implements flt {
        private a() {
            super(Value.f);
        }
    ...
    public static fll<Value> parser() {
        return f.c();
    }
                    ...
                    try {
                        ...
                        if (a2 != 0) {
                            if (a2 == 8) {
                                ...
                                this.d = 2;
                                this.e = Double.valueOf(Double.longBitsToDouble(fkw.j()));
                            } else if (a2 == 26) {
                                String d2 = fkw.d();
                                this.d = 3;
                                this.e = d2;
                                ...
                                this.e = fkw.a(ListValue.parser(), fky);
                                if (aVar2 != null) {
    ...
    public final void a(CodedOutputStream codedOutputStream) {
        ...
        if (this.d == 5) {
            codedOutputStream.a(5, (fli) (Struct) this.e);
        }
        if (this.d == 6) {
            codedOutputStream.a(6, (fli) (ListValue) this.e);
        }
    }
    ...
    public final int j() {
        ...
        if (this.d == 5) {
            i2 += CodedOutputStream.b(5, (fli) (Struct) this.e);
        }
        if (this.d == 6) {
            i2 += CodedOutputStream.b(6, (fli) (ListValue) this.e);
        }
        this.c = i2;
        return i2;
    }
