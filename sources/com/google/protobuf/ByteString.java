...
public abstract class ByteString implements Serializable, Iterable<Byte> {
    public static final ByteString a = new LiteralByteString(flc.b);
    ...
    public static class LiteralByteString extends LeafByteString {
        ...
        public final int a(int i, int i2, int i3) {
            return flc.a(i, this.bytes, e(), i3);
        }

        public final ByteString a(int i, int i2) {
            int b = b(i, i2, b());
            return b == 0 ? ByteString.a : new BoundedByteString(this.bytes, e() + i, b);
        }

        /* access modifiers changed from: 0000 */
        public final void a(fkv fkv) {
            fkv.a(this.bytes, e(), b());
        }
    ...
    public static ByteString a(String str) {
        return new LiteralByteString(str.getBytes(flc.a));
    }
    ...
    /* access modifiers changed from: 0000 */
    public abstract void a(fkv fkv);
