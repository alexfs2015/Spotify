...
public final class Utf8 {
    private static final a a = (fls.a() && fls.b() ? new c() : new b());
    ...
    static final class c extends a {
        ...
        private static int a(byte[] bArr, int i, long j, int i2) {
            ...
            if (i2 == 1) {
                return Utf8.b(i, fls.a(bArr, j));
            }
            if (i2 == 2) {
                return Utf8.b(i, (int) fls.a(bArr, j), (int) fls.a(bArr, j + 1));
            }
        ...
        private static int a(byte[] r17, long r18, int r20) {
            ...
            L_0x0014:
                ...
                long r11 = r9 + r5
                byte r9 = defpackage.fls.a(r0, r9)
            ...
            L_0x0026:
                ...
                long r11 = defpackage.fls.b(r0, r9)
            ...
            L_0x0046:
                ...
                long r7 = r1 + r5
                byte r1 = defpackage.fls.a(r0, r1)
            ...
            L_0x0068:
                ...
                long r1 = r7 + r5
                byte r7 = defpackage.fls.a(r0, r7)
            ...
            L_0x0099:
                long r1 = r11 + r5
                byte r7 = defpackage.fls.a(r0, r11)
                if (r7 <= r9) goto L_0x0045
            L_0x00a1:
                return r10
            L_0x00a2:
            ...
            L_0x00aa:
                int r3 = r3 + -3
                long r11 = r7 + r5
                byte r2 = defpackage.fls.a(r0, r7)
        ...
        public final int a(int i, byte[] bArr, int i2, int i3) {
            if ((i2 | i3 | (bArr.length - i3)) >= 0) {
                long c = fls.c() + ((long) i2);
                return a(bArr, c, (int) ((fls.c() + ((long) i3)) - c));
            }
        ...
        public final int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
            ...
            if (i5 == length) {
                ...
                while (i5 < length) {
                    ...
                    if (charAt2 < c && c3 < j4) {
                        long j6 = c3 + j;
                        fls.a(bArr2, c3, (byte) charAt2);
                        j3 = j;
                        j2 = j6;
                    } else if (charAt2 < 2048 && c3 <= j4 - 2) {
                        long j7 = c3 + j;
                        fls.a(bArr2, c3, (byte) ((charAt2 >>> 6) | 960));
                        long j8 = j7 + j;
                        fls.a(bArr2, j7, (byte) ((charAt2 & '?') | 128));
                        j2 = j8;
                        j3 = j;
                        i5++;
                        c = 128;
                        ...
                        long j10 = c3 + j;
                        fls.a(bArr2, c3, (byte) ((charAt2 >>> 12) | 480));
                        long j11 = j10 + j;
                        fls.a(bArr2, j10, (byte) (((charAt2 >>> 6) & 63) | 128));
                        long j12 = j11 + 1;
                        fls.a(bArr2, j11, (byte) ((charAt2 & '?') | 128));
                        j2 = j12;
                        j3 = 1;
                    } else if (c3 <= j4 - 4) {
                        int i6 = i5 + 1;
                        if (i6 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                int codePoint = Character.toCodePoint(charAt2, charAt3);
                                long j13 = c3 + 1;
                                fls.a(bArr2, c3, (byte) ((codePoint >>> 18) | 240));
                                long j14 = j13 + 1;
                                fls.a(bArr2, j13, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j15 = j14 + 1;
                                fls.a(bArr2, j14, (byte) (((codePoint >>> 6) & 63) | 128));
                                j3 = 1;
                                j2 = j15 + 1;
                                fls.a(bArr2, j15, (byte) ((codePoint & 63) | 128));
                                i5 = i6;
                                i5++;
                                c = 128;
                                long j92 = j3;
