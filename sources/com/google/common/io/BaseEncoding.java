...
public abstract class BaseEncoding {
            ...
            try {
                ...
                if (length > 0) {
                    switch (AnonymousClass1.a[roundingMode.ordinal()]) {
                        case 1:
                            fep.a((length > 0) & (((length + -1) & length) == 0));
                            break;
                        case 2:
                        case 3:
                            break;
                    ...
                    try {
                        ...
                        for (int i2 = 0; i2 < cArr.length; i2++) {
                            char c2 = cArr[i2];
                            fbp.a(c2 < 128, "Non-ASCII character: %s", c2);
                            fbp.a(bArr[c2] == -1, "Duplicate character: %s", c2);
                            bArr[c2] = (byte) i2;
                        }
                        this.g = bArr;
                        boolean[] zArr = new boolean[this.e];
                        for (int i3 = 0; i3 < this.f; i3++) {
                            zArr[feo.a(i3 << 3, this.d, RoundingMode.CEILING)] = true;
                        }
                        this.h = zArr;
    ...
    static class d extends BaseEncoding {
        ...
        d(com.google.common.io.BaseEncoding.a r5, java.lang.Character r6) {
            /*
                r4 = this;
                r4.<init>()
                java.lang.Object r0 = defpackage.fbp.a(r5)
        ...
        public final int a(int i) {
            return this.a.e * feo.a(i, this.a.f, RoundingMode.CEILING);
        }
        ...
        public final BaseEncoding b() {
            ...
            if (baseEncoding == 0) {
                ...
                if (z) {
                    ...
                    fbp.b(!z2, "Cannot call lowerCase() on a mixed-case alphabet");
        ...
        public boolean equals(Object obj) {
            if (obj instanceof d) {
                d dVar = (d) obj;
                if (this.a.equals(dVar.a) && fbn.a(this.b, dVar.b)) {
                    return true;
                }
            }
            return false;
    ...
    public CharSequence b(CharSequence charSequence) {
        return (CharSequence) fbp.a(charSequence);
    }
}
