...
final class Murmur3_128HashFunction extends fdo implements Serializable {
    static final fdr a = new Murmur3_128HashFunction(0);
    static final fdr b = new Murmur3_128HashFunction(Hashing.a);
    private static final long serialVersionUID = 0;
    private final int seed;

    static final class a extends fdq {
        private long a;
        private long b;
        private int c = 0;
