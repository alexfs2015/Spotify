...
final class Murmur3_32HashFunction extends feg implements Serializable {
    static final fej a = new Murmur3_32HashFunction(0);
    static final fej b = new Murmur3_32HashFunction(Hashing.a);
    private static final long serialVersionUID = 0;
    private final int seed;

    static final class a extends feh {
        private int a;
        private long b;
        private int c;
        private int d = 0;
    ...
    public static int b(byte[] bArr, int i) {
        return fev.a(bArr[i + 3], bArr[i + 2], bArr[i + 1], bArr[i]);
    }
