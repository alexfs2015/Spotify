...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E> implements fcz<E> {
    ...
    static final class SerializedForm<E> implements Serializable {
        ...
        SerializedForm(fcz<E> fcz) {
            this.comparator = fcz.comparator();
            int size = fcz.S_().size();
            this.elements = (Object[]) new Object[size];
            this.counts = new int[size];
            int i = 0;
            for (defpackage.fcp.a aVar : fcz.S_()) {
    ...
    public static class a<E> extends com.google.common.collect.ImmutableMultiset.a<E> {
        ...
        public a(Comparator<? super E> comparator) {
            super(0);
            this.a = (Comparator) fay.a(comparator);
        }
        ...
        private void a(boolean z) {
            ...
            if (i != 0) {
                ...
                if (z) {
                    ...
                    int i5 = this.d;
                    if (i4 > i5 * 3) {
                        copyOf = Arrays.copyOf(copyOf, fdw.a(i5, (i5 / 2) + 1));
                    }
                }
        ...
        public a<E> b(Iterable<? extends E> iterable) {
            if (iterable instanceof fcp) {
                for (defpackage.fcp.a aVar : ((fcp) iterable).S_()) {
                    a(aVar.b(), aVar.a());
                }
            } else {
    ...
    public ImmutableSortedMultiset<E> m() {
        ...
        if (immutableSortedMultiset == null) {
            immutableSortedMultiset = isEmpty() ? a(fct.a(comparator()).a()) : new DescendingImmutableSortedMultiset<>(this);
    ...
    public final /* synthetic */ fcz a(Object obj, BoundType boundType, Object obj2, BoundType boundType2) {
        fay.a(comparator().compare(obj, obj2) <= 0, "Expected lowerBound <= upperBound but %s > %s", obj, obj2);
