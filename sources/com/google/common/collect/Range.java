...
public final class Range<C extends Comparable> extends RangeGwtSerializationDependencies implements fbq<C>, Serializable {
    ...
    private Range(Cut<C> cut, Cut<C> cut2) {
        this.lowerBound = (Cut) fbp.a(cut);
        this.upperBound = (Cut) fbp.a(cut2);
