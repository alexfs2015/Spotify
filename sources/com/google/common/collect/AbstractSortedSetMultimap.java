...
abstract class AbstractSortedSetMultimap<K, V> extends AbstractSetMultimap<K, V> implements fdu<K, V> {
    ...
    public final Collection<V> a(K k, Collection<V> collection) {
        return collection instanceof NavigableSet ? new k(k, (NavigableSet) collection, null) : new m(k, (SortedSet) collection, null);
    }
