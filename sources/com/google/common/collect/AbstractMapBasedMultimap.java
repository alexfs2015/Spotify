...
abstract class AbstractMapBasedMultimap<K, V> extends fcg<K, V> implements Serializable {
    ...
    class a extends com.google.common.collect.Maps.i<K, Collection<V>> {
        ...
        class C0009a extends com.google.common.collect.Maps.c<K, Collection<V>> {
            ...
            public final boolean contains(Object obj) {
                return fcm.a((Collection<?>) a.this.a.entrySet(), obj);
            }
    ...
    public final Collection<Entry<K, V>> i() {
        return this instanceof fdo ? new defpackage.fcg.b() : new defpackage.fcg.a();
    }
