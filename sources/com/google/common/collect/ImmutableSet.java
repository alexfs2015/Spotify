...
public abstract class ImmutableSet<E> extends ImmutableCollection<E> implements Set<E> {
    ...
    public static <E> ImmutableSet<E> a(E e, E e2, E e3, E e4, E e5, E e6, E... eArr) {
        fay.a(eArr.length <= 2147483641, (Object) "the total number of elements must fit in an int");
    ...
    public static <E> ImmutableSet<E> b(int i, Object... objArr) {
        while (i != 0) {
            ...
            for (int i5 = 0; i5 < i; i5++) {
                Object a2 = fcq.a(objArr[i5], i5);
                int hashCode = a2.hashCode();
                int a3 = fck.a(hashCode);
                while (true) {
                    int i6 = a3 & i2;
    ...
    static int b(int i) {
        ...
        if (max < 751619276) {
            ...
            fay.a(z, (Object) "collection too large");
            return 1073741824;
        }
    }
