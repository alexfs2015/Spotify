...
class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class a extends AbstractSet<Entry<K, V>> {
        ...
        public final boolean contains(Object obj) {
            if (obj instanceof Entry) {
                ...
                if (a2 != -1 && faw.a(CompactHashMap.this.b[a2], entry.getValue())) {
                    return true;
                }
            }
            return false;
    ...
    abstract class b<T> implements Iterator<T> {
        ...
        public void remove() {
            a();
            fay.b(this.c >= 0, "no calls to next() since the last call to remove()");
            this.a++;
    ...
    final class d extends fbo<K, V> {
        ...
        private void a() {
            int i = this.b;
            if (i == -1 || i >= CompactHashMap.this.size() || !faw.a(this.a, CompactHashMap.this.a[this.b])) {
    ...
    public void a(int i2, float f2) {
        boolean z = false;
        fay.a(i2 >= 0, (Object) "Initial capacity must be non-negative");
        if (f2 > 0.0f) {
            z = true;
        }
        fay.a(z, (Object) "Illegal load factor");
        int a2 = fck.a(i2, (double) f2);
        this.d = f(a2);
        this.f = f2;
    ...
    public V put(K k2, V v) {
        ...
        if (i3 == -1) {
            ...
            while (true) {
                long j2 = jArr[i3];
                if (((int) (j2 >>> 32)) != a2 || !faw.a(k2, objArr[i3])) {
                    int i4 = (int) j2;
                    if (i4 == -1) {
                        jArr[i3] = a(j2, i2);
                        break;
    ...
    public int a(Object obj) {
        ...
        while (i2 != -1) {
            long j2 = this.e[i2];
            if (((int) (j2 >>> 32)) == a2 && faw.a(obj, this.a[i2])) {
                return i2;
            }
            i2 = (int) j2;
        }
    ...
    public V a(Object obj, int i2) {
        ...
        int i4 = -1;
        while (true) {
            if (((int) (this.e[i3] >>> 32)) != i2 || !faw.a(obj, this.a[i3])) {
