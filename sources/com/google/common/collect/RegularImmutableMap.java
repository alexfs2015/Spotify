...
final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    static <K, V> RegularImmutableMap<K, V> a(int i, Object[] objArr) {
        ...
        if (i == 1) {
            fcl.a(objArr[0], objArr[1]);
            return new RegularImmutableMap<>(null, objArr, 1);
        }
        fbp.b(i, objArr.length >> 1, "index");
    ...
    static int[] a(java.lang.Object[] r10, int r11, int r12, int r13) {
        ...
        L_0x0017:
            ...
            int r4 = r4 + r7
            r4 = r10[r4]
            defpackage.fcl.a(r6, r4)
            int r7 = r6.hashCode()
            int r7 = defpackage.fdc.a(r7)
        L_0x002f:
            r7 = r7 & r1
            r8 = r12[r7]
