...
final class GeneralRange<T> implements Serializable {
    ...
    private GeneralRange(Comparator<? super T> comparator2, boolean z, T t, BoundType boundType, boolean z2, T t2, BoundType boundType2) {
        ...
        this.lowerBoundType = (BoundType) fbp.a(boundType);
        this.upperEndpoint = t2;
        this.upperBoundType = (BoundType) fbp.a(boundType2);
        if (z) {
        ...
        if (z && z2) {
            ...
            boolean z3 = true;
            fbp.a(compare <= 0, "lowerEndpoint (%s) > upperEndpoint (%s)", t, t2);
            if (compare == 0) {
