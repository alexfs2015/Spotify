...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    final class a extends fbo<K, V> {
        ...
        private void a() {
            int i = this.b;
            if (i == -1 || i > HashBiMap.this.c || !faw.a(HashBiMap.this.a[this.b], this.a)) {
    ...
    static final class b<K, V> extends fbo<V, K> {
        ...
        private void a() {
            int i = this.c;
            if (i == -1 || i > this.a.c || !faw.a(this.b, this.a.b[this.c])) {
    ...
    final class c extends g<K, V, Entry<K, V>> {
        ...
        public final boolean contains(Object obj) {
            if (obj instanceof Entry) {
                ...
                if (a != -1 && faw.a(value, HashBiMap.this.b[a])) {
                    return true;
                }
            }
            return false;
        ...
        public final boolean remove(Object obj) {
            if (obj instanceof Entry) {
                ...
                if (a2 != -1 && faw.a(value, HashBiMap.this.b[a2])) {
        ...
        public Iterator<T> iterator() {
            return new Iterator<T>() {
                ...
                public final void remove() {
                    ...
                    int i = this.b;
                    hashBiMap.a(i, fck.a((Object) hashBiMap.a[i]));
    ...
    private void c(int i2) {
        ...
        if (this.e.length < i2) {
            int a3 = fck.a(i2, 1.0d);
            this.e = b(a3);
            this.f = b(a3);
            for (int i3 = 0; i3 < this.c; i3++) {
                int d2 = d(fck.a((Object) this.a[i3]));
                int[] iArr2 = this.g;
                int[] iArr3 = this.e;
                iArr2[i3] = iArr3[d2];
                iArr3[d2] = i3;
                int d3 = d(fck.a((Object) this.b[i3]));
                int[] iArr4 = this.h;
                int[] iArr5 = this.f;
                iArr4[i3] = iArr5[d3];
                iArr5[d3] = i3;
    ...
    private V b(K k2, V v, boolean z) {
        ...
        int a4 = fck.a((Object) v);
        int b2 = b((Object) v, a4);
        if (!z) {
            fay.a(b2 == -1, "Value already present: %s", (Object) v);
        } else if (b2 != -1) {
            b(b2, a4);
        }
        c(this.c + 1);
    ...
    public final K a(V v, K k2, boolean z) {
        ...
        int i2 = this.j;
        int a3 = fck.a((Object) k2);
        int a4 = a((Object) k2, a3);
        if (!z) {
            fay.a(a4 == -1, "Key already present: %s", (Object) k2);
        } else if (a4 != -1) {
            i2 = this.k[a4];
            a(a4, a3);
        }
    ...
    public void b(int i2, K k2, boolean z) {
        ...
        f(i2, fck.a((Object) this.a[i2]));
        this.a[i2] = k2;
        d(i2, fck.a((Object) k2));
        c(i3, i2);
        c(i2, a3);
    }
    ...
    public final void a(int i2, int i3) {
        a(i2, i3, fck.a((Object) this.b[i2]));
    }

    /* access modifiers changed from: 0000 */
    public final void b(int i2, int i3) {
        a(i2, fck.a((Object) this.a[i2]), i3);
    }
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        ...
        a(16);
        fcv.a((Map<K, V>) this, objectInputStream, readInt);
    }
