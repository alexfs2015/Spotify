...
public class LinkedListMultimap<K, V> extends fbp<K, V> implements fcm<K, V>, Serializable {
    ...
    class c implements Iterator<K> {
        ...
        public final void remove() {
            a();
            fay.b(this.c != null, "no calls to next() since the last call to remove()");
    ...
    static final class e<K, V> extends fbo<K, V> {
        final K a;
        V b;
        e<K, V> c;
        e<K, V> d;
    ...
    class g implements ListIterator<V> {
        ...
        public final void remove() {
            fay.b(this.d != null, "no calls to next() since the last call to remove()");
            e<K, V> eVar = this.d;
            if (eVar != this.c) {
                this.e = eVar.f;
                this.b--;
    ...
    public final Map<K, Collection<V>> k() {
        return new defpackage.fco.a(this);
    }
