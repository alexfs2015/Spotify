...
public final class C$Gson$Types {
    ...
    static final class WildcardTypeImpl implements Serializable, WildcardType {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            boolean z = true;
            fit.a(typeArr2.length <= 1);
            fit.a(typeArr.length == 1);
    ...
    public static Class<?> b(Type type) {
        ...
        while (!(type instanceof Class)) {
            if (type instanceof ParameterizedType) {
                ...
                fit.a(rawType instanceof Class);
    ...
    private static Type b(Type type, Class<?> cls, Class<?> cls2) {
        ...
        fit.a(cls2.isAssignableFrom(cls));
    ...
    static void e(Type type) {
        fit.a(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
}
