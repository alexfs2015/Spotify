...
class a {
    ...
    /* renamed from: com.moat.analytics.mobile.spot.a$a reason: collision with other inner class name */
    static class C0010a implements ActivityLifecycleCallbacks {
        C0010a() {
        }
        ...
        private static void a(boolean z) {
            ...
            if (z) {
                p.a(3, str, (Object) null, "App became visible");
                if (w.a().a == d.ON && !((k) MoatAnalytics.getInstance()).c) {
                    o.a().c();
                }
            } else {
                p.a(3, str, (Object) null, "App became invisible");
                if (w.a().a == d.ON && !((k) MoatAnalytics.getInstance()).c) {
                    o.a().d();
                }
            }
    ...
    static void a(Application application) {
        ...
        if (!b) {
            b = true;
            c.registerActivityLifecycleCallbacks(new C0010a());
        }
    }
