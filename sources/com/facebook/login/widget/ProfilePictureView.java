...
public class ProfilePictureView extends FrameLayout {
    ...
    private void b(boolean z) {
        a aVar = new a(getContext(), amk.a(this.b, this.d, this.c));
        aVar.d = z;
        aVar.e = this;
        aVar.c = new b() {
            public final void a(aml aml) {
                ProfilePictureView.a(ProfilePictureView.this, aml);
            }
        };
        amk a2 = aVar.a();
        amk amk = this.i;
    ...
    static /* synthetic */ void a(ProfilePictureView profilePictureView, aml aml) {
        if (aml.a == profilePictureView.i) {
            profilePictureView.i = null;
            Bitmap bitmap = aml.d;
            Exception exc = aml.b;
            if (exc != null) {
                amp.a(LoggingBehavior.REQUESTS, 6, a, exc.toString());
            } else if (bitmap != null) {
