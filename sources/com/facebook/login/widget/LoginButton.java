...
public class LoginButton extends akn {
    ...
    public class b implements OnClickListener {
        ...
        public void onClick(View view) {
            ...
            alk alk = new alk(LoginButton.this.getContext());
            Bundle bundle = new Bundle();
            if (a2 == null) {
                i = 1;
            }
            bundle.putInt("logging_in", i);
            bundle.putInt("access_token_expired", aki.b() ? 1 : 0);
            alk.b(LoginButton.this.f, bundle);
        }
    }
    ...
    static /* synthetic */ void a(LoginButton loginButton, amu amu) {
        if (amu != null && amu.c && loginButton.getVisibility() == 0) {
            loginButton.b(amu.b);
        }
    }
    ...
    public final void a(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, defpackage.aoc.a.a, i2, i3);
        try {
            this.c = obtainStyledAttributes.getBoolean(defpackage.aoc.a.b, true);
            this.d = obtainStyledAttributes.getString(defpackage.aoc.a.c);
            this.e = obtainStyledAttributes.getString(defpackage.aoc.a.d);
            this.i = ToolTipMode.a(obtainStyledAttributes.getInt(defpackage.aoc.a.e, ToolTipMode.d.intValue));
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (!this.g && !isInEditMode()) {
            ...
            if (i2 == 1) {
                final String a2 = ank.a(getContext());
                akq.e().execute(new Runnable() {
                    public final void run() {
                        final amu a2 = FetchedAppSettingsManager.a(a2, false);
