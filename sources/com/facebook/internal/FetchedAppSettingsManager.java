...
public final class FetchedAppSettingsManager {
    ...
    /* access modifiers changed from: private */
    public static final Map<String, amu> c = new ConcurrentHashMap();
    /* access modifiers changed from: private */
    ...
    public static amu a(String str) {
        if (str != null) {
            return (amu) c.get(str);
        }
        return null;
    }

    public static amu a(String str, boolean z) {
    ...
    /* JADX WARNING: type inference failed for: r6v1, types: [java.lang.Object, amu$a] */
    /* JADX WARNING: type inference failed for: r6v2, types: [android.net.Uri] */
    /* JADX WARNING: type inference failed for: r7v7, types: [amu$a] */
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r6v0
      ...
      uses: [?[int, boolean, OBJECT, ARRAY, byte, short, char], amu$a, java.lang.Object, android.net.Uri]
      mth insns count: 46
    ...
    private static java.util.Map<java.lang.String, java.util.Map<java.lang.String, defpackage.amu.a>> a(org.json.JSONObject r9) {
        /*
        ...
        L_0x0011:
            ...
            boolean r5 = defpackage.ank.a(r4)
            r6 = 0
        ...
        L_0x0034:
            ...
            r7 = 1
            r4 = r4[r7]
            boolean r7 = defpackage.ank.a(r5)
            if (r7 != 0) goto L_0x0066
            boolean r7 = defpackage.ank.a(r4)
            ...
            akq.e().execute(new Runnable() {
                public final void run() {
                    ...
                    if (!ank.a(string)) {
                        ...
                        if (jSONObject != null) {
                            amu = FetchedAppSettingsManager.b(k, jSONObject);
                        }
                    }
    ...
    /* access modifiers changed from: private */
    public static amu b(String str, JSONObject jSONObject) {
        JSONObject jSONObject2 = jSONObject;
        JSONArray optJSONArray = jSONObject2.optJSONArray("android_sdk_error_categories");
        amq a2 = optJSONArray == null ? amq.a() : amq.a(optJSONArray);
        ...
        g = optJSONArray2;
        amu amu = r2;
        amu amu2 = new amu(jSONObject2.optBoolean("supports_implicit_sdk_logging", false), jSONObject2.optString("gdpv4_nux_content", ""), jSONObject2.optBoolean("gdpv4_nux_enabled", false), jSONObject2.optBoolean("gdpv4_chrome_custom_tabs_enabled", false), jSONObject2.optInt("app_events_session_timeout", 60), SmartLoginOption.a(jSONObject2.optLong("seamless_login")), a(jSONObject2.optJSONObject("android_dialog_configs")), z, a2, jSONObject2.optString("smart_login_bookmark_icon_url"), jSONObject2.optString("smart_login_menu_icon_url"), z2, z3, optJSONArray2, jSONObject2.optString("sdk_update_message"), z4);
        amu amu3 = amu;
        c.put(str, amu3);
        return amu3;
    }
    ...
    public static JSONObject c(String str) {
        ...
        akr a2 = akr.a((aki) null, str, (b) null);
        a2.h = true;
        a2.d = bundle;
        return akr.a(a2).a;
    }
    ...
    public static synchronized void g() {
        /*
            ...
            goto L_0x006f
        L_0x001c:
            java.lang.String r2 = defpackage.akq.k()     // Catch:{ all -> 0x0071 }
            java.util.Map<java.lang.String, amu> r3 = c     // Catch:{ all -> 0x0071 }
            java.lang.Object r2 = r3.get(r2)     // Catch:{ all -> 0x0071 }
            amu r2 = (defpackage.amu) r2     // Catch:{ all -> 0x0071 }
