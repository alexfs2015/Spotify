...
public class CustomTabMainActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            aml aml = new aml("oauth", bundleExtra);
            de a2 = new a().a();
            ...
            mh.a((Context) this).a(this.f, new IntentFilter(CustomTabActivity.a));
        }
    }
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (d.equals(intent.getAction())) {
            mh.a((Context) this).a(new Intent(CustomTabActivity.b));
            a(-1, intent);
            return;
        }
