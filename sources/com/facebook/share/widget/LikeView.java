...
public class LikeView extends FrameLayout {
    ...
    class a implements defpackage.anx.c {
        boolean a;
    ...
    class b extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            if (extras != null) {
                ...
                if (!amw.a(string) && !amw.a(LikeView.this.a, string)) {
                    z = false;
                }
            }
            if (z) {
    ...
    public LikeView(Context context, AttributeSet attributeSet) {
        ...
        if (!(attributeSet == null || getContext() == null)) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, defpackage.alp.a.a);
            if (obtainStyledAttributes != null) {
                this.a = amw.a(obtainStyledAttributes.getString(defpackage.alp.a.e), (String) null);
                this.b = ObjectType.a(obtainStyledAttributes.getInt(defpackage.alp.a.f, ObjectType.c.intValue));
                this.j = Style.a(obtainStyledAttributes.getInt(defpackage.alp.a.g, Style.c.intValue));
                if (this.j != null) {
                    this.l = AuxiliaryViewPosition.a(obtainStyledAttributes.getInt(defpackage.alp.a.b, AuxiliaryViewPosition.d.intValue));
                    if (this.l != null) {
                        this.k = HorizontalAlignment.a(obtainStyledAttributes.getInt(defpackage.alp.a.d, HorizontalAlignment.d.intValue));
                        if (this.k != null) {
                            this.m = obtainStyledAttributes.getColor(defpackage.alp.a.c, -1);
    ...
    public void onDetachedFromWindow() {
        ...
        String a2 = amw.a((String) null, (String) null);
        if (objectType == null) {
            objectType = ObjectType.c;
        }
        if (!amw.a(a2, this.a) || objectType != this.b) {
            a(a2, objectType);
            b();
        }
    ...
    public void a(String str, ObjectType objectType) {
        ...
        if (!amw.a(str)) {
            this.i = new a(this, 0);
            if (!isInEditMode()) {
                anx.a(str, objectType, (defpackage.anx.c) this.i);
            }
        }
    }
    ...
    private void c() {
        ...
        L_0x0023:
            ...
            boolean r0 = defpackage.amw.a(r0)
            if (r0 != 0) goto L_0x004c
            android.widget.TextView r0 = r7.f
            goto L_0x0065
        L_0x004c:
    ...
    static /* synthetic */ void a(com.facebook.share.widget.LikeView r6) {
        ...
        L_0x0017:
            ...
            java.lang.String r5 = ""
            java.lang.String r4 = defpackage.amw.a(r4, r5)
    ...
    static /* synthetic */ void a(LikeView likeView, anx anx) {
        likeView.g = anx;
        likeView.h = new b(likeView, 0);
        mc a2 = mc.a(likeView.getContext());
