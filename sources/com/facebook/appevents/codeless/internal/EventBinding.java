...
public final class EventBinding {
    ...
    private EventBinding(String str, MappingMethod mappingMethod, ActionType actionType, String str2, List<PathComponent> list, List<ale> list2, String str3, String str4, String str5) {
        this.a = str;
    ...
    private static EventBinding a(JSONObject jSONObject) {
        ...
        if (optJSONArray != null) {
            for (int i3 = 0; i3 < optJSONArray.length(); i3++) {
                arrayList2.add(new ale(optJSONArray.getJSONObject(i3)));
            }
        }
