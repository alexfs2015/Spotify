...
public abstract class MapperConfigBase<CFG extends ConfigFeature, T extends MapperConfigBase<CFG, T>> extends MapperConfig<T> implements Serializable {
    ...
    public PropertyName findRootName(JavaType javaType) {
        ...
        return propertyName != null ? propertyName : this._rootNames.findRootName(javaType, (MapperConfig<?>) this);
    }

    public PropertyName findRootName(Class<?> cls) {
        PropertyName propertyName = this._rootName;
        return propertyName != null ? propertyName : this._rootNames.findRootName(cls, (MapperConfig<?>) this);
    }
