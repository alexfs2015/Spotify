...
public class EnumMapDeserializer extends ContainerDeserializerBase<EnumMap<?, ?>> implements ContextualDeserializer, ResolvableDeserializer {
                ...
                if (enumR != null) {
                    try {
                        if (nextToken != JsonToken.VALUE_NULL) {
                            obj = this._valueTypeDeserializer == null ? this._valueDeserializer.deserialize(jsonParser, deserializationContext) : this._valueDeserializer.deserializeWithType(jsonParser, deserializationContext, this._valueTypeDeserializer);
    ...
    public EnumMap<?, ?> deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        return (currentToken == JsonToken.START_OBJECT || currentToken == JsonToken.FIELD_NAME || currentToken == JsonToken.END_OBJECT) ? deserialize(jsonParser, deserializationContext, constructMap(deserializationContext)) : currentToken == JsonToken.VALUE_STRING ? (EnumMap) this._valueInstantiator.createFromString(deserializationContext, jsonParser.getText()) : (EnumMap) _deserializeFromEmpty(jsonParser, deserializationContext);
    }
