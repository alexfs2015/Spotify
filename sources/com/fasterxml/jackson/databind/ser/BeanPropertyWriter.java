...
public class BeanPropertyWriter extends PropertyWriter implements Serializable {
    ...
    public JsonSerializer<Object> _findAndAddDynamic(PropertySerializerMap propertySerializerMap, Class<?> cls, SerializerProvider serializerProvider) {
        ...
        SerializerAndMapResult findAndAddPrimarySerializer = javaType != null ? propertySerializerMap.findAndAddPrimarySerializer(serializerProvider.constructSpecializedType(javaType, cls), serializerProvider, (BeanProperty) this) : propertySerializerMap.findAndAddPrimarySerializer(cls, serializerProvider, (BeanProperty) this);
