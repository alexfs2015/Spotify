...
public abstract class GuavaMapDeserializer<T> extends JsonDeserializer<T> implements ContextualDeserializer {
    ...
    public T deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) {
        ...
        return (currentToken == JsonToken.FIELD_NAME || currentToken == JsonToken.END_OBJECT) ? _deserializeEntries(jsonParser, deserializationContext) : deserializationContext.handleUnexpectedToken(this._mapType.getRawClass(), jsonParser);
    }
