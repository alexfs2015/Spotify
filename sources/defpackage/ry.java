...
public final class ry extends rx {
    ...
    private ry(Parcel parcel, int i2, int i3, String str, dp<String, Method> dpVar, dp<String, Method> dpVar2, dp<String, Class> dpVar3) {
    ...
    public final rx b() {
        ...
        sb.append(this.h);
        sb.append("  ");
        ry ryVar = new ry(parcel, dataPosition, i3, sb.toString(), this.a, this.b, this.c);
        return ryVar;
    }
