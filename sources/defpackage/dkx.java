...
public final class dkx implements OnGlobalLayoutListener, OnScrollChangedListener {
    protected final dkv a;
    private final Object b = new Object();
    private final WeakReference<clq> c;
    ...
    private cos t;
    private final HashSet<dlt> u = new HashSet<>();
    private final Rect v = new Rect();
    private final dla w;
    private float x;

    public dkx(Context context, dpt dpt, clq clq, cpp cpp, dmi dmi) {
        this.c = new WeakReference<>(clq);
        this.e = dmi;
        this.d = new WeakReference<>(null);
        this.o = true;
        this.q = false;
        this.t = new cos(200);
        dkv dkv = new dkv(UUID.randomUUID().toString(), cpp, dpt.a, clq.k, clq.a(), dpt.h);
        this.a = dkv;
        ...
        this.f = context;
        this.w = new dla(this, new Handler());
    ...
    private final JSONObject a(View view, Boolean bool) {
        ...
        try {
            ...
            cml.a("Failure getting view location.", e2);
        }
        Rect rect = new Rect();
        rect.left = iArr[0];
        rect.top = iArr[1];
        ...
        if (bool == null) {
            bkc.e();
            bool2 = Boolean.valueOf(cmu.a(view2, this.h, this.i));
        } else {
            bool2 = bool;
        }
    ...
    private final void a(JSONObject jSONObject, boolean z) {
        try {
            ...
            cml.a("Skipping active view message.", th);
        }
    }
    ...
    private final JSONObject j() {
        ...
        jSONObject.put("afmaVersion", this.a.d).put(str, this.a.b).put(str2, bkc.l().b()).put(str3, this.a.a).put(str4, this.a.c).put(str5, this.a.e).put(str6, this.n).put(str7, this.m).put(str8, this.a.f).put(str9, k()).put(str10, bkc.D().b()).put(str11, (double) bkc.D().a()).put(str12, (double) this.x);
        return jSONObject;
    }
    ...
    public final void a(int r8) {
        /*
            ...
            monitor-enter(r0)
            java.util.HashSet<dlt> r1 = r7.u     // Catch:{ all -> 0x00cb }
        ...
        L_0x0009:
            ...
            dlt r2 = (defpackage.dlt) r2     // Catch:{ all -> 0x00cb }
        ...
        L_0x0088:
            r8 = 3
            defpackage.cpn.a(r8)     // Catch:{ all -> 0x00cb }
        L_0x008c:
            dmi r8 = r7.e     // Catch:{ all -> 0x00cb }
            dmi r8 = r8.c()     // Catch:{ all -> 0x00cb }
        ...
        L_0x00cf:
            goto L_0x00ce
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dkx.a(int):void");
    }

    public final void a(dlf dlf) {
        synchronized (this.b) {
            this.k = dlf;
        }
    }
    ...
    public final void b() {
        ...
        L_0x001c:
            defpackage.cml.a(r2, r1)     // Catch:{ all -> 0x0043 }
            goto L_0x0024
        L_0x0020:
            r1 = move-exception
        ...
        L_0x003d:
            r1 = 3
            defpackage.cpn.a(r1)     // Catch:{ all -> 0x0043 }
        L_0x0041:
        ...
        L_0x0047:
            goto L_0x0046
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dkx.b():void");
    }

    public final void b(dlt dlt) {
        if (this.u.isEmpty()) {
            synchronized (this.b) {
                if (this.r == null) {
                    ...
                    this.r = new dky(this);
                    bkc.E().a(this.f, this.r, intentFilter);
                }
            }
            a(3);
        }
        this.u.add(dlt);
        try {
            dlt.a(a(a(this.e.a(), (Boolean) null)), false);
        } catch (JSONException e2) {
            cml.a("Skipping measurement update for new client.", e2);
        }
    }
        ...
        if (this.u.isEmpty()) {
            synchronized (this.b) {
                ...
                synchronized (this.b) {
                    if (this.r != null) {
                        try {
                            bkc.E().a(this.f, this.r);
                        } catch (IllegalStateException e2) {
                            cml.a("Failed trying to unregister the receiver", e2);
                        } catch (Exception e3) {
                            bkc.i().a((Throwable) e3, "ActiveViewUnit.stopScreenStatusMonitoring");
                        }
                        this.r = null;
                    }
                }
