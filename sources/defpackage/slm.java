...
public final class slm extends FrameLayout implements Checkable {
    ...
    public slm(Context context, int i, int i2, LyricsAppearance lyricsAppearance) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.lyrics_line_view, this);
        uuu.a(context, this.a, lyricsAppearance.mTextStyle);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        int b2 = uts.b((float) this.f.mLineHeight, getResources());
        int i3 = size / b2;
        int i4 = i3 - (i3 % 2);
        if (i4 == 0) {
