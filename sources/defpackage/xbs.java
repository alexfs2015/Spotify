...
public final class xbs {
    ...
    static {
        ...
        for (int i = 0; i < 256; i++) {
            d[i] = xaq.a("%8s", Integer.toBinaryString(i)).replace(' ', '0');
        }
        String[] strArr = c;
        strArr[0] = "";
        strArr[1] = "END_STREAM";
    ...
    static IllegalArgumentException a(String str, Object... objArr) {
        throw new IllegalArgumentException(xaq.a(str, objArr));
    }

    static String a(boolean z, int i, int i2, byte b2, byte b3) {
        String str;
        String a2 = b2 < 10 ? b[b2] : xaq.a("0x%02x", Byte.valueOf(b2));
        if (b3 == 0) {
            str = "";
        } else {
            if (!(b2 == 2 || b2 == 3)) {
        ...
        objArr[3] = a2;
        objArr[4] = str;
        return xaq.a("%s 0x%08x %5d %-13s %s", objArr);
    }

    static IOException b(String str, Object... objArr) {
        throw new IOException(xaq.a(str, objArr));
    }
}
