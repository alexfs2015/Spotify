...
public final class wga extends wgs {
    ...
    public final defpackage.wgs.a a(defpackage.wgq r5, int r6) {
        /*
            r4 = this;
        ...
        L_0x0056:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wga.a(wgq, int):wgs$a");
    }

    public final boolean a(wgq wgq) {
        Uri uri = wgq.d;
        return "content".equals(uri.getScheme()) && Contacts.CONTENT_URI.getHost().equals(uri.getHost()) && a.match(wgq.d) != -1;
    }
}
