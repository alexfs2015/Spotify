...
public class fcr<K> {
    ...
    class a extends com.google.common.collect.Multisets.a<K> {
        ...
        public final int a() {
            int i = this.b;
            if (i == -1 || i >= fcr.this.c || !faw.a(this.a, fcr.this.a[this.b])) {
                this.b = fcr.this.a((Object) this.a);
            }
            if (this.b == -1) {
                return 0;
            }
            return fcr.this.b[this.b];
        }
    }
    ...
    public fcr(fcr<? extends K> fcr) {
        a(fcr.c, 1.0f);
        int a2 = fcr.a();
        while (a2 != -1) {
            a((K) fcr.b(a2), fcr.c(a2));
            a2 = fcr.a(a2);
        }
    }
    ...
    public void a(int i, float f2) {
        boolean z = false;
        fay.a(i >= 0, (Object) "Initial capacity must be non-negative");
        if (f2 > 0.0f) {
            z = true;
        }
        fay.a(z, (Object) "Illegal load factor");
        int a2 = fck.a(i, (double) f2);
        this.e = i(a2);
        this.g = f2;
        this.a = new Object[i];
        this.b = new int[i];
    ...
    public final defpackage.fcp.a<K> d(int i) {
        fay.a(i, this.c, "index");
        return new a(i);
    }
    ...
    public final int a(K k, int i) {
        ...
        if (i3 == -1) {
            ...
            while (true) {
                long j = jArr[i3];
                if (((int) (j >>> 32)) != a2 || !faw.a(k, objArr[i3])) {
                    int i4 = (int) j;
                    if (i4 == -1) {
                        jArr[i3] = a(j, i2);
                        break;
    ...
    public final int a(Object obj) {
        ...
        while (i != -1) {
            long j = this.f[i];
            if (((int) (j >>> 32)) == a2 && faw.a(obj, this.a[i])) {
                return i;
            }
            i = (int) j;
        }
    ...
    public int b(Object obj, int i) {
        ...
        int i3 = -1;
        while (true) {
            if (((int) (this.f[i2] >>> 32)) != i || !faw.a(obj, this.a[i2])) {
