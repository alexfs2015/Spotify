...
public class rd {
    ...
    static class a extends ViewGroup {
        ...
        a(Context context, ViewGroup viewGroup, View view, rd rdVar) {
            super(context);
            this.c = viewGroup;
            this.d = view;
        ...
        public final void a(View view) {
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (!(viewGroup == this.c || viewGroup.getParent() == null || !ip.E(viewGroup))) {
                    ...
                    ip.g(view, iArr[0] - iArr2[0]);
                    ip.f(view, iArr[1] - iArr2[1]);
                }
        ...
        public final void b(android.view.View r1) {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.rd.a.b(android.view.View):void");
        }
    ...
    rd(Context context, ViewGroup viewGroup, View view) {
    ...
    public static rd c(View view) {
        ...
        return new qx(a2.getContext(), a2, view);
    }
}
