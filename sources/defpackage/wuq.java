...
public final class wuq {
    private static final wyc b = wyd.a(wuq.class);
    private static final Date c = new Date(wxu.a("io.netty.selfSignedCertificate.defaultNotBefore", System.currentTimeMillis() - 31536000000L));
    private static final Date d = new Date(wxu.a("io.netty.selfSignedCertificate.defaultNotAfter", 253402300799000L));
    ...
    private wuq(java.lang.String r6, java.security.SecureRandom r7, int r8, java.util.Date r9, java.util.Date r10) {
        /*
            r5 = this;
            ...
            java.lang.String[] r6 = defpackage.wup.a(r6, r0, r7, r9, r10)     // Catch:{ all -> 0x0019 }
            goto L_0x0025
        L_0x0019:
            r1 = move-exception
            wyc r2 = b
            ...
            r2.b(r3, r1)
            java.lang.String[] r6 = defpackage.wuo.a(r6, r0, r7, r9, r10)     // Catch:{ all -> 0x009b }
        L_0x0025:
        ...
        L_0x00ab:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wuq.<init>(java.lang.String, java.security.SecureRandom, int, java.util.Date, java.util.Date):void");
    }

    private wuq(String str, Date date, Date date2) {
        this(str, ThreadLocalInsecureRandom.a(), 1024, date, date2);
    }

    private wuq(Date date, Date date2) {
    ...
    private static void a(File file, OutputStream outputStream) {
        try {
            ...
            sb.append(file);
            wyc.d(sb.toString(), (Throwable) e2);
        }
    }
    ...
    static java.lang.String[] a(java.lang.String r6, java.security.PrivateKey r7, java.security.cert.X509Certificate r8) {
        /*
            ...
            wnb r7 = defpackage.woc.a(r7)
            r0 = 1
            wnb r1 = defpackage.wrn.a(r7, r0)     // Catch:{ all -> 0x00e0 }
            ...
            java.nio.charset.Charset r3 = defpackage.wvh.b     // Catch:{ all -> 0x00db }
            ...
            r4.<init>(r7)
            java.nio.charset.Charset r5 = defpackage.wvh.b     // Catch:{ all -> 0x00d3 }
            byte[] r2 = r2.getBytes(r5)     // Catch:{ all -> 0x00d3 }
            r4.write(r2)     // Catch:{ all -> 0x00d3 }
            r4.close()     // Catch:{ all -> 0x00d3 }
            byte[] r8 = r8.getEncoded()
            wnb r8 = defpackage.woc.a(r8)
            wnb r2 = defpackage.wrn.a(r8, r0)     // Catch:{ all -> 0x00ce }
            ...
            java.nio.charset.Charset r5 = defpackage.wvh.b     // Catch:{ all -> 0x00c9 }
            ...
            r8.<init>(r6)
            java.nio.charset.Charset r1 = defpackage.wvh.b     // Catch:{ all -> 0x00be }
        ...
        L_0x00e0:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wuq.a(java.lang.String, java.security.PrivateKey, java.security.cert.X509Certificate):java.lang.String[]");
    }
}
