...
public final class pbd implements vua<PlayOrigin> {
    private final wlc<udr> a;
    private final wlc<String> b;
    private final wlc<sih> c;
    private final wlc<gjb> d;

    private pbd(wlc<udr> wlc, wlc<String> wlc2, wlc<sih> wlc3, wlc<gjb> wlc4) {
        this.a = wlc;
        this.b = wlc2;
        this.c = wlc3;
        this.d = wlc4;
    ...
    public static pbd a(wlc<udr> wlc, wlc<String> wlc2, wlc<sih> wlc3, wlc<gjb> wlc4) {
        return new pbd(wlc, wlc2, wlc3, wlc4);
    }
