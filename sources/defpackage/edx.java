...
public abstract class edx extends dkp implements edw {
    public edx() {
    ...
    public final boolean dispatchTransaction(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x00b0:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.edx.dispatchTransaction(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
