...
final class wgo extends BitmapDrawable {
    ...
    private wgo(Context context, Bitmap bitmap, Drawable drawable, LoadedFrom loadedFrom, boolean z, boolean z2) {
    ...
    static void a(ImageView imageView, Context context, Bitmap bitmap, LoadedFrom loadedFrom, boolean z, boolean z2) {
        ...
        wgo wgo = new wgo(context, bitmap, drawable, loadedFrom, z, z2);
        imageView.setImageDrawable(wgo);
    }
