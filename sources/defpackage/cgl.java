...
final class cgl implements Runnable {
    ...
    cgl(OutputStream outputStream, byte[] bArr) {
        this.a = outputStream;
        this.b = bArr;
    }
    ...
    public final void run() {
        ...
        L_0x0022:
            ...
            defpackage.clu.a(r2, r0)     // Catch:{ all -> 0x003c }
            cle r2 = defpackage.bjl.i()     // Catch:{ all -> 0x003c }
        ...
        L_0x0041:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cgl.run():void");
    }
}
