...
final class xcf extends xch {
    ...
    private xcf(Method method, Method method2, Method method3, Class<?> cls, Class<?> cls2) {
        this.b = method;
        this.c = method2;
        this.d = method3;
        this.e = cls;
    ...
    public static xch a() {
        ...
        try {
            ...
            xcf xcf = new xcf(method2, cls.getMethod("get", new Class[]{SSLSocket.class}), cls.getMethod("remove", new Class[]{SSLSocket.class}), cls3, cls4);
            return xcf;
    ...
    public final String a(SSLSocket sSLSocket) {
        try {
            ...
            if (!aVar.a && aVar.b == null) {
                xch.a.a(4, "ALPN callback dropped: HTTP/2 is disabled. Is alpn-boot on the boot class path?", (Throwable) null);
                return null;
            } else if (aVar.a) {
                return null;
            } else {
            ...
            throw xaq.a("unable to get selected protocol", (Exception) e2);
        }
    }
    ...
    public final void a(SSLSocket sSLSocket, String str, List<Protocol> list) {
        List a2 = a(list);
        try {
            Object newProxyInstance = Proxy.newProxyInstance(xch.class.getClassLoader(), new Class[]{this.e, this.f}, new a(a2));
            this.b.invoke(null, new Object[]{sSLSocket, newProxyInstance});
        } catch (IllegalAccessException | InvocationTargetException e2) {
            throw xaq.a("unable to set alpn", (Exception) e2);
        }
    }
    ...
    public final void b(SSLSocket sSLSocket) {
        try {
            ...
            throw xaq.a("unable to remove alpn", (Exception) e2);
        }
    }
}
