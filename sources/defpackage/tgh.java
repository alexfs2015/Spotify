...
final class tgh implements tgg {
    public final tgf a(VoiceViewResponse voiceViewResponse, int i) {
    ...
    /* JADX WARNING: type inference failed for: r4v4, types: [tgf$a] */
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r4v0
      assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], ?[OBJECT, ARRAY], java.lang.String, tgf$a]
    ...
    private static java.util.List<defpackage.tgf.a> b(com.spotify.voice.model.VoiceViewResponse r7, int r8) {
        /*
        ...
        L_0x0015:
            ...
            com.spotify.voice.model.VoiceViewResponse$Body r1 = (com.spotify.voice.model.VoiceViewResponse.Body) r1
            com.spotify.voice.model.VoiceViewResponse$Body$Target r2 = r1.target()
            com.spotify.voice.model.VoiceViewResponse$Body$Text r3 = r1.text()
            r4 = 0
            if (r2 == 0) goto L_0x008c
            java.lang.String r5 = r2.uri()
            boolean r5 = defpackage.fax.a(r5)
        ...
        L_0x006c:
            tgf$a$a r2 = r2.b(r3)
            com.spotify.voice.model.VoiceViewResponse$Body$Images r1 = r1.images()
            if (r1 == 0) goto L_0x0080
            com.spotify.voice.model.VoiceViewResponse$Body$Images$Image r1 = r1.main()
            if (r1 == 0) goto L_0x0080
        ...
        L_0x0092:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.tgh.b(com.spotify.voice.model.VoiceViewResponse, int):java.util.List");
    }
}
