...
public final class mqc extends guh {
    public final ViewGroup a;
    private final RecyclerView b = ((RecyclerView) ip.c((View) this.a, (int) R.id.feed_body_recycler));
    private final RecyclerView c;

    public mqc(Context context, ViewGroup viewGroup) {
