...
public final class wll {
    public static final wll a = new wll(new LinkedHashSet(new a().a), null);
    final Set<b> b;
    final wof c;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof wll) {
            wll wll = (wll) obj;
            if (wmk.a((Object) this.c, (Object) wll.c) && this.b.equals(wll.b)) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        wof wof = this.c;
        return ((wof != null ? wof.hashCode() : 0) * 31) + this.b.hashCode();
    }
    ...
    public final void a(String str, List<Certificate> list) {
        ...
        if (!list2.isEmpty()) {
            ...
            List<Certificate> a2 = wof != null ? wof.a(list3, str3) : list3;
            int size = a2.size();
