...
public final class ezj extends u {
    boolean a;
    boolean b;
    boolean c;
    ...
    public ezj(Context context, int i) {
        if (i == 0) {
            ...
            i = context.getTheme().resolveAttribute(R.attr.bottomSheetDialogTheme, typedValue, true) ? typedValue.resourceId : 2132017710;
        }
        super(context, i);
        this.a = true;
        this.b = true;
    ...
    private View a(int i, View view, LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(R.id.touch_outside).setOnClickListener(new OnClickListener() {
            public final void onClick(View view) {
                if (ezj.this.a && ezj.this.isShowing()) {
                    ezj ezj = ezj.this;
                    if (!ezj.c) {
                        TypedArray obtainStyledAttributes = ezj.getContext().obtainStyledAttributes(new int[]{16843611});
                        ezj.b = obtainStyledAttributes.getBoolean(0, true);
