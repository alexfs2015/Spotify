...
class alh {
    ...
    public static synchronized com.facebook.appevents.PersistedEvents a() {
        /*
            ...
            monitor-enter(r0)
            android.content.Context r1 = defpackage.akq.g()     // Catch:{ all -> 0x0062 }
            r2 = 0
            java.lang.String r3 = "AppEventsLogger.persistedevents"
            java.io.FileInputStream r3 = r1.openFileInput(r3)     // Catch:{ FileNotFoundException -> 0x004e, Exception -> 0x003e, all -> 0x0030 }
            alh$a r4 = new alh$a     // Catch:{ FileNotFoundException -> 0x004e, Exception -> 0x003e, all -> 0x0030 }
            ...
            defpackage.ank.a(r4)     // Catch:{ all -> 0x0062 }
        ...
        L_0x0030:
            r3 = move-exception
        L_0x0031:
            defpackage.ank.a(r2)     // Catch:{ all -> 0x0062 }
            java.lang.String r2 = "AppEventsLogger.persistedevents"
        ...
        L_0x0066:
            goto L_0x0065
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.alh.a():com.facebook.appevents.PersistedEvents");
    }

    public static synchronized void a(alf alf) {
        synchronized (alh.class) {
            PersistedEvents a2 = a();
            for (AccessTokenAppIdPair accessTokenAppIdPair : alf.a()) {
                a2.a(accessTokenAppIdPair, alf.a(accessTokenAppIdPair).b());
            }
            a(a2);
        }
    }

    public static synchronized void a(AccessTokenAppIdPair accessTokenAppIdPair, all all) {
        synchronized (alh.class) {
            PersistedEvents a2 = a();
            if (a2.events.containsKey(accessTokenAppIdPair)) {
                a2.a(accessTokenAppIdPair).addAll(all.b());
            } else {
                a2.a(accessTokenAppIdPair, all.b());
            }
            a(a2);
        }
    }
    ...
    private static void a(com.facebook.appevents.PersistedEvents r6) {
        /*
            ...
            android.content.Context r1 = defpackage.akq.g()
            r2 = 0
        ...
        L_0x0030:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.alh.a(com.facebook.appevents.PersistedEvents):void");
    }
}
