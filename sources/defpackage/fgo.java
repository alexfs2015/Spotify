...
public final class fgo {
    ...
    public static synchronized fgo a() {
        fgo fgo;
    ...
    private final int a(android.content.Context r6, android.content.Intent r7) {
        ...
        L_0x00e3:
            ...
            android.content.ComponentName r6 = defpackage.kw.a_(r6, r7)     // Catch:{ SecurityException -> 0x012a, IllegalStateException -> 0x0102 }
            goto L_0x00f4
        L_0x00f0:
        ...
        L_0x0135:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fgo.a(android.content.Context, android.content.Intent):int");
    }
}
