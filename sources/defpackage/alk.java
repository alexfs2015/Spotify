...
class alk {
    private static final String a = alk.class.getCanonicalName();
    private static final HashMap<String, Method> b = new HashMap<>();
    private static final HashMap<String, Class<?>> c = new HashMap<>();
    private static final String d = akc.g().getPackageName();
    private static final SharedPreferences e = akc.g().getSharedPreferences("com.facebook.internal.SKU_DETAILS", 0);
    private static final SharedPreferences f = akc.g().getSharedPreferences("com.facebook.internal.PURCHASE", 0);
    private static final SharedPreferences g = akc.g().getSharedPreferences("com.facebook.internal.PURCHASE_SUBS", 0);
    ...
    private static SubscriptionType a(Context context, String str, Object obj) {
        ...
        try {
            ...
            if (subscriptionType2 == null) {
                if (!string2.isEmpty()) {
                    if (currentTimeMillis - jSONObject2.getLong(str5) > 43200) {
                        subscriptionType2 = SubscriptionType.HEARTBEAT;
                    } else {
    ...
    private static java.util.ArrayList<java.lang.String> a(android.content.Context r12, java.lang.Object r13, java.lang.String r14, java.util.Set<java.lang.Integer> r15) {
        ...
        L_0x0079:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.alk.a(android.content.Context, java.lang.Object, java.lang.String, java.util.Set):java.util.ArrayList");
    }
