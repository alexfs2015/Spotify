...
public final class qkv extends jsn {
    public qkv(Resources resources) {
        super(resources);
    }
    ...
    public final String a(boolean z) {
        if (z) {
            return a(R.string.free_tier_taste_onboarding_artist_picker_next, new Object[0]);
        }
        return a(R.string.free_tier_taste_onboarding_artist_picker_done, new Object[0]);
    }
