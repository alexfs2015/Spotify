...
public final class png implements Callable<String> {
    private final Context a;
    private final int b;

    public png(Context context, int i) {
    ...
    public java.lang.String call() {
        ...
        L_0x0033:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.png.call():java.lang.String");
    }
}
