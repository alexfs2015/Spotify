...
public final class mid {
    ...
    public mid(Context context, mia mia) {
        this.b = context;
        this.c = mia;
    ...
    public final Drawable a(SpotifyIconV2 spotifyIconV2) {
        int b2 = uts.b(32.0f, this.b.getResources());
    ...
    public final Drawable a(SpotifyIconV2 spotifyIconV2, int i, int i2) {
        ...
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(this.b, spotifyIconV2, (float) uts.b(32.0f, this.b.getResources()));
