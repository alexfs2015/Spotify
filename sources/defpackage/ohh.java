...
public final class ohh {
    ...
    /* renamed from: ohh$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0062:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ohh.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public ohh(jty jty, vxa vxa, uun uun) {
        this.e = (jty) fbp.a(jty);
        this.f = (vxa) fbp.a(vxa);
        this.g = uun;
    }
    ...
    public /* synthetic */ String a(IdentifierTokenSignupResponse identifierTokenSignupResponse) {
        if (identifierTokenSignupResponse.status().isOk()) {
            return (String) fbp.a(identifierTokenSignupResponse.status().asOk().oneTimeToken());
        }
    ...
    public final Single<String> c() {
        ...
        fbp.a(this.b);
        fbp.a(this.c);
        IdentifierTokenSignupRequestBody build = IdentifierTokenSignupRequestBody.builder().identifierToken(this.b).gender(this.d).birthDay(this.c.get(5)).birthMonth(this.c.get(2) + 1).birthYear(this.c.get(1)).iAgree(true).appVersion(Integer.toString(852900828)).build();
        vxa vxa = this.f;
        if (!fbo.a(vxa.b)) {
            build = build.withCreationPoint(vxa.b);
        }
        return vxa.a.a(build).f(new $$Lambda$ohh$dywG4uuCqmpbb5paFOUjbzeBu9w(this));
    }
}
