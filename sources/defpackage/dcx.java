...
final class dcx implements dfi {
    private final dcv a;
    private int b;
    private int c;
    private int d = 0;
    ...
    dcx(dcv dcv) {
        this.a = (dcv) ddr.a(dcv, "input");
        this.a.c = this;
    }

    private final Object a(zzbes zzbes, Class<?> cls, dde dde) {
        switch (dcy.a[zzbes.ordinal()]) {
            case 1:
    ...
    private final <T> T c(dfj<T> dfj, dde dde) {
        int m = this.a.m();
    ...
    private final <T> T d(dfj<T> dfj, dde dde) {
        int i = this.c;
        this.c = ((this.b >>> 3) << 3) | 4;
        try {
            T a2 = dfj.a();
    ...
    public final <T> T a(dfj<T> dfj, dde dde) {
        a(2);
        return c(dfj, dde);
    }
    ...
    public final <T> void a(List<T> list, dfj<T> dfj, dde dde) {
        int a2;
        int i = this.b;
        if ((i & 7) == 2) {
            do {
    ...
    public final <K, V> void a(java.util.Map<K, V> r8, defpackage.dek<K, V> r9, defpackage.dde r10) {
        /*
            r7 = this;
            r0 = 2
            r7.a(r0)
        ...
        L_0x006c:
            goto L_0x006b
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dcx.a(java.util.Map, dek, dde):void");
    }
    ...
    public final <T> T b(dfj<T> dfj, dde dde) {
        a(3);
        return d(dfj, dde);
    }
    ...
    public final <T> void b(List<T> list, dfj<T> dfj, dde dde) {
        int a2;
        int i = this.b;
        if ((i & 7) == 3) {
            do {
