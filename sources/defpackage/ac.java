...
public class ac extends af implements gn {
    ...
    private int c(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        if (a3 == null) {
            ...
            if (next == 2) {
                a3 = xmlPullParser.getName().equals("animated-vector") ? ru.a(context, resources, xmlPullParser, attributeSet, theme) : VERSION.SDK_INT >= 21 ? Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet, theme) : Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet);
            } else {
                StringBuilder sb = new StringBuilder();
                sb.append(xmlPullParser.getPositionDescription());
                sb.append(str);
    ...
    private int d(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        if (a3 == null) {
            ...
            if (next == 2) {
                a3 = xmlPullParser.getName().equals("vector") ? sa.a(resources, xmlPullParser, attributeSet, theme) : VERSION.SDK_INT >= 21 ? Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet, theme) : Drawable.createFromXmlInner(resources, xmlPullParser, attributeSet);
            } else {
                StringBuilder sb = new StringBuilder();
                sb.append(xmlPullParser.getPositionDescription());
                sb.append(str);
    ...
    public boolean onStateChange(int[] r19) {
        ...
        L_0x00ba:
            ...
            goto L_0x00d9
        L_0x00c2:
            boolean r3 = r10 instanceof defpackage.ru
            if (r3 == 0) goto L_0x00ce
            ac$c r7 = new ac$c
            ru r10 = (defpackage.ru) r10
            r7.<init>(r10)
            goto L_0x00d9
        L_0x00ce:
