...
public final class ack {
    ...
    public static void a(Path path, float f2, float f3, float f4) {
        ...
        if (f2 == 1.0f && f3 == 0.0f) {
            ...
            if (min >= length && max >= length) {
                min = (float) acj.a(min, length);
                max = (float) acj.a(max, length);
            }
            if (min < 0.0f) {
                min = (float) acj.a(min, length);
            }
    ...
    public static void a(Path path, yq yqVar) {
        if (yqVar != null) {
            a(path, ((Float) yqVar.b.d()).floatValue() / 100.0f, ((Float) yqVar.c.d()).floatValue() / 100.0f, ((Float) yqVar.d.d()).floatValue() / 360.0f);
        }
    }
