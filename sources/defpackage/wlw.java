...
public final class wlw {
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof wlw) && Arrays.equals(((wlw) obj).a, this.a);
    }
    ...
    public static wlw a(String... strArr) {
        ...
        if (str == null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (charAt <= ' ' || charAt >= 127) {
                    throw new IllegalArgumentException(wmk.a("Unexpected char %#04x at %d in header name: %s", Integer.valueOf(charAt), Integer.valueOf(i), str));
                }
            }
        } else {
        ...
        if (str != null) {
            ...
            while (i < length) {
                ...
                if ((charAt > 31 || charAt == 9) && charAt < 127) {
                    ...
                    throw new IllegalArgumentException(wmk.a("Unexpected char %#04x at %d in %s value: %s", Integer.valueOf(charAt), Integer.valueOf(i), str2, str));
                }
            }
            return;
        }
