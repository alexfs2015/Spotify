...
public final class arh implements AudioSink {
    ...
    public static class b implements a {
        ...
        public final aql a(aql aql) {
            ...
            arm.h();
            aro aro = this.c;
            float a2 = bdw.a(aql.b, 0.1f, 8.0f);
            if (aro.c != a2) {
                aro.c = a2;
                aro.f = null;
            }
            aro.h();
            aro aro2 = this.c;
            float a3 = bdw.a(aql.c, 0.1f, 8.0f);
            if (aro2.d != a3) {
                aro2.d = a3;
                aro2.f = null;
            }
            aro2.h();
            return new aql(a2, a3, aql.d);
        }
        ...
        public final long a(long j) {
            ...
            aro aro = this.c;
            if (aro.h < 1024) {
                double d = (double) aro.c;
                double d2 = (double) j;
                Double.isNaN(d);
                Double.isNaN(d2);
                j2 = (long) (d * d2);
            } else if (aro.e == aro.b) {
                j2 = bdw.b(j, aro.g, aro.h);
            } else {
                return bdw.b(j, aro.g * ((long) aro.e), aro.h * ((long) aro.b));
            }
            return j2;
        }
    ...
    static final class c {
        ...
        /* synthetic */ c(aql aql, long j, long j2, byte b2) {
            this(aql, j, j2);
        }

        private c(aql aql, long j, long j2) {
            this.a = aql;
            this.b = j;
            this.c = j2;
        }
    ...
    /* renamed from: arh$d */
    final class d implements defpackage.are.a {
        private d() {
        }

        /* synthetic */ d(arh arh, byte b) {
            this();
        }
        ...
        public final void a(long j, long j2, long j3, long j4) {
            ...
            sb.append(j4);
            sb.append(str);
            sb.append(arh.this.p());
            sb.append(str);
            sb.append(arh.this.q());
            String sb2 = sb.toString();
            boolean z = arh.a;
            bdd.c("AudioTrack", sb2);
        }
        ...
        public final void a(long j) {
            ...
            sb.append(j);
            bdd.c("AudioTrack", sb.toString());
        }

        public final void a(int i, long j) {
            if (arh.this.m != null) {
                arh.this.m.a(i, j, SystemClock.elapsedRealtime() - arh.this.ab);
            }
        }
    }

    public arh(aqz aqz, AudioProcessor[] audioProcessorArr) {
        this(aqz, audioProcessorArr, false);
    }

    private arh(aqz aqz, AudioProcessor[] audioProcessorArr, boolean z2) {
        this(aqz, (a) new b(audioProcessorArr), false);
    }

    private arh(aqz aqz, a aVar, boolean z2) {
        this.c = aqz;
        this.d = (a) bcu.a(aVar);
        this.e = z2;
        this.j = new ConditionVariable(true);
        this.k = new are(new d(this, 0));
        this.f = new arg();
        this.g = new arp();
        ArrayList arrayList = new ArrayList();
        Collections.addAll(arrayList, new AudioProcessor[]{new arl(), this.f, this.g});
        Collections.addAll(arrayList, aVar.a());
        this.h = (AudioProcessor[]) arrayList.toArray(new AudioProcessor[arrayList.size()]);
        this.i = new AudioProcessor[]{new arj()};
        this.O = 1.0f;
        this.M = 0;
        this.v = aqy.a;
        this.Y = 0;
        this.Z = new arf(0, 0.0f);
        this.A = aql.a;
        this.V = -1;
    ...
    public final boolean a(int i2) {
        if (bdw.c(i2)) {
            return i2 != 4 || bdw.a >= 21;
        }
        aqz aqz = this.c;
        if (aqz != null) {
            if (Arrays.binarySearch(aqz.a, i2) >= 0) {
                return true;
            }
        }
        return false;
    ...
    public final void a(int r9, int r10, int r11, int r12, int[] r13, int r14, int r15) {
        /*
            r8 = this;
            r8.r = r11
            boolean r12 = defpackage.bdw.c(r9)
            r8.p = r12
            boolean r12 = r8.e
            r0 = 1
            r1 = 0
            ...
            if (r12 == 0) goto L_0x001e
            boolean r12 = defpackage.bdw.d(r9)
            if (r12 == 0) goto L_0x001e
            r12 = 1
            goto L_0x001f
        L_0x001e:
        ...
        L_0x001f:
            ...
            int r12 = defpackage.bdw.b(r9, r10)
            r8.F = r12
        L_0x002b:
            boolean r12 = r8.p
            r2 = 4
        ...
        L_0x00b1:
            ...
            java.lang.String r2 = defpackage.bdw.b
        ...
        L_0x00e1:
            ...
            int r9 = r8.u
            int r9 = defpackage.bdw.b(r9, r10)
            goto L_0x00f8
        L_0x00f7:
            r9 = -1
        L_0x00f8:
        ...
        L_0x0110:
            ...
            int r10 = (int) r9
            int r9 = defpackage.bdw.a(r12, r11, r10)
            goto L_0x0164
        L_0x0135:
            int r9 = r8.u
        ...
        L_0x017c:
            goto L_0x017b
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.arh.a(int, int, int, int, int[], int, int):void");
    }
    ...
    public final boolean a(java.nio.ByteBuffer r24, long r25) {
        ...
        L_0x007a:
            r4.g = r9
            boolean r9 = defpackage.bdw.c(r14)
            r4.k = r9
            boolean r9 = r4.k
        ...
        L_0x0139:
            ...
            int r4 = defpackage.aqx.a()
            goto L_0x0173
        L_0x0140:
            if (r4 != r7) goto L_0x0147
            int r4 = defpackage.aqx.a(r24)
            goto L_0x0173
        L_0x0147:
            r7 = 14
            if (r4 != r7) goto L_0x015b
            int r4 = defpackage.aqx.b(r24)
            r7 = -1
            if (r4 != r7) goto L_0x0154
            r4 = 0
            goto L_0x0173
        L_0x0154:
            int r4 = defpackage.aqx.a(r1, r4)
            int r4 = r4 << 4
            goto L_0x0173
        L_0x015b:
        ...
        L_0x0186:
            ...
            arh$a r7 = r0.d
            aql r17 = r7.a(r4)
            java.util.ArrayDeque<arh$c> r4 = r0.l
            arh$c r7 = new arh$c
        ...
        L_0x0276:
            ...
            defpackage.bdd.c(r6, r1)
            r23.i()
            goto L_0x024f
        L_0x0281:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.arh.a(java.nio.ByteBuffer, long):boolean");
    }
    ...
    public final void c() {
        if (!this.W && o() && m()) {
            ...
            long q2 = q();
            are.q = are.d();
            are.o = SystemClock.elapsedRealtime() * 1000;
            are.r = q2;
            this.o.stop();
            this.E = 0;
            this.W = true;
    ...
    private boolean m() {
        ...
        L_0x0044:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.arh.m():boolean");
    }
    ...
    private AudioTrack r() {
        ...
        if (bdw.a >= 21) {
            ...
            int i2 = this.Y;
            audioTrack = new AudioTrack(audioAttributes2, build, this.y, 1, i2 != 0 ? i2 : 0);
        } else {
            int f2 = bdw.f(this.v.c);
            int i3 = this.Y;
            if (i3 == 0) {
                audioTrack = new AudioTrack(f2, this.s, this.t, this.u, this.y, 1);
            } else {
                audioTrack = new AudioTrack(f2, this.s, this.t, this.u, this.y, 1, i3);
            }
        }
