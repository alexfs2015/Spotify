...
public final class wka {
    public static wjv a(String str, Object obj) {
        return a(str, new Object[]{obj});
    }

    public static wjv a(String str, Object obj, Object obj2) {
    ...
    public static wjv a(String str, Object[] objArr) {
        int i;
        Throwable a = a(objArr);
        if (str == null) {
            return new wjv(null, objArr, a);
        }
        if (objArr == null) {
            return new wjv(str);
        }
        ...
        while (i2 < objArr.length) {
            ...
            if (indexOf != -1) {
                ...
                return new wjv(str, objArr, a);
            } else {
                stringBuffer.append(str.substring(i3, str.length()));
                return new wjv(stringBuffer.toString(), objArr, a);
            }
        }
        stringBuffer.append(str.substring(i3, str.length()));
        ...
        return new wjv(stringBuffer.toString(), objArr, null);
    }
