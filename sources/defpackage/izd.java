...
public final class izd {
    ...
    public izd(a aVar, DisplayMetrics displayMetrics) {
        this.a = aVar;
        this.b = displayMetrics;
    }

    public final Optional<Bitmap> a(wsj<wmg> wsj) {
        if (!wsj.a() || wsj.b() == null) {
            return Optional.e();
        }
        try {
            InputStream d = ((wmg) wsj.b()).d();
    ...
    public final com.google.common.base.Optional<android.graphics.Bitmap> b(defpackage.wsj<defpackage.wmg> r23) {
        /*
            r22 = this;
            r0 = r23
            boolean r1 = r23.a()
        ...
        L_0x002a:
            ...
            wmg r0 = (defpackage.wmg) r0     // Catch:{ IOException | IllegalArgumentException -> 0x00bf }
        ...
        L_0x00cd:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.izd.b(wsj):com.google.common.base.Optional");
    }
}
