...
final class dgm extends dgk {
    ...
    private static int a(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return dgj.b(i, dgh.a(bArr, j));
        }
        if (i2 == 2) {
            return dgj.b(i, (int) dgh.a(bArr, j), (int) dgh.a(bArr, j + 1));
        }
    ...
    public final int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < c && j4 < j5) {
                long j7 = j4 + j;
                dgh.a(bArr2, j4, (byte) charAt3);
                j3 = j;
                j2 = j7;
            } else if (charAt3 < 2048 && j4 <= j5 - 2) {
                long j8 = j4 + j;
                dgh.a(bArr2, j4, (byte) ((charAt3 >>> 6) | 960));
                long j9 = j8 + j;
                dgh.a(bArr2, j8, (byte) ((charAt3 & '?') | 128));
                j2 = j9;
                j3 = j;
                i6++;
                c = 128;
                ...
                long j11 = j4 + j;
                dgh.a(bArr2, j4, (byte) ((charAt3 >>> 12) | 480));
                long j12 = j11 + j;
                dgh.a(bArr2, j11, (byte) (((charAt3 >>> 6) & 63) | 128));
                long j13 = j12 + 1;
                dgh.a(bArr2, j12, (byte) ((charAt3 & '?') | 128));
                j2 = j13;
                j3 = 1;
            } else if (j4 <= j5 - 4) {
                int i7 = i6 + 1;
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j14 = j4 + 1;
                        dgh.a(bArr2, j4, (byte) ((codePoint >>> 18) | 240));
                        long j15 = j14 + 1;
                        dgh.a(bArr2, j14, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j16 = j15 + 1;
                        dgh.a(bArr2, j15, (byte) (((codePoint >>> 6) & 63) | 128));
                        j3 = 1;
                        j2 = j16 + 1;
                        dgh.a(bArr2, j16, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                        i6++;
                        c = 128;
                        long j102 = j3;
    ...
    public final int b(byte[] r13, int r14, int r15) {
        ...
        L_0x0018:
            ...
            long r10 = r8 + r6
            byte r0 = defpackage.dgh.a(r13, r8)
        ...
        L_0x002c:
            ...
            long r8 = r4 + r6
            byte r14 = defpackage.dgh.a(r13, r4)
        ...
        L_0x0067:
            int r15 = r15 + -2
            long r10 = r4 + r6
            byte r4 = defpackage.dgh.a(r13, r4)
        ...
        L_0x007d:
            long r4 = r10 + r6
            byte r14 = defpackage.dgh.a(r13, r10)
        ...
        L_0x008d:
            int r15 = r15 + -3
            long r10 = r4 + r6
            byte r0 = defpackage.dgh.a(r13, r4)
        ...
        L_0x00d4:
            goto L_0x00d3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dgm.b(byte[], int, int):int");
    }
}
