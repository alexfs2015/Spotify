...
public final class vvo {
    public final String a(Context context) {
        ...
        if (TextUtils.isEmpty(b)) {
            ...
            if (a != 0) {
                vuu.a().a(str, "Generating Crashlytics ApiKey from google_app_id in Strings");
        ...
        if (TextUtils.isEmpty(b)) {
            ...
            if (vuu.b() || CommonUtils.h(context)) {
        ...
        try {
            ...
            try {
                if ("@string/twitter_consumer_secret".equals(string)) {
                    vuu.a().a(str, "Ignoring bad default value for Fabric ApiKey set by FirebaseUI-Auth");
                } else {
                    str2 = string;
                }
                if (str2 != null) {
                ...
                vuu.a().a(str, "Falling back to Crashlytics key lookup from Manifest");
    ...
    protected static String c(Context context) {
        ...
        if (a == 0) {
            vuu.a().a("Fabric", "Falling back to Crashlytics key lookup from Strings");
