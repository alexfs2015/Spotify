...
public final class ezg extends ezf {
    ...
    public ezg(VisibilityAwareImageButton visibilityAwareImageButton, ezz ezz) {
        super(visibilityAwareImageButton, ezz);
    }
    ...
    public final void a(ColorStateList colorStateList, Mode mode, ColorStateList colorStateList2, int i) {
        ...
        this.k = new RippleDrawable(ezx.a(colorStateList2), drawable, null);
        this.m = this.k;
        this.A.a(this.k);
    }
    ...
    public final void a(Rect rect) {
        if (this.A.b()) {
            ...
            int ceil = (int) Math.ceil((double) ezy.b(elevation, a2, false));
            int ceil2 = (int) Math.ceil((double) ezy.a(elevation, a2, false));
