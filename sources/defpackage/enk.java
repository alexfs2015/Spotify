...
final class enk extends emh<Float> implements ent<Float>, eoz, RandomAccess {
    private float[] b;
    private int c;
    ...
    public final /* synthetic */ ent a(int i) {
        if (i >= this.c) {
            return new enk(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        c();
        enp.a(collection);
        if (!(collection instanceof enk)) {
            return super.addAll(collection);
        }
        enk enk = (enk) collection;
        int i = enk.c;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(enk.b, 0, this.b, this.c, enk.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
