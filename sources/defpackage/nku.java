...
public final class nku implements wig<gwm> {
    ...
    private nku(wzi<Activity> wzi, wzi<a> wzi2, wzi<gxw> wzi3, wzi<rnu> wzi4, wzi<has> wzi5, wzi<Map<String, gxk>> wzi6) {
        this.a = wzi;
        this.b = wzi2;
        this.c = wzi3;
        this.d = wzi4;
    ...
    public static nku a(wzi<Activity> wzi, wzi<a> wzi2, wzi<gxw> wzi3, wzi<rnu> wzi4, wzi<has> wzi5, wzi<Map<String, gxk>> wzi6) {
        nku nku = new nku(wzi, wzi2, wzi3, wzi4, wzi5, wzi6);
        return nku;
    }
