...
public final class gsl {
    ...
    public gsl(Context context, int i, int i2) {
        this.a = context;
        this.b = i;
        this.c = i2;
    }
    ...
    public final Drawable a(final View view) {
        ...
        final $$Lambda$gsl$SNyVm4F3gf0cUkFQJy_Je0eGpNI r1 = new $$Lambda$gsl$SNyVm4F3gf0cUkFQJy_Je0eGpNI(animationDrawable);
    ...
    private static SpotifyIconDrawable b(Context context, SpotifyIconV2 spotifyIconV2, int i, int i2) {
        ...
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(context, spotifyIconV2, (float) uts.b(32.0f, context.getResources()));
