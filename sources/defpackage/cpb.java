...
public final class cpb {
    ...
    public cpb(Activity activity, View view, OnGlobalLayoutListener onGlobalLayoutListener, OnScrollChangedListener onScrollChangedListener) {
        this.a = activity;
        this.b = view;
    ...
    private final void f() {
        ...
        if (activity != null && this.c) {
            ...
            if (onGlobalLayoutListener != null) {
                ViewTreeObserver a2 = a(activity);
                if (a2 != null) {
                    bkc.g().a(a2, onGlobalLayoutListener);
                }
            }
            OnScrollChangedListener onScrollChangedListener = this.g;
            if (onScrollChangedListener != null) {
