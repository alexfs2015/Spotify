...
public final class wxu {
    private static final wyc a = wyd.a(wxu.class);
    ...
    public static String a(final String str, String str2) {
        if (str == null) {
            ...
            String str3 = null;
            try {
                str3 = System.getSecurityManager() == null ? System.getProperty(str) : (String) AccessController.doPrivileged(new PrivilegedAction<String>() {
