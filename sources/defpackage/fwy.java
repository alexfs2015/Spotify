...
public final class fwy extends fww {
    ...
    public fwy(PrettyHeaderView prettyHeaderView, ImageView imageView, View view, int i, fxn fxn) {
        super(prettyHeaderView, imageView, view, i);
        this.p = fxn;
        this.t = new fwv(this.b);
        this.v = uuu.b(imageView.getContext(), 16842836);
    }
