...
public final class fbc extends bet {
    ...
    private fbc(Context context, asu<asy> asu, boolean z2, long j, Handler handler, kcs kcs, int i) {
        super(context, awp.a, j, asu, z2, handler, kcs, i);
        this.B = kcs;
    }

    public static fbc a(Context context, asu<asy> asu, boolean z2, long j, Handler handler, bex bex, int i) {
        fbc fbc = new fbc(context, asu, true, 5000, handler, new kcs(bex, handler), 50);
        return fbc;
    }
    ...
    public final void a(long j, long j2) {
        ...
        if (surface != null && surface.isValid() && this.A) {
            ...
            if (!kcs.b) {
                kcs.b = true;
                kcs.a.post(new Runnable(surface2) {
