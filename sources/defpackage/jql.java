...
public class jql extends LinearLayout {
    ...
    public jql(Context context) {
        ...
        int b2 = uts.b(16.0f, getResources());
        setPadding(b2, 0, b2, uts.b(6.0f, getResources()));
        setGravity(17);
        setOrientation(1);
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(getContext(), SpotifyIconV2.RELEASED, (float) uts.b(32.0f, getContext().getResources()));
        ...
        SpotifyIconDrawable spotifyIconDrawable2 = new SpotifyIconDrawable(getContext(), SpotifyIconV2.TIME, (float) uts.b(32.0f, getContext().getResources()));
