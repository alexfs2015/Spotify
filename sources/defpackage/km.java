...
public abstract class km {
    ...
    public final km a(Fragment fragment, String str) {
        a(0, fragment, str, 1);
        return this;
    }

    public final km a(int i2, Fragment fragment) {
        a(i2, fragment, (String) null, 1);
        return this;
    }

    public final km a(int i2, Fragment fragment, String str) {
        a(i2, fragment, str, 1);
        return this;
    }
    ...
    public final km b(int i2, Fragment fragment, String str) {
        if (i2 != 0) {
            a(i2, fragment, str, 2);
            return this;
        }
    ...
    public km a(Fragment fragment) {
        b(new a(3, fragment));
        return this;
    }

    public km b(Fragment fragment) {
        b(new a(6, fragment));
        return this;
    }

    public final km c(Fragment fragment) {
        b(new a(7, fragment));
        return this;
    }

    public km a(Fragment fragment, State state) {
        b(new a(10, fragment, state));
        return this;
    }

    public final km a(int i2, int i3) {
        return a(i2, i3, 0, 0);
    }

    public final km a(int i2, int i3, int i4, int i5) {
        this.d = i2;
        this.e = i3;
        this.f = i4;
        this.g = i5;
    ...
    public final km a(View view, String str) {
        if (kn.a()) {
            String q2 = ip.q(view);
            if (q2 != null) {
                if (this.p == null) {
    ...
    public final km a(Runnable runnable) {
        g();
        if (this.s == null) {
