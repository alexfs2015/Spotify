...
public final class fzd extends ReplacementSpan {
    private final int a;
    private final Paint b;
    private final Drawable c;
    private final Rect d;

    public fzd(Context context, int i) {
        this(context, R.attr.pasteTextStyleLabel, i);
    }

    private fzd(Context context, int i, int i2) {
        this.d = new Rect();
        this.a = i2;
        TextView textView = (TextView) fzz.a(context, TextView.class, null, i);
