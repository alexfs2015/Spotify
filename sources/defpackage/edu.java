...
public abstract class edu extends dkp implements eds {
    public edu() {
    ...
    public final boolean dispatchTransaction(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x00c4:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.edu.dispatchTransaction(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
