...
public final class bdh {
    ...
    public static defpackage.bdh.b a(byte[] r21, int r22, int r23) {
        /*
            bdk r0 = new bdk
            r1 = r21
            r2 = r22
        ...
        L_0x0180:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bdh.a(byte[], int, int):bdh$b");
    }

    public static a b(byte[] bArr, int i, int i2) {
        bdk bdk = new bdk(bArr, 3, i2);
        bdk.a(8);
        int e = bdk.e();
        int e2 = bdk.e();
        bdk.a();
        return new a(e, e2, bdk.b());
    }
    ...
    public static int a(byte[] r7, int r8, int r9, boolean[] r10) {
        ...
        L_0x00ba:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bdh.a(byte[], int, int, boolean[]):int");
    }
