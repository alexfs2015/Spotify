...
public final class bdh implements bde {
    public static final bdh a = new bdh(Collections.emptyMap());
    final Map<String, byte[]> b;
    private int c;

    private bdh(Map<String, byte[]> map) {
        this.b = Collections.unmodifiableMap(map);
    }

    public static bdh a(DataInputStream dataInputStream) {
        ...
        return new bdh(hashMap);
    }

    private static Map<String, byte[]> a(Map<String, byte[]> map, bdg bdg) {
    ...
    public final bdh a(bdg bdg) {
        Map a2 = a(this.b, bdg);
        return a(a2) ? this : new bdh(a2);
    }
