...
public final class fak {
    ...
    public fak(TextInputLayout textInputLayout) {
            ...
            AnonymousClass1 r0 = new AnimatorListenerAdapter() {
                public final void onAnimationEnd(Animator animator) {
                    ...
                    if (textView != null) {
                        ...
                        if (i7 == 1 && fak.this.f != null) {
                            fak.this.f.setText(null);
                        }
                    }
                }
    ...
    public final boolean d() {
        if (this.c != 1 || this.f == null || TextUtils.isEmpty(this.d)) {
            return false;
        }
        return true;
    }
