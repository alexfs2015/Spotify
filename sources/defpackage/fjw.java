...
public class fjw implements Closeable, Flushable {
    ...
    private fjw a(int i2, String str) {
        i();
        a(i2);
        this.e.write(str);
        return this;
    ...
    private fjw a(int i2, int i3, String str) {
        int f2 = f();
        if (f2 != i3 && f2 != i2) {
