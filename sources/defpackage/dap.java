...
public final class dap implements dbp {
    private final SecretKeySpec a;
    private final int b;
    private final int c = ((Cipher) dbe.a.a("AES/CTR/NoPadding")).getBlockSize();

    public dap(byte[] bArr, int i) {
    ...
    public final byte[] a(byte[] bArr) {
        ...
        if (length <= Integer.MAX_VALUE - i) {
            ...
            int i2 = this.b;
            Cipher cipher = (Cipher) dbe.a.a("AES/CTR/NoPadding");
