...
public final class nt {
    ...
    public nt(ViewGroup viewGroup) {
        this.a = viewGroup;
    }

    public static a a(Context context, AttributeSet attributeSet) {
        a aVar;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.ns.a.a);
        float fraction = obtainStyledAttributes.getFraction(defpackage.ns.a.k, 1, 1, -1.0f);
        if (fraction != -1.0f) {
            aVar = new a();
            aVar.a = fraction;
        } else {
        ...
        float fraction2 = obtainStyledAttributes.getFraction(defpackage.ns.a.c, 1, 1, -1.0f);
        if (fraction2 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction3 = obtainStyledAttributes.getFraction(defpackage.ns.a.g, 1, 1, -1.0f);
        if (fraction3 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction4 = obtainStyledAttributes.getFraction(defpackage.ns.a.f, 1, 1, -1.0f);
        if (fraction4 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction5 = obtainStyledAttributes.getFraction(defpackage.ns.a.j, 1, 1, -1.0f);
        if (fraction5 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction6 = obtainStyledAttributes.getFraction(defpackage.ns.a.h, 1, 1, -1.0f);
        if (fraction6 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction7 = obtainStyledAttributes.getFraction(defpackage.ns.a.d, 1, 1, -1.0f);
        if (fraction7 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction8 = obtainStyledAttributes.getFraction(defpackage.ns.a.i, 1, 1, -1.0f);
        if (fraction8 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction9 = obtainStyledAttributes.getFraction(defpackage.ns.a.e, 1, 1, -1.0f);
        if (fraction9 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
        ...
        float fraction10 = obtainStyledAttributes.getFraction(defpackage.ns.a.b, 1, 1, -1.0f);
        if (fraction10 != -1.0f) {
            if (aVar == null) {
                aVar = new a();
            }
