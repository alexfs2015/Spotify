...
public final class vw implements InvocationHandler {
    private int a = 3000;
    private int b;
    ...
    public vw(Context context, vx vxVar) {
        this.i = we.a("com.adjust.sdk.play.InstallReferrer", new Class[]{Context.class, vx.class, vr.class}, context, vxVar, this.d);
        this.f = context;
        this.c = new AtomicBoolean(false);
        this.b = 0;
        this.g = new ww(new Runnable() {
    ...
    public final void a() {
        ...
        if (obj != null) {
            try {
                we.a(obj, "startConnection", (Class[]) null, new Object[0]);
                return;
            } catch (Exception e2) {
    ...
    private Object a(Context context) {
        try {
            return we.a(we.a("com.android.installreferrer.api.InstallReferrerClient", "newBuilder", new Class[]{Context.class}, context), "build", (Class[]) null, new Object[0]);
    ...
    private void a(Class cls, Object obj) {
        try {
            we.a(this.e, "startConnection", new Class[]{cls}, obj);
        } catch (InvocationTargetException e2) {
            if (wm.a((Exception) e2)) {
                this.d.f("InstallReferrer encountered an InvocationTargetException %s", wm.b((Exception) e2));
            }
        } catch (Exception e3) {
    ...
    private Object c() {
        ...
        try {
            return we.a(obj, "getInstallReferrer", (Class[]) null, new Object[0]);
        } catch (Exception e2) {
    ...
    private String a(Object obj) {
        ...
        try {
            return (String) we.a(obj, "getInstallReferrer", (Class[]) null, new Object[0]);
        } catch (Exception e2) {
    ...
    private long b(Object obj) {
        ...
        try {
            return ((Long) we.a(obj, "getReferrerClickTimestampSeconds", (Class[]) null, new Object[0])).longValue();
        } catch (Exception e2) {
    ...
    private long c(Object obj) {
        ...
        try {
            return ((Long) we.a(obj, "getInstallBeginTimestampSeconds", (Class[]) null, new Object[0])).longValue();
        } catch (Exception e2) {
    ...
    private void e() {
        ...
        if (obj != null) {
            try {
                we.a(obj, "endConnection", (Class[]) null, new Object[0]);
