...
public final class cnn {
    ...
    public cnn(Context context, String str) {
        this(context);
        this.b = str;
    }
    ...
    public final void a() {
        try {
            ...
            String str = !TextUtils.isEmpty(bkc.o().a()) ? "Creative Preview (Enabled)" : "Creative Preview";
            String str2 = bkc.o().b() ? "Troubleshooting (Enabled)" : "Troubleshooting";
            ArrayList arrayList = new ArrayList();
            int a2 = a((List<String>) arrayList, "Ad Information", true);
            int a3 = a((List<String>) arrayList, str, ((Boolean) dqe.f().a(dtg.cM)).booleanValue());
            int a4 = a((List<String>) arrayList, str2, ((Boolean) dqe.f().a(dtg.cN)).booleanValue());
            Builder builder = new Builder(this.a, bkc.g().f());
            builder.setTitle("Select a Debug Mode").setItems((CharSequence[]) arrayList.toArray(new String[0]), new cnp(this, a2, a3, a4));
            builder.create().show();
    ...
    public final void a(MotionEvent motionEvent) {
        if (((Boolean) dqe.f().a(dtg.cO)).booleanValue()) {
            ...
            if (i2 != -1) {
                ...
                if (i2 == 0 && actionMasked == 5) {
                    ...
                    this.p.postDelayed(this.q, ((Long) dqe.f().a(dtg.cP)).longValue());
                    return;
                } else if (this.f == 5) {
                    if (pointerCount == 2) {
                        if (actionMasked == 2) {
    ...
    public final void b() {
        ...
        L_0x000b:
            ...
            r1.<init>()
            defpackage.bkc.e()
            java.util.Map r0 = defpackage.cmu.a(r0)
        ...
        L_0x0070:
            ...
            android.content.DialogInterface$OnClickListener r0 = defpackage.cnr.a
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cnn.b():void");
    }
