...
public final class xaf {
    ...
    private xaf(String str, String str2, String str3, String str4) {
        this.d = str;
        this.a = str2;
        this.e = str3;
        this.f = str4;
    ...
    public static xaf a(String str) {
        ...
        if (matcher.lookingAt()) {
            ...
            return new xaf(str, lowerCase, lowerCase2, str2);
        }
    ...
    public static xaf b(String str) {
        try {
            return a(str);
    ...
    public final boolean equals(Object obj) {
        return (obj instanceof xaf) && ((xaf) obj).d.equals(this.d);
    }
