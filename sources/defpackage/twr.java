...
public final class twr {
    ...
    public twr(RxResolver rxResolver, rnf rnf) {
        this.a = rxResolver;
        this.b = rnf.a().a();
    }
    ...
    private <T> Observable<T> a(String str, String str2, Class<T> cls) {
        ...
        sb.append(str2);
        return rxResolver.resolve(new Request(str, sb.toString())).c((Function<? super T, ? extends R>) new $$Lambda$twr$qoV45WvyWKSebGk3XEOkyancwU4<Object,Object>(this, str2, cls));
    }
