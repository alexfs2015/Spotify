...
public final class we {
    ...
    static Map<String, String> a(Context context, vr vrVar) {
        try {
            Object a = a("com.adjust.sdk.imei.Util", "getImeiParameters", new Class[]{Context.class, vr.class}, context, vrVar);
