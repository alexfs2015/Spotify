...
public final class fmp extends fmw {
    ...
    public final boolean[] a(String str) {
        if (str.length() == 8) {
            ...
            while (i <= 3) {
                int i2 = i + 1;
                a += a(zArr, a, fmv.e[Integer.parseInt(str.substring(i, i2))], false);
                i = i2;
            }
            ...
            while (i3 <= 7) {
                int i4 = i3 + 1;
                a2 += a(zArr, a2, fmv.e[Integer.parseInt(str.substring(i3, i4))], true);
                i3 = i4;
            }
