...
public final class nz extends oq {
        ...
        if (z || z2 || z4 || z3) {
                ...
                AnonymousClass1 r6 = new Runnable() {
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            nzVar.e.add(uVar);
                            ViewPropertyAnimator duration = animate.setDuration(nzVar.i);
                ...
                AnonymousClass2 r62 = new Runnable() {
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            u uVar = aVar.a;
                            View view = null;
                            View view2 = uVar == null ? null : uVar.o;
                            u uVar2 = aVar.b;
                            if (uVar2 != null) {
                                view = uVar2.o;
                            }
                            if (view2 != null) {
                                ViewPropertyAnimator duration = view2.animate().setDuration(nzVar.j);
                                nzVar.g.add(aVar.a);
                            ...
                            if (view != null) {
                                ViewPropertyAnimator animate = view.animate();
                                nzVar.g.add(aVar.b);
                                animate.translationX(0.0f).translationY(0.0f).setDuration(nzVar.j).alpha(1.0f).setListener(new AnimatorListenerAdapter(aVar, animate, view) {
                                    private /* synthetic */ a a;
                                    private /* synthetic */ ViewPropertyAnimator b;
                                    private /* synthetic */ View c;
            ...
            if (z4) {
                ...
                AnonymousClass3 r5 = new Runnable() {
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            ViewPropertyAnimator animate = view.animate();
                            nzVar.d.add(uVar);
                            animate.alpha(1.0f).setDuration(nzVar.e()).setListener(new AnimatorListenerAdapter(uVar, view, animate) {
                                private /* synthetic */ u a;
                ...
                if (z || z2 || z3) {
                    ...
                    ip.a(((u) arrayList3.get(0)).o, (Runnable) r5, f2 + Math.max(j2, j));
                } else {
                    r5.run();
                }
            }
