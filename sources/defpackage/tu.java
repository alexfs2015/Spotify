...
public final class tu extends tv<Boolean> {
    private static final String c = sg.a("BatteryNotLowTracker");

    public tu(Context context, vb vbVar) {
        super(context, vbVar);
    }
    ...
    public final /* synthetic */ Object b() {
        ...
        if (registerReceiver == null) {
            sg.a().a(c, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
