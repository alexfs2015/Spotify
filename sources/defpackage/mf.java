...
public abstract class mf extends Service {
    ...
    class b implements DeathRecipient {
        ...
        b(String str, int i2, int i3, Bundle bundle, l lVar) {
            ...
            this.b = i2;
            this.c = i3;
            this.h = new defpackage.mg.a(str, i2, i3);
            this.i = bundle;
            this.d = lVar;
        }

        public final void binderDied() {
            mf.this.f.post(new Runnable() {
                public final void run() {
                    mf.this.d.remove(b.this.d.a());
                }
            });
        }
    }
    ...
    class d implements c {
        ...
        class a extends MediaBrowserService {
            ...
            public void onLoadChildren(String str, Result<List<MediaItem>> result) {
                ...
                mf.this.e = mf.this.b;
                mf.this.a(str, (i<List<MediaBrowserCompat.MediaItem>>) r5);
                mf.this.e = null;
            }
        }
        ...
        public final void a(final String str, Bundle bundle) {
            b(str, null);
            mf.this.f.post(new Runnable(null) {
                public final void run() {
                    for (IBinder iBinder : mf.this.d.keySet()) {
                        b bVar = (b) mf.this.d.get(iBinder);
                        d dVar = d.this;
                        String str = str;
                        Bundle bundle = null;
                        ...
                        if (list != null) {
                            for (ho hoVar : list) {
                                if (me.b(bundle, (Bundle) hoVar.b)) {
                                    mf.this.a(str, bVar, (Bundle) hoVar.b, bundle);
                                }
                            }
                        }
                    }
        ...
        public final defpackage.mf.a a(java.lang.String r12, int r13, android.os.Bundle r14) {
            /*
                r11 = this;
                r0 = -1
                r1 = 0
            ...
            L_0x005d:
                ...
                mf r3 = defpackage.mf.this
                r3.e = r0
                mf$a r12 = r3.a(r12, r13, r14)
                mf r13 = defpackage.mf.this
                r13.e = r1
            ...
            L_0x0078:
                ...
                java.util.ArrayList<mf$b> r13 = r13.c
                r13.add(r0)
            L_0x0081:
            ...
            L_0x008f:
                ...
                return r13
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.mf.d.a(java.lang.String, int, android.os.Bundle):mf$a");
        }
    ...
    class e extends d {
        ...
        class a extends a {
            ...
            public void onLoadItem(String str, Result<MediaItem> result) {
                ...
                mf.this.e = mf.this.b;
                mf.a((i<MediaBrowserCompat.MediaItem>) r4);
                mf.this.e = null;
            }
        }
    ...
    class h implements c {
        ...
        public final void a() {
            this.b = new Messenger(mf.this.f);
        }
        ...
        public final void a(final Token token) {
            mf.this.f.post(new Runnable() {
                public final void run() {
                    Iterator it = mf.this.d.values().iterator();
                    while (it.hasNext()) {
                        b bVar = (b) it.next();
                        try {
        ...
        public final void handleMessage(Message message) {
            ...
            switch (message2.what) {
                case 1:
                    ...
                    boolean z = false;
                    if (string != null) {
                        String[] packagesForUid = mfVar.getPackageManager().getPackagesForUid(i2);
                    ...
                    if (z) {
                        ...
                        AnonymousClass1 r5 = new Runnable(mVar, string, i, i2, bundle) {
                            ...
                            public final void run() {
                                ...
                                mf.this.e = bVar;
                                bVar.f = mf.this.a(this.b, this.d, this.e);
                                mf.this.e = null;
                                if (bVar.f == null) {
                                    ...
                                    try {
                                        mf.this.d.put(a2, bVar);
                                        a2.linkToDeath(bVar, 0);
                                        if (mf.this.g != null) {
                                            this.a.a(bVar.f.a, mf.this.g, bVar.f.b);
                                        }
                ...
                case 2:
                    k kVar2 = this.a;
                    mf.this.f.a(new Runnable(new m(message2.replyTo)) {
                        private /* synthetic */ l a;
                        ...
                        public final void run() {
                            b bVar = (b) mf.this.d.remove(this.a.a());
                            if (bVar != null) {
                ...
                case 4:
                    ...
                    mf.this.f.a(new Runnable(new m(message2.replyTo), string3, a3) {
                        private /* synthetic */ l a;
                        private /* synthetic */ String b;
                        private /* synthetic */ IBinder c;
                        ...
                        public final void run() {
                            ...
                            if (!mf.this.a(this.b, bVar, this.c)) {
                ...
                case 5:
                    ...
                    if (!TextUtils.isEmpty(string4) && iVar != null) {
                        mf.this.f.a(new Runnable(mVar3, string4, iVar) {
                            private /* synthetic */ l a;
                            private /* synthetic */ String b;
                    ...
                    if (!TextUtils.isEmpty(string6) && iVar2 != null) {
                        ...
                        AnonymousClass8 r10 = new Runnable(mVar5, string6, bundle4, iVar2) {
                            ...
                            public final void run() {
                                ...
                                mfVar.e = bVar;
                                mfVar.a(str, bundle, (i<List<MediaBrowserCompat.MediaItem>>) r5);
                                mfVar.e = null;
                                if (!r5.b()) {
    ...
    public final void a(String str, b bVar, IBinder iBinder, Bundle bundle) {
        ...
        for (ho hoVar : list) {
            if (iBinder == hoVar.a && me.a(bundle, (Bundle) hoVar.b)) {
                return;
            }
        }
    ...
    public final void a(String str, b bVar, Bundle bundle, Bundle bundle2) {
        ...
        AnonymousClass1 r0 = new i<List<MediaBrowserCompat.MediaItem>>(str) {
            ...
            public final /* synthetic */ void a(Object obj) {
                List list = (List) obj;
                if (mf.this.d.get(bVar2.d.a()) != bVar2) {
                    if (mf.a) {
