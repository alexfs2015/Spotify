...
public final class ept {
    ...
    private ept(byte[] bArr, int i, int i2) {
    ...
    private ept(ByteBuffer byteBuffer) {
        this.a = byteBuffer;
        this.a.order(ByteOrder.LITTLE_ENDIAN);
    }

    public static ept a(byte[] bArr, int i) {
        return new ept(bArr, 0, i);
    }
    ...
    public final void a(int i, epz epz) {
        c(i, 2);
        a(epz);
    }
    ...
    public static int b(int i, epz epz) {
        int c2 = c(i << 3);
        int e = epz.e();
        return c2 + c(e) + e;
    }
