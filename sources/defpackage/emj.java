...
final class emj extends emh<Boolean> implements ent<Boolean>, eoz, RandomAccess {
    private boolean[] b;
    private int c;
    ...
    private emj(boolean[] zArr, int i) {
        this.b = zArr;
        this.c = i;
    }
    ...
    public final /* synthetic */ ent a(int i) {
        if (i >= this.c) {
            return new emj(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Boolean> collection) {
        c();
        enp.a(collection);
        if (!(collection instanceof emj)) {
            return super.addAll(collection);
        }
        emj emj = (emj) collection;
        int i = emj.c;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(emj.b, 0, this.b, this.c, emj.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
