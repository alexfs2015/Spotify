...
public final class xng<E> extends xni<E> {
    private static int g = Integer.getInteger("jctools.spsc.max.lookahead.step", 4096).intValue();
    private static final long h;
    private static final long i;
    private static final long j = ((long) xnm.a.arrayBaseOffset(Object[].class));
    ...
    static {
        ...
        try {
            h = xnm.a.objectFieldOffset(xnl.class.getDeclaredField("producerIndex"));
            try {
                i = xnm.a.objectFieldOffset(xni.class.getDeclaredField("consumerIndex"));
    ...
    private long a() {
        return xnm.a.getLongVolatile(this, i);
    }

    private static <E> Object a(E[] eArr, long j2) {
        return xnm.a.getObjectVolatile(eArr, j2);
    }

    private void a(long j2) {
        xnm.a.putOrderedLong(this, h, j2);
    }

    private static void a(Object[] objArr, long j2, Object obj) {
        xnm.a.putOrderedObject(objArr, j2, obj);
    }
    ...
    private void b(long j2) {
        xnm.a.putOrderedLong(this, i, j2);
    }
    ...
    public final int size() {
        long a = a();
        while (true) {
            long longVolatile = xnm.a.getLongVolatile(this, h);
            long a2 = a();
            if (a == a2) {
