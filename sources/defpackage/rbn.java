...
abstract class rbn extends b {
    ...
    /* renamed from: rbn$a */
    static final class a extends defpackage.rbq.b.a {
        private String a;
        private String b;
        private String c;
        ...
        public final defpackage.rbq.b.a a(String str) {
            this.a = str;
            return this;
        }

        public final defpackage.rbq.b.a b(String str) {
            if (str != null) {
                this.b = str;
                return this;
            }
        ...
        public final defpackage.rbq.b.a c(String str) {
            if (str != null) {
                this.c = str;
                return this;
            }
        ...
        public final defpackage.rbq.b.a a(SpotifyIconV2 spotifyIconV2) {
        ...
        public final defpackage.rbq.b.a b(SpotifyIconV2 spotifyIconV2) {
            if (spotifyIconV2 != null) {
        ...
        public final defpackage.rbq.b.a a(boolean z) {
        ...
        public final b a() {
            ...
            if (str.isEmpty()) {
                rbp rbp = new rbp(this.a, this.b, this.c, this.d, this.e, this.f.booleanValue());
                return rbp;
            }
    ...
    rbn(String str, String str2, String str3, SpotifyIconV2 spotifyIconV2, SpotifyIconV2 spotifyIconV22, boolean z) {
        if (str != null) {
            this.f = str;
            if (str2 != null) {
                this.a = str2;
    ...
    public final defpackage.rbq.b.a g() {
        return new a(this, 0);
    }
}
