...
public class ala {
    ...
    public static final String e = ala.class.getCanonicalName();
    ...
    public static class b implements OnGlobalLayoutListener, OnScrollChangedListener, Runnable {
        ...
        private static boolean a(android.view.View r5, com.facebook.appevents.codeless.internal.PathComponent r6, int r7) {
            ...
            L_0x0056:
                ...
                java.lang.String r3 = defpackage.alf.b(r5)
                java.lang.String r4 = defpackage.amw.c(r3)
                java.lang.String r4 = defpackage.amw.a(r4, r2)
            ...
            L_0x00ac:
                ...
                java.lang.String r3 = defpackage.alf.c(r5)
                java.lang.String r4 = defpackage.amw.c(r3)
                java.lang.String r4 = defpackage.amw.a(r4, r2)
                boolean r3 = r7.equals(r3)
            ...
            L_0x00eb:
                java.lang.String r7 = defpackage.amw.c(r5)
                java.lang.String r7 = defpackage.amw.a(r7, r2)
            ...
            L_0x0100:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ala.b.a(android.view.View, com.facebook.appevents.codeless.internal.PathComponent, int):boolean");
        }
        ...
        private void a(a aVar, View view, EventBinding eventBinding) {
            if (eventBinding != null) {
                try {
                    ...
                    if (a2 != null) {
                        View f = alf.f(a2);
                        if (f != null && alf.a(a2, f)) {
                            a(aVar, view, f, eventBinding);
                        } else if (!a2.getClass().getName().startsWith("com.facebook.react")) {
                            String str = aVar.a;
                            AccessibilityDelegate d2 = alf.d(a2);
                            boolean z = true;
                            boolean z2 = d2 != null;
                            boolean z3 = z2 && (d2 instanceof defpackage.akz.a);
                            if (!z3 || !((defpackage.akz.a) d2).a) {
                                z = false;
                            }
                            if (!this.d.containsKey(str) && (!z2 || !z3 || !z)) {
                                a2.setAccessibilityDelegate(akz.a(eventBinding, view, a2));
                                this.d.put(str, eventBinding.a);
                            }
                        }
                    }
                } catch (FacebookException e2) {
                    Log.e(ala.e, "Failed to attach auto logging event listener.", e2);
                }
            }
        }
        ...
        private void a(a aVar, View view, View view2, EventBinding eventBinding) {
            if (eventBinding != null) {
                View a2 = aVar.a();
                if (a2 != null && alf.a(a2, view2)) {
                    String str = aVar.a;
                    OnTouchListener e2 = alf.e(a2);
                    boolean z = true;
                    boolean z2 = e2 != null;
                    boolean z3 = z2 && (e2 instanceof defpackage.alb.a);
                    if (!z3 || !((defpackage.alb.a) e2).a) {
                        z = false;
                    }
                    if (!this.d.containsKey(str) && (!z2 || !z3 || !z)) {
                        a2.setOnTouchListener(alb.a(eventBinding, view, a2));
                        this.d.put(str, eventBinding.a);
                    }
                }
            }
    ...
    public static Bundle a(EventBinding eventBinding, View view, View view2) {
        ...
        List<ale> unmodifiableList = Collections.unmodifiableList(eventBinding.d);
        if (unmodifiableList != null) {
            for (ale ale : unmodifiableList) {
                if (ale.b == null || ale.b.length() <= 0) {
                    if (ale.c.size() > 0) {
                        if (ale.d.equals("relative")) {
                            list = b.a(eventBinding, view2, ale.c, 0, -1, view2.getClass().getSimpleName());
                        } else {
                            list = b.a(eventBinding, view, ale.c, 0, -1, view.getClass().getSimpleName());
                        }
                        ...
                        while (true) {
                            ...
                            a aVar = (a) it.next();
                            if (aVar.a() != null) {
                                String b2 = alf.b(aVar.a());
                                if (b2.length() > 0) {
                                    bundle.putString(ale.a, b2);
                                    break;
                                }
                            }
                        }
