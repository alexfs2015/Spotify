    ...
    public static final ThreadFactory a(final String str) {
        ...
        return new ThreadFactory() {
            public final Thread newThread(final Runnable runnable) {
                Thread newThread = Executors.defaultThreadFactory().newThread(new wjv() {
                    public final void a() {
                        runnable.run();
                    }
                });
        ...
        AnonymousClass2 r0 = new wjv(2) {
            public final void a() {
                ...
                try {
                    ...
                    wja.a().a(str, String.format(Locale.US, "Interrupted while waiting for %s to shut down. Requesting immediate shutdown.", new Object[]{str2}));
                    executorService2.shutdownNow();
                }
            }
        };
