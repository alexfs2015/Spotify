...
public final class vgq extends AppsMusicFeaturesRemoteconfigurationProperties {
    ...
    public static final class a extends com.spotify.remoteconfig.AppsMusicFeaturesRemoteconfigurationProperties.a {
        ...
        public final AppsMusicFeaturesRemoteconfigurationProperties a() {
            ...
            if (str.isEmpty()) {
                return new vgq(this.a.booleanValue(), this.b, this.c, 0);
            }
    ...
    /* synthetic */ vgq(boolean z, ButtonColor buttonColor, Message message, byte b2) {
        this(z, buttonColor, message);
    }

    private vgq(boolean z, ButtonColor buttonColor, Message message) {
        this.a = z;
        this.b = buttonColor;
        this.c = message;
    }
