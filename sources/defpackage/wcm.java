...
public final class wcm extends wcg {
    private static final wjw h = wjx.a(wcm.class);
    private static final boolean i = wjo.a("io.netty.noKeySetOptimization", false);
    private static final int j;
    Selector b;
    int c;
    boolean d;
    private final whf k = new whf() {
        public final int a() {
            return wcm.this.i();
        }
    };
    private final Callable<Integer> l = new Callable<Integer>() {
        public final /* synthetic */ Object call() {
            return Integer.valueOf(wcm.super.d());
        }
    };
    private wcp m;
    ...
    static {
        int i2 = 0;
        if (wjo.b("sun.nio.ch.bugLevel") == null) {
            try {
        ...
        int a = wjo.a("io.netty.selectorAutoRebuildThreshold", 512);
        if (a >= 3) {
            i2 = a;
        }
        j = i2;
    ...
    wcm(wcn wcn, Executor executor, SelectorProvider selectorProvider, wcd wcd, wiq wiq) {
        super(wcn, executor, false, a, wiq);
                    ...
                    Object doPrivileged2 = AccessController.doPrivileged(new PrivilegedAction<Object>() {
                        public final Object run() {
                            try {
                                ...
                                declaredField.set(openSelector, wcp);
                                declaredField2.set(openSelector, wcp);
                                return null;
    ...
    public final void f() {
        /*
            ...
            r1 = r16
        L_0x0002:
            wcd r0 = r1.p     // Catch:{ all -> 0x0156 }
            whf r2 = r1.k     // Catch:{ all -> 0x0156 }
        ...
        L_0x0017:
            ...
            wit r6 = r16.o()     // Catch:{ CancelledKeyException -> 0x00e6 }
            r7 = 0
            if (r6 != 0) goto L_0x002e
            long r9 = defpackage.wiu.g     // Catch:{ CancelledKeyException -> 0x00e6 }
            goto L_0x0039
        L_0x002e:
            long r9 = r6.c     // Catch:{ CancelledKeyException -> 0x00e6 }
            long r11 = defpackage.wit.b     // Catch:{ CancelledKeyException -> 0x00e6 }
            long r11 = r4 - r11
            long r9 = r9 - r11
        ...
        L_0x0066:
            ...
            wjw r0 = h     // Catch:{ CancelledKeyException -> 0x00e6 }
        ...
        L_0x016a:
            ...
            goto L_0x0002
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wcm.f():void");
    }
    ...
    private void a(Set<SelectionKey> set) {
        if (!set.isEmpty()) {
            ...
            while (true) {
                ...
                it.remove();
                if (attachment instanceof wcl) {
                    a(selectionKey, (wcl) attachment);
                } else {
                    a(selectionKey, (wco) attachment);
                }
                if (!it.hasNext()) {
                    break;
                } else if (this.d) {
    ...
    private void a(SelectionKey selectionKey, wcl wcl) {
        b I = wcl.I();
    ...
    private static void a(SelectionKey selectionKey, wco<SelectableChannel> wco) {
        try {
            selectionKey.channel();
            if (!selectionKey.isValid()) {
                a(wco, selectionKey, null);
            }
        } catch (Exception e) {
            selectionKey.cancel();
            a(wco, selectionKey, e);
        } catch (Throwable th) {
            selectionKey.cancel();
            a(wco, selectionKey, null);
            throw th;
    ...
    private void y() {
        ...
        ArrayList<wcl> arrayList = new ArrayList<>(keys.size());
        for (SelectionKey selectionKey : keys) {
            Object attachment = selectionKey.attachment();
            if (attachment instanceof wcl) {
                arrayList.add((wcl) attachment);
            } else {
                selectionKey.cancel();
                a((wco) attachment, selectionKey, null);
            }
        }
        for (wcl wcl : arrayList) {
            wcl.I().b(wcl.I().i());
        }
    }

    private static void a(wco<SelectableChannel> wco, SelectionKey selectionKey, Throwable th) {
        try {
            selectionKey.channel();
        } catch (Exception e) {
    ...
    public final int d() {
        ...
        return ((Integer) submit(this.l).aX_().d()).intValue();
    }
    ...
    public final void e() {
        ...
        L_0x0046:
            ...
            boolean r7 = r5 instanceof defpackage.wcl     // Catch:{ Exception -> 0x0061 }
            if (r7 == 0) goto L_0x005e     // Catch:{ Exception -> 0x0061 }
            r7 = r5     // Catch:{ Exception -> 0x0061 }
            wcl r7 = (defpackage.wcl) r7     // Catch:{ Exception -> 0x0061 }
        ...
        L_0x0061:
            r6 = move-exception
            wjw r7 = h     // Catch:{ ConcurrentModificationException -> 0x001d }
            ...
            boolean r7 = r5 instanceof defpackage.wcl     // Catch:{ ConcurrentModificationException -> 0x001d }
            if (r7 == 0) goto L_0x007f     // Catch:{ ConcurrentModificationException -> 0x001d }
            wcl r5 = (defpackage.wcl) r5     // Catch:{ ConcurrentModificationException -> 0x001d }
            wcl$b r4 = r5.I()     // Catch:{ ConcurrentModificationException -> 0x001d }
            wcl$b r5 = r5.I()     // Catch:{ ConcurrentModificationException -> 0x001d }
            wbi r5 = r5.i()     // Catch:{ ConcurrentModificationException -> 0x001d }
            r4.b(r5)     // Catch:{ ConcurrentModificationException -> 0x001d }
            goto L_0x0025     // Catch:{ ConcurrentModificationException -> 0x001d }
        L_0x007f:
            wco r5 = (defpackage.wco) r5     // Catch:{ ConcurrentModificationException -> 0x001d }
        ...
        L_0x00b4:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wcm.e():void");
    }
}
