...
public abstract class om extends k {
    RecyclerView a;
    private Scroller b;
    ...
    public final boolean a(int r5, int r6) {
        ...
        L_0x0042:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.om.a(int, int):boolean");
    }
