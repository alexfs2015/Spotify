...
abstract class viz extends defpackage.vje.a {
    ...
    final Optional<vkg> l;
    final Optional<Integer> m;
    final int n;

    /* renamed from: viz$a */
    static final class a implements C0083a {
        ...
        private a(defpackage.vje.a aVar) {
            this.a = Optional.e();
            this.b = Optional.e();
            this.d = Optional.e();
            this.e = Optional.e();
        ...
        /* synthetic */ a(defpackage.vje.a aVar, byte b2) {
            this(aVar);
        }
        ...
        public final C0083a a(Optional<Policy> optional) {
            if (optional != null) {
                this.a = optional;
                return this;
            }
        ...
        public final defpackage.vje.a a() {
            String str = "";
            if (this.c == null) {
            ...
            if (str.isEmpty()) {
                vjb vjb = new vjb(this.a, this.b, this.c, this.d, this.e, this.f, this.g, this.h.booleanValue(), this.i.booleanValue(), this.j, this.k, this.l, this.m, this.n.intValue());
                return vjb;
            }
        ...
        public final C0083a b(Optional<way> optional) {
            if (optional != null) {
                this.b = optional;
                return this;
            }
        ...
        public final C0083a c(Optional<Boolean> optional) {
            if (optional != null) {
                this.d = optional;
                return this;
            }
        ...
        public final C0083a d(Optional<Boolean> optional) {
            if (optional != null) {
                this.e = optional;
                return this;
            }
        ...
        public final C0083a e(Optional<Boolean> optional) {
            if (optional != null) {
                this.f = optional;
                return this;
            }
        ...
        public final C0083a f(Optional<Boolean> optional) {
            if (optional != null) {
                this.g = optional;
                return this;
            }
        ...
        public final C0083a g(Optional<Boolean> optional) {
            if (optional != null) {
                this.j = optional;
                return this;
            }
        ...
        public final C0083a h(Optional<Boolean> optional) {
            if (optional != null) {
                this.k = optional;
                return this;
            }
        ...
        public final C0083a i(Optional<vkg> optional) {
            if (optional != null) {
                this.l = optional;
                return this;
            }
        ...
        public final C0083a j(Optional<Integer> optional) {
            if (optional != null) {
                this.m = optional;
                return this;
            }
    ...
    viz(Optional<Policy> optional, Optional<way> optional2, String str, Optional<Boolean> optional3, Optional<Boolean> optional4, Optional<Boolean> optional5, Optional<Boolean> optional6, boolean z, boolean z2, Optional<Boolean> optional7, Optional<Boolean> optional8, Optional<vkg> optional9, Optional<Integer> optional10, int i2) {
        if (optional != null) {
            this.a = optional;
            if (optional2 != null) {
                this.b = optional2;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof defpackage.vje.a) {
            defpackage.vje.a aVar = (defpackage.vje.a) obj;
