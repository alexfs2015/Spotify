...
public final class wsr implements Comparable<wsr> {
    public static final wsr a = a(100, "Continue");
    public final int b;
    private final wvc c;
    ...
    public wsr(int i, String str) {
        this(i, str, false);
    }

    private wsr(int i, String str, boolean z) {
        if (i < 0) {
            ...
            this.b = i;
            this.c = new wvc(Integer.toString(i));
            this.d = str;
            if (z) {
                ...
                sb3.append(" ");
                sb3.append(str);
                this.e = sb3.toString().getBytes(wvh.b);
                return;
            }
            this.e = null;
        } else {
    ...
    private static wsr a(int i, String str) {
        return new wsr(i, str, true);
    }

    public final /* bridge */ /* synthetic */ int compareTo(Object obj) {
        return this.b - ((wsr) obj).b;
    }

    public final boolean equals(Object obj) {
        return (obj instanceof wsr) && this.b == ((wsr) obj).b;
    }
