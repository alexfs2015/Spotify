...
public final class bx {
    ...
    private StaticLayout b(CharSequence charSequence, Alignment alignment, int i2, int i3) {
        ...
        try {
            obtain.setTextDirection(VERSION.SDK_INT >= 29 ? this.l.getTextDirectionHeuristic() : (TextDirectionHeuristic) a((Object) this.l, "getTextDirectionHeuristic", (T) TextDirectionHeuristics.FIRSTSTRONG_LTR));
        ...
        if (b()) {
            if (this.i) {
                if (this.l.getMeasuredHeight() > 0 && this.l.getMeasuredWidth() > 0) {
                    int measuredWidth = VERSION.SDK_INT >= 29 ? this.l.isHorizontallyScrollable() : ((Boolean) a((Object) this.l, "getHorizontallyScrolling", (T) Boolean.FALSE)).booleanValue() ? 1048576 : (this.l.getMeasuredWidth() - this.l.getTotalPaddingLeft()) - this.l.getTotalPaddingRight();
                    int height = (this.l.getHeight() - this.l.getCompoundPaddingBottom()) - this.l.getCompoundPaddingTop();
                    if (measuredWidth > 0 && height > 0) {
                        synchronized (f) {
                            f.setEmpty();
                            f.right = (float) measuredWidth;
