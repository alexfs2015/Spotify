...
final class pz implements pu {
    private final a a;

    /* renamed from: pz$a */
    static class a extends SQLiteOpenHelper {
        private py[] a;
        private defpackage.pu.a b;
        private boolean c;

        a(Context context, String str, final py[] pyVarArr, final defpackage.pu.a aVar) {
            super(context, str, null, aVar.a, new DatabaseErrorHandler() {
                ...
                /* JADX WARNING: Code restructure failed: missing block: B:14:0x0045, code lost:
                    defpackage.pu.a.a((java.lang.String) ((android.util.Pair) r3.next()).second);
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:15:0x0053, code lost:
                    defpackage.pu.a.a(r3.f());
                 */
                ...
                public final void onCorruption(android.database.sqlite.SQLiteDatabase r3) {
                    /*
                        r2 = this;
                        pu$a r0 = defpackage.pu.a.this
                        py[] r0 = r9
                        py r3 = defpackage.pz.a.a(r0, r3)
                    ...
                    L_0x0077:
                        ...
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: defpackage.pz.a.AnonymousClass1.onCorruption(android.database.sqlite.SQLiteDatabase):void");
                }
            });
            this.b = aVar;
            this.a = pyVarArr;
        ...
        private py a(SQLiteDatabase sQLiteDatabase) {
            return a(this.a, sQLiteDatabase);
        }

        static py a(py[] pyVarArr, SQLiteDatabase sQLiteDatabase) {
            py pyVar = pyVarArr[0];
            if (pyVar == null || !pyVar.a(sQLiteDatabase)) {
                pyVarArr[0] = new py(sQLiteDatabase);
            }
            return pyVarArr[0];
        }

        /* access modifiers changed from: 0000 */
        public final synchronized pt a() {
            this.c = false;
    ...
    pz(Context context, String str, defpackage.pu.a aVar) {
        this.a = new a(context, str, new py[1], aVar);
    }
