...
public final class jjk implements PlayerStateObserver {
    private ContentType a = ContentType.DEFAULT;
    private final ContentTypeChangeListener b;

    jjk(ContentTypeChangeListener contentTypeChangeListener) {
    ...
    public final void onPlayerStateReceived(PlayerState playerState) {
        ...
        if (b2.b()) {
            ContentType contentType = jva.a((String) b2.c()).b == LinkType.SHOW_EPISODE ? ContentType.SPEECH : ContentType.DEFAULT;
