...
public final class lbh {
    ...
    /* renamed from: lbh$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.lbh.AnonymousClass1.<clinit>():void");
        }
    }

    public static Observable<lbg> a(Observable<State> observable, Observable<Boolean> observable2) {
        return Observable.a((ObservableSource<? extends T1>) observable, (ObservableSource<? extends T2>) observable2, (BiFunction<? super T1, ? super T2, ? extends R>) $$Lambda$lbh$GS4mRKIBMnI_fDrelTOFzEadPgo.INSTANCE).a(Functions.a());
    }

    /* access modifiers changed from: private */
    public static lbg a(State state, boolean z) {
        if (state == State.FORCED_OFFLINE) {
            return lbg.a(OfflineReason.FORCED_OFFLINE);
        }
        if (!z) {
            return lbg.a(OfflineReason.NO_INTERNET);
        }
        int i = AnonymousClass1.a[state.ordinal()];
        return i != 1 ? i != 2 ? new a() : new c() : lbg.a(OfflineReason.AP_CONNECTION_PROBLEM);
    }
}
