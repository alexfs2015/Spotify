...
public final class ony extends PlaylistDataSourceConfiguration {
    ...
    public static final class a implements com.spotify.music.features.playlistentity.configuration.PlaylistDataSourceConfiguration.a {
        ...
        public final PlaylistDataSourceConfiguration a() {
            ...
            if (str.isEmpty()) {
                ony ony = new ony(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d, this.e, this.f, this.g, this.h.booleanValue(), this.i.booleanValue(), this.j.booleanValue(), this.k, 0);
                return ony;
            }
    ...
    private ony(boolean z, boolean z2, boolean z3, Optional<Boolean> optional, Optional<Boolean> optional2, Optional<Boolean> optional3, Optional<Integer> optional4, boolean z4, boolean z5, boolean z6, DecorationPolicy decorationPolicy) {
        this.b = z;
        this.c = z2;
        this.d = z3;
        this.e = optional;
    ...
    /* synthetic */ ony(boolean z, boolean z2, boolean z3, Optional optional, Optional optional2, Optional optional3, Optional optional4, boolean z4, boolean z5, boolean z6, DecorationPolicy decorationPolicy, byte b2) {
