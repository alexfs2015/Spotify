...
final class wxf {
    ...
    static {
        /*
            java.lang.Class<wxf> r0 = defpackage.wxf.class
            ...
            long r7 = defpackage.wxr.a(r1)     // Catch:{ all -> 0x004e }
        ...
        L_0x005a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wxf.<clinit>():void");
    }
    ...
    static void a(ByteBuffer byteBuffer) {
        if (a != -1 && byteBuffer.isDirect()) {
            if (e || b != null || c) {
                try {
                    Object a2 = wxr.a((Object) byteBuffer, a);
                    if (a2 == null) {
                        return;
                    }
                    if (c) {
