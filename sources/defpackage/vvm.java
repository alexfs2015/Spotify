...
final class vvm implements vvn {
    ...
    static final class a implements ServiceConnection {
        ...
        public final IBinder a() {
            if (this.a) {
                vuu.a().e("Fabric", "getBinder already called");
            }
            this.a = true;
            try {
    ...
    static final class b implements IInterface {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:6:?, code lost:
            defpackage.vuu.a().a("Fabric", "Could not get parcel from Google Play Service to capture AdvertisingId");
         */
        ...
        public final java.lang.String a() {
            ...
            L_0x0022:
                ...
                goto L_0x0037
            L_0x0024:
                vvc r2 = defpackage.vuu.a()     // Catch:{ all -> 0x0022 }
            ...
            L_0x0037:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.vvm.b.a():java.lang.String");
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:?, code lost:
            defpackage.vuu.a().a("Fabric", "Could not get parcel from Google Play Service to capture Advertising limitAdTracking");
         */
        /* JADX WARNING: Failed to process nested try/catch */
        ...
        public final boolean b() {
            ...
            L_0x0023:
                ...
                goto L_0x0037
            L_0x0025:
                vvc r3 = defpackage.vuu.a()     // Catch:{ all -> 0x0023 }
            ...
            L_0x0037:
                ...
                throw r2
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.vvm.b.b():boolean");
        }
    }
    ...
    public final vvj a() {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            vuu.a().a(str2, "AdvertisingInfoServiceStrategy cannot be called on the main thread");
            return null;
        }
        try {
            ...
            try {
                if (this.a.bindService(intent, aVar, 1)) {
                    try {
                        b bVar = new b(aVar.a());
                        vvj vvj = new vvj(bVar.a(), bVar.b());
                        this.a.unbindService(aVar);
                        return vvj;
                    } catch (Exception e) {
                        vuu.a().b(str2, "Exception in binding to Google Play Service to capture AdvertisingId", e);
                        this.a.unbindService(aVar);
                    }
                } else {
                    vuu.a().a(str2, str);
            ...
            vuu.a().a(str2, "Unable to find Google Play Services package name");
            return null;
        } catch (Exception e2) {
            vuu.a().a(str2, "Unable to determine if Google Play Services is available", (Throwable) e2);
            return null;
        }
    }
}
