...
public final class gmn {
    ...
    public gmn(Context context, String str, jro jro, Scheduler scheduler, ghm ghm, boolean z) {
        this.a = context;
        this.b = str;
        this.c = jro;
        this.d = scheduler;
        DebugFlag debugFlag = DebugFlag.PRE_SIGN_UP_EXPERIMENT_TEST_ENDPOINT;
        this.e = (gmm) ghm.a(gmm.class);
        this.f = z;
    }
    ...
    public final Observable<PreSignupExperimentFlags> a() {
        ...
        if (b3 != null) {
            ...
            single = this.e.a(str, str2, b2).f(new $$Lambda$gmn$GgvnzNHomkuSBowq_S4adnUDE4(this));
        }
    ...
    private com.spotify.libs.pse.model.PreSignupExperimentFlags b() {
        ...
        L_0x007a:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gmn.b():com.spotify.libs.pse.model.PreSignupExperimentFlags");
    }
}
