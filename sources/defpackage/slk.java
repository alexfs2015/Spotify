...
public final class slk extends LinearLayout {
    public int a = -7829368;
    public TrackLyrics b;
    private final LyricsAppearance c;

    public slk(Context context, int i, LyricsAppearance lyricsAppearance) {
        super(context);
    ...
    public final void onMeasure(int i, int i2) {
        ...
        if (trackLyrics != null) {
            ...
            if ("プチリリ".equals(provider)) {
                if (TrackLyrics.KIND_TEXT.equals(trackLyrics.getKind())) {
                    ...
                    if (providerAndroidIntent != null) {
                        textView.setOnClickListener(new $$Lambda$slk$i5ObuOVpqiosxDC3RnXIo3YtTU(this, providerAndroidIntent));
                    }
                }
            }
            ...
            textView.setText(jrw.a(fau.a(str2).a((Iterable<?>) arrayList)));
            addView(textView);
        }
        super.onMeasure(i, i2);
    }
    ...
    public /* synthetic */ void a(ProviderAndroidIntent providerAndroidIntent, View view) {
        ...
        try {
            ...
            if (sli.a(context, intent)) {
                return;
            }
        } catch (NameNotFoundException unused) {
            Logger.b("Application not installed: %s", providerAndroidPackage);
        } catch (Throwable th) {
            sli.a(context, sli.a(providerAndroidPackage));
            throw th;
        }
        sli.a(context, sli.a(providerAndroidPackage));
    }
