...
final class mow extends u {
    ...
    mow(View view, Picasso picasso, LayoutInflater layoutInflater) {
        super(view);
        ...
        this.a.a((h) new h() {
            public final void a(Rect rect, View view, RecyclerView recyclerView, s sVar) {
                ...
                if (e != -1) {
                    i d = recyclerView.d();
                    if (d != null) {
                        rect.set(e == 0 ? mow.this.e : mow.this.d, 0, e == d.t() + -1 ? mow.this.e : mow.this.d, 0);
                    }
                }
            }
        }, -1);
