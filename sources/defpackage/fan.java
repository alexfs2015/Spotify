...
public final class fan {
    ...
    public fan(Context context, int i2) {
        ...
        this.a = fam.a(context, obtainStyledAttributes, a.cL);
        this.f = fam.a(context, obtainStyledAttributes, a.cM);
        this.g = fam.a(context, obtainStyledAttributes, a.cN);
        ...
        this.k = fam.a(context, obtainStyledAttributes, a.cO);
        ...
        try {
            ...
            AnonymousClass1 r4 = new a() {
                ...
                public final void a(Typeface typeface) {
                    fan fan = fan.this;
                    fan.d = Typeface.create(typeface, fan.b);
                    fan.this.a(textPaint, typeface);
                    fan.this.c = true;
                    aVar.a(typeface);
                }
            };
