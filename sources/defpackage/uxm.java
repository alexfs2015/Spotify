...
public final class uxm {
    public static Drawable a(Context context) {
        ...
        vhl vhl = new vhl(context2, SpotifyIconV2.MIC, (float) vfj.b((float) 48, context.getResources()), (float) vfj.b((float) 96, context.getResources()), fr.c(context, R.color.white), fr.c(context, R.color.voice_floating_mic_icon));
        return vhl;
    }
