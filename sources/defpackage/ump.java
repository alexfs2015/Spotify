...
public final class ump implements ulf {
    private final umj a;
    ...
    /* renamed from: ump$3 reason: invalid class name */
    static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ump.AnonymousClass3.<clinit>():void");
        }
    }

    public ump(Picasso picasso, xir xir, umk umk, umj umj) {
        this.d = picasso;
        this.a = umj;
        this.c = umk;
        this.b = xir;
    ...
    public final View getSlateContentView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        C0082b c2 = f.c();
        TextView textView = (TextView) fbp.a(inflate.findViewById(c2.b()));
        Button button = (Button) fbp.a(inflate.findViewById(c2.c()));
        this.a.a().a((TextView) fbp.a(inflate.findViewById(c2.a())));
        this.a.b().a(textView);
        ...
        if (i3 == 1) {
            ...
            this.a.c().a(imageView, this.d, new vha() {
                public final void a(int i) {
                    ip.a(inflate, (Drawable) ump.a(i));
                }
            }, this.c);
        }
        return inflate;
