...
public final class pyo implements rza, rzb {
    ...
    public final gzt a(SearchHistoryItem searchHistoryItem, int i, String str) {
        ...
        a a = builder.a(sb.toString()).a((gzr) create).a(haf.builder().a(searchHistoryItem.getTitle()).b(searchHistoryItem.getSubtitle())).a(had.builder().a(gxs.a(hag.builder().a(searchHistoryItem.getImageUri()).a(), searchHistoryItem.getTargetUri()))).a("click", pwd.a(str, searchHistoryItem.getOriginUri(), i));
        return a.a("rightAccessoryClick", pwf.a(searchHistoryItem.getOriginUri(), i)).c("secondary_icon", SpotifyIconV2.X.toString()).f(gwf.a(false)).a();
    }
}
