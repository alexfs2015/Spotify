...
public class bet extends MediaCodecRenderer {
    ...
    private final bev p = new bev(this.o);
    private final defpackage.bex.a q;
    ...
    final class b implements OnFrameRenderedListener {
        ...
        /* synthetic */ b(bet bet, MediaCodec mediaCodec, byte b) {
            this(mediaCodec);
        }
    ...
    public bet(Context context, awp awp, long j, asu<asy> asu, boolean z2, Handler handler, bex bex, int i) {
        boolean z3;
        super(2, awp, asu, z2, 30.0f);
        this.r = j;
        this.s = i;
        this.o = context.getApplicationContext();
        this.q = new defpackage.bex.a(handler, bex);
        if (ben.a <= 22) {
            if ("foster".equals(ben.b)) {
                if ("NVIDIA".equals(ben.c)) {
                    z3 = true;
                    this.t = z3;
                    this.u = new long[10];
                    this.v = new long[10];
    ...
    private static int a(defpackage.awo r7, java.lang.String r8, int r9, int r10) {
        /*
            r0 = -1
        ...
        L_0x005e:
            ...
            goto L_0x00a3
        L_0x0061:
            java.lang.String r8 = defpackage.ben.d
            java.lang.String r1 = "BRAVIA 4K 2015"
            boolean r8 = r1.equals(r8)
            if (r8 != 0) goto L_0x009f
            java.lang.String r8 = defpackage.ben.c
        ...
        L_0x008e:
            r7 = 16
            int r8 = defpackage.ben.a(r9, r7)
            int r7 = defpackage.ben.a(r10, r7)
            int r8 = r8 * r7
            int r7 = r8 << 4
            int r9 = r7 << 4
            goto L_0x00a2
        ...
        L_0x00a9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bet.a(awo, java.lang.String, int, int):int");
    }

    private static Point a(awo awo, aqv aqv) {
        int i = 0;
        boolean z2 = aqv.l > aqv.k;
        int i2 = z2 ? aqv.l : aqv.k;
        int i3 = z2 ? aqv.k : aqv.l;
        ...
        while (true) {
            ...
            if (ben.a >= 21) {
                ...
                if (awo.c == null) {
                    ...
                    VideoCapabilities videoCapabilities = awo.c.getVideoCapabilities();
                    if (videoCapabilities == null) {
                        awo.a("align.vCaps");
                    } else {
                        int widthAlignment = videoCapabilities.getWidthAlignment();
                        int heightAlignment = videoCapabilities.getHeightAlignment();
                        point = new Point(ben.a(i6, widthAlignment) * widthAlignment, ben.a(i4, heightAlignment) * heightAlignment);
                    }
                }
                if (awo.a(point.x, point.y, (double) aqv.m)) {
                    return point;
                }
            } else {
                int a2 = ben.a(i4, 16) << 4;
                int a3 = ben.a(i5, 16) << 4;
    ...
    private static boolean a(java.lang.String r6) {
        /*
            ...
            goto L_0x05d6
        L_0x0011:
            java.lang.Class<bet> r6 = defpackage.bet.class
            monitor-enter(r6)
            boolean r0 = m     // Catch:{ all -> 0x05d3 }
            if (r0 != 0) goto L_0x05cf
            java.lang.String r0 = defpackage.ben.b     // Catch:{ all -> 0x05d3 }
        ...
        L_0x05a1:
            java.lang.String r0 = defpackage.ben.d     // Catch:{ all -> 0x05d3 }
    ...
    private static int b(awo awo, aqv aqv) {
        if (aqv.g == -1) {
            return a(awo, aqv.f, aqv.k, aqv.l);
        }
        int i = 0;
        for (int i2 = 0; i2 < aqv.h.size(); i2++) {
            i += ((byte[]) aqv.h.get(i2)).length;
        }
        return aqv.g + i;
    }
    ...
    private boolean b(awo awo) {
        return ben.a >= 23 && !this.T && !a(awo.a) && (!awo.e || ber.a(this.o));
    }
    ...
    public final int a(awo awo, aqv aqv, aqv aqv2) {
        if (!awo.a(aqv, aqv2, true) || aqv2.k > this.w.a || aqv2.l > this.w.b || b(awo, aqv2) > this.w.c) {
            return 0;
        }
        return aqv.b(aqv2) ? 1 : 3;
    }
    ...
    public final int a(awp awp, asu<asy> asu, aqv aqv) {
        ...
        awo awo = (awo) a2.get(0);
        boolean a3 = awo.a(aqv);
        int i3 = awo.b(aqv) ? 16 : 8;
        if (awo.d) {
            i = 32;
        }
        return (a3 ? 4 : 3) | i3 | i;
    ...
    public final void a(MediaCodec mediaCodec, MediaFormat mediaFormat) {
        ...
        a(mediaCodec, z2 ? (mediaFormat.getInteger(str) - mediaFormat.getInteger(str4)) + 1 : mediaFormat.getInteger("width"), z2 ? (mediaFormat.getInteger(str3) - mediaFormat.getInteger(str2)) + 1 : mediaFormat.getInteger("height"));
    }

    public final void a(asm asm) {
        this.H++;
        this.V = Math.max(asm.d, this.V);
        if (ben.a < 23 && this.T) {
            e(asm.d);
        }
    }

    public final void a(awo awo, MediaCodec mediaCodec, aqv aqv, MediaCrypto mediaCrypto, float f) {
        a aVar;
        awo awo2 = awo;
        ...
        if (aqvArr.length == 1) {
            if (b2 != -1) {
                int a2 = a(awo2, aqv2.f, aqv2.k, aqv2.l);
                if (a2 != -1) {
            ...
            int i5 = i;
            for (aqv aqv3 : aqvArr) {
                if (awo2.a(aqv2, aqv3, false)) {
                    z2 |= aqv3.k == -1 || aqv3.l == -1;
                    i5 = Math.max(i5, aqv3.k);
                    int max = Math.max(i3, aqv3.l);
                    i4 = Math.max(i4, b(awo2, aqv3));
                    i3 = max;
                }
            }
            if (z2) {
                ...
                Point a3 = a(awo2, aqv2);
                if (a3 != null) {
                    i5 = Math.max(i5, a3.x);
                    i3 = Math.max(i3, a3.y);
                    i4 = Math.max(i4, a(awo2, aqv2.f, i5, i3));
        ...
        mediaFormat.setString("mime", aqv2.f);
        mediaFormat.setInteger("width", aqv2.k);
        mediaFormat.setInteger("height", aqv2.l);
        awq.a(mediaFormat, aqv2.h);
        float f3 = aqv2.m;
        if (f3 != -1.0f) {
            mediaFormat.setFloat("frame-rate", f3);
        }
        awq.a(mediaFormat, "rotation-degrees", aqv2.n);
        beq beq = aqv2.p;
        if (beq != null) {
            awq.a(mediaFormat, "color-transfer", beq.c);
            awq.a(mediaFormat, "color-standard", beq.a);
            awq.a(mediaFormat, "color-range", beq.b);
            byte[] bArr = beq.d;
            if (bArr != null) {
    ...
    public final void a(aqv[] aqvArr, long j) {
        if (this.W == -9223372036854775807L) {
            ...
            if (i == 10) {
                ...
                bdu.c("MediaCodecVideoRenderer", sb.toString());
            } else {
                this.X = i + 1;
            }
            long[] jArr = this.u;
    ...
    public final boolean a(awo awo) {
        return this.y != null || b(awo);
    }
    ...
    public void handleMessage(int i, Object obj) {
        if (i == 1) {
            ...
            if (this.y != surface) {
                ...
                if (i2 == 1 || i2 == 2) {
                    MediaCodec mediaCodec = this.h;
                    if (ben.a < 23 || mediaCodec == null || surface == null || this.x) {
                        v();
                        t();
                    } else {
    ...
    public final boolean q() {
        ...
        L_0x0036:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bet.q():boolean");
    }
