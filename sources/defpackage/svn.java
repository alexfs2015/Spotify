...
public final class svn {
    ...
    private static boolean b(UnicodeBlock unicodeBlock) {
        if (VERSION.SDK_INT >= 19) {
            return UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C.equals(unicodeBlock) || UnicodeBlock.CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D.equals(unicodeBlock) || UnicodeBlock.CJK_STROKES.equals(unicodeBlock) || UnicodeBlock.ENCLOSED_IDEOGRAPHIC_SUPPLEMENT.equals(unicodeBlock);
        }
        return false;
    }
    ...
    private static boolean e(UnicodeBlock unicodeBlock) {
        if (VERSION.SDK_INT >= 19) {
            return UnicodeBlock.HANGUL_JAMO_EXTENDED_A.equals(unicodeBlock) || UnicodeBlock.HANGUL_JAMO_EXTENDED_B.equals(unicodeBlock);
        }
        return false;
    }
}
