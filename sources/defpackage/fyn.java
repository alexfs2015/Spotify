...
public final class fyn<T extends fyb> extends fxq<T> {
    ...
    public fyn(fxs fxs, Context context, Fragment fragment, fxh fxh) {
        this.a = new TextHeaderView(context);
        this.d = fxs.d;
        this.b = fxp.b(fxs, fragment, this.a, fxs.h, fxh);
        this.b.a().c(fxs.q);
        this.b.b().a(fxs.l);
        int i = fxs.c;
        if (i == 0) {
