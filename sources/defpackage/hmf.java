...
public final class hmf implements SpotifyServiceIntentProcessor {
    private final vti<hmw> a;

    public /* synthetic */ Result a(boolean z, Intent intent, a aVar) {
        return CC.$default$a(this, z, intent, aVar);
    }

    public hmf(vti<hmw> vti) {
        this.a = vti;
    }
    ...
    public final com.spotify.mobile.android.service.plugininterfaces.SpotifyServiceIntentProcessor.Result a(boolean r7, android.content.Intent r8) {
        ...
        L_0x00a8:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hmf.a(boolean, android.content.Intent):com.spotify.mobile.android.service.plugininterfaces.SpotifyServiceIntentProcessor$Result");
    }
}
