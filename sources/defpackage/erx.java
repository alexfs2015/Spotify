...
final class erx extends Thread {
    private final Object a = new Object();
    private final BlockingQueue<erw<?>> b;
    private final /* synthetic */ eru c;

    public erx(eru eru, String str, BlockingQueue<erw<?>> blockingQueue) {
        this.c = eru;
        bwx.a(str);
        bwx.a(blockingQueue);
    ...
    public final void run() {
        ...
        L_0x0001:
            ...
            eru r1 = r5.c     // Catch:{ InterruptedException -> 0x000e }
        ...
        L_0x001b:
            java.util.concurrent.BlockingQueue<erw<?>> r1 = r5.b     // Catch:{ all -> 0x00b4 }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x00b4 }
            erw r1 = (defpackage.erw) r1     // Catch:{ all -> 0x00b4 }
        ...
        L_0x0034:
            ...
            java.util.concurrent.BlockingQueue<erw<?>> r2 = r5.b     // Catch:{ all -> 0x00b1 }
            java.lang.Object r2 = r2.peek()     // Catch:{ all -> 0x00b1 }
            if (r2 != 0) goto L_0x0053
            eru r2 = r5.c     // Catch:{ all -> 0x00b1 }
        ...
        L_0x0053:
            ...
            eru r1 = r5.c     // Catch:{ all -> 0x00b4 }
            java.lang.Object r1 = r1.g     // Catch:{ all -> 0x00b4 }
            monitor-enter(r1)     // Catch:{ all -> 0x00b4 }
            java.util.concurrent.BlockingQueue<erw<?>> r2 = r5.b     // Catch:{ all -> 0x00ae }
        ...
        L_0x0099:
            eru r1 = r5.c     // Catch:{ all -> 0x00a8 }
            eqw r1 = r1.q()     // Catch:{ all -> 0x00a8 }
            eqy r1 = r1.c     // Catch:{ all -> 0x00a8 }
        ...
        L_0x00b4:
            ...
            eru r2 = r5.c     // Catch:{ all -> 0x00f9 }
            erx r2 = r2.a     // Catch:{ all -> 0x00f9 }
            if (r5 == r2) goto L_0x00f2
            eru r2 = r5.c     // Catch:{ all -> 0x00f9 }
            erx r2 = r2.b     // Catch:{ all -> 0x00f9 }
        ...
        L_0x00e4:
            eru r2 = r5.c     // Catch:{ all -> 0x00f9 }
            eqw r2 = r2.q()     // Catch:{ all -> 0x00f9 }
            eqy r2 = r2.c     // Catch:{ all -> 0x00f9 }
        ...
        L_0x00fd:
            goto L_0x00fc
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.erx.run():void");
    }
