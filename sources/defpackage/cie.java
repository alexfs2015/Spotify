...
public final class cie {
    ...
    public final void a(Map<String, List<String>> map) {
        ...
        this.w = cko.a(a(map, "X-Afma-Rewards"));
        if (this.x == null) {
        ...
        if (a4 == null || TextUtils.isEmpty(a4)) {
            Builder buildUpon = Uri.parse("http://=").buildUpon();
            buildUpon.appendQueryParameter("id", "gmob-apps-blocked-navigation");
            if (!TextUtils.isEmpty(this.f)) {
                buildUpon.appendQueryParameter("debugDialog", this.f);
            }
            boolean booleanValue = ((Boolean) dqe.f().a(dtg.g)).booleanValue();
            String builder = buildUpon.toString();
            StringBuilder sb = new StringBuilder(String.valueOf(builder).length() + 31);
            sb.append(builder);
            sb.append("&navigationURL={NAVIGATION_URL}");
            this.A = new cgr(booleanValue, Arrays.asList(new String[]{sb.toString()}));
        } else {
            try {
                this.A = cgr.a(new JSONObject(a4));
        ...
        if (!TextUtils.isEmpty(a5)) {
            try {
                this.G = cky.a(new JSONObject(a5));
