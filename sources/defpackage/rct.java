...
public final class rct extends rdq {
    private static final Policy a;
    private final a c;
    private final iqv d;
    private final rgf e;

    /* renamed from: rct$1 reason: invalid class name */
    ...
    public static abstract class a {
        ...
        /* renamed from: rct$a$a reason: collision with other inner class name */
        public static abstract class C0077a {
            public abstract C0077a a(Optional<SortOrder> optional);

            public abstract C0077a a(boolean z);

            public abstract a a();

            public abstract C0077a b(boolean z);

            public abstract C0077a c(boolean z);
        }
    ...
    public rct(a aVar, rbg rbg, iqv iqv, rgf rgf) {
        super(rbg);
        this.c = aVar;
        this.d = iqv;
        this.e = rgf;
    ...
    public /* synthetic */ defpackage.rdc a(int r21, boolean r22, boolean r23, defpackage.rdb r24, defpackage.vlb r25) {
        /*
            r20 = this;
            java.lang.Object[] r0 = r25.getItems()
            vku[] r0 = (defpackage.vku[]) r0
        ...
        L_0x003f:
            ...
            boolean r11 = defpackage.fbo.a(r6)
        ...
        L_0x00a1:
            ...
            r7 = r21
            r9 = r24
            rdc r0 = defpackage.rdd.a(r5, r6, r7, r8, r9, r10)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rct.a(int, boolean, boolean, rdb, vlb):rdc");
    }
    ...
    public final Observable<rdc> a(rdb rdb) {
        ...
        this.d.b = rdb.c().b();
        this.d.a(false, ((Boolean) fbm.a(rdb.c().d().get("available_offline_only"), Boolean.FALSE)).booleanValue(), false);
        if (this.c.d().b()) {
            SortOrder sortOrder = (SortOrder) this.c.d().c();
            if (AnonymousClass1.a[sortOrder.ordinal()] == 1) {
                way = way.e().a("recentlyPlayedRank").a(way.e().a("addTime").a()).a();
            } else {
        ...
        boolean booleanValue = ((Boolean) fbm.a(rdb.e(), Boolean.FALSE)).booleanValue();
        boolean c2 = this.c.c();
        Observable b = this.d.a(a);
        $$Lambda$rct$JRFtxKTJPVLWE6v4Rq_5_cIGOso r0 = new $$Lambda$rct$JRFtxKTJPVLWE6v4Rq_5_cIGOso(this, a2, booleanValue, c2, rdb);
