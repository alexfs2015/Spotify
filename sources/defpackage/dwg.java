...
public abstract class dwg extends dkp implements dwf {
    public dwg() {
    ...
    public final boolean dispatchTransaction(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x009e:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dwg.dispatchTransaction(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
