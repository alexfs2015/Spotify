...
public final class fja {
    ...
    public static defpackage.fih a(defpackage.fjv r2) {
        /*
            r2.f()     // Catch:{ EOFException -> 0x0024, MalformedJsonException -> 0x001d, IOException -> 0x0016, NumberFormatException -> 0x000f }
            r0 = 0
            fin<fih> r1 = defpackage.fjp.C     // Catch:{ EOFException -> 0x000d, MalformedJsonException -> 0x001d, IOException -> 0x0016, NumberFormatException -> 0x000f }
            ...
            fih r2 = (defpackage.fih) r2     // Catch:{ EOFException -> 0x000d, MalformedJsonException -> 0x001d, IOException -> 0x0016, NumberFormatException -> 0x000f }
            return r2
        L_0x000d:
            r2 = move-exception
            goto L_0x0026
        ...
        L_0x002b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fja.a(fjv):fih");
    }

    public static void a(fih fih, fjw fjw) {
        fjp.C.a(fjw, fih);
    }
}
