...
final /* synthetic */ class fga implements Runnable {
    private final ffx a;
    ...
    public final void run() {
        ...
        L_0x0002:
            monitor-enter(r0)
            int r1 = r0.a     // Catch:{ all -> 0x00ba }
            r2 = 2
            if (r1 == r2) goto L_0x000a
            monitor-exit(r0)     // Catch:{ all -> 0x00ba }
            return
        L_0x000a:
            java.util.Queue<fge<?>> r1 = r0.d     // Catch:{ all -> 0x00ba }
        ...
        L_0x0017:
            ...
            fge r1 = (defpackage.fge) r1     // Catch:{ all -> 0x00ba }
            android.util.SparseArray<fge<?>> r3 = r0.e     // Catch:{ all -> 0x00ba }
            int r4 = r1.a     // Catch:{ all -> 0x00ba }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ba }
            ffw r3 = r0.f     // Catch:{ all -> 0x00ba }
            java.util.concurrent.ScheduledExecutorService r3 = r3.b     // Catch:{ all -> 0x00ba }
            fgb r4 = new fgb     // Catch:{ all -> 0x00ba }
        ...
        L_0x005b:
            ...
            r4.putBundle(r3, r1)
            r5.setData(r4)
            fgc r1 = r0.c     // Catch:{ RemoteException -> 0x00b0 }
            android.os.Messenger r3 = r1.a     // Catch:{ RemoteException -> 0x00b0 }
            if (r3 == 0) goto L_0x009d
            android.os.Messenger r1 = r1.a     // Catch:{ RemoteException -> 0x00b0 }
            r1.send(r5)     // Catch:{ RemoteException -> 0x00b0 }
            goto L_0x0002
        L_0x009d:
            fhe r3 = r1.b     // Catch:{ RemoteException -> 0x00b0 }
            if (r3 == 0) goto L_0x00a8
            fhe r1 = r1.b     // Catch:{ RemoteException -> 0x00b0 }
            r1.a(r5)     // Catch:{ RemoteException -> 0x00b0 }
            goto L_0x0002
        L_0x00a8:
        ...
        L_0x00be:
            goto L_0x00bd
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fga.run():void");
    }
}
