...
class ozf<T extends Plugin> {
    private final Set<T> a;

    public ozf(Set<T> set) {
        this.a = set;
    }

    /* access modifiers changed from: protected */
    public final T b(FormatListType formatListType, fqn fqn, LicenseLayout licenseLayout) {
        T t = null;
        for (T t2 : this.a) {
            boolean a2 = t2.a(formatListType, fqn);
