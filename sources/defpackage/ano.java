...
public final class ano extends aoe {
    public static final Creator<ano> CREATOR = new Creator() {
    ...
    public ano(LoginClient loginClient) {
        super(loginClient);
        this.e = ank.a(20);
    }
    ...
    public final boolean a(int r7, int r8, android.content.Intent r9) {
        ...
        L_0x0008:
            ...
            android.os.Bundle r9 = defpackage.ank.d(r9)
            java.lang.String r8 = r8.getFragment()
            android.os.Bundle r8 = defpackage.ank.d(r8)
            r9.putAll(r8)
            boolean r8 = r6.a(r9)
        ...
        L_0x0080:
            r4 = -1
        L_0x0081:
            boolean r5 = defpackage.ank.a(r8)
        ...
        L_0x00c9:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ano.a(int, int, android.content.Intent):boolean");
    }

    /* access modifiers changed from: 0000 */
    public final boolean a(c cVar) {
        amu a = FetchedAppSettingsManager.a(ank.a((Context) this.b.b.p()));
        if (!((a != null && a.d) && e() != null && (ank.e((Context) this.b.b.p()) ^ true) && anl.c(akq.g()))) {
            return false;
        }
