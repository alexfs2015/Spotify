...
public final class juo {
    ...
    public static void a(Parcel parcel, Map<String, String> map) {
        a(parcel, map, jxu.a(), jxu.a(), 0);
    }

    public static void a(Parcel parcel, Map<String, ? extends Parcelable> map, int i) {
        a(parcel, map, jxu.a(), jxu.b(), i);
    }

    private static <K, V> void a(Parcel parcel, Map<K, V> map, jxs<? super K> jxs, jxs<? super V> jxs2, int i) {
        parcel.writeInt(map.size());
        for (Entry entry : map.entrySet()) {
            fbp.a(entry.getKey());
            fbp.a(entry.getValue());
            jxs.a(entry.getKey(), parcel, i);
            jxs2.a(entry.getValue(), parcel, i);
        }
    }
