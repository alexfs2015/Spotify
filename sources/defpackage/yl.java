...
public final class yl implements yi, yk, a {
    private final Path a = new Path();
    private final String b;
    private final xq c;
    private final Type d;
    private final yr<?, Float> e;
    private final yr<?, PointF> f;
    private final yr<?, Float> g;
    private final yr<?, Float> h;
    private final yr<?, Float> i;
    private final yr<?, Float> j;
    private final yr<?, Float> k;
    private yq l;
    private boolean m;

    /* renamed from: yl$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.yl.AnonymousClass1.<clinit>():void");
        }
    }

    public yl(xq xqVar, aaq aaq, PolystarShape polystarShape) {
        this.c = xqVar;
    ...
    public final void a(List<ya> list, List<ya> list2) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            if (yaVar instanceof yq) {
                yq yqVar = (yq) yaVar;
                if (yqVar.a == ShapeTrimPath.Type.Simultaneously) {
                    this.l = yqVar;
                    this.l.a(this);
                }
            }
    ...
    public final Path e() {
        ...
        if (i2 == 1) {
            ...
            if (yrVar != null) {
                d6 = (double) ((Float) yrVar.d()).floatValue();
            }
            ...
            yr<?, Float> yrVar2 = this.j;
            float floatValue4 = yrVar2 != null ? ((Float) yrVar2.d()).floatValue() / 100.0f : 0.0f;
            yr<?, Float> yrVar3 = this.k;
            float floatValue5 = yrVar3 != null ? ((Float) yrVar3.d()).floatValue() / 100.0f : 0.0f;
            if (f17 != 0.0f) {
            ...
            yr<?, Float> yrVar4 = this.g;
            if (yrVar4 != null) {
                d6 = (double) ((Float) yrVar4.d()).floatValue();
            }
