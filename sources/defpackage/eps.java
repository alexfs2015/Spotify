...
public final class eps {
    ...
    public static eps a(byte[] bArr, int i2) {
        return new eps(bArr, 0, i2);
    }
    ...
    public final String c() {
        ...
        if (d2 >= 0) {
            ...
            int i3 = this.h;
            if (d2 <= i2 - i3) {
                String str = new String(this.a, i3, d2, epy.a);
                this.h += d2;
                return str;
            }
            throw zzzq.a();
    ...
    private eps(byte[] bArr, int i2, int i3) {
        this.a = bArr;
        this.b = 0;
        int i4 = i3 + 0;
        this.f = i4;
    ...
    public final <T extends emw<T, ?>> T a(eoh<T> eoh) {
        try {
            if (this.l == null) {
                this.l = emc.a(this.a, this.b, this.e);
            }
            int u = this.l.u();
