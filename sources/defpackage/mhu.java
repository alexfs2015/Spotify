...
public final class mhu {
    private static View a(Context context, int i, int i2, int i3, int i4, SpotifyIconDrawable spotifyIconDrawable, OnClickListener onClickListener, OnClickListener onClickListener2) {
        ...
        if (jvi.b(context) || spotifyIconDrawable == null) {
            a.a().a(vfj.b(16.0f, context.getResources()));
        } else {
    ...
    public static View a(Context context, int i, int i2, SpotifyIconDrawable spotifyIconDrawable, szp szp) {
        return a(context, i, -1, R.string.placeholder_collection_empty_browse_music_button, spotifyIconDrawable, new $$Lambda$mhu$01psdJDA54scM4r3cxlvbBOl3x4(szp));
    }
    ...
    public static View a(Context context, fqn fqn, OnClickListener onClickListener, nxo nxo) {
        View a = a(context, onClickListener, (OnClickListener) new $$Lambda$mhu$8dONQBFhKE_CDYrsM3AVG5rRDQI(nxo, fqn), (int) R.string.placeholder_collection_no_local_files_content_button);
        ((fvd) fqv.a(a.findViewById(R.id.empty), fvd.class)).b((CharSequence) context.getString(R.string.placeholder_collection_no_local_files_content_body));
        return a;
    }

    public static View a(Context context, fqn fqn, szp szp, OnClickListener onClickListener) {
        $$Lambda$mhu$CwDYZHbQtZXrpiNUcHXAveQAuvo r6 = new $$Lambda$mhu$CwDYZHbQtZXrpiNUcHXAveQAuvo(szp);
        boolean z = true;
        if (((Integer) fqn.a(nxq.a)).intValue() != 1) {
            z = false;
        }
        if (z) {
    ...
    public static SpotifyIconDrawable a(Context context, SpotifyIcon spotifyIcon) {
        ...
        spotifyIconDrawable.a(vgl.b(context, R.attr.pasteColorPlaceholder));
