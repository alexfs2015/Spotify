...
public abstract class qxk extends e {
    final String a;
    final String b;
    final String c;
    final String d;
    ...
    public static final class a extends com.spotify.music.features.yourlibrary.musicpages.item.MusicItem.e.a {
        ...
        public final e a() {
            ...
            if (str.isEmpty()) {
                qxo qxo = new qxo(this.a, this.b, this.c, this.d, this.e.booleanValue(), this.f.booleanValue(), this.g);
                return qxo;
            }
    ...
    qxk(String str, String str2, String str3, String str4, boolean z, boolean z2, String str5) {
        if (str != null) {
            this.a = str;
            if (str2 != null) {
                this.b = str2;
