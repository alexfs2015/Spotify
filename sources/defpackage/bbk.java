...
public final class bbk extends azz {
    public final long d;
    public final long e;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.bbk.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static class a {
        ...
        private a c() {
            if (this.d == null) {
                ...
                if (i2 == 1) {
                    ...
                    sb.append(this.d);
                    bdu.c("WebvttCueBuilder", sb.toString());
                    this.i = 0;
                } else {
                    this.i = 2;
                }
        ...
        public final bbk b() {
            ...
            bbk bbk = new bbk(this.a, this.b, this.c, this.d, this.e, this.f, this.g, this.h, this.i, this.j);
            return bbk;
        }
    }

    private bbk(long j, long j2, CharSequence charSequence) {
    ...
    public bbk(long j, long j2, CharSequence charSequence, Alignment alignment, float f, int i, int i2, float f2, int i3, float f3) {
        super(charSequence, alignment, f, i, i2, f2, i3, f3);
        this.d = j;
        this.e = j2;
    }

    public bbk(CharSequence charSequence) {
