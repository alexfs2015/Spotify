...
public abstract class qxi extends MusicItem {
    final long a;
    final Type b;
    final boolean c;
    final boolean d;
    ...
    public static final class a extends com.spotify.music.features.yourlibrary.musicpages.item.MusicItem.a {
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.item.MusicItem.a a(uzf uzf) {
            this.o = uzf;
            return this;
        }
        ...
        public final MusicItem a() {
            ...
            if (str.isEmpty()) {
                qxm qxm = new qxm(this.a.longValue(), this.b, this.c.booleanValue(), this.d.booleanValue(), this.e.booleanValue(), this.f.booleanValue(), this.g, this.h, this.i, this.j, this.k, this.l.intValue(), this.m.intValue(), this.n, this.o, this.p);
                return qxm;
            }
    ...
    qxi(long j2, Type type, boolean z, boolean z2, boolean z3, boolean z4, String str, String str2, String str3, String str4, String str5, int i2, int i3, Boolean bool, uzf uzf, b bVar) {
        Type type2 = type;
        String str6 = str;
        String str7 = str2;
        String str8 = str3;
        ...
        if (obj instanceof MusicItem) {
            ...
            if (this.a == musicItem.b() && this.b.equals(musicItem.a()) && this.c == musicItem.d() && this.d == musicItem.e() && this.e == musicItem.f() && this.f == musicItem.g() && this.g.equals(musicItem.h()) && this.h.equals(musicItem.i()) && this.q.equals(musicItem.j()) && this.i.equals(musicItem.k()) && this.j.equals(musicItem.l()) && this.k == musicItem.m() && this.l == musicItem.n()) {
                ...
                if (bool != null ? bool.equals(musicItem.o()) : musicItem.o() == null) {
                    uzf uzf = this.n;
                    if (uzf != null ? uzf.equals(musicItem.p()) : musicItem.p() == null) {
                        b bVar = this.o;
    ...
    public int hashCode() {
        ...
        uzf uzf = this.n;
        int hashCode4 = (hashCode3 ^ (uzf == null ? 0 : uzf.hashCode())) * 1000003;
        b bVar = this.o;
        if (bVar != null) {
            i3 = bVar.hashCode();
        }
