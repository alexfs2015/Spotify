...
public final class gam {
    ...
    public final java.util.Set<java.lang.String> a(java.lang.String r7) {
        ...
        L_0x0074:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gam.a(java.lang.String):java.util.Set");
    }
    ...
    private Set<String> b(Set<String> set) {
        HashSet hashSet = new HashSet();
        for (String str : set) {
            if (gbi.a(new File(str))) {
                hashSet.add(str);
            } else if (gbi.a(new File(str, this.c))) {
                hashSet.add(str);
            } else {
