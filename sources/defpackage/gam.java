...
public final class gam extends b {
    ...
    public gam(int i2, int i3, int i4, float f2, int i5) {
        super(d + 192);
        a(c(), c, 0.25f, 64);
    }
    ...
    private void a(FloatBuffer floatBuffer, float[] fArr, float f2, int i2) {
        boolean z = true;
        fbp.b(floatBuffer.capacity() == d + (i2 * 3));
        floatBuffer.position(0);
        floatBuffer.put(fArr, 0, fArr.length);
        fbp.b(floatBuffer.position() == fArr.length);
