...
public final class ftu implements ftv {
    final Context a;
    final Picasso b;
    final View c;
    final ImageView d;
    ...
    private final OnClickListener l = new OnClickListener() {
        public final void onClick(View view) {
            ftu.this.h.setMaxLines(Integer.MAX_VALUE);
            ftu.this.i.setVisibility(8);
        }
    };

    public ftu(Context context, Picasso picasso, String str) {
        this.a = context;
        this.b = picasso;
