...
public final class axf implements aws {
    public static final int a = ben.g("ID3");
    private final a b;
    ...
    static {
        $$Lambda$axf$U4n30UoWvF1JalWHm8l_Q0XyJI r0 = $$Lambda$axf$U4n30UoWvF1JalWHm8l_Q0XyJI.INSTANCE;
    }
    ...
    private static int a(bea bea, int i) {
        byte[] bArr = bea.a;
        int i2 = bea.b;
        while (true) {
            int i3 = i2 + 1;
    ...
    private static axb a(bea bea, int i, int i2, boolean z, int i3, a aVar) {
        bea bea2 = bea;
        int i4 = bea2.b;
        int b2 = b(bea2.a, i4);
        String str = new String(bea2.a, i4, b2 - i4, "ISO-8859-1");
        bea.c(b2 + 1);
        int i5 = bea.i();
        int i6 = bea.i();
        long g = bea.g();
        ...
        int i7 = i4 + i;
        while (bea2.b < i7) {
            axg a2 = a(i2, bea, z, i3, aVar);
            if (a2 != null) {
                arrayList.add(a2);
            }
        }
        axg[] axgArr = new axg[arrayList.size()];
        arrayList.toArray(axgArr);
        axb axb = new axb(str, i5, i6, j, j2, axgArr);
        return axb;
    }

    private static b a(bea bea) {
        String str = "Id3Decoder";
        if (bea.b() < 10) {
            bdu.c(str, "Data too short to be an ID3 tag");
            return null;
        }
        int f = bea.f();
        if (f != a) {
        ...
        if (c == 2) {
            if ((c2 & 64) != 0) {
                bdu.c(str, "Skipped ID3 tag with majorVersion=2 and undefined compression scheme");
                return null;
            }
        } else if (c == 3) {
            if ((c2 & 64) != 0) {
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [axg] */
    /* JADX WARNING: type inference failed for: r5v2, types: [axg] */
    /* JADX WARNING: type inference failed for: r5v3 */
    /* JADX WARNING: type inference failed for: r5v6, types: [axa] */
    /* JADX WARNING: type inference failed for: r5v8, types: [axc] */
    /* JADX WARNING: type inference failed for: r5v10, types: [axb] */
    /* JADX WARNING: type inference failed for: r2v16, types: [axd] */
    /* JADX WARNING: type inference failed for: r5v12 */
    /* JADX WARNING: type inference failed for: r5v13 */
    /* JADX WARNING: type inference failed for: r5v15, types: [awz] */
    /* JADX WARNING: type inference failed for: r5v17, types: [axe] */
    /* JADX WARNING: type inference failed for: r2v23, types: [axi] */
    /* JADX WARNING: type inference failed for: r2v24 */
    /* JADX WARNING: type inference failed for: r5v19 */
    /* JADX WARNING: type inference failed for: r2v26, types: [axk] */
    /* JADX WARNING: type inference failed for: r5v22, types: [axk] */
    /* JADX WARNING: type inference failed for: r5v24, types: [axj] */
    /* JADX WARNING: type inference failed for: r5v25 */
    /* JADX WARNING: type inference failed for: r5v28, types: [axj] */
    ...
    private static defpackage.axg a(int r19, defpackage.bea r20, boolean r21, int r22, defpackage.axf.a r23) {
        /*
            r0 = r19
            r7 = r20
            int r8 = r20.c()
        ...
        L_0x0113:
            ...
            axj r5 = new axj     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
        ...
        L_0x0186:
            ...
            axk r5 = new axk     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
        ...
        L_0x01b4:
            ...
            axk r2 = new axk     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
        ...
        L_0x01d2:
            ...
            axi r2 = new axi     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
        ...
        L_0x020f:
            ...
            axe r5 = new axe     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
        ...
        L_0x0264:
            ...
            java.lang.String r4 = defpackage.ben.d(r14)     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
        ...
        L_0x029a:
            ...
            java.lang.String r3 = defpackage.ben.d(r11)     // Catch:{ UnsupportedEncodingException -> 0x0170, all -> 0x016c }
            r6 = 47
        ...
        L_0x02bf:
            ...
            awz r5 = new awz     // Catch:{ UnsupportedEncodingException -> 0x039e, all -> 0x039a }
        ...
        L_0x02fc:
            ...
            axd r2 = new axd     // Catch:{ UnsupportedEncodingException -> 0x039e, all -> 0x039a }
        ...
        L_0x0333:
            ...
            r5 = r22
            r6 = r23
            axb r5 = a(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x039e, all -> 0x039a }
            goto L_0x0378
        L_0x034f:
            ...
            r5 = r22
            r6 = r23
            axc r5 = b(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x039e, all -> 0x039a }
            goto L_0x0378
        L_0x0369:
            ...
            axa r5 = new axa     // Catch:{ UnsupportedEncodingException -> 0x039e, all -> 0x039a }
        ...
        L_0x0378:
            ...
            r1 = r16
            defpackage.bdu.c(r1, r0)     // Catch:{ UnsupportedEncodingException -> 0x03a0, all -> 0x039a }
            goto L_0x03a3
        L_0x039a:
            r0 = move-exception
            r2 = r18
        ...
        L_0x03a9:
            ...
            defpackage.bdu.c(r1, r0)     // Catch:{ all -> 0x03b3 }
            r7.c(r2)
            r0 = 0
            return r0
        L_0x03b3:
        ...
        L_0x03b8:
            ...
            defpackage.bdu.c(r1, r3)
            r7.c(r2)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.axf.a(int, bea, boolean, int, axf$a):axg");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static boolean a(defpackage.bea r18, int r19, int r20, boolean r21) {
        /*
            r1 = r18
            r0 = r19
            int r2 = r1.b
        ...
        L_0x00b6:
            goto L_0x00b5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.axf.a(bea, int, int, boolean):boolean");
    }
    ...
    private static axc b(bea bea, int i, int i2, boolean z, int i3, a aVar) {
        bea bea2 = bea;
        int i4 = bea2.b;
        int b2 = b(bea2.a, i4);
        String str = "ISO-8859-1";
        String str2 = new String(bea2.a, i4, b2 - i4, str);
        bea.c(b2 + 1);
        int c = bea.c();
        boolean z2 = (c & 2) != 0;
        boolean z3 = (c & 1) != 0;
        ...
        for (int i5 = 0; i5 < c2; i5++) {
            int i6 = bea2.b;
            int b3 = b(bea2.a, i6);
            strArr[i5] = new String(bea2.a, i6, b3 - i6, str);
            bea.c(b3 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i7 = i4 + i;
        ...
        axg[] axgArr = new axg[arrayList.size()];
        arrayList.toArray(axgArr);
        axc axc = new axc(str2, z2, z3, strArr, axgArr);
        return axc;
    }
    ...
    private static byte[] b(byte[] bArr, int i, int i2) {
        return i2 <= i ? ben.f : Arrays.copyOfRange(bArr, i, i2);
    }
    ...
    public final awr a(byte[] bArr, int i) {
        ArrayList arrayList = new ArrayList();
        ...
        bea.b(i2 + i4);
        boolean z = false;
        if (!a(bea, a2.a, i3, false)) {
            if (a2.a != 4 || !a(bea, 4, i3, true)) {
                StringBuilder sb = new StringBuilder("Failed to validate ID3 tag with majorVersion=");
                sb.append(a2.a);
                bdu.c("Id3Decoder", sb.toString());
                return null;
            }
            z = true;
        }
        while (bea.b() >= i3) {
            axg a3 = a(a2.a, bea, z, i3, this.b);
            if (a3 != null) {
                arrayList.add(a3);
            }
        }
