...
public final class uti {
    ...
    /* renamed from: uti$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.uti.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static Drawable a(RepeatState repeatState, Context context) {
        ...
        if (i == 1) {
            return ury.k(context);
        }
        if (i == 2) {
            return ury.m(context);
        }
        if (i == 3) {
            return ury.l(context);
        }
        if (i == 4) {
            return ury.n(context);
        }
