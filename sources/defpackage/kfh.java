...
public final class kfh implements kfg {
    /* access modifiers changed from: private */
    public static final Waze_Message[] a = Waze_Message.values();
    private final Context b;
    private final kff c;
    private boolean d;
    private defpackage.kfg.a e;
    private a f;

    /* renamed from: kfh$a */
    static class a extends Handler {
        private final WeakReference<defpackage.kfg.a> a;

        public a(defpackage.kfg.a aVar) {
            this.a = new WeakReference<>(aVar);
        }

        public final void handleMessage(Message message) {
            defpackage.kfg.a aVar = (defpackage.kfg.a) this.a.get();
            if (aVar == null) {
                Assertion.b("Weak reference has been lost, can't handle messages");
                return;
            }
            Waze_Message waze_Message = kfh.a[message.what];
            switch (waze_Message) {
    ...
    public kfh(Context context, kff kff) {
        this.b = context;
        this.c = kff;
    }
    ...
    public final void a(defpackage.kfg.a aVar) {
        if (this.d) {
        ...
        if (!defpackage.lcm.a.a) {
            defpackage.whn.a aVar2 = new defpackage.whn.a();
            aVar2.a = this.c.a(this.b);
            whn whn = new whn(aVar2.a, false, false, false, null, null, null, 0);
            WazeSDKManager a2 = WazeSDKManager.a();
