...
public final class ril implements rim {
    ...
    public ril(Context context, ViewGroup viewGroup, Picasso picasso) {
        this.a = context;
        this.b = LayoutInflater.from((Context) fay.a(context)).inflate(R.layout.home_tappable_section_header, viewGroup, false);
        this.f = new vsd(new vso(picasso), context);
        uui.b(this.b).b(this.e).a(this.c, this.d).a();
    }
    ...
    public final void a(Uri uri, Drawable drawable, String str) {
        ...
        if (c2 == 0) {
            a2.a(drawable);
            a2.b(drawable);
            a2.a(uvt.a(this.e, uvc.a((float) getView().getResources().getDimensionPixelSize(R.dimen.episode_card_corner_radius))));
        } else if (c2 != 1) {
            a2.a(drawable);
            a2.b(drawable);
            a2.a(this.e);
        } else {
            uva uva = new uva(drawable, 1.0f);
            a2.a((Drawable) uva);
            a2.b((Drawable) uva);
            a2.a(uvt.a(this.e));
            this.c.setGravity(1);
