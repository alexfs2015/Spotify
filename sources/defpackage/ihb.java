...
public final class ihb implements kcs {
    ...
    public ihb(ReactiveVideoTracker reactiveVideoTracker, Ad ad, Handler handler, VideoSurfaceView videoSurfaceView) {
    ...
    public final void a(final java.lang.String r8, long r9) {
        ...
        L_0x00ae:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ihb.a(java.lang.String, long):void");
    }

    public final void a() {
        this.c.post(new Runnable() {
            public final void run() {
                ihb.this.a.dispatchEvent(new MoatAdEvent(MoatAdEventType.AD_EVT_COMPLETE));
                Logger.b("MOAT_EVENT - %s", MoatAdEventType.AD_EVT_COMPLETE);
                ihb.this.a.stopTracking();
