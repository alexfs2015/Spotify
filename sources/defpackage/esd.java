...
public final class esd {
    ...
    public final Bundle a(String str, emd emd) {
        this.a.p().c();
        if (emd == null) {
    ...
    public final void a(String str) {
        ...
        if (resolveInfo.serviceInfo != null) {
            ...
            if (resolveInfo.serviceInfo.name == null || !str2.equals(str3) || !a()) {
                ...
                try {
                    this.a.q().i.a("Install Referrer Service is", bzs.a().b(this.a.m(), new Intent(intent), ese, 1) ? "available" : "not available");
                } catch (Exception e) {
