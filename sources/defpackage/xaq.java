...
public final class xaq {
    ...
    public static final xam c = xam.a(null, a);
            ...
            if (address.length == 16) {
                ...
                while (i2 < address.length) {
                    if (i2 == i4) {
                        ...
                        xcq.m((long) (((address[i2] & 255) << 8) | (address[i2 + 1] & 255)));
                        i2 += 2;
                    }
                }
                return xcq.o();
    ...
    public static String a(xad xad, boolean z) {
        String str;
        String str2 = ":";
        if (xad.b.contains(str2)) {
            StringBuilder sb = new StringBuilder("[");
            sb.append(xad.b);
            sb.append("]");
            str = sb.toString();
    ...
    public static Charset a(xcs xcs, Charset charset) {
        if (xcs.a(0, h)) {
            xcs.i((long) h.h());
            return d;
        } else if (xcs.a(0, i)) {
    ...
    public static boolean a(xdg xdg, int i2, TimeUnit timeUnit) {
        try {
            return b(xdg, 100, timeUnit);
    ...
    public static xac b(List<xbq> list) {
        a aVar = new a();
        for (xbq xbq : list) {
            xao.a.a(aVar, xbq.g.a(), xbq.h.a());
        }
        return aVar.a();
    }
    ...
    public static boolean b(xdg xdg, int i2, TimeUnit timeUnit) {
        long nanoTime = System.nanoTime();
        long c2 = xdg.a().bj_() ? xdg.a().c() - nanoTime : Long.MAX_VALUE;
        xdg.a().a(Math.min(c2, timeUnit.toNanos((long) i2)) + nanoTime);
        try {
            xcq xcq = new xcq();
            while (xdg.a(xcq, 8192) != -1) {
                xcq.r();
            }
    ...
    private static java.net.InetAddress d(java.lang.String r16, int r17, int r18) {
        ...
        L_0x00ee:
            goto L_0x00ed
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xaq.d(java.lang.String, int, int):java.net.InetAddress");
    }
