...
public final class tra extends Drawable {
    final trj a;
    final trh b;
    ...
    public tra(Context context, TextPaint textPaint, int i2) {
        this(context, new trk(textPaint, context.getResources().getDimensionPixelSize(R.dimen.episode_card_corner_radius), i2), new tri(), context.getResources().getDimensionPixelSize(R.dimen.episode_card_corner_radius), new Matrix());
    }

    private tra(Context context, trj trj, trh trh, int i2, Matrix matrix) {
        this.c = new Paint(1);
        this.d = new Paint(1);
    ...
    private void a(boolean z) {
        ...
        this.h.setInterpolator(ftn.b);
        this.h.addUpdateListener(new $$Lambda$tra$XCdPSWqGfI2IDcmy0lO8V4N8LQ(this));
        if (z) {
            this.h.start();
        } else {
            this.h.end();
