...
public final class hfk {
    ...
    private final OrbitServiceObserver x = new OrbitServiceObserver() {
        ...
        public final void onOrbitStartupFailed(int i) {
            ...
            if (i == 1301) {
                ...
                Intent intent = new Intent(hga.a, MainActivity.class);
                intent.addFlags(268435456);
                PendingIntent activity = PendingIntent.getActivity(hga.a.getApplicationContext(), 0, intent, 0);
                c cVar = new c(hga.a);
                c a2 = cVar.a((CharSequence) hga.a.getString(R.string.alert_title_no_sd_card_found)).b((CharSequence) hga.a.getString(R.string.alert_text_no_sd_card_found)).a((int) R.drawable.icn_notification).a(true).a(0);
                a2.p = "err";
                a2.h = 0;
                a2.f = activity;
                a2.b(true);
                hga.b.notify(R.id.notification_no_storage_device, cVar.b());
                if (hga.c.nextDouble() >= 0.99d) {
                    Assertion.c("Could not find valid cache location. (Throttled 99%)");
                }
            }
            hfk.this.b.c = true;
            synchronized (hfk.this.b.a) {
                hfk.this.b.c();
            }
        ...
        public final void onOrbitStopped() {
            ...
            synchronized (hfk.this.m) {
                if (hfk.this.p != null) {
                    hfk.this.o = null;
                    hfk.this.p.destroy();
                    hfk.this.p = null;
                    hfk.this.n.a(Disposables.b());
                }
            }
            synchronized (hfk.this.b.a) {
                hfk.this.b.c();
        ...
        public final void onLoginError(int i) {
            ...
            hfk.this.a.sendBroadcast(hfk.this.g.a(i));
        }

        public final void onIncognitoModeDisabledByTimer() {
            Logger.b("onIncognitoModeDisabledByTimer()", new Object[0]);
            PendingIntent b = hfk.this.g.b(hfk.this.a);
            hhs hhs = hfk.this.f;
            Resources resources = hhs.a.getResources();
            ...
            c cVar = new c(hhs.a, "spotify_updates_channel");
            cVar.f = b;
            ...
            cVar.b(true);
            ((NotificationManager) hhs.a.getSystemService("notification")).notify(R.id.notification_incognito_mode_disabled, cVar.b());
        }

        public final void onForgetCredentials() {
            super.onForgetCredentials();
            for (b bVar : hfk.this.k.a) {
                glm glm = hfk.this.h;
                bVar.getClass();
                $$Lambda$N066pKpIzBS5qxnLDmcf6E1GtpA r3 = new $$Lambda$N066pKpIzBS5qxnLDmcf6E1GtpA(bVar);
    ...
    hfk(Context context, hft hft, hfu hfu, hfi hfi, hga hga, hhs hhs, hgo hgo, hfx hfx, glm glm, unt unt, StateRestoreFileDeleter stateRestoreFileDeleter, hha hha, hhu hhu, hfh hfh, rla rla, Looper looper, Handler handler, Optional<OrbitServiceInterface> optional) {
        this.a = context;
        this.b = hft;
        this.c = hfu;
        this.d = hfi;
    ...
    public final void b() {
        this.v.post(new $$Lambda$hfk$QS_eEvy7b_lt4Vp71v_rlheTY(this));
    }
    ...
    /* JADX INFO: used method not loaded: unt.b(java.lang.String):null, types can be incorrect */
    /* JADX INFO: used method not loaded: unt.a(java.lang.String):null, types can be incorrect */
    ...
    /* JADX INFO: used method not loaded: hfh.a(com.spotify.cosmos.router.RxRouter):null, types can be incorrect */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00b1, code lost:
        ...
        r12 = a();
        r0 = (defpackage.unt) defpackage.fay.a(r1.q);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:60:0x0147, code lost:
        if (r6 != defpackage.unt.b.e()) goto L_0x00d2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:65:0x0167, code lost:
        if (defpackage.unt.c(r6.toString()) == false) goto L_0x0182;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:80:0x01a9, code lost:
        r0.e.a().a(defpackage.unt.g, r7).b();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:93:0x025d, code lost:
        ...
        com.spotify.base.java.logging.Logger.c("Core hash: %s", "b19b74731e3d121ff38a6240ab4352d67187efa7");
        r12.start(r13, r14, com.spotify.localization.SpotifyLocale.a(r1.a), false, defpackage.hhu.a(), r2.getNativeRouter());
    ...
    public final void c() {
        /*
            ...
            hhg r2 = r0.a
            monitor-enter(r2)
            hfu r0 = r1.c     // Catch:{ all -> 0x02eb }
            hft r3 = r0.a     // Catch:{ all -> 0x02eb }
            jrp r4 = r0.b     // Catch:{ all -> 0x02eb }
        ...
        L_0x003d:
            hft r0 = r1.b     // Catch:{ all -> 0x02eb }
            r0.d = r8     // Catch:{ all -> 0x02eb }
            hfu r0 = r1.c     // Catch:{ all -> 0x02eb }
            hft r3 = r0.a     // Catch:{ all -> 0x02eb }
            hhg r3 = r3.a     // Catch:{ all -> 0x02eb }
        ...
        L_0x0050:
            ...
            hft r0 = r0.a     // Catch:{ all -> 0x02eb }
            hhg r0 = r0.a     // Catch:{ all -> 0x02eb }
        ...
        L_0x00a8:
            ...
            unt r0 = (defpackage.unt) r0
            boolean r6 = r0.c
            if (r6 != 0) goto L_0x01d1
        L_0x00d2:
            boolean r6 = defpackage.unt.b.e()
            com.spotify.mobile.android.util.prefs.SpSharedPreferences<java.lang.Object> r7 = r0.e
            com.spotify.mobile.android.util.prefs.SpSharedPreferences$b<java.lang.Object, java.lang.String> r8 = defpackage.unt.g
            boolean r7 = r7.e(r8)
        ...
        L_0x00e9:
            com.spotify.mobile.android.util.prefs.SpSharedPreferences<java.lang.Object> r7 = r0.e
            com.spotify.mobile.android.util.prefs.SpSharedPreferences$b<java.lang.Object, java.lang.String> r8 = defpackage.unt.h
            boolean r7 = r7.e(r8)
        ...
        L_0x015a:
            ...
            boolean r8 = defpackage.unt.c(r8)
        ...
        L_0x025d:
            ...
            java.lang.String r3 = "b19b74731e3d121ff38a6240ab4352d67187efa7"
            r0[r11] = r3
            ...
            hft r0 = r1.b     // Catch:{ InterruptedException -> 0x02c6 }
        ...
        L_0x02ef:
            goto L_0x02ee
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hfk.c():void");
    }
}
