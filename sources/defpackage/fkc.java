...
public final class fkc {
    ...
    public static fkc a(byte[] bArr) {
        return a(bArr, 0, bArr.length, false);
    }

    static fkc a(byte[] bArr, int i2, int i3, boolean z) {
        fkc fkc = new fkc(bArr, i2, i3, z);
        try {
            fkc.c(i3);
            return fkc;
    ...
    public final String c() {
        ...
        int i3 = this.g;
        if (g2 <= i2 - i3 && g2 > 0) {
            String str = new String(this.c, i3, g2, fki.a);
            this.g += g2;
            return str;
        } else if (g2 == 0) {
            return "";
            ...
            if (g2 > this.e) {
                return new String(g(g2), fki.a);
            }
            e(g2);
            String str2 = new String(this.c, this.g, g2, fki.a);
            this.g += g2;
            return str2;
        }
    }
    ...
    public final String d() {
        ...
        if (Utf8.a(bArr, i3, i3 + g2)) {
            return new String(bArr, i3, g2, fki.a);
        }
        throw InvalidProtocolBufferException.i();
    }

    public final <T extends fko> T a(fkr<T> fkr, fke fke) {
        int g2 = g();
        if (this.a < this.b) {
            int c2 = c(g2);
            this.a++;
            T t = (fko) fkr.a(this, fke);
            a(0);
            this.a--;
            d(c2);
            return t;
    ...
    public final int g() {
        ...
        L_0x006b:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fkc.g():int");
    }
    ...
    public final long h() {
        ...
        L_0x00b5:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fkc.h():long");
    }
    ...
    private fkc(byte[] bArr, int i2, int i3, boolean z) {
        this.j = false;
    ...
    fkc(InputStream inputStream, int i2) {
        this.j = false;
        this.l = Integer.MAX_VALUE;
        this.b = 100;
        this.m = 67108864;
