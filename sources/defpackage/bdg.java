...
public final class bdg {
        ...
        if (trim.startsWith("mp4a")) {
            if (trim.startsWith("mp4a.")) {
                ...
                if (substring.length() >= 2) {
                    try {
                        str2 = a(Integer.parseInt(bdw.e(substring.substring(0, 2)), 16));
    ...
    public static int h(java.lang.String r7) {
        ...
        L_0x0062:
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bdg.h(java.lang.String):int");
    }
