...
public final class wos extends wpw {
    ...
    /* renamed from: wos$a */
    final class a extends defpackage.wpw.a {
        private final int b;
        private final int c;
        private int d;
        private int e = wos.b[this.d];
        private boolean f;
        ...
        public final void b() {
            int i = this.a;
            if (i > wos.b[Math.max(0, (this.d - 1) - 1)]) {
                if (i >= this.e) {
    ...
    private wos(int i, int i2, int i3) {
        int c2 = c(64);
        if (b[c2] < 64) {
            this.c = c2 + 1;
        } else {
