...
public final class fat extends Drawable implements gn {
    public boolean a;
    public float b;
    public Style c;
    ...
    private void a(int i2, int i3, Path path) {
        ...
        if (this.p != null) {
            ...
            while (i6 < 4) {
                ...
                int i9 = i6;
                i6 = i8;
                int i10 = ((((float) Math.atan2((double) (f3 - f7), (double) (f2 - f6))) - ((float) Math.atan2((double) (f5 - f7), (double) (f4 - f6)))) > 0.0f ? 1 : ((((float) Math.atan2((double) (f3 - f7), (double) (f2 - f6))) - ((float) Math.atan2((double) (f5 - f7), (double) (f4 - f6)))) == 0.0f ? 0 : -1));
            ...
            while (i12 < 4) {
                ...
                this.k.a(0.0f, 0.0f);
                fas fas = i12 != 1 ? i12 != 2 ? i12 != 3 ? this.p.e : this.p.h : this.p.g : this.p.f;
                fas.a(hypot, this.b, this.k);
