...
public final class hgg implements hgf {
    ...
    public hgg(hmw hmw, Resources resources, ConnectManager connectManager, Player player, jhz jhz, jgj jgj, hhp hhp) {
        this.h = hhp;
        fay.a(hmw);
        fay.a(resources);
        fay.a(connectManager);
        fay.a(player);
        fay.a(jhz);
        fay.a(jgj);
        this.a = hmw;
    ...
    public final void a(android.view.KeyEvent r9, defpackage.hgf.a r10) {
        /*
            r8 = this;
        ...
        L_0x00f0:
            ...
            -$$Lambda$hgg$yzchUaRc9MoXZKB7DfsUuLppoIk r1 = new -$$Lambda$hgg$yzchUaRc9MoXZKB7DfsUuLppoIk
            r1.<init>(r8)
        ...
        L_0x0108:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.hgg.a(android.view.KeyEvent, hgf$a):void");
    }
}
