...
public abstract class aso<I extends asm, O extends asn, E extends Exception> implements ask<I, O, E> {
    protected final I[] a;
    protected int b;
    ...
    public final void c() {
        synchronized (this.d) {
            ...
            while (!this.e.isEmpty()) {
                a((I) (asm) this.e.removeFirst());
            }
            while (!this.f.isEmpty()) {
                ((asn) this.f.removeFirst()).e();
            }
        }
    }
    ...
    public boolean e() {
        ...
        L_0x001a:
            ...
            asm r1 = (defpackage.asm) r1     // Catch:{ all -> 0x0096 }
        ...
        L_0x009a:
            goto L_0x0099
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.aso.e():boolean");
    }
