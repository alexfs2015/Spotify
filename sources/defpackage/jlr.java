...
public final class jlr {
    public static Optional<bk> a(Offer offer, String str, Reason reason, String str2, String str3, String str4, sih sih) {
        if (!a(reason, str2, str3, str4)) {
            return Optional.e();
        }
        bk bkVar = new bk(String.valueOf(offer), str, reason.mAdSlotName, str2, str3, str4, sih.toString());
        return Optional.b(bkVar);
    }
