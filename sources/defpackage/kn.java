...
final class kn {
    ...
    private static final kp b = (VERSION.SDK_INT >= 21 ? new ko() : null);
    private static final kp c = b();
    ...
    private static kp b() {
        try {
            return (kp) Class.forName("qd").getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    static void a(defpackage.kg r36, java.util.ArrayList<defpackage.jx> r37, java.util.ArrayList<java.lang.Boolean> r38, int r39, int r40, boolean r41) {
        /*
            r0 = r36
            r1 = r37
            r2 = r38
        ...
        L_0x01a0:
            java.util.ArrayList r20 = defpackage.kp.a(r3)
            r21 = r14
            r22 = r1
            r23 = r5
            r24 = r9
        ...
        L_0x035c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.kn.a(kg, java.util.ArrayList, java.util.ArrayList, int, int, boolean):void");
    }

    private static dp<String, String> a(int i, ArrayList<jx> arrayList, ArrayList<Boolean> arrayList2, int i2, int i3) {
        ArrayList arrayList3;
        ArrayList arrayList4;
        dp<String, String> dpVar = new dp<>();
        for (int i4 = i3 - 1; i4 >= i2; i4--) {
            jx jxVar = (jx) arrayList.get(i4);
            if (jxVar.b(i)) {
                boolean booleanValue = ((Boolean) arrayList2.get(i4)).booleanValue();
                if (jxVar.p != null) {
                    int size = jxVar.p.size();
                    if (booleanValue) {
                        arrayList3 = jxVar.p;
                        arrayList4 = jxVar.q;
                    } else {
                        ArrayList arrayList5 = jxVar.p;
                        arrayList3 = jxVar.q;
    ...
    private static kp a(Fragment fragment, Fragment fragment2) {
        ...
        kp kpVar = b;
        if (kpVar != null && a(kpVar, (List<Object>) arrayList)) {
            return b;
        }
        kp kpVar2 = c;
        if (kpVar2 != null && a(kpVar2, (List<Object>) arrayList)) {
            return c;
        }
        if (b == null && c == null) {
            return null;
    ...
    private static boolean a(kp kpVar, List<Object> list) {
        int size = list.size();
        for (int i = 0; i < size; i++) {
            if (!kpVar.a(list.get(i))) {
                return false;
            }
        }
        return true;
    ...
    private static Object a(kp kpVar, Fragment fragment, Fragment fragment2, boolean z) {
        Object obj;
        ...
        return kpVar.c(kpVar.b(obj));
    }

    private static Object a(kp kpVar, Fragment fragment, boolean z) {
        Object obj;
        if (fragment == null) {
            return null;
        }
    ...
    private static Object b(kp kpVar, Fragment fragment, boolean z) {
        Object obj;
        if (fragment == null) {
            return null;
        }
    ...
    private static dp<String, View> b(kp kpVar, dp<String, String> dpVar, Object obj, a aVar) {
        fp fpVar;
        ArrayList arrayList;
        ...
        kpVar.a((Map<String, View>) dpVar2, fragment.y());
        jx jxVar = aVar.f;
        if (aVar.e) {
            fpVar = fragment.X();
            arrayList = jxVar.q;
    ...
    static dp<String, View> a(kp kpVar, dp<String, String> dpVar, Object obj, a aVar) {
        fp fpVar;
        ArrayList arrayList;
        ...
        dp<String, View> dpVar2 = new dp<>();
        kpVar.a((Map<String, View>) dpVar2, view);
        jx jxVar = aVar.c;
        if (aVar.b) {
            fpVar = fragment.Y();
            arrayList = jxVar.p;
    ...
    static View a(dp<String, View> dpVar, a aVar, Object obj, boolean z) {
        String str;
        jx jxVar = aVar.c;
        if (obj == null || dpVar == null || jxVar.p == null || jxVar.p.isEmpty()) {
            return null;
        }
        if (z) {
            str = (String) jxVar.p.get(0);
        } else {
            str = (String) jxVar.q.get(0);
        }
        return (View) dpVar.get(str);
    }

    private static void a(kp kpVar, Object obj, Object obj2, dp<String, View> dpVar, boolean z, jx jxVar) {
        String str;
        if (jxVar.p != null && !jxVar.p.isEmpty()) {
            if (z) {
                str = (String) jxVar.q.get(0);
            } else {
                str = (String) jxVar.p.get(0);
            }
            View view = (View) dpVar.get(str);
            kpVar.a(obj, view);
            if (obj2 != null) {
                kpVar.a(obj2, view);
            }
    ...
    static void a(Fragment fragment, Fragment fragment2, boolean z, dp<String, View> dpVar, boolean z2) {
        ...
        if (fpVar != null) {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                arrayList2.add(dpVar.b(i2));
                arrayList.add(dpVar.c(i2));
            }
        }
    }

    static ArrayList<View> a(kp kpVar, Object obj, Fragment fragment, ArrayList<View> arrayList, View view) {
        if (obj == null) {
            return null;
        }
    ...
    private static Object a(kp kpVar, Object obj, Object obj2, Object obj3, Fragment fragment, boolean z) {
        return kpVar.a(obj2, obj, obj3);
    }

    private static void a(jx jxVar, SparseArray<a> sparseArray, boolean z) {
        int size = jxVar.c.size();
        for (int i = 0; i < size; i++) {
            a(jxVar, (a) jxVar.c.get(i), sparseArray, false, z);
        }
    }

    private static void b(jx jxVar, SparseArray<a> sparseArray, boolean z) {
        if (jxVar.a.k.e_()) {
            for (int size = jxVar.c.size() - 1; size >= 0; size--) {
                a(jxVar, (a) jxVar.c.get(size), sparseArray, true, z);
            }
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static void a(defpackage.jx r11, defpackage.km.a r12, android.util.SparseArray<defpackage.kn.a> r13, boolean r14, boolean r15) {
        /*
        ...
        L_0x00eb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.kn.a(jx, km$a, android.util.SparseArray, boolean, boolean):void");
    }
