...
public final class flo implements Cloneable {
    ...
    private flo(int i, int i2, int i3, int[] iArr) {
        this.a = i;
        this.b = i2;
        this.c = i3;
        this.d = iArr;
    ...
    public final boolean equals(Object obj) {
        ...
        flo flo = (flo) obj;
        if (this.a == flo.a && this.b == flo.b && this.c == flo.c && Arrays.equals(this.d, flo.d)) {
            return true;
        }
        return false;
    }
    ...
    public final /* synthetic */ Object clone() {
        return new flo(this.a, this.b, this.c, (int[]) this.d.clone());
    }
}
