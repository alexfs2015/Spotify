...
public final class fka extends fkp {
    ...
    public final void c() {
        ...
        a((Object) ((fjd) g()).a.entrySet().iterator());
    }
    ...
    public final JsonToken f() {
        while (this.e != 0) {
            ...
            if (g2 instanceof Iterator) {
                boolean z = this.d[this.e - 2] instanceof fjd;
                ...
                a(it.next());
            } else if (g2 instanceof fjd) {
                return JsonToken.BEGIN_OBJECT;
            } else {
                if (g2 instanceof fiz) {
                    return JsonToken.BEGIN_ARRAY;
                }
                if (g2 instanceof fjf) {
                    fjf fjf = (fjf) g2;
                    if (fjf.a instanceof String) {
                        return JsonToken.STRING;
                    }
                    if (fjf.a instanceof Boolean) {
                        return JsonToken.BOOLEAN;
                    }
                    if (fjf.a instanceof Number) {
                        return JsonToken.NUMBER;
                    }
                    throw new AssertionError();
                } else if (g2 instanceof fjc) {
    ...
    public final String p() {
        ...
        while (i < this.e) {
            ...
            } else if (objArr[i] instanceof fjd) {
                i++;
                if (objArr[i] instanceof Iterator) {
                    sb.append('.');
