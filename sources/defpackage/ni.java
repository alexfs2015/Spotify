...
public final class ni {
    ...
    /* renamed from: ni$d */
    static final class d implements defpackage.nm.a, defpackage.no.f {
        final Context a;
        final ArrayList<WeakReference<ni>> b = new ArrayList<>();
        final ArrayList<f> c = new ArrayList<>();
        final defpackage.nn.c d = new defpackage.nn.c();
        final a e = new a();
        final no f;
        nm g;
        f h;
        ...
        private final ArrayList<C0061d> p = new ArrayList<>();
        private final c q = new c();
        private final gs r;
        private final boolean s;
        private f t;
        private f u;
        private final Map<String, defpackage.ne.e> v = new HashMap();
        private nd w;
        private C0060b x = new C0060b() {
            public final void a(defpackage.ne.b bVar, Collection<defpackage.ne.b.a> collection) {
                if (bVar == d.this.i) {
                    f fVar = d.this.h;
                    fVar.s.clear();
                    for (defpackage.ne.b.a aVar : collection) {
        ...
        final class a extends Handler {
            ...
            public final void handleMessage(android.os.Message r12) {
                /*
                    ...
                    ni$d r3 = defpackage.ni.d.this
                    ni$f r3 = r3.b()
                    java.lang.String r3 = r3.c
                    r4 = r1
                    ni$f r4 = (defpackage.ni.f) r4
                ...
                L_0x004c:
                    ...
                    r3.d(r4)
                L_0x0056:
                    ni$d r3 = defpackage.ni.d.this     // Catch:{ all -> 0x00f2 }
                    java.util.ArrayList<java.lang.ref.WeakReference<ni>> r3 = r3.b     // Catch:{ all -> 0x00f2 }
                    int r3 = r3.size()     // Catch:{ all -> 0x00f2 }
                L_0x005e:
                    int r3 = r3 + -1
                    if (r3 < 0) goto L_0x0084
                    ni$d r4 = defpackage.ni.d.this     // Catch:{ all -> 0x00f2 }
                    java.util.ArrayList<java.lang.ref.WeakReference<ni>> r4 = r4.b     // Catch:{ all -> 0x00f2 }
                    ...
                    ni r4 = (defpackage.ni) r4     // Catch:{ all -> 0x00f2 }
                    ...
                    goto L_0x005e
                L_0x007c:
                    java.util.ArrayList<ni$b> r5 = r11.a     // Catch:{ all -> 0x00f2 }
                    java.util.ArrayList<ni$b> r4 = r4.d     // Catch:{ all -> 0x00f2 }
                    r5.addAll(r4)     // Catch:{ all -> 0x00f2 }
                    goto L_0x005e
                L_0x0084:
                    java.util.ArrayList<ni$b> r3 = r11.a     // Catch:{ all -> 0x00f2 }
                    int r3 = r3.size()     // Catch:{ all -> 0x00f2 }
                    r4 = 0
                    r5 = 0
                L_0x008c:
                    if (r5 >= r3) goto L_0x00ec
                    java.util.ArrayList<ni$b> r6 = r11.a     // Catch:{ all -> 0x00f2 }
                    java.lang.Object r6 = r6.get(r5)     // Catch:{ all -> 0x00f2 }
                    ni$b r6 = (defpackage.ni.b) r6     // Catch:{ all -> 0x00f2 }
                    ni r7 = r6.a     // Catch:{ all -> 0x00f2 }
                    ni$a r8 = r6.b     // Catch:{ all -> 0x00f2 }
                ...
                L_0x00b7:
                    r9 = r1
                    ni$f r9 = (defpackage.ni.f) r9     // Catch:{ all -> 0x00f2 }
                    int r10 = r6.d     // Catch:{ all -> 0x00f2 }
                    r10 = r10 & 2
                    if (r10 != 0) goto L_0x00cb
                    nh r6 = r6.c     // Catch:{ all -> 0x00f2 }
                ...
                L_0x00e9:
                    ...
                    goto L_0x008c
                L_0x00ec:
                    java.util.ArrayList<ni$b> r12 = r11.a
                    r12.clear()
                    return
                L_0x00f2:
                    r12 = move-exception
                    java.util.ArrayList<ni$b> r0 = r11.a
                    r0.clear()
                    goto L_0x00fa
                L_0x00f9:
                    throw r12
                L_0x00fa:
                    goto L_0x00f9
                */
                throw new UnsupportedOperationException("Method not decompiled: defpackage.ni.d.a.handleMessage(android.os.Message):void");
            }
        }
        ...
        final class b {
            ...
            public final void a(int i, int i2, int i3) {
                if (this.a != null) {
                    mp mpVar = this.c;
                    if (mpVar != null && i == 0 && i2 == 0) {
                        mpVar.a(i3);
                    } else {
                        this.c = new mp(i, i2, i3) {
        ...
        /* renamed from: ni$d$c */
        final class c extends defpackage.ne.a {
            c() {
            }

            public final void a(ne neVar, nf nfVar) {
                d dVar = d.this;
                e c = dVar.c(neVar);
                if (c != null) {
                    dVar.a(c, nfVar);
        ...
        final class C0061d implements defpackage.nn.d {
            final nn a;
            private boolean b;

            public C0061d(Object obj) {
                Context context = d.this.a;
                this.a = VERSION.SDK_INT >= 16 ? new a(context, obj) : new b(context, obj);
                this.a.a((defpackage.nn.d) this);
                b();
            }

            public final void a() {
                this.b = true;
                this.a.a((defpackage.nn.d) null);
            }
        ...
        private int c(Object obj) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (((C0061d) this.p.get(i2)).a.a() == obj) {
                    return i2;
                }
            }
            return -1;
        ...
        private void d(f fVar, int i2) {
            if (ni.b == null || (this.u != null && fVar.b())) {
            ...
            if (fVar2 != fVar) {
                if (fVar2 != null) {
                    ...
                    if (!this.v.isEmpty()) {
                        for (defpackage.ne.e eVar2 : this.v.values()) {
                            eVar2.a(i2);
                            eVar2.c();
                        }
                        this.v.clear();
                ...
                if (eVar3.d != null && eVar3.d.b) {
                    e eVar4 = fVar.a;
                    ni.e();
                    defpackage.ne.b b2 = eVar4.a.b(fVar.b);
                    ...
                    synchronized (b2.a) {
                        if (d2 == null) {
                            ...
                            if (b2.d != null && !b2.d.isEmpty()) {
                                Collection<defpackage.ne.b.a> collection = b2.d;
                                b2.d = null;
                ...
                if (this.h.f()) {
                    ...
                    for (f fVar3 : unmodifiableList) {
                        e eVar7 = fVar3.a;
                        ni.e();
                        defpackage.ne.e a2 = eVar7.a.a(fVar3.b, this.h.b);
                        a2.d();
        ...
        public final ni a(Context context) {
            ...
            while (true) {
                size--;
                if (size >= 0) {
                    ni niVar = (ni) ((WeakReference) this.b.get(size)).get();
                    if (niVar == null) {
                        this.b.remove(size);
                    } else if (niVar.c == context) {
                        return niVar;
                    }
                } else {
                    ni niVar2 = new ni(context);
                    this.b.add(new WeakReference(niVar2));
                    return niVar2;
                }
            }
        }
        ...
        public final void a(ne neVar) {
            if (c(neVar) == null) {
                ...
                this.e.a(513, eVar);
                a(eVar, neVar.g);
                neVar.a((defpackage.ne.a) this.q);
                neVar.a(this.w);
            }
        }

        /* access modifiers changed from: 0000 */
        public void a(e eVar, nf nfVar) {
            boolean z;
            String str;
            if (eVar.a(nfVar)) {
                int i2 = 0;
                if (nfVar == null || (!nfVar.a() && nfVar != this.f.g)) {
                    new StringBuilder("Ignoring invalid provider descriptor: ").append(nfVar);
                    z = false;
                } else {
                    ...
                    while (true) {
                        ...
                        if (ncVar == null || !ncVar.s()) {
                            new StringBuilder("Ignoring invalid system route descriptor: ").append(ncVar);
                        } else {
                            String a2 = ncVar.a();
                            int a3 = eVar.a(a2);
                            if (a3 < 0) {
                                ...
                                this.c.add(fVar);
                                if (ncVar.b().size() > 0) {
                                    arrayList.add(new ho(fVar, ncVar));
                                } else {
                                    fVar.a(ncVar);
                                    if (ni.a) {
                                ...
                                new StringBuilder("Ignoring route descriptor with duplicate id: ").append(ncVar);
                            } else {
                                f fVar2 = (f) eVar.b.get(a3);
                                int i4 = i2 + 1;
                                Collections.swap(eVar.b, a3, i2);
                                if (ncVar.b().size() > 0) {
                                    arrayList2.add(new ho(fVar2, ncVar));
                                } else if (a(fVar2, ncVar) != 0 && fVar2 == this.h) {
                                    i2 = i4;
                                    z = true;
                                }
                                i2 = i4;
                    ...
                    for (ho hoVar2 : arrayList2) {
                        f fVar4 = (f) hoVar2.a;
                        if (a(fVar4, (nc) hoVar2.b) != 0 && fVar4 == this.h) {
                            z = true;
                        }
                    }
                }
        ...
        public final void a(f fVar, int i2) {
            ...
            if (!this.v.isEmpty()) {
                defpackage.ne.e eVar2 = (defpackage.ne.e) this.v.get(fVar.c);
                if (eVar2 != null) {
                    eVar2.b(i2);
                }
            }
                ...
                if (this.h.f()) {
                    ...
                    while (it3.hasNext()) {
                        ...
                        if (!hashSet.contains(entry.getKey())) {
                            defpackage.ne.e eVar2 = (defpackage.ne.e) entry.getValue();
                            eVar2.e();
                            eVar2.c();
                            it3.remove();
                        }
                    ...
                    for (f fVar7 : unmodifiableList) {
                        if (!this.v.containsKey(fVar7.c)) {
                            e eVar3 = fVar7.a;
                            ni.e();
                            defpackage.ne.e a2 = eVar3.a.a(fVar7.b, this.h.b);
                            a2.d();
        ...
        public final boolean a(nh nhVar, int i2) {
            if (nhVar.c()) {
                return false;
            }
            if ((i2 & 2) == 0 && this.s) {
        ...
        public final void c() {
            defpackage.nh.a aVar = new defpackage.nh.a();
            int size = this.b.size();
            boolean z = false;
            boolean z2 = false;
            while (true) {
            ...
            nh a2 = z ? aVar.a() : nh.c;
            nd ndVar = this.w;
            if (ndVar == null || !ndVar.a().equals(a2) || this.w.b() != z2) {
                if (!a2.c() || z2) {
                    this.w = new nd(a2, z2);
                } else if (this.w != null) {
                    this.w = null;
    ...
    public static class f {
        ...
        private boolean a(java.util.List<android.content.IntentFilter> r9, java.util.List<android.content.IntentFilter> r10) {
            ...
            L_0x0085:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ni.f.a(java.util.List, java.util.List):boolean");
        }
        ...
        private int b(nc ncVar) {
            ...
            if (!hn.a(this.d, ncVar.c())) {
                this.d = ncVar.c();
                i2 = 1;
            } else {
                i2 = 0;
            }
            if (!hn.a(this.e, ncVar.d())) {
                this.e = ncVar.d();
                i2 = 1;
            }
            if (!hn.a(this.f, ncVar.e())) {
                this.f = ncVar.e();
                i2 = 1;
            }
            if (this.g != ncVar.f()) {
            ...
            if (!hn.a(this.q, ncVar.r())) {
                this.q = ncVar.r();
                i2 |= 1;
            }
            if (!hn.a(this.v, ncVar.i())) {
                this.v = ncVar.i();
                i2 |= 1;
            }
            if (this.i != ncVar.h()) {
        ...
        public static defpackage.ne.b h() {
            defpackage.ne.e eVar = ni.b.i;
            if (eVar instanceof defpackage.ne.b) {
                return (defpackage.ne.b) eVar;
            }
            return null;
        }
        ...
        public final void a(int i2) {
            ni.e();
            ni.b.a(this, Math.min(this.o, Math.max(0, i2)));
        }
        ...
        public final boolean a(nh nhVar) {
            if (nhVar != null) {
                ni.e();
                return nhVar.a((List<IntentFilter>) this.t);
            }
        ...
        if (context != null) {
            ...
            if (b == null) {
                ...
                if (!nmVar.c) {
                    ...
                    nmVar.a.registerReceiver(nmVar.d, intentFilter, null, nmVar.b);
                    nmVar.b.post(nmVar.e);
                }
            }
            return b.a(context);
        }
    ...
    public static boolean a(nh nhVar, int i) {
        if (nhVar != null) {
            e();
            return b.a(nhVar, i);
        }
    ...
    public static void b(f fVar) {
        e();
        d dVar = b;
        if (dVar.h.g() == null || !(dVar.i instanceof defpackage.ne.b)) {
        ...
        if (Collections.unmodifiableList(dVar.h.s).contains(fVar) || g == null || !g.b()) {
            ...
            ((defpackage.ne.b) dVar.i).a(fVar.b);
        }
    }
    ...
    public static void c(f fVar) {
        ...
        if (Collections.unmodifiableList(dVar.h.s).size() > 1) {
            ((defpackage.ne.b) dVar.i).b(fVar.b);
        }
    }
    ...
    public final void a(nh nhVar, a aVar, int i) {
        b bVar;
        if (nhVar == null) {
            throw new IllegalArgumentException("selector must not be null");
        } else if (aVar != null) {
            ...
            if (!bVar.c.a(nhVar)) {
                bVar.c = new defpackage.nh.a(bVar.c).a(nhVar).a();
                z = true;
            }
            if (z) {
                b.c();
