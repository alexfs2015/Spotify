...
public final class py extends ImageView {
    ...
    class a extends OvalShape {
        ...
        public final void draw(Canvas canvas, Paint paint) {
            int width = py.this.getWidth() / 2;
            float f = (float) width;
            float height = (float) (py.this.getHeight() / 2);
            canvas.drawCircle(f, height, f, this.b);
            canvas.drawCircle(f, height, (float) (width - py.this.b), paint);
        }

        private void a(int i) {
            float f = (float) (i / 2);
            RadialGradient radialGradient = new RadialGradient(f, f, (float) py.this.b, new int[]{1023410176, 0}, null, TileMode.CLAMP);
