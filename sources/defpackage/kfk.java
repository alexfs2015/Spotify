...
public final class kfk extends jsy {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.kfk.AnonymousClass1.<clinit>():void");
        }
    }

    public kfk(SnackBar snackBar, String str) {
        this(snackBar, str, jte.a(snackBar.getContext()));
    }

    public kfk(SnackBar snackBar, String str, int i2) {
    ...
    public final void a(ViewGroup viewGroup) {
        ...
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(context, SpotifyIconV2.X, (float) vfj.b(32.0f, context.getResources()));
        ...
        this.g.setOnClickListener(new $$Lambda$kfk$kQ7gitWBljnHu3Prav0KfqbM3XY(this));
        this.h.setOnClickListener(new $$Lambda$kfk$zpHWiJDccBN4wGryUhWfpYxvvvM(this));
