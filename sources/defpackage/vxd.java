...
final class vxd implements X509TrustManager {
    ...
    private static TrustManager[] a(vxe vxe) {
        try {
    ...
    public final void checkServerTrusted(X509Certificate[] x509CertificateArr, String str) {
        if (!this.f.contains(x509CertificateArr[0])) {
            ...
            if (this.d == -1 || System.currentTimeMillis() - this.d <= 15552000000L) {
                X509Certificate[] a2 = vwz.a(x509CertificateArr, this.c);
