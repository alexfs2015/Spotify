...
public final class cbv extends cce {
    ...
    public final void a(int i2, int i3) {
        bjl.e();
        a(i2, i3 - cmd.c(this.i)[0], this.f, this.c);
    }
        ...
        synchronized (this.g) {
            ...
            if (this.n != null && z) {
                ...
                if (a2 != null) {
                    ...
                    dpn.a();
                    int a3 = col.a((Context) this.i, a2[0]);
                    dpn.a();
                    popupWindow.update(a3, col.a((Context) this.i, a2[1]), this.n.getWidth(), this.n.getHeight());
                    a(a2[0], a2[1]);
                } else {
                    a(true);
                }
    ...
    public final int[] a() {
        /*
            ...
            int[] r0 = defpackage.cmd.b(r0)
            defpackage.bjl.e()
            android.app.Activity r1 = r12.i
            int[] r1 = defpackage.cmd.c(r1)
            r2 = 0
            r3 = r0[r2]
            r4 = 1
            r0 = r0[r4]
        ...
        L_0x0156:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cbv.a():int[]");
    }

    static {
        String[] strArr = {"top-left", "top-right", "top-center", "center", "bottom-left", "bottom-right", "bottom-center"};
        Set a2 = bzh.a(7, false);
