...
/* renamed from: ubr reason: default package */
public final class ubr {
    ...
    static class a extends Drawable {
        ...
        public a(Context context, String str, int i, int i2) {
            ...
            this.d.setTypeface(utw.b(context, R.attr.pasteTextAppearanceBodyMediumBold));
        }
    ...
    public final Drawable a(String str) {
        return a(str.substring(0, 1).toUpperCase(Locale.getDefault()), this.a.getResources().getColor(ubt.a(str)));
    }
