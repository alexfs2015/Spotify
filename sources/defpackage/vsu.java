...
public final class vsu implements Downloader {
    ...
    public final a a(Uri uri, int i) {
        ...
        if (VERSION.SDK_INT >= 14) {
            ...
            if (a == null) {
                try {
                    synchronized (b) {
                        if (a == null) {
                            File b2 = vsv.b(context);
                            HttpResponseCache installed = HttpResponseCache.getInstalled();
                            if (installed == null) {
                                installed = HttpResponseCache.install(b2, vsv.a(b2));
                            }
                            a = installed;
                        }
                    }
        ...
        if (responseCode < 300) {
            ...
            return new a(httpURLConnection.getInputStream(), vsv.a(httpURLConnection.getHeaderField("X-Android-Response-Source")), headerFieldInt);
        }
