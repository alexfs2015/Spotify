...
public final class nx extends h implements l {
    ...
    private final Runnable D = new Runnable() {
        public final void run() {
            ...
            nxVar.o = 3;
            nxVar.n.setFloatValues(new float[]{((Float) nxVar.n.getAnimatedValue()).floatValue(), 0.0f});
            nxVar.n.setDuration(500);
            nxVar.n.start();
        }
    };
    private final m E = new m() {
        public final void a(RecyclerView recyclerView, int i, int i2) {
            ...
            int computeVerticalScrollRange = nxVar.j.computeVerticalScrollRange();
            int i3 = nxVar.i;
            nxVar.k = computeVerticalScrollRange - i3 > 0 && nxVar.i >= nxVar.a;
            int computeHorizontalScrollRange = nxVar.j.computeHorizontalScrollRange();
            int i4 = nxVar.h;
            nxVar.l = computeHorizontalScrollRange - i4 > 0 && nxVar.h >= nxVar.a;
            if (nxVar.k || nxVar.l) {
                if (nxVar.k) {
                    float f = (float) i3;
                    nxVar.e = (int) ((f * (((float) computeVerticalScrollOffset) + (f / 2.0f))) / ((float) computeVerticalScrollRange));
                    nxVar.d = Math.min(i3, (i3 * i3) / computeVerticalScrollRange);
                }
                if (nxVar.l) {
                    float f2 = (float) computeHorizontalScrollOffset;
                    float f3 = (float) i4;
                    nxVar.g = (int) ((f3 * (f2 + (f3 / 2.0f))) / ((float) computeHorizontalScrollRange));
                    nxVar.f = Math.min(i4, (i4 * i4) / computeHorizontalScrollRange);
                }
                if (nxVar.m == 0 || nxVar.m == 1) {
                    nxVar.a(1);
                }
                return;
            }
    ...
    class a extends AnimatorListenerAdapter {
        ...
        public final void onAnimationEnd(Animator animator) {
            if (this.a) {
                this.a = false;
            } else if (((Float) nx.this.n.getAnimatedValue()).floatValue() == 0.0f) {
                nx nxVar = nx.this;
                nxVar.o = 0;
                nxVar.a(0);
            } else {
    ...
    class b implements AnimatorUpdateListener {
        ...
        public final void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            nx.this.b.setAlpha(floatValue);
            nx.this.c.setAlpha(floatValue);
            nx.this.j.invalidate();
        }
    }
    ...
    public nx(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i3, int i4) {
