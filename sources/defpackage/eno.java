...
final class eno extends emh<Integer> implements ent<Integer>, eoz, RandomAccess {
    private int[] b;
    private int c;
    ...
    public final /* synthetic */ ent a(int i) {
        if (i >= this.c) {
            return new eno(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        c();
        enp.a(collection);
        if (!(collection instanceof eno)) {
            return super.addAll(collection);
        }
        eno eno = (eno) collection;
        int i = eno.c;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(eno.b, 0, this.b, this.c, eno.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
