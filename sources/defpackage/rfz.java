...
public final class rfz {
    ...
    /* renamed from: rfz$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.rfz.AnonymousClass1.<clinit>():void");
        }
    }

    public rfz(Flowable<PlayerState> flowable, uzm uzm) {
        this.a = flowable;
        this.b = uzm;
    }
    ...
    public final Flowable<PlayerState> a() {
        return this.a.c(1).a((Predicate<? super T>) $$Lambda$rfz$RieEAjRhqRMcO8jTFMFYOcDcQ_8.INSTANCE).a((Predicate<? super T>) new $$Lambda$rfz$IFDwZ_I1cQNVAAdxaEoQKSCxZ4<Object>(this));
    }

    /* access modifiers changed from: private */
    public static boolean a(PlayerState playerState) {
        int i = AnonymousClass1.a[jst.a(playerState.contextUri()).b.ordinal()];
