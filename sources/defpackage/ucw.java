...
public final class ucw implements ucv {
    ...
    private final vhu n = new vhu((ViewGroup) this.a.findViewById(R.id.accessory));
    private final LottieAnimationView o = ((LottieAnimationView) this.a.findViewById(R.id.lottie_animated_icon_end));
    private final int p;
    private final uct q;

    private ucw(Context context, View view, Picasso picasso) {
        this.a = view;
        vfz.c(this.i).b(this.i).a();
        vfz.c(this.j).b(this.j).a();
        vfz.c(this.k).b(this.k).a();
        vfz.b(this.b).b(this.b).a();
        Context context2 = view.getContext();
        vgl.b(context2, this.e, R.attr.pasteTextAppearanceBodySmall);
        ...
        this.q = new uct(context, picasso);
    ...
    public static ucv a(Context context, ViewGroup viewGroup, Picasso picasso) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.episode_quick_action_card, viewGroup, false);
        if (VERSION.SDK_INT >= 21) {
            inflate.setClipToOutline(true);
        }
        return new ucw(context, inflate, picasso);
    }
