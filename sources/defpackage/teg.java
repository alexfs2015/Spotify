...
public final class teg implements a {
    private final teh a;
    private final tdi b;
    private tgb c;

    /* renamed from: teg$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.teg.AnonymousClass1.<clinit>():void");
        }
    }

    public teg(teh teh, tdi tdi) {
        this.a = teh;
        this.b = tdi;
    }

    public final void a(DrivingShowVoiceViewButtonViewBinder drivingShowVoiceViewButtonViewBinder, tgb tgb) {
        this.c = tgb;
