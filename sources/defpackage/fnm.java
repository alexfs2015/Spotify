...
final class fnm {
    ...
    private static void a(int i, int i2, fnj fnj) {
        int i3 = 0;
        while (i3 < 8) {
            int i4 = i + i3;
            if (a(fnj.a(i4, i2))) {
    ...
    private static void b(int i, int i2, fnj fnj) {
        int i3 = 0;
        while (i3 < 7) {
            int i4 = i2 + i3;
            if (a(fnj.a(i, i4))) {
    ...
    private static void c(int i, int i2, fnj fnj) {
        for (int i3 = 0; i3 < 7; i3++) {
            for (int i4 = 0; i4 < 7; i4++) {
                fnj.a(i + i4, i2 + i3, a[i3][i4]);
            }
        }
    }

    static void a(fln fln, ErrorCorrectionLevel errorCorrectionLevel, fnh fnh, int i, fnj fnj) {
        int i2;
        fnh fnh2 = fnh;
        int i3 = i;
        fnj fnj2 = fnj;
        ...
        c(0, 0, fnj2);
        c(fnj2.b - length, 0, fnj2);
        c(0, fnj2.b - length, fnj2);
        a(0, 7, fnj2);
        a(fnj2.b - 8, 7, fnj2);
        a(0, fnj2.b - 8, fnj2);
        b(7, 0, fnj2);
        ...
        if (fnj2.a(8, fnj2.c - 8) != 0) {
            ...
            if (fnh2.a >= 2) {
                ...
                while (i7 < length2) {
                    ...
                    while (i8 < length2) {
                        int i9 = iArr2[i7];
                        int i10 = iArr2[i8];
                        if (!(i10 == i2 || i9 == i2 || !a(fnj2.a(i10, i9)))) {
                            int i11 = i10 - 2;
                            int i12 = i9 - 2;
                            for (int i13 = 0; i13 < 5; i13++) {
                                for (int i14 = 0; i14 < 5; i14++) {
                                    fnj2.a(i11 + i14, i12 + i13, b[i13][i14]);
                                }
                            }
                        }
                        i8++;
            ...
            if (i3 >= 0 && i3 < 8) {
                ...
                fln2.a(i18, 5);
                fln2.a(a(i18, 1335), 10);
                fln fln3 = new fln();
                fln3.a(21522, 15);
                if (fln2.b == fln3.b) {
                    for (int i19 = 0; i19 < fln2.a.length; i19++) {
                        int[] iArr3 = fln2.a;
                        iArr3[i19] = iArr3[i19] ^ fln3.a[i19];
                    }
                    if (fln2.b == 15) {
                        for (int i20 = 0; i20 < fln2.b; i20++) {
                            boolean a2 = fln2.a((fln2.b - 1) - i20);
                            int[][] iArr4 = d;
                            fnj2.a(iArr4[i20][0], iArr4[i20][1], a2);
                            if (i20 < 8) {
                                fnj2.a((fnj2.b - i20) - 1, 8, a2);
                            } else {
                                fnj2.a(8, (fnj2.c - 7) + (i20 - 8), a2);
                            }
                        }
                        a(fnh2, fnj2);
                        a(fln, i3, fnj2);
    ...
    private static void a(fnh fnh, fnj fnj) {
        if (fnh.a >= 7) {
            fln fln = new fln();
            fln.a(fnh.a, 6);
            fln.a(a(fnh.a, 7973), 12);
            if (fln.b == 18) {
                int i = 0;
                int i2 = 17;
                while (i < 6) {
                    ...
                    for (int i4 = 0; i4 < 3; i4++) {
                        boolean a2 = fln.a(i3);
                        i3--;
                        fnj.a(i, (fnj.c - 11) + i4, a2);
                        fnj.a((fnj.c - 11) + i4, i, a2);
                    }
                    i++;
                    i2 = i3;
                }
    ...
    private static void a(defpackage.fln r12, int r13, defpackage.fnj r14) {
        /*
            int r0 = r14.b
            r1 = 1
            int r0 = r0 - r1
        ...
        L_0x00b5:
            goto L_0x00b4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fnm.a(fln, int, fnj):void");
    }
