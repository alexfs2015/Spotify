...
public final class dfx {
    ...
    private dfx(byte[] bArr, int i2, int i3) {
        this.a = bArr;
        this.b = 0;
        int i4 = i3 + 0;
        this.d = i4;
    ...
    public static dfx a(byte[] bArr, int i2) {
        return new dfx(bArr, 0, i2);
    }
    ...
    public final String d() {
        ...
        if (f2 >= 0) {
            ...
            int i3 = this.f;
            if (f2 <= i2 - i3) {
                String str = new String(this.a, i3, f2, dge.a);
                this.f += f2;
                return str;
            }
            throw zzbfh.a();
