...
public final class kbs {
    ...
    public kbs(RxResolver rxResolver, rwl rwl, Scheduler scheduler) {
        this.c = rxResolver;
        this.a = rwl.a().a(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false).a(SerializationFeature.FAIL_ON_EMPTY_BEANS, false).a(Include.NON_NULL).a();
        this.b = scheduler;
    }
