...
public final class uze {
    ...
    public static ConsumptionOrder a(String str) {
        return (ConsumptionOrder) jtc.a(a.get(str), ConsumptionOrder.UNKNOWN);
    }

    public static MediaType a(int i) {
        return (MediaType) jtc.a(b.get(Integer.valueOf(i)), MediaType.UNKNOWN);
    }
    ...
    public static String a(Covers covers, Size size) {
        ...
        if (size == Size.XLARGE && !fax.a(xlargeUri)) {
            return xlargeUri;
        }
        String largeUri = covers.getLargeUri();
        if ((size == Size.LARGE || size == Size.XLARGE) && !fax.a(largeUri)) {
            return largeUri;
        }
        String smallUri = covers.getSmallUri();
        return (size != Size.SMALL || fax.a(smallUri)) ? covers.getUri() : smallUri;
    }
    ...
    public static boolean a(uzb uzb) {
        uzc b2 = uzb.b();
        uys a2 = uzb.a();
