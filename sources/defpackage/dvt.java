...
public abstract class dvt extends djy implements dvs {
    public dvt() {
    ...
    public final boolean dispatchTransaction(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x008d:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dvt.dispatchTransaction(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
