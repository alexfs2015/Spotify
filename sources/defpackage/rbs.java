...
public final class rbs implements vby {
    private final rgs a;

    /* renamed from: rbs$2 reason: invalid class name */
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.rbs.AnonymousClass2.<clinit>():void");
        }
    }
    ...
    private vbx a(final YourLibraryPageId yourLibraryPageId) {
        final MusicPageId b = b(yourLibraryPageId);
        final rgq a2 = this.a.a(b);
        return new vbx() {
            ...
            public final vbw a(fqn fqn, String str) {
                return rbk.a(fqn, a2, str);
            }

            public final boolean a(String str) {
                return rgs.b(b).a().contains(jva.a(str).b);
            }
    ...
    public final ImmutableList<vbx> a() {
