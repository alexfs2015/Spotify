...
public final class riv implements riw {
    ...
    public riv(Context context, Picasso picasso, HubsGlueImageDelegate hubsGlueImageDelegate, ViewGroup viewGroup) {
        this.c = LayoutInflater.from((Context) fay.a(context)).inflate(R.layout.home_premium_promo_card, viewGroup, false);
        this.a = (Picasso) fay.a(picasso);
        this.b = (HubsGlueImageDelegate) fay.a(hubsGlueImageDelegate);
    }
    ...
    public final void a(String str, String str2) {
        ...
        Drawable a2 = fzg.a(context, spotifyIconV2, (float) uts.b(64.0f, context.getResources()));
