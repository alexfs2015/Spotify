...
interface dgn {
    ...
    <K, V> void a(int i, dek<K, V> dek, Map<K, V> map);

    void a(int i, Object obj);

    void a(int i, Object obj, dfj dfj);

    void a(int i, String str);

    void a(int i, List<String> list);

    void a(int i, List<?> list, dfj dfj);
    ...
    @Deprecated
    void b(int i, Object obj, dfj dfj);

    void b(int i, List<zzbah> list);

    @Deprecated
    void b(int i, List<?> list, dfj dfj);
