...
public final class se {
    public static final se a = new a().a();
    private static final String c = sg.a("Data");
        ...
        private a a(String str, Object obj) {
            if (obj == null) {
                ...
                if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                    ...
                    this.a.put(str, se.a((boolean[]) obj));
                } else if (cls == byte[].class) {
                    this.a.put(str, se.b((byte[]) obj));
                } else if (cls == int[].class) {
                    this.a.put(str, se.a((int[]) obj));
                } else if (cls == long[].class) {
                    this.a.put(str, se.a((long[]) obj));
                } else if (cls == float[].class) {
                    this.a.put(str, se.a((float[]) obj));
                } else if (cls == double[].class) {
                    this.a.put(str, se.a((double[]) obj));
                } else {
    ...
    public static byte[] a(defpackage.se r5) {
        /*
        ...
        L_0x00a7:
            goto L_0x00a6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.se.a(se):byte[]");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static defpackage.se a(byte[] r7) {
        /*
        ...
        L_0x0089:
            goto L_0x0088
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.se.a(byte[]):se");
    }
