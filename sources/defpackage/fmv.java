...
public final class fmv {
    ...
    public static String a(String str, fmx fmx) {
        if (str.length() == fmx.a) {
            StringBuilder sb = new StringBuilder(fmx.a + fmx.b);
            sb.append(str);
            int a2 = fmx.a();
            if (a2 == 1) {
                sb.append(a((CharSequence) str, fmx.b));
            } else {
                ...
                for (int i3 = 0; i3 < a2; i3++) {
                    ...
                    while (i5 < iArr2[i3] * a2) {
                        int i7 = i6 + 1;
                        sb.setCharAt(fmx.a + i5, a3.charAt(i6));
                        i5 += a2;
                        i6 = i7;
                    }
                }
