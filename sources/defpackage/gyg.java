...
final class gyg implements gul {
    private static final Function<HubsComponentCategory, Integer> a = new Function<HubsComponentCategory, Integer>() {
        public final /* synthetic */ Object apply(Object obj) {
            ...
            int i = AnonymousClass2.a[((HubsComponentCategory) fay.a(hubsComponentCategory)).ordinal()];
            if (i == 1) {
    ...
    private final gbg<HubsComponentCategory> b = gbg.a(HubsComponentCategory.class);

    /* renamed from: gyg$2 reason: invalid class name */
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.gyg.AnonymousClass2.<clinit>():void");
        }
    }
    ...
    public final int resolve(gzt gzt) {
        return ((Integer) this.b.b(gzt.componentId().category()).a(a).a(Integer.valueOf(0))).intValue();
    }
}
