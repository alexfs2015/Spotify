...
final /* synthetic */ class fgu implements Runnable {
    ...
    public final void run() {
        ...
        L_0x0002:
            ...
            return
        L_0x000a:
            java.util.Queue<fgy<?>> r1 = r0.d     // Catch:{ all -> 0x00ba }
        ...
        L_0x0017:
            ...
            fgy r1 = (defpackage.fgy) r1     // Catch:{ all -> 0x00ba }
            android.util.SparseArray<fgy<?>> r3 = r0.e     // Catch:{ all -> 0x00ba }
            int r4 = r1.a     // Catch:{ all -> 0x00ba }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ba }
            fgq r3 = r0.f     // Catch:{ all -> 0x00ba }
            java.util.concurrent.ScheduledExecutorService r3 = r3.b     // Catch:{ all -> 0x00ba }
            fgv r4 = new fgv     // Catch:{ all -> 0x00ba }
        ...
        L_0x005b:
            ...
            r4.putBundle(r3, r1)
            r5.setData(r4)
            fgw r1 = r0.c     // Catch:{ RemoteException -> 0x00b0 }
            ...
            goto L_0x0002
        L_0x009d:
            fhy r3 = r1.b     // Catch:{ RemoteException -> 0x00b0 }
            if (r3 == 0) goto L_0x00a8
            fhy r1 = r1.b     // Catch:{ RemoteException -> 0x00b0 }
        ...
        L_0x00be:
            goto L_0x00bd
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fgu.run():void");
    }
}
