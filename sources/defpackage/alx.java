...
public class alx {
    private static final String a = alx.class.getCanonicalName();
    ...
    public static void a() {
            ...
            try {
                ...
                f = new ActivityLifecycleCallbacks() {
                    ...
                    public final void onActivityResumed(Activity activity) {
                        akq.e().execute(new Runnable() {
                            public final void run() {
                                Context g = akq.g();
                                alx.a(g, aly.a(g, alx.h));
                                Map b = aly.b(g, alx.h);
                                alx.a(g, b, new HashMap());
                                HashSet hashSet = new HashSet();
                                b.clear();
                                Iterator it = aly.a(g, alx.h, (Set<Integer>) hashSet).iterator();
                                while (it.hasNext()) {
                    ...
                    public final void onActivityStopped(Activity activity) {
                        if (alx.d.booleanValue() && activity.getLocalClassName().equals("com.android.billingclient.api.ProxyBillingActivity")) {
                            akq.e().execute(new Runnable() {
                                public final void run() {
                                    Context g = akq.g();
                                    ArrayList a2 = aly.a(g, alx.h);
                                    if (a2.isEmpty()) {
                                        a2 = aly.c(g, alx.h);
                                    }
                                    alx.a(g, a2);
        ...
        if (c.booleanValue() && alw.b() && b.compareAndSet(false, true)) {
            Context g2 = akq.g();
    ...
    static /* synthetic */ void a(Context context, ArrayList arrayList) {
        if (!arrayList.isEmpty()) {
            ...
            for (Entry entry : aly.a(context, arrayList2, h, false).entrySet()) {
                alw.a((String) hashMap.get(entry.getKey()), (String) entry.getValue());
            }
        }
    }
    ...
    static /* synthetic */ void a(Context context, Map map, Map map2) {
        if (!map.isEmpty()) {
            ...
            Map a2 = aly.a(context, arrayList, h, true);
            for (String str2 : a2.keySet()) {
                String str3 = (String) hashMap.get(str2);
                alw.a((SubscriptionType) map.get(str3), str3, (String) a2.get(str2), map2);
            }
        }
    }
}
