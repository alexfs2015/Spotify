...
public final class rv {
    ...
    /* JADX WARNING: type inference failed for: r4v3, types: [ry] */
    ...
    public static android.view.animation.Interpolator a(android.content.Context r6, int r7) {
        ...
        L_0x000b:
            ...
            kx r6 = new kx     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001d }
        ...
        L_0x0023:
            ...
            ky r6 = new ky     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001d }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001d }
            return r6
        L_0x002e:
            r0 = 17563662(0x10c000e, float:2.5713978E-38)
            if (r7 != r0) goto L_0x0039
            kz r6 = new kz     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001d }
            r6.<init>()     // Catch:{ XmlPullParserException -> 0x0020, IOException -> 0x001d }
            return r6
        L_0x0039:
        ...
        L_0x00e6:
            ...
            ry r4 = new ry     // Catch:{ XmlPullParserException -> 0x0117, IOException -> 0x0114, all -> 0x0112 }
        ...
        L_0x0153:
            goto L_0x0152
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rv.a(android.content.Context, int):android.view.animation.Interpolator");
    }
}
