...
public final class rv extends ru {
    ...
    static class f {
        ...
        private void a(defpackage.rv.c r17, android.graphics.Matrix r18, android.graphics.Canvas r19, int r20, int r21, android.graphics.ColorFilter r22) {
            /*
                r16 = this;
                r7 = r16
                r8 = r17
                ...
                r12 = 0
            L_0x001b:
                java.util.ArrayList<rv$d> r0 = r8.b
                int r0 = r0.size()
                if (r12 >= r0) goto L_0x0222
                java.util.ArrayList<rv$d> r0 = r8.b
                java.lang.Object r0 = r0.get(r12)
                rv$d r0 = (defpackage.rv.d) r0
                boolean r1 = r0 instanceof defpackage.rv.c
                if (r1 == 0) goto L_0x0043
                r1 = r0
                rv$c r1 = (defpackage.rv.c) r1
                ...
                goto L_0x0217
            L_0x0043:
                boolean r1 = r0 instanceof defpackage.rv.e
                if (r1 == 0) goto L_0x0217
                rv$e r0 = (defpackage.rv.e) r0
                r1 = r20
                float r2 = (float) r1
                float r3 = r7.f
                float r2 = r2 / r3
            ...
            L_0x0222:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.rv.f.a(rv$c, android.graphics.Matrix, android.graphics.Canvas, int, int, android.graphics.ColorFilter):void");
        }
    ...
    static class h extends ConstantState {
        ...
        public final Drawable newDrawable() {
            rv rvVar = new rv();
            rvVar.b = (VectorDrawable) this.a.newDrawable();
            return rvVar;
        }

        public final Drawable newDrawable(Resources resources) {
            rv rvVar = new rv();
            rvVar.b = (VectorDrawable) this.a.newDrawable(resources);
            return rvVar;
        }

        public final Drawable newDrawable(Resources resources, Theme theme) {
            rv rvVar = new rv();
            rvVar.b = (VectorDrawable) this.a.newDrawable(resources, theme);
            return rvVar;
        }
    ...
    public final void draw(android.graphics.Canvas r11) {
        ...
        L_0x0179:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.rv.draw(android.graphics.Canvas):void");
    }
    ...
    public static rv a(Resources resources, int i2, Theme theme) {
        int next;
        String str = "parser error";
        String str2 = "VectorDrawableCompat";
        if (VERSION.SDK_INT >= 24) {
            rv rvVar = new rv();
            rvVar.b = gb.a(resources, i2, theme);
            rvVar.h = new h(rvVar.b.getConstantState());
            return rvVar;
        }
        try {
    ...
    public static rv a(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        rv rvVar = new rv();
        rvVar.inflate(resources, xmlPullParser, attributeSet, theme);
        return rvVar;
    }
    ...
    public final void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        g gVar = this.d;
        gVar.b = new f();
        TypedArray a2 = gc.a(resources2, theme2, attributeSet2, rn.a);
        g gVar2 = this.d;
        f fVar = gVar2.b;
    ...
    private void b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Theme theme) {
        ...
        for (int i2 = 1; eventType != i2 && (xmlPullParser.getDepth() >= depth || eventType != 3); i2 = 1) {
            ...
            if (eventType == 2) {
                ...
                if ("path".equals(name)) {
                    b bVar = new b();
                    TypedArray a2 = gc.a(resources2, theme2, attributeSet2, rn.c);
                    ...
                    if (gc.a(xmlPullParser2, "pathData")) {
                        TypedArray a3 = gc.a(resources2, theme2, attributeSet2, rn.d);
                    ...
                    c cVar2 = new c();
                    TypedArray a4 = gc.a(resources2, theme2, attributeSet2, rn.b);
                    cVar2.l = null;
