...
public final class wld {
    ...
    public static wld a(TextView textView, AttributeSet attributeSet, int i2) {
        wld wld = new wld(textView);
        boolean z = true;
        if (attributeSet != null) {
            Context context = textView.getContext();
            int i3 = (int) wld.f;
            float f2 = wld.h;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.wle.a.a, i2, 0);
            z = obtainStyledAttributes.getBoolean(defpackage.wle.a.d, true);
            int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(defpackage.wle.a.b, i3);
            float f3 = obtainStyledAttributes.getFloat(defpackage.wle.a.c, f2);
            obtainStyledAttributes.recycle();
            wld.a(0, (float) dimensionPixelSize).c(f3);
        }
        wld.a(z);
        return wld;
    }
    ...
    public final wld a(float f2) {
        return a(2, 14.0f);
    }

    private wld a(int i2, float f2) {
