...
public final class lue implements lud {
    ...
    public final void a(Context context) {
        ...
        BrandType brandType2 = BrandType.ALL;
        ...
        if (context != null) {
            ...
            if (context != null) {
                ...
                AnonymousClass2 r4 = new Runnable(context, R.string.app_name, R.drawable.bmw_spotify_logo, applicationType, str, str2, brandType) {
