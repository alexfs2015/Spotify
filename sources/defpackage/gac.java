...
public final class gac {
    ...
    public static void a(View view, long j) {
        if (view.getVisibility() != 0) {
            ...
            alphaAnimation.setInterpolator(ftn.d);
    ...
    public static <V extends View> void a(final V v, final gbr<V> gbr, final boolean z) {
        fay.a(v);
        fay.a(gbr);
    ...
    public static void b(final View view, final int i) {
        ...
        if (view.getVisibility() != i) {
            ...
            alphaAnimation.setAnimationListener(new jxf() {
