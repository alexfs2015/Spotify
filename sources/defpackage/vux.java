...
/* renamed from: vux reason: default package */
public final class vux implements vuy {
    private final File a;

    private vux(File file) {
        this.a = file;
    }

    public static vux a(Context context, String str) {
        return a(context.getDir("remote-config", 0), str);
    }

    private static vux a(File file, String str) {
        if (!file.exists()) {
            file.mkdirs();
        }
        return new vux(new File(file, str));
    }
    ...
    private byte[] c() {
        ...
        L_0x0023:
            ...
            defpackage.xop.a(r1, r3, r2)
        L_0x0035:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vux.c():byte[]");
    }

    private void d() {
        if (this.a.exists()) {
            if (!this.a.delete()) {
                xop.c("Can't delete file <%s>", this.a.getAbsolutePath());
                return;
            }
            xop.a("File <%s> deleted", this.a.getAbsolutePath());
        }
    }

    public final synchronized vup a() {
        if (!this.a.exists() || this.a.length() == 0) {
            xop.b("No existing configuration. Returning the default one.", new Object[0]);
            return vup.d();
        }
        try {
            return vup.a(GranularConfiguration.a(c()));
        } catch (InvalidProtocolBufferException e) {
            xop.a(e, "Can't parse protobuf", new Object[0]);
            return vup.d();
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void a(defpackage.vup r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            ...
            defpackage.xop.a(r0, r2)     // Catch:{ all -> 0x0059 }
        ...
        L_0x0014:
            ...
            defpackage.xop.a(r3, r4)     // Catch:{ all -> 0x0040 }
        ...
        L_0x0047:
            ...
            defpackage.xop.a(r6, r2, r0)     // Catch:{ all -> 0x0059 }
        L_0x0057:
            monitor-exit(r5)
            return
        L_0x0059:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vux.a(vup):void");
    }

    public final void b() {
        xop.a("Cleaning configuration store.", new Object[0]);
        d();
    }
}
