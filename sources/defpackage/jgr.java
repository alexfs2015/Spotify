...
public final class jgr extends AuthorizationRequest {
    ...
    public jgr(String str, String str2, List<String> list, ResponseType responseType, ClientIdentity clientIdentity, String str3, boolean z) {
        if (str != null) {
            this.a = str;
            if (str2 != null) {
                this.b = str2;
