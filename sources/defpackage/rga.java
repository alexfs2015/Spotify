...
public abstract class rga extends f {
    final boolean a;
    final boolean b;
    final boolean c;
    final boolean d;
    ...
    public static final class a extends com.spotify.music.features.yourlibrary.musicpages.item.MusicItem.f.a {
        ...
        public final f a() {
            ...
            if (str.isEmpty()) {
                rge rge = new rge(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d.booleanValue(), this.e.booleanValue(), this.f.booleanValue(), this.g.booleanValue(), this.h.booleanValue(), this.i, this.j);
                return rge;
            }
    ...
    rga(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, String str, String str2) {
        this.a = z;
        this.b = z2;
        this.c = z3;
        this.d = z4;
