...
public abstract class wuh extends wuj implements wvo {
    ...
    private static final boolean j = ((Boolean) AccessController.doPrivileged(new PrivilegedAction<Boolean>() {
        public final /* synthetic */ Object run() {
            return Boolean.valueOf(wxu.a("jdk.tls.rejectClientInitiatedRenegotiation", false));
        }
    })).booleanValue();
    private static final List<String> k;
    private static final Integer l;
    private static final ResourceLeakDetector<wuh> m;
    private static wtq u = new wtq() {
    ...
    /* renamed from: wuh$5 reason: invalid class name */
    static /* synthetic */ class AnonymousClass5 {
        ...
        static {
            ...
            L_0x006f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.wuh.AnonymousClass5.<clinit>():void");
        }
    }
    ...
    /* renamed from: wuh$b */
    static final class b implements wtv {
    ...
    static {
        /*
            java.lang.Class<wuh> r0 = defpackage.wuh.class
            wyc r1 = defpackage.wyd.a(r0)
            i = r1
            wuh$1 r1 = new wuh$1
            r1.<init>()
        ...
        L_0x007f:
            r0 = 0
            wuh$4 r1 = new wuh$4     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00a5:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wuh.<clinit>():void");
    }

    wuh(Iterable<String> iterable, wtb wtb, ApplicationProtocolConfig applicationProtocolConfig, long j2, long j3, int i2, Certificate[] certificateArr, ClientAuth clientAuth, boolean z, boolean z2) {
        this(iterable, wtb, a(applicationProtocolConfig), j2, j3, i2, certificateArr, clientAuth, z, z2);
    }

    wuh(Iterable<String> iterable, wtb wtb, wtq wtq, long j2, long j3, int i2, Certificate[] certificateArr, ClientAuth clientAuth, boolean z, boolean z2) {
        long j4 = j2;
        long j5 = j3;
        int i3 = i2;
        super(z);
        this.t = new wvb() {
            public final wvo b(Object obj) {
                if (wuh.this.s != null) {
                    wuh.this.s.a(obj);
                }
                return wuh.this;
        ...
        if (i3 == 1 || i3 == 0) {
            ...
            this.r = i3;
            this.d = e() ? (ClientAuth) wxq.a(clientAuth, "clientAuth") : ClientAuth.NONE;
            if (i3 == 1) {
                this.f = j;
            }
            ...
            this.o = Arrays.asList(((wtb) wxq.a(wtb, "cipherFilter")).a(arrayList, k, wtp.c()));
            this.b = (wtq) wxq.a(wtq, "apn");
            ...
            try {
                synchronized (wuh.class) {
                    try {
                        ...
                        SSLContext.setCipherSuite(this.a, wta.a((Iterable<String>) this.o));
                        List a3 = wtq.a();
                        if (!a3.isEmpty()) {
                            String[] strArr = (String[]) a3.toArray(new String[a3.size()]);
                            int i5 = AnonymousClass5.b[wtq.c().ordinal()];
                            if (i5 != 1) {
                                if (i5 == 2) {
                                    i4 = 1;
                                } else {
                            ...
                            int i6 = AnonymousClass5.a[wtq.b().ordinal()];
                            if (i6 == 1) {
    ...
    static long a(PrivateKey privateKey) {
        ...
        wnc wnc = wnc.a;
        wud a2 = PemPrivateKey.a(wnc, true, privateKey);
        try {
            return a(wnc, a2.c());
        } finally {
            a2.B();
    ...
    private static long a(wnb wnb) {
        try {
            long newMemBIO = SSL.newMemBIO();
            int g = wnb.g();
            if (SSL.writeToBIO(newMemBIO, wtp.a(wnb) + ((long) wnb.c()), g) == g) {
                return newMemBIO;
            }
    ...
    static long a(X509Certificate... x509CertificateArr) {
        wnc wnc = wnc.a;
        wud a2 = PemX509Certificate.a(wnc, true, x509CertificateArr);
        try {
            return a(wnc, a2.c());
        } finally {
            a2.B();
    ...
    static wtq a(ApplicationProtocolConfig applicationProtocolConfig) {
        ...
        if (i2 == 1 || i2 == 2 || i2 == 3) {
            ...
            if (i3 == 1 || i3 == 2) {
                ...
                if (i4 == 1 || i4 == 2) {
                    return new wtt(applicationProtocolConfig);
                }
    ...
    static void a(long r17, java.security.cert.X509Certificate[] r19, java.security.PrivateKey r20, java.lang.String r21) {
        /*
            r1 = 0
            r3 = 0
            wnc r0 = defpackage.wnc.a     // Catch:{ SSLException -> 0x007c, Exception -> 0x0071, all -> 0x006d }
            r4 = 1
            r5 = r19
            wud r3 = io.netty.handler.ssl.PemX509Certificate.a(r0, r4, r5)     // Catch:{ SSLException -> 0x007c, Exception -> 0x0071, all -> 0x006d }
            wnc r0 = defpackage.wnc.a     // Catch:{ SSLException -> 0x007c, Exception -> 0x0071, all -> 0x006d }
            wud r5 = r3.c()     // Catch:{ SSLException -> 0x007c, Exception -> 0x0071, all -> 0x006d }
            long r13 = a(r0, r5)     // Catch:{ SSLException -> 0x007c, Exception -> 0x0071, all -> 0x006d }
            wnc r0 = defpackage.wnc.a     // Catch:{ SSLException -> 0x006a, Exception -> 0x0067, all -> 0x0064 }
            wud r5 = r3.c()     // Catch:{ SSLException -> 0x006a, Exception -> 0x0067, all -> 0x0064 }
        ...
        L_0x0092:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wuh.a(long, java.security.cert.X509Certificate[], java.security.PrivateKey, java.lang.String):void");
    }
    ...
    public SSLEngine b(wnc wnc, String str, int i2) {
        ReferenceCountedOpenSslEngine referenceCountedOpenSslEngine = new ReferenceCountedOpenSslEngine(this, wnc, str, i2, true);
        return referenceCountedOpenSslEngine;
    }

    public abstract wub b();
