...
/* renamed from: vvz reason: default package */
final class vvz extends vwe {
    private final String a;
    private final String b;
    private final String c;
    private final String d;

    vvz(String str, String str2, String str3, String str4) {
        if (str != null) {
            this.a = str;
            if (str2 != null) {
                this.b = str2;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof vwe) {
            vwe vwe = (vwe) obj;
            return this.a.equals(vwe.a()) && this.b.equals(vwe.b()) && this.c.equals(vwe.c()) && this.d.equals(vwe.d());
        }
    }
