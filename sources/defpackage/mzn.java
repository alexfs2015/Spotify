...
public final class mzn implements vua<gum> {
    ...
    private mzn(wlc<Activity> wlc, wlc<a> wlc2, wlc<gvv> wlc3, wlc<res> wlc4, wlc<gxz> wlc5, wlc<Map<String, gvk>> wlc6) {
        this.a = wlc;
        this.b = wlc2;
        this.c = wlc3;
        this.d = wlc4;
    ...
    public static mzn a(wlc<Activity> wlc, wlc<a> wlc2, wlc<gvv> wlc3, wlc<res> wlc4, wlc<gxz> wlc5, wlc<Map<String, gvk>> wlc6) {
        mzn mzn = new mzn(wlc, wlc2, wlc3, wlc4, wlc5, wlc6);
        return mzn;
    }
