...
public final class vgr extends AppsMusicLibsRemoteconfigProperties {
    ...
    public static final class a extends com.spotify.remoteconfig.AppsMusicLibsRemoteconfigProperties.a {
        ...
        public final AppsMusicLibsRemoteconfigProperties a() {
            ...
            if (str.isEmpty()) {
                return new vgr(this.a, this.b, 0);
            }
    ...
    /* synthetic */ vgr(SettingsDebugLabel settingsDebugLabel, SimpleMessageTest simpleMessageTest, byte b2) {
        this(settingsDebugLabel, simpleMessageTest);
    }

    private vgr(SettingsDebugLabel settingsDebugLabel, SimpleMessageTest simpleMessageTest) {
        this.a = settingsDebugLabel;
        this.b = simpleMessageTest;
    }
