...
public final class amj {
    ...
    private static amz b = new amz(8);
    private static amz c = new amz(2);
    ...
    public static void a(amk amk) {
        if (amk != null) {
            d dVar = new d(amk.b, amk.e);
            synchronized (d) {
                c cVar = (c) d.get(dVar);
                if (cVar != null) {
                    cVar.b = amk;
    ...
    public static boolean b(amk amk) {
        boolean z;
        d dVar = new d(amk.b, amk.e);
        synchronized (d) {
            c cVar = (c) d.get(dVar);
    ...
    private static void a(amk amk, d dVar, boolean z) {
        a(amk, dVar, c, (Runnable) new a(amk.a, dVar, z));
    }

    private static void a(amk amk, d dVar, amz amz, Runnable runnable) {
        synchronized (d) {
            c cVar = new c(0);
            cVar.b = amk;
            d.put(dVar, cVar);
            cVar.a = amz.a(runnable, true);
        }
    }
    ...
    private static void a(d dVar, Exception exc, Bitmap bitmap, boolean z) {
        ...
        if (a2 != null && !a2.c) {
            final amk amk = a2.b;
            final defpackage.amk.b bVar = amk.c;
            if (bVar != null) {
                Handler a3 = a();
                ...
                AnonymousClass1 r1 = new Runnable() {
                    public final void run() {
                        bVar.a(new aml(amk, exc2, z2, bitmap2));
                    }
                };
                a3.post(r1);
            }
    ...
    static /* synthetic */ void a(defpackage.amj.d r2, android.content.Context r3, boolean r4) {
        /*
            r0 = 0
            r1 = 0
            if (r4 == 0) goto L_0x0014
            android.net.Uri r4 = r2.a
            android.net.Uri r4 = defpackage.amv.a(r4)
            if (r4 == 0) goto L_0x0014
            java.io.InputStream r4 = defpackage.amm.a(r4, r3)
        ...
        L_0x0042:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.amj.a(amj$d, android.content.Context, boolean):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    static /* synthetic */ void a(defpackage.amj.d r10, android.content.Context r11) {
        /*
            r0 = 0
            r1 = 0
            r2 = 1
        ...
        L_0x003b:
            ...
            goto L_0x003b
        L_0x0045:
            defpackage.amw.a(r5)     // Catch:{ IOException -> 0x005d, all -> 0x005a }
            goto L_0x004e
        L_0x0049:
        ...
        L_0x005f:
            ...
            boolean r2 = defpackage.amw.a(r11)     // Catch:{ IOException -> 0x008e, all -> 0x00a1 }
            ...
            defpackage.amv.a(r2, r11)     // Catch:{ IOException -> 0x008e, all -> 0x00a1 }
            amj$c r2 = a(r10)     // Catch:{ IOException -> 0x008e, all -> 0x00a1 }
            if (r2 == 0) goto L_0x008a
            boolean r4 = r2.c     // Catch:{ IOException -> 0x008e, all -> 0x00a1 }
            if (r4 != 0) goto L_0x008a
            amk r2 = r2.b     // Catch:{ IOException -> 0x008e, all -> 0x00a1 }
            amj$d r4 = new amj$d     // Catch:{ IOException -> 0x008e, all -> 0x00a1 }
        ...
        L_0x00c0:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.amj.a(amj$d, android.content.Context):void");
    }
}
