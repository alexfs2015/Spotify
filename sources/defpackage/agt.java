...
public abstract class agt {
    private static final agw b = agw.a("kju.remoting");
    protected String a;
    ...
    public final void a(android.content.BroadcastReceiver r7) {
        /*
            ...
            agw r0 = b     // Catch:{ IllegalArgumentException -> 0x0046 }
        ...
        L_0x005b:
            goto L_0x005a
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.agt.a(android.content.BroadcastReceiver):void");
    }

    public final void a(String str, BroadcastReceiver broadcastReceiver) {
        Context applicationContext = agu.a(this.a).a.getApplicationContext();
