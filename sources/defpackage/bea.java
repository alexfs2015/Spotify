...
public final class bea {
    ...
    public final void a(bdz bdz, int i) {
        a(bdz.a, 0, i);
        bdz.a(0);
    }
    ...
    public final String f(int i) {
        ...
        int i2 = (this.b + i) - 1;
        String a2 = ben.a(this.a, this.b, (i2 >= this.c || this.a[i2] != 0) ? i : i - 1);
        this.b += i;
        return a2;
    }
    ...
    public final String r() {
        ...
        int i = this.b;
        while (i < this.c && !ben.a((int) this.a[i])) {
            i++;
        }
        int i2 = this.b;
        if (i - i2 >= 3) {
