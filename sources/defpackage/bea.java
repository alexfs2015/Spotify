...
public final class bea extends Surface {
        ...
        public final boolean handleMessage(Message message) {
            ...
            if (i == 1) {
                try {
                    ...
                    if (eglGetDisplay != null) {
                        ...
                        if (EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1)) {
                            ...
                            if (!eglChooseConfig || iArr2[0] <= 0 || eGLConfigArr[0] == null) {
                                throw new GlException(bdw.a("eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]), 0);
                            }
                            ...
                            if (eglCreateContext != null) {
                                ...
                                if (EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eGLContext)) {
                                    ...
                                    if (glGetError == 0) {
                                        ...
                                        this.e = new bea(this, (SurfaceTexture) bcu.a(this.b.f), i2 != 0, 0);
                                        synchronized (this) {
                                            notify();
                                        }
                                        return true;
                    ...
                    bdd.b("DummySurface", "Failed to initialize dummy surface", e2);
                    this.d = e2;
                    synchronized (this) {
                        notify();
                    }
                    ...
                    try {
                        bdd.b("DummySurface", "Failed to initialize dummy surface", e3);
                        this.c = e3;
                        synchronized (this) {
                            notify();
                        }
    ...
    /* synthetic */ bea(a aVar, SurfaceTexture surfaceTexture, boolean z, byte b2) {
    ...
    public static synchronized boolean a(Context context) {
        ...
        synchronized (bea.class) {
            if (!c) {
                if (bdw.a >= 24) {
                    if (bdw.a < 26) {
                        if (!"samsung".equals(bdw.c)) {
                            if ("XT1650".equals(bdw.d)) {
                            }
                        }
                    }
                    if (bdw.a >= 26 || context.getPackageManager().hasSystemFeature("android.hardware.vr.high_performance")) {
    ...
    private bea(a aVar, SurfaceTexture surfaceTexture, boolean z) {
    ...
    public static bea a(Context context, boolean z) {
        if (bdw.a >= 17) {
            int i = 0;
            bcu.b(!z || a(context));
            a aVar = new a();
