...
final class szb extends c {
    ...
    /* renamed from: szb$a */
    static final class a extends defpackage.sze.c.a {
        private Boolean a;
        private Boolean b;
        private Boolean c;
        private Boolean d;
        ...
        public final defpackage.sze.c.a a(boolean z) {
            this.a = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a b(boolean z) {
            this.b = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a c(boolean z) {
            this.c = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a d(boolean z) {
            this.d = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a e(boolean z) {
            this.e = Boolean.TRUE;
            return this;
        }

        public final defpackage.sze.c.a f(boolean z) {
            this.f = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a g(boolean z) {
            this.g = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a h(boolean z) {
            this.h = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a i(boolean z) {
            this.i = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a j(boolean z) {
            this.j = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a k(boolean z) {
            this.k = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.c.a l(boolean z) {
        ...
        public final c a() {
            ...
            if (str.isEmpty()) {
                szb szb = new szb(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d.booleanValue(), this.e.booleanValue(), this.f.booleanValue(), this.g.booleanValue(), this.h.booleanValue(), this.i.booleanValue(), this.j.booleanValue(), this.k.booleanValue(), this.l.booleanValue(), 0);
                return szb;
            }
    ...
    /* synthetic */ szb(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12, byte b2) {
        this(z, z2, z3, z4, z5, z6, z7, z8, z9, z10, z11, z12);
    }

    private szb(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12) {
        this.b = z;
        this.c = z2;
        this.d = z3;
        this.e = z4;
