...
public final class rgi {
    ...
    public rgi(ViewGroup viewGroup) {
        this.a = viewGroup;
    }
    ...
    public final void a(List<View> list) {
        if (!faw.a(this.b, list)) {
            ...
            view2.post(new $$Lambda$rgi$etn4UsWBA97iZMbuIeiQNVqmFM(this, view2));
        }
    }
    ...
    public /* synthetic */ void b(View view) {
        ...
        if (list != null && !list.isEmpty()) {
            int b2 = uts.b(24.0f, this.a.getResources());
            List<View> list2 = this.b;
            View view2 = (View) list2.get(list2.size() - 1);
            Rect rect = this.d;
