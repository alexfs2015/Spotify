...
public final class nqm extends ListeningHistoryModel {
    ...
    public static final class a implements com.spotify.music.features.listeninghistory.domain.ListeningHistoryModel.a {
        ...
        public final ListeningHistoryModel a() {
            ...
            if (str.isEmpty()) {
                nqm nqm = new nqm(this.a, this.b, this.c, this.d.booleanValue(), 0);
                return nqm;
            }
    ...
    /* synthetic */ nqm(ImmutableList immutableList, String str, LoadState loadState, boolean z, byte b2) {
        this(immutableList, str, loadState, z);
    }

    private nqm(ImmutableList<Session> immutableList, String str, LoadState loadState, boolean z) {
