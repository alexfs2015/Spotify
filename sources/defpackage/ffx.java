...
final class ffx implements ServiceConnection {
    int a;
    final Messenger b;
    fgc c;
    final Queue<fge<?>> d;
    final SparseArray<fge<?>> e;
    final /* synthetic */ ffw f;

    private ffx(ffw ffw) {
        this.f = ffw;
        this.a = 0;
        this.b = new Messenger(new ejb(Looper.getMainLooper(), new ffy(this)));
    ...
    public final synchronized boolean a(defpackage.fge r6) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x002e:
            ...
            return r2
        L_0x0030:
            java.util.Queue<fge<?>> r0 = r5.d     // Catch:{ all -> 0x0089 }
        ...
        L_0x004c:
            r6 = 0
        L_0x004d:
            defpackage.bwx.a(r6)     // Catch:{ all -> 0x0089 }
            ...
            bzb r0 = defpackage.bzb.a()     // Catch:{ all -> 0x0089 }
            ffw r1 = r5.f     // Catch:{ all -> 0x0089 }
        ...
        L_0x0089:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ffx.a(fge):boolean");
    }

    /* JADX INFO: used method not loaded: fge.a(com.google.firebase.iid.zzal):null, types can be incorrect */
    /* JADX INFO: used method not loaded: fge.a(android.os.Bundle):null, types can be incorrect */
    /* access modifiers changed from: 0000 */
    ...
    public final boolean a(android.os.Message r5) {
        ...
        L_0x001a:
            monitor-enter(r4)
            android.util.SparseArray<fge<?>> r1 = r4.e     // Catch:{ all -> 0x005d }
            java.lang.Object r1 = r1.get(r0)     // Catch:{ all -> 0x005d }
            fge r1 = (defpackage.fge) r1     // Catch:{ all -> 0x005d }
            r2 = 1
            ...
            return r2
        L_0x0037:
            android.util.SparseArray<fge<?>> r3 = r4.e     // Catch:{ all -> 0x005d }
        ...
        L_0x005d:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ffx.a(android.os.Message):boolean");
    }
    ...
    public final synchronized void a(int i) {
        fge fge = (fge) this.e.get(i);
        if (fge != null) {
            StringBuilder sb = new StringBuilder(31);
            sb.append("Timing out request: ");
            sb.append(i);
            this.e.remove(i);
            fge.a(new zzal(3, "Timed out waiting for response"));
            a();
        }
    }

    /* synthetic */ ffx(ffw ffw, byte b2) {
        this(ffw);
    }
}
