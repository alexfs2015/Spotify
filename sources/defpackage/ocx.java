...
public final class ocx {
    ...
    /* renamed from: ocx$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ocx.AnonymousClass1.<clinit>():void");
        }
    }

    public ocx(jjf jjf, hec hec) {
        this.b = hec;
        this.a = jjf;
    }
    ...
    public final Observable<Boolean> a() {
        return b().c((Function<? super T, ? extends R>) new $$Lambda$ocx$5khBWyjhKsR1cfqP7X560Hy_QiI<Object,Object>(this));
    }
    ...
    public /* synthetic */ Boolean a(BundlingPlaceboBannerFlag bundlingPlaceboBannerFlag) {
        ...
        if (i == 1 || i == 2) {
            this.a.a(new ar("", "should-show", null));
            z = true;
        } else {
            if (!(i == 3 || i == 4 || i == 5)) {
