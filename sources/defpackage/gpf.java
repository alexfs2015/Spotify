...
public class gpf extends jrd implements a {
    public gpv T;
    private String U;
    private String V;
    private Button W;
    ...
    public static gpf a(String str, boolean z, String str2) {
        gpf gpf = new gpf();
    ...
    public /* synthetic */ boolean a(TextView textView, int i, KeyEvent keyEvent) {
        if (i == 6 && !TextUtils.isEmpty(textView.getText())) {
            this.T.a(gpp.a(new b(), new h(), new c()));
    ...
    public /* synthetic */ void b(View view) {
        this.a.a.af();
        this.T.a(gpp.a(new a(), new g(), new c()));
    }
    ...
    public /* synthetic */ void d(View view) {
        this.T.a(gpp.a(this.X.getDisplayedChild() == 0 ? new b() : new a(), new a(), new c()));
        this.t.c();
    }
    ...
    public final View a(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ((SpotifyIconView) inflate.findViewById(R.id.back_button)).setOnClickListener(new $$Lambda$gpf$VW2jNiNhwnCREDvU67n2zCvI988(this));
        ...
        this.ab.addTextChangedListener(new jzg() {
            public final void afterTextChanged(Editable editable) {
                if (!gpf.this.ad && !gpf.this.ae) {
                    gpf.this.T.a(gpp.a((gpw) new b(), (gpu) new a()));
                    gpf.this.ad = true;
                }
                gpf.this.ae = false;
                gpf.this.a.a.i(!editable.toString().isEmpty());
            }
        });
        this.ab.setOnEditorActionListener(new $$Lambda$gpf$fDnnPlk1YUrBYfKl07jvXd_W0(this));
        this.W = (Button) inflate.findViewById(R.id.login_password_reset_button);
        this.W.setOnClickListener(new $$Lambda$gpf$bIiMAqdHHTUQbFKyxHz8YsoatLc(this));
        ((Button) inflate.findViewById(R.id.open_email_app_button)).setOnClickListener(new $$Lambda$gpf$2p2bYhG561HDZaPWqNyzfwzbGzs(this));
    ...
    public final void a(boolean z) {
        ...
        if (z) {
            this.T.a(gpp.a((gpw) new b(), (gpt) new g()));
        } else {
            this.T.a(gpp.a((gpw) new b(), (gpt) new f()));
        }
        gbx.b(this.ab);
