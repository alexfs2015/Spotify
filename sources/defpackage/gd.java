...
public final class gd {
    ...
    public static double a(int i) {
        ...
        if (dArr.length == 3) {
            ...
            double d7 = (double) blue;
            Double.isNaN(d7);
            double d8 = d7 / 255.0d;
            double pow2 = d8 < 0.04045d ? d8 / 12.92d : Math.pow((d8 + 0.055d) / 1.055d, d);
            dArr[0] = ((0.4124d * pow) + (0.3576d * d2) + (0.1805d * pow2)) * 100.0d;
            dArr[1] = ((0.2126d * pow) + (0.7152d * d2) + (0.0722d * pow2)) * 100.0d;
            dArr[2] = ((pow * 0.0193d) + (d2 * 0.1192d) + (pow2 * 0.9505d)) * 100.0d;
