...
public final class xa {
    ...
    public static int a(GetField getField, String str, int i) {
        try {
            ...
            vv.a().b("Unable to read '%s' field in migration device with message (%s)", str, e.getMessage());
            return i;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:?, code lost:
        defpackage.vv.a().f("Failed to read %s object (%s)", r9, r8.getMessage());
        r7 = r7;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0041, code lost:
        defpackage.vv.a().f("Failed to cast %s object (%s)", r9, r8.getMessage());
        r7 = r7;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0056, code lost:
        defpackage.vv.a().f("Failed to find %s class (%s)", r9, r8.getMessage());
        r7 = r7;
     */
    ...
    public static <T> T a(android.content.Context r7, java.lang.String r8, java.lang.String r9, java.lang.Class<T> r10) {
        /*
            ...
            wf r8 = defpackage.vv.a()     // Catch:{ ClassNotFoundException -> 0x0055, ClassCastException -> 0x0040, Exception -> 0x002b, FileNotFoundException -> 0x0086 }
        ...
        L_0x002b:
            r8 = move-exception
            wf r10 = defpackage.vv.a()     // Catch:{ FileNotFoundException -> 0x0086, Exception -> 0x0071 }
        ...
        L_0x00a9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xa.a(android.content.Context, java.lang.String, java.lang.String, java.lang.Class):java.lang.Object");
    }
    ...
    public static <T> void a(T r5, android.content.Context r6, java.lang.String r7, java.lang.String r8) {
        /*
            ...
            wf r7 = defpackage.vv.a()     // Catch:{ NotSerializableException -> 0x0024 }
            ...
            goto L_0x0048
        L_0x0024:
            wf r5 = defpackage.vv.a()     // Catch:{ Exception -> 0x0035 }
        ...
        L_0x005e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xa.a(java.lang.Object, android.content.Context, java.lang.String, java.lang.String):void");
    }
    ...
    public static boolean a(Context context, String str) {
        try {
            ...
            vv.a().b("Unable to check permission '%s' with message (%s)", str, e.getMessage());
            return false;
        }
    }
    ...
    public static boolean a(Uri uri) {
        ...
        return uri2 == null || uri2.length() == 0 || uri2.matches("^(fb|vk)[0-9]{5,}[^:]*://authorize.*access_token=.*");
    }
    ...
    public static boolean a(String str, String str2, String str3) {
        if (str == null) {
            vv.a().f("%s parameter %s is missing", str3, str2);
            return false;
        } else if (!str.equals("")) {
            return true;
        } else {
            vv.a().f("%s parameter %s is empty", str3, str2);
            return false;
        }
    }
    ...
    public static int e(Context context) {
        try {
            ...
            vv.a().d("Couldn't read connectivity type (%s)", e.getMessage());
            return -1;
        }
    }
    ...
    public static java.lang.String e(java.lang.String r5) {
        ...
        L_0x002d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xa.e(java.lang.String):java.lang.String");
    }
    ...
    public static int f(Context context) {
        try {
            ...
            vv.a().d("Couldn't read network type (%s)", e.getMessage());
            return -1;
        }
    }
    ...
    public static String g(Context context) {
        try {
            ...
            vv.a().d("Couldn't receive networkOperator string to read MCC", new Object[0]);
            return null;
        } catch (Exception unused) {
            vv.a().d("Couldn't return mcc", new Object[0]);
            return null;
        }
    }
    ...
    public static String h(Context context) {
        try {
            ...
            vv.a().d("Couldn't receive networkOperator string to read MNC", new Object[0]);
            return null;
        } catch (Exception unused) {
            vv.a().d("Couldn't return mnc", new Object[0]);
            return null;
        }
    }
}
