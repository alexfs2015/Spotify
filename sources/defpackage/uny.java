...
public final class uny extends b {
    ...
    public static final class a extends com.spotify.music.sociallistening.delegate.domain.SocialListeningDeviceModel.b.a {
        ...
        public final b a() {
            ...
            if (str.isEmpty()) {
                uny uny = new uny(this.a.booleanValue(), this.b, this.c.booleanValue(), this.d, this.e, this.f.booleanValue(), this.g.booleanValue(), this.h.booleanValue(), this.i.booleanValue(), this.j.booleanValue(), this.k.booleanValue(), 0);
                return uny;
            }
    ...
    private uny(boolean z, ImmutableList<Participant> immutableList, boolean z2, Optional<Integer> optional, Optional<String> optional2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8) {
        this.b = z;
    ...
    /* synthetic */ uny(boolean z, ImmutableList immutableList, boolean z2, Optional optional, Optional optional2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, byte b2) {
