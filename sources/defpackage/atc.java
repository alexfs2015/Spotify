...
public final class atc extends bcb implements HttpDataSource {
    ...
    public atc(a aVar, String str, bec<String> bec, wzo wzo, c cVar) {
        super(true);
        this.b = (a) bdl.a(aVar);
        this.d = str;
        this.f = wzo;
    ...
    public final long a(bcg bcg) {
        ...
        if (e2 != null) {
            ...
            xak xak = null;
            if (bcg.c != null) {
                xak = xak.a((xaf) null, bcg.c);
            } else if (bcg.b == 2) {
                xak = xak.a((xaf) null, ben.f);
            }
            ...
            try {
                ...
                if (!xal.a()) {
                    Map c2 = xal.f.c();
                    e();
                    InvalidResponseCodeException invalidResponseCodeException = new InvalidResponseCodeException(i2, c2, bcg);
                    if (i2 == 416) {
                ...
                xaf a4 = xam.a();
                String xaf = a4 != null ? a4.toString() : "";
                bec<String> bec = this.e;
                if (bec == null || bec.evaluate(xaf)) {
                    if (i2 == 200 && bcg.e != 0) {
                        j2 = bcg.e;
                    }
                    this.l = j2;
                ...
                e();
                throw new InvalidContentTypeException(xaf, bcg);
            } catch (IOException e3) {
                StringBuilder sb4 = new StringBuilder("Unable to connect to ");
                sb4.append(bcg.a);
                throw new HttpDataSourceException(sb4.toString(), e3, bcg, 1);
            }
        } else {
