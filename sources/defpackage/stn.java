...
public final class stn extends FrameLayout {
    View a;
    View b;
    private View c;
    private View d;
    ...
    public final void a() {
        setAlpha(0.0f);
        ip.n(this).a(1.0f).a(500).b((Runnable) new $$Lambda$stn$BgiNKMNjljudIBvljAJlrVLt1OU(this)).c();
    ...
    public final void b() {
        ip.n(this).a(0.0f).a(500).a((Runnable) new $$Lambda$stn$kulxC1B_j5jVgISHjKTIhyMShVM(this)).c();
