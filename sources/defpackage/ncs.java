...
public final class ncs implements wig<gwm> {
    ...
    private ncs(wzi<Activity> wzi, wzi<a> wzi2, wzi<gxw> wzi3, wzi<rnu> wzi4, wzi<has> wzi5, wzi<Map<String, gxk>> wzi6) {
        this.a = wzi;
        this.b = wzi2;
        this.c = wzi3;
        this.d = wzi4;
    ...
    public static ncs a(wzi<Activity> wzi, wzi<a> wzi2, wzi<gxw> wzi3, wzi<rnu> wzi4, wzi<has> wzi5, wzi<Map<String, gxk>> wzi6) {
        ncs ncs = new ncs(wzi, wzi2, wzi3, wzi4, wzi5, wzi6);
        return ncs;
    }
