...
public final class qzg {
    ...
    private static void a(Context context, xit<AppWidgetManager, int[]> xit) {
        AppWidgetManager instance = AppWidgetManager.getInstance(context);
        if (instance != null) {
            try {
                xit.call(instance, instance.getAppWidgetIds(new ComponentName(context, SpotifyWidget.class)));
    ...
    public static void b(Context context, Intent intent) {
        ...
        a(context, (xit<AppWidgetManager, int[]>) new $$Lambda$qzg$JbzxXo43h2RB5nIzg0YresiKtvg<AppWidgetManager,int[]>(remoteViews));
    }

    public static void b(Context context, RemoteViews remoteViews) {
        a(context, (xit<AppWidgetManager, int[]>) new $$Lambda$qzg$7pbhvoK1NUQ0fnUQsQyu5pfMHgU<AppWidgetManager,int[]>(remoteViews));
    }
