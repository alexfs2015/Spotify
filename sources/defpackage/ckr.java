...
public class ckr implements drl {
        ...
        if (inputStream != null) {
            try {
                ...
                while (true) {
                    ...
                    cvs.write(bArr, 0, read);
                }
                byte[] byteArray = cvs.toByteArray();
                if (inputStream != null) {
                    try {
                        inputStream.close();
                    } catch (IOException unused) {
                        cgp.a(str, new Object[0]);
                    }
                }
                return byteArray;
            } finally {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:78:0x0192, code lost:
        r0 = r10.a;
        defpackage.cgp.c("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r2.b);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:80:0x01a7, code lost:
        r11 = new defpackage.dud(r0, r13, false, android.os.SystemClock.elapsedRealtime() - r3, r17);
     */
    ...
    public defpackage.dud a(defpackage.dwe<?> r22) {
        /*
            r21 = this;
            r1 = r21
            r2 = r22
        ...
        L_0x0008:
            ...
            r7 = 2
            r9 = 0
            dho r0 = r2.j     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x018b }
        ...
        L_0x0028:
            ...
            java.text.SimpleDateFormat r0 = defpackage.cqt.a()     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x018b }
        ...
        L_0x0044:
            r0 = r10
        L_0x0045:
            cjq r10 = r1.c     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x018b }
            cru r10 = r10.a(r2, r0)     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x018b }
            int r12 = r10.a     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
            java.util.List<dql> r0 = r10.b     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
            ...
            dho r0 = r2.j     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
            if (r0 != 0) goto L_0x006f
            dud r0 = new dud     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
        ...
        L_0x0080:
            ...
            dql r13 = (defpackage.dql) r13     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
        ...
        L_0x0092:
            ...
            java.util.List<dql> r13 = r0.h     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
        ...
        L_0x00a9:
            ...
            dql r14 = (defpackage.dql) r14     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
        ...
        L_0x00d3:
            ...
            dql r15 = new dql     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
            ...
            goto L_0x00d3
        L_0x0100:
            dud r8 = new dud     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0187 }
        ...
        L_0x014b:
            ...
            r13 = 4
            ccs r14 = r2.i     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0182 }
            ...
            r11[r13] = r14     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0182 }
            defpackage.cgp.b(r0, r11)     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0182 }
        L_0x0164:
            r0 = 200(0xc8, float:2.8E-43)
            if (r12 < r0) goto L_0x017c
            r0 = 299(0x12b, float:4.19E-43)
            if (r12 > r0) goto L_0x017c
            dud r0 = new dud     // Catch:{ SocketTimeoutException -> 0x021a, MalformedURLException -> 0x01fb, IOException -> 0x0182 }
            r14 = 0
        ...
        L_0x021a:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ckr.a(dwe):dud");
    }

    private static void a(String str, dwe<?> dwe, zzae zzae) {
        ccs ccs = dwe.i;
        int c2 = dwe.c();
        try {
            ccs.a(zzae);
            dwe.b(String.format("%s-retry [timeout=%s]", new Object[]{str, Integer.valueOf(c2)}));
        } catch (zzae e) {
            dwe.b(String.format("%s-timeout-giveup [timeout=%s]", new Object[]{str, Integer.valueOf(c2)}));
            throw e;
        }
    }
}
