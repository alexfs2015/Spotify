...
public final class dfz {
    ...
    private dfz(ByteBuffer byteBuffer) {
        this.a = byteBuffer;
    ...
    public static dfz a(byte[] bArr, int i) {
        return new dfz(bArr, 0, i);
    }
    ...
    public final void a(int i, dgf dgf) {
        c(i, 2);
        if (dgf.Z < 0) {
            dgf.d();
        }
    ...
    public static int b(int i, dgf dgf) {
        int c = c(i << 3);
        int d = dgf.d();
        return c + c(d) + d;
    }
