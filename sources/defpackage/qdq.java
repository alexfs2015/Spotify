...
public abstract class qdq extends BaseAdapter {
    public final List<String> a = new ArrayList();
    private final DataSetObserver b = new DataSetObserver() {
        public final void onChanged() {
            qdq.this.a();
            qdq.this.notifyDataSetChanged();
        }

        public final void onInvalidated() {
            qdq.this.a();
            qdq.this.notifyDataSetInvalidated();
        }
    };
    ...
    protected qdq(Context context, ListAdapter listAdapter) {
        this.c = context;
        this.d = listAdapter;
