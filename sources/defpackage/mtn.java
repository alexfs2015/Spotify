...
public final class mtn implements vua<gum> {
    ...
    private mtn(wlc<Activity> wlc, wlc<a> wlc2, wlc<gvv> wlc3, wlc<res> wlc4, wlc<gxz> wlc5, wlc<Map<String, gvk>> wlc6) {
        this.a = wlc;
        this.b = wlc2;
        this.c = wlc3;
        this.d = wlc4;
    ...
    public static mtn a(wlc<Activity> wlc, wlc<a> wlc2, wlc<gvv> wlc3, wlc<res> wlc4, wlc<gxz> wlc5, wlc<Map<String, gvk>> wlc6) {
        mtn mtn = new mtn(wlc, wlc2, wlc3, wlc4, wlc5, wlc6);
        return mtn;
    }
