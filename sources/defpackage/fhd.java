...
public final class fhd {
    ...
    private final Map<Pair<String, String>, exz<String>> b = new dp();

    public fhd(Executor executor) {
        this.a = executor;
    }

    /* access modifiers changed from: 0000 */
    public final /* synthetic */ exz a(Pair pair, exz exz) {
        synchronized (this) {
            this.b.remove(pair);
        }
        return exz;
    ...
    public final synchronized defpackage.exz<java.lang.String> a(java.lang.String r3, java.lang.String r4, defpackage.fhf r5) {
        /*
            r2 = this;
            monitor-enter(r2)
            android.util.Pair r0 = new android.util.Pair     // Catch:{ all -> 0x006f }
            r0.<init>(r3, r4)     // Catch:{ all -> 0x006f }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, exz<java.lang.String>> r3 = r2.b     // Catch:{ all -> 0x006f }
            java.lang.Object r3 = r3.get(r0)     // Catch:{ all -> 0x006f }
            exz r3 = (defpackage.exz) r3     // Catch:{ all -> 0x006f }
            r4 = 3
        ...
        L_0x0059:
            exz r3 = r5.a()     // Catch:{ all -> 0x006f }
            java.util.concurrent.Executor r4 = r2.a     // Catch:{ all -> 0x006f }
            fhe r5 = new fhe     // Catch:{ all -> 0x006f }
            r5.<init>(r2, r0)     // Catch:{ all -> 0x006f }
            exz r3 = r3.b(r4, r5)     // Catch:{ all -> 0x006f }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, exz<java.lang.String>> r4 = r2.b     // Catch:{ all -> 0x006f }
        ...
        L_0x006f:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fhd.a(java.lang.String, java.lang.String, fhf):exz");
    }
}
