...
public final class azt extends azw {
    ...
    static class a {
        ...
        public final azi d() {
            ...
            if (this.h != 1) {
                ...
                if (i3 <= 7) {
                    i2 = 0;
                    azi azi = new azi(spannableStringBuilder, Alignment.ALIGN_NORMAL, (float) i3, 1, i2, f2, i, Float.MIN_VALUE);
                    return azi;
                }
            }
            i3 = (this.d - 15) - 2;
            i2 = 2;
            azi azi2 = new azi(spannableStringBuilder, Alignment.ALIGN_NORMAL, (float) i3, 1, i2, f2, i, Float.MIN_VALUE);
            return azi2;
        }
    ...
    public final void a(azo azo) {
        byte b2;
        this.i.a(azo.c.array(), azo.c.limit());
        boolean z = false;
        boolean z2 = false;
        while (true) {
            int b3 = this.i.b();
            ...
            if (b3 >= i2) {
                ...
                byte c2 = (byte) (this.i.c() & 127);
                byte c3 = (byte) (this.i.c() & 127);
                if ((b2 & 6) == 4 && ((this.k != 1 || (b2 & 1) == 0) && ((this.k != 2 || (b2 & 1) == 1) && !(c2 == 0 && c3 == 0)))) {
                    byte b4 = c2 & 247;
                    if (b4 == 17 && (c3 & 240) == 48) {
                        this.m.a((char) f[c3 & 15]);
                    } else if ((c2 & 246) == 18 && (c3 & 224) == 32) {
                        this.m.b();
                        if ((c2 & 1) == 0) {
                            this.m.a((char) g[c3 & 31]);
                        } else {
                            this.m.a((char) h[c3 & 31]);
                        }
                    } else if ((c2 & 224) == 0) {
                        byte b5 = c2 & 240;
                        boolean z3 = b5 == 16;
                        if (z3) {
                            if (this.r && this.s == c2 && this.t == c3) {
                                this.r = false;
                                z2 = true;
                            } else {
                                this.r = true;
                        ...
                        if (b4 == 17 && (c3 & 240) == 32) {
                            ...
                            if (b5 == 16 && (c3 & 192) == 64) {
                                ...
                                boolean z4 = (c3 & 16) == 16;
                                int i4 = (c3 >> 1) & 7;
                                this.m.a(z4 ? 8 : i4, (c3 & 1) == 1);
                                if (z4) {
                                    this.m.e = c[i4];
                                }
                            } else {
                                if (b4 == 23 && c3 >= 33 && c3 <= 35) {
                                    this.m.f = c3 - 32;
                                } else {
                                    if (b4 == 20 && (c3 & 240) == 32) {
                                        if (c3 == 32) {
