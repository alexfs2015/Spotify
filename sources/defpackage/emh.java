...
public final class emh implements epr {
    private final zzve a;

    emh(zzve zzve) {
        this.a = (zzve) emy.a(zzve, "output");
    }
    ...
    public final void a(int i, Object obj, eon eon) {
        this.a.a(i, (enx) obj, eon);
    }

    public final void b(int i, Object obj, eon eon) {
        zzve zzve = this.a;
        enx enx = (enx) obj;
        zzve.a(i, 3);
        eon.a(enx, (epr) zzve.b);
        zzve.a(i, 4);
    }
    ...
    public final void a(int i, List<?> list, eon eon) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            a(i, list.get(i2), eon);
        }
    }

    public final void b(int i, List<?> list, eon eon) {
        for (int i2 = 0; i2 < list.size(); i2++) {
            b(i, list.get(i2), eon);
        }
    }

    public final <K, V> void a(int i, enr<K, V> enr, Map<K, V> map) {
        for (Entry entry : map.entrySet()) {
            this.a.a(i, 2);
            this.a.b(enq.a(enr, entry.getKey(), entry.getValue()));
            enq.a(this.a, enr, entry.getKey(), entry.getValue());
        }
    }
}
