...
final class fhr {
    ...
    public final fhs a(Context context, String str) {
        fhs fhs = new fhs(ffv.a(), System.currentTimeMillis());
        fhs a = a(context, str, fhs, true);
        String str2 = "FirebaseInstanceId";
        if (a == null || a.equals(fhs)) {
    ...
    /* access modifiers changed from: 0000 */
    public final fhs b(Context context, String str) {
        try {
            fhs c = c(context, str);
            if (c != null) {
                a(context, str, c);
            ...
            e = null;
            try {
                fhs a = a(context.getSharedPreferences("com.google.android.gms.appid", 0), str);
                if (a != null) {
    ...
    private final fhs c(Context context, String str) {
    ...
    private static defpackage.fhs a(android.content.Context r8, java.lang.String r9, defpackage.fhs r10, boolean r11) {
        /*
            r0 = 3
            ...
            fhs r10 = a(r8)     // Catch:{ IOException -> 0x005c, zzaa -> 0x005a }
        ...
        L_0x00a1:
            ...
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fhr.a(android.content.Context, java.lang.String, fhs, boolean):fhs");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static defpackage.fhs a(java.io.File r7) {
        /*
        ...
        L_0x002e:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fhr.a(java.io.File):fhs");
    }

    private static fhs a(FileChannel fileChannel) {
        ...
        try {
            return new fhs(a(property, property2), Long.parseLong(properties.getProperty("cre")));
        } catch (NumberFormatException e) {
            throw new zzaa((Exception) e);
        }
    }

    private static fhs a(SharedPreferences sharedPreferences, String str) {
        String string = sharedPreferences.getString(fgp.a(str, "|P|"), null);
        String string2 = sharedPreferences.getString(fgp.a(str, "|K|"), null);
        if (string == null || string2 == null) {
            return null;
        }
        return new fhs(a(string, string2), b(sharedPreferences, str));
    }

    private static void a(Context context, String str, fhs fhs) {
        SharedPreferences sharedPreferences = context.getSharedPreferences("com.google.android.gms.appid", 0);
        try {
            if (fhs.equals(a(sharedPreferences, str))) {
                return;
            }
        } catch (zzaa unused) {
        }
        ...
        edit.putString(fgp.a(str, "|P|"), fhs.a());
        edit.putString(fgp.a(str, "|K|"), fhs.b());
        edit.putString(fgp.a(str, "cre"), String.valueOf(fhs.b));
        edit.commit();
    }

    private static long b(SharedPreferences sharedPreferences, String str) {
        String string = sharedPreferences.getString(fgp.a(str, "cre"), null);
        if (string != null) {
            try {
