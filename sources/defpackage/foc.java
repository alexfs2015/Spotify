...
public interface foc extends IInterface {
    ...
    /* renamed from: foc$a */
    public static abstract class a extends Binder implements foc {

        /* renamed from: foc$a$a reason: collision with other inner class name */
        static class C0031a implements foc {
            private IBinder a;
            ...
            public final String a(String str, String str2, String str3, fob fob) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(fob != null ? fob.asBinder() : null);
        ...
        public static foc a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.msc.sa.aidl.ISAService");
            if (queryLocalInterface == null || !(queryLocalInterface instanceof foc)) {
                return new C0031a(iBinder);
            }
            return (foc) queryLocalInterface;
        }

        /* JADX WARNING: type inference failed for: r0v1 */
        /* JADX WARNING: type inference failed for: r0v2, types: [fob] */
        /* JADX WARNING: type inference failed for: r0v5, types: [fob$a$a] */
        /* JADX WARNING: type inference failed for: r0v6, types: [fob] */
        ...
        /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r0v1
          assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], android.os.Bundle, fob$a$a, fob]
          uses: [fob, android.os.Bundle]
          mth insns count: 89
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            ...
            L_0x00cd:
                ...
                boolean r3 = r0 instanceof defpackage.fob
                if (r3 == 0) goto L_0x00dc
                fob r0 = (defpackage.fob) r0
                goto L_0x00e1
            L_0x00dc:
                fob$a$a r0 = new fob$a$a
                r0.<init>(r6)
            L_0x00e1:
            ...
            L_0x00ec:
                ...
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.foc.a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    String a(String str, String str2, String str3, fob fob);
