...
abstract class vja extends defpackage.vjp.a {
    ...
    /* renamed from: vja$a */
    static final class a implements C0084a {
        ...
        public final C0084a a(Optional<RootlistRequestPayload> optional) {
            if (optional != null) {
                this.a = optional;
                return this;
            }
        ...
        public final defpackage.vjp.a a() {
            String str = "";
            if (this.c == null) {
            ...
            if (str.isEmpty()) {
                vjd vjd = new vjd(this.a, this.b, this.c, this.d, this.e, this.f.booleanValue(), this.g, this.h.intValue());
                return vjd;
            }
        ...
        public final C0084a b(Optional<way> optional) {
            if (optional != null) {
                this.b = optional;
                return this;
            }
        ...
        public final C0084a c(Optional<Boolean> optional) {
            if (optional != null) {
                this.d = optional;
                return this;
            }
        ...
        public final C0084a d(Optional<Boolean> optional) {
            if (optional != null) {
                this.e = optional;
                return this;
            }
        ...
        public final C0084a e(Optional<vkg> optional) {
            if (optional != null) {
                this.g = optional;
                return this;
            }
    ...
    vja(Optional<RootlistRequestPayload> optional, Optional<way> optional2, String str, Optional<Boolean> optional3, Optional<Boolean> optional4, boolean z, Optional<vkg> optional5, int i) {
        if (optional != null) {
            this.a = optional;
            if (optional2 != null) {
                this.b = optional2;
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof defpackage.vjp.a) {
            defpackage.vjp.a aVar = (defpackage.vjp.a) obj;
