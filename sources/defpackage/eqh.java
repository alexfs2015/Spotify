...
final class eqh extends eqf {
    ...
    private static int a(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 1) {
            return eqd.b(i, eqb.a(bArr, j));
        }
        if (i2 == 2) {
            return eqd.b(i, (int) eqb.a(bArr, j), (int) eqb.a(bArr, j + 1));
        }
    ...
    public final int a(CharSequence charSequence, byte[] bArr, int i, int i2) {
        ...
        while (i6 < length) {
            ...
            if (charAt3 < c && j4 < j5) {
                long j7 = j4 + j;
                eqb.a(bArr2, j4, (byte) charAt3);
                j3 = j;
                j2 = j7;
            } else if (charAt3 < 2048 && j4 <= j5 - 2) {
                long j8 = j4 + j;
                eqb.a(bArr2, j4, (byte) ((charAt3 >>> 6) | 960));
                long j9 = j8 + j;
                eqb.a(bArr2, j8, (byte) ((charAt3 & '?') | 128));
                j2 = j9;
                j3 = j;
                i6++;
                c = 128;
                ...
                long j11 = j4 + j;
                eqb.a(bArr2, j4, (byte) ((charAt3 >>> 12) | 480));
                long j12 = j11 + j;
                eqb.a(bArr2, j11, (byte) (((charAt3 >>> 6) & 63) | 128));
                long j13 = j12 + 1;
                eqb.a(bArr2, j12, (byte) ((charAt3 & '?') | 128));
                j2 = j13;
                j3 = 1;
            } else if (j4 <= j5 - 4) {
                int i7 = i6 + 1;
                if (i7 != length) {
                    ...
                    if (Character.isSurrogatePair(charAt3, charAt4)) {
                        ...
                        long j14 = j4 + 1;
                        eqb.a(bArr2, j4, (byte) ((codePoint >>> 18) | 240));
                        long j15 = j14 + 1;
                        eqb.a(bArr2, j14, (byte) (((codePoint >>> 12) & 63) | 128));
                        long j16 = j15 + 1;
                        eqb.a(bArr2, j15, (byte) (((codePoint >>> 6) & 63) | 128));
                        j3 = 1;
                        j2 = j16 + 1;
                        eqb.a(bArr2, j16, (byte) ((codePoint & 63) | 128));
                        i6 = i7;
                        i6++;
                        c = 128;
                        long j102 = j3;
            ...
            while (i < length) {
                ...
                if (charAt2 < c && j < limit) {
                    ...
                    if ((charAt2 < 55296 || 57343 < charAt2) && j <= limit - 3) {
                        long j5 = j + 1;
                        eqb.a(j, (byte) ((charAt2 >>> 12) | 480));
                        long j6 = j5 + 1;
                        eqb.a(j5, (byte) (((charAt2 >>> 6) & 63) | 128));
                        long j7 = j6 + 1;
                        eqb.a(j6, (byte) ((charAt2 & '?') | 128));
                        j = j7;
                    } else if (j <= limit - 4) {
                        int i2 = i + 1;
                        if (i2 != length) {
                            ...
                            if (Character.isSurrogatePair(charAt2, charAt3)) {
                                ...
                                long j8 = j + 1;
                                eqb.a(j, (byte) ((codePoint >>> 18) | 240));
                                long j9 = j8 + 1;
                                eqb.a(j8, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j10 = j9 + 1;
                                eqb.a(j9, (byte) (((codePoint >>> 6) & 63) | 128));
                                long j11 = j10 + 1;
                                eqb.a(j10, (byte) ((codePoint & 63) | 128));
                                i = i2;
                                j = j11;
                            }
                        } else {
                    ...
                    j2 = a;
                    long j12 = j + 1;
                    eqb.a(j, (byte) ((charAt2 >>> 6) | 960));
                    long j13 = j12 + 1;
                    eqb.a(j12, (byte) ((charAt2 & '?') | 128));
                    j = j13;
                }
                i++;
    ...
    public final int b(byte[] r13, int r14, int r15) {
        ...
        L_0x0018:
            ...
            long r10 = r8 + r6
            byte r0 = defpackage.eqb.a(r13, r8)
        ...
        L_0x002c:
            ...
            long r8 = r4 + r6
            byte r14 = defpackage.eqb.a(r13, r4)
        ...
        L_0x0067:
            int r15 = r15 + -2
            long r10 = r4 + r6
            byte r4 = defpackage.eqb.a(r13, r4)
        ...
        L_0x007d:
            long r4 = r10 + r6
            byte r14 = defpackage.eqb.a(r13, r10)
        ...
        L_0x008d:
            int r15 = r15 + -3
            long r10 = r4 + r6
            byte r0 = defpackage.eqb.a(r13, r4)
        ...
        L_0x00d4:
            goto L_0x00d3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eqh.b(byte[], int, int):int");
    }
    ...
    public final String c(byte[] bArr, int i, int i2) {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            while (r13 < i3) {
                int i7 = r13 + 1;
                byte a2 = eqb.a(bArr, (long) r13);
                if (eqe.a(a2)) {
                    int i8 = i6 + 1;
                    eqe.a(a2, cArr, i6);
                    while (i7 < i3) {
                        byte a3 = eqb.a(bArr, (long) i7);
                        if (!eqe.a(a3)) {
                            break;
                        }
                        i7++;
                    ...
                    if (i7 < i3) {
                        int i10 = i7 + 1;
                        int i11 = i6 + 1;
                        eqe.a(a2, eqb.a(bArr, (long) i7), cArr, i6);
                        r13 = i10;
                        i6 = i11;
                    } else {
                        throw zzwe.h();
                    ...
                    if (i7 < i3 - 1) {
                        ...
                        int i13 = i12 + 1;
                        int i14 = i6 + 1;
                        eqe.a(a2, eqb.a(bArr, (long) i7), eqb.a(bArr, (long) i12), cArr, i6);
                        r13 = i13;
                        i6 = i14;
                    } else {
                        throw zzwe.h();
                    ...
                    int i15 = i7 + 1;
                    byte a4 = eqb.a(bArr, (long) i7);
                    int i16 = i15 + 1;
                    int i17 = i16 + 1;
                    int i18 = i6 + 1;
                    eqe.a(a2, a4, eqb.a(bArr, (long) i15), eqb.a(bArr, (long) i16), cArr, i6);
                    r13 = i17;
                    i6 = i18 + 1;
                } else {
                    throw zzwe.h();
