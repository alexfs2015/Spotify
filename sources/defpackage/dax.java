...
public final class dax implements cwp {
    ...
    public dax(ECPublicKey eCPublicKey, byte[] bArr, String str, zzayw zzayw, dav dav) {
        dbb.a(eCPublicKey.getW(), eCPublicKey.getParams().getCurve());
        this.b = new daz(eCPublicKey);
        this.d = bArr;
        this.c = str;
        this.e = zzayw;
        this.f = dav;
    ...
    public final byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        int a2 = this.f.a();
        zzayw zzayw = this.e;
        KeyPair a3 = dbb.a(daz.a.getParams());
        ECPublicKey eCPublicKey = (ECPublicKey) a3.getPublic();
        ECPrivateKey eCPrivateKey = (ECPrivateKey) a3.getPrivate();
        ECPublicKey eCPublicKey2 = daz.a;
        ECParameterSpec params = eCPublicKey2.getParams();
        ECParameterSpec params2 = eCPrivateKey.getParams();
        if (!params.getCurve().equals(params2.getCurve()) || !params.getGenerator().equals(params2.getGenerator()) || !params.getOrder().equals(params2.getOrder()) || params.getCofactor() != params2.getCofactor()) {
            throw new GeneralSecurityException("invalid public key spec");
        }
        byte[] a4 = dbb.a(eCPrivateKey, eCPublicKey2.getW());
        EllipticCurve curve = eCPublicKey.getParams().getCurve();
        ECPoint w = eCPublicKey.getW();
        dbb.a(w, curve);
        int bitLength = (dbb.a(curve).subtract(BigInteger.ONE).bitLength() + 7) / 8;
        int i = dbc.a[zzayw.ordinal()];
        int i2 = 1;
        if (i == 1) {
        ...
        byte[] a5 = das.a(bArr3, a4);
        Mac mac = (Mac) dbe.b.a(str);
        if (a2 <= mac.getMacLength() * 255) {
            ...
            dba dba = new dba(bArr3, bArr6);
            byte[] bArr8 = null;
            byte[] a6 = this.f.a(dba.b == null ? null : dba.b.a()).a(bArr, a);
            if (dba.a != null) {
                bArr8 = dba.a.a();
            }
