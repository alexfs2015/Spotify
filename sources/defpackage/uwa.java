...
public final class uwa extends ol {
                ...
                AnonymousClass1 r2 = new Runnable() {
                    public final void run() {
                        ...
                        while (it.hasNext()) {
                            ...
                            uvz uvz = (uvz) uVar.o.getTag(R.id.paste_carousel_tag);
                            if (uvz != null) {
                                if (uvz.b == -1) {
                                    ip.a(uVar.o, (float) (-uvz.c));
                                }
                                if (uvz.b == 1) {
                                    ip.a(uVar.o, (float) uvz.c);
                                }
                            ...
                            a2.a(300).a((it) new it(uVar, n) {
                                ...
                                public final void b(View view) {
                                    ...
                                    this.b.a((it) null);
                                    uwa.this.f(this.a);
                                    uwa.this.b.remove(this.a);
                                    uwa.this.c();
                                }
                            }).c();
                        }
                        arrayList.clear();
                        uwa.this.a.remove(arrayList);
                    }
                };
                if (z) {
