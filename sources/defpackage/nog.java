...
public final class nog implements noh {
    ...
    public final /* synthetic */ Object apply(Object obj, Object obj2) {
        ...
        arrayList.addAll(valueOf.intValue(), Arrays.asList(new hcm[]{hcx.builder().a((hck) HubsGlueSectionHeader.SECTION_HEADER).a(hcy.builder().a(string)).a(), hcx.builder().a(str4).a("home:recentlyPlayedCarousel", HubsComponentCategory.ROW.name()).a(a3).c(a2).a()}));
