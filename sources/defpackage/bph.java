...
public final class bph extends BroadcastReceiver {
    private final /* synthetic */ MediaNotificationService a;

    public bph(MediaNotificationService mediaNotificationService) {
        ...
        if (this.a.q.d()) {
            ...
            if (!a2.a.isEmpty()) {
                ...
                if (VERSION.SDK_INT >= 16) {
                    pendingIntent = PendingIntent.getActivities(a2.b, 1, intentArr, 134217728, null);
                } else {
                    pendingIntent = PendingIntent.getActivities(a2.b, 1, intentArr, 134217728);
                }
            } else {
