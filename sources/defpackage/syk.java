...
public final class syk implements sej {
    private final Activity a;
    private final PlayerStateCompat b;

    public syk(Activity activity, PlayerStateCompat playerStateCompat) {
        this.a = (Activity) fbp.a(activity);
        this.b = (PlayerStateCompat) fbp.a(playerStateCompat);
    }

    public final void a(sso sso, String str) {
        String str2 = str;
    ...
    public final void a(sso sso, String str, List<String> list) {
        Activity activity = this.a;
        ArrayList a2 = Lists.a();
        a2.add(str);
        a2.addAll(list);
        activity.startActivity(ModerationReportActivity.a(activity, syq.c().a(sso).a((List<String>) a2).a()));
    }
}
