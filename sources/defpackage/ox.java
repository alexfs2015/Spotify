...
public final class ox {
    ...
    public Runnable h = new Runnable() {
        ...
        /* JADX WARNING: type inference failed for: r5v14, types: [pp] */
        ...
        public final void run() {
            /*
                ...
                ox r4 = defpackage.ox.this     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
            ...
            L_0x001c:
                ...
                androidx.room.RoomDatabase r5 = r4.b     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
                pp r5 = r5.c     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
            ...
            L_0x0056:
                ...
                ox r4 = defpackage.ox.this     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
                androidx.room.RoomDatabase r4 = r4.b     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
                pp r4 = r4.c     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
                po r4 = r4.a()     // Catch:{ IllegalStateException -> 0x008c, SQLiteException -> 0x008a }
            ...
            L_0x0095:
                ...
                ox r0 = defpackage.ox.this
                db<ox$b, ox$c> r0 = r0.f
                monitor-enter(r0)
                ox r4 = defpackage.ox.this     // Catch:{ all -> 0x00f4 }
                db<ox$b, ox$c> r4 = r4.f     // Catch:{ all -> 0x00f4 }
            ...
            L_0x00ad:
                ...
                ox$c r6 = (defpackage.ox.c) r6     // Catch:{ all -> 0x00f4 }
            ...
            L_0x00fd:
                goto L_0x00fc
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ox.AnonymousClass1.run():void");
        }

        /* JADX INFO: finally extract failed */
        private Set<Integer> a() {
            dq dqVar = new dq();
            Cursor a2 = ox.this.b.a((pr) new pn("SELECT * FROM room_table_modification_log WHERE invalidated = 1;"));
            while (a2.moveToNext()) {
                try {
    ...
    public ox(RoomDatabase roomDatabase, Map<String, String> map, Map<String, Set<String>> map2, String... strArr) {
        this.b = roomDatabase;
        this.l = new a(strArr.length);
        this.j = new dp<>();
        this.k = map2;
        this.m = new ow(this.b);
    ...
    private void a(po poVar, int i2) {
    ...
    private void b(po poVar, int i2) {
