...
public abstract class eea extends dkp implements edz {
    public eea() {
    ...
    public final boolean dispatchTransaction(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) {
        ...
        L_0x0011:
            ...
            cbi r4 = defpackage.cbi.a.a(r4)
            android.os.IBinder r2 = r2.readStrongBinder()
            cbi r2 = defpackage.cbi.a.a(r2)
            r0.a(r1, r4, r2)
            goto L_0x003c
        L_0x002d:
            android.os.IBinder r1 = r2.readStrongBinder()
        ...
        L_0x00ba:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eea.dispatchTransaction(int, android.os.Parcel, android.os.Parcel, int):boolean");
    }
}
