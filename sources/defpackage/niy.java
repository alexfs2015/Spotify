...
public final class niy implements wuu<gzz, RecentlyPlayedItems, gzz> {
    private final neq a;
    ...
    public final /* synthetic */ Object call(Object obj, Object obj2) {
        ...
        arrayList.addAll(valueOf.intValue(), Arrays.asList(new gzt[]{hae.builder().a(rif.a).a(haf.builder().a(string)).a(), hae.builder().a(str4).a("home:carousel", HubsComponentCategory.ROW.name()).a(a3).c(a2).a()}));
