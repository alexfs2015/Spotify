...
final class bap {
    ...
    public final defpackage.bas a(defpackage.bdj r18) {
        /*
            r17 = this;
            r0 = r17
            r1 = r18
        ...
        L_0x00d9:
            java.lang.String r2 = "\\."
            java.lang.String[] r2 = defpackage.bdw.a(r4, r2)
            r4 = r2[r3]
            r5 = 35
        ...
        L_0x01d2:
            ...
            java.lang.String r2 = defpackage.bdw.d(r3)
            r1.e = r2
            goto L_0x0206
        L_0x01e1:
        ...
        L_0x0211:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bap.a(bdj):bas");
    }
    ...
    private static String a(bdj bdj, StringBuilder sb) {
        b(bdj);
        if (bdj.b() == 0) {
            return null;
        }
        ...
        sb2.append((char) bdj.c());
        return sb2.toString();
    }

    private static String b(bdj bdj, StringBuilder sb) {
        boolean z = false;
        sb.setLength(0);
        int i = bdj.b;
        int i2 = bdj.c;
        while (i < i2 && !z) {
            char c2 = (char) bdj.a[i];
    ...
    private static boolean c(bdj bdj) {
        char c2 = (char) bdj.a[bdj.b];
    ...
    private static boolean d(bdj bdj) {
        int i = bdj.b;
        int i2 = bdj.c;
        byte[] bArr = bdj.a;
        if (i + 2 <= i2) {
