...
public final class isc {
    public static ProtoAlbumMetadata a(vkt vkt) {
        ImmutableList artists = vkt.getArtists();
        ArrayList arrayList = new ArrayList();
        Iterator it = artists.iterator();
        while (true) {
            String str = "";
            if (!it.hasNext()) {
                return (ProtoAlbumMetadata) ProtoAlbumMetadata.m().b((String) jvi.a(vkt.getName(), str)).a((String) jvi.a(vkt.getUri(), str)).a((Iterable<? extends ProtoAlbumArtistMetadata>) arrayList).c((String) jvi.a(vkt.getCopyright(), str)).b(vkt.getNumDiscs()).c(vkt.getNumTracks()).a(vkt.getYear()).a(vkt.isAnyTrackPlayable()).a(a(vkt.getCovers())).g();
            }
            vku vku = (vku) it.next();
            arrayList.add(vku == null ? null : (ProtoAlbumArtistMetadata) ProtoAlbumArtistMetadata.k().b((String) jvi.a(vku.getName(), str)).a((String) jvi.a(vku.getUri(), str)).g());
        }
    }
    ...
    public static com.spotify.mobile.android.spotlets.collection.proto.TrackMetadata.ProtoTrackMetadata a(defpackage.vlf r7) {
        /*
            r0 = 0
        ...
        L_0x00c5:
            ...
            java.lang.Object r1 = defpackage.jvi.a(r1, r4)
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.isc.a(vlf):com.spotify.mobile.android.spotlets.collection.proto.TrackMetadata$ProtoTrackMetadata");
    }
    ...
    public static ProtoImageGroup a(Covers covers) {
        ...
        String str = "";
        return (ProtoImageGroup) ProtoImageGroup.k().a((String) jvi.a(covers.getUri(), str)).b((String) jvi.a(covers.getSmallUri(), str)).c((String) jvi.a(covers.getLargeUri(), str)).d((String) jvi.a(covers.getXlargeUri(), str)).g();
    }
}
