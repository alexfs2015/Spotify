...
public final class avg implements avr {
    private final auy a;
    private final bdi b = new bdi(new byte[10]);
    private int c = 0;
    private int d;
    private bdt e;
    private boolean f;
    ...
    public final void a(defpackage.bdj r14, boolean r15) {
        /*
            r13 = this;
        ...
        L_0x01c5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.avg.a(bdj, boolean):void");
    }
    ...
    private boolean a(bdj bdj, byte[] bArr, int i2) {
        int min = Math.min(bdj.b(), i2 - this.d);
        if (min <= 0) {
            return true;
        }
        if (bArr == null) {
