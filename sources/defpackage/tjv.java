...
public final class tjv {
    ...
    public final String a(FormatListType formatListType, String str, fpt fpt) {
        ...
        boolean a2 = a(formatListType, fpt);
        if (a2 && isEmpty) {
    ...
    private boolean a(FormatListType formatListType, fpt fpt) {
        a aVar = (a) this.a.get(formatListType);
        if (aVar == null) {
            return false;
        }
