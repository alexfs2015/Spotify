...
public final class boh extends bxw {
    public static final Creator<boh> CREATOR = new brw();
    public MediaInfo a;
    public long b;
    public int c;
    public double d;
    ...
    boh(MediaInfo mediaInfo, long j2, int i2, double d2, int i3, int i4, long j3, long j4, double d3, boolean z, long[] jArr, int i5, int i6, String str, int i7, List<bof> list, boolean z2, bnw bnw, bok bok) {
        List<bof> list2 = list;
        ...
        if (list2 != null && !list.isEmpty()) {
            a((bof[]) list2.toArray(new bof[list.size()]));
        }
        this.k = z2;
        this.t = bnw;
        this.u = bok;
    ...
    public boh(JSONObject jSONObject) {
    ...
    private final void a(bof[] bofArr) {
        this.j.clear();
        this.w.clear();
        for (int i2 = 0; i2 < bofArr.length; i2++) {
            bof bof = bofArr[i2];
            this.j.add(bof);
            this.w.put(bof.b, Integer.valueOf(i2));
        }
    }
    ...
    public final int a(org.json.JSONObject r13, int r14) {
        ...
        L_0x01dd:
            ...
            java.lang.Integer r14 = defpackage.eit.a(r14)
        ...
        L_0x029c:
            ...
            goto L_0x024b
        L_0x029f:
            java.util.ArrayList<bof> r14 = r12.j
            int r14 = r14.size()
        ...
        L_0x0369:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.boh.a(org.json.JSONObject, int):int");
    }

    public final bof a(int i2) {
        Integer num = (Integer) this.w.get(i2);
        if (num == null) {
            return null;
        }
        return (bof) this.j.get(num.intValue());
    }
    ...
    public final boolean equals(Object obj) {
        ...
        boh boh = (boh) obj;
        if ((this.s == null) == (boh.s == null) && this.b == boh.b && this.c == boh.c && this.d == boh.d && this.e == boh.e && this.f == boh.f && this.g == boh.g && this.n == boh.n && this.o == boh.o && this.h == boh.h && this.q == boh.q && this.i == boh.i && Arrays.equals(this.p, boh.p) && eic.a(Long.valueOf(this.m), Long.valueOf(boh.m)) && eic.a(this.j, boh.j) && eic.a(this.a, boh.a)) {
            JSONObject jSONObject = this.s;
            if (jSONObject != null) {
                JSONObject jSONObject2 = boh.s;
                if (jSONObject2 != null && !cae.a(jSONObject, jSONObject2)) {
                    z = false;
                    return !z && this.k == boh.k && eic.a(this.t, boh.t) && eic.a(this.u, boh.u) && eic.a(this.l, boh.l) && bxm.a(this.v, boh.v);
                }
            }
            z = true;
            if (!z) {
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        bxx.a(parcel, 9, this.m);
        bxx.a(parcel, 10, this.n);
        bxx.a(parcel, 11, this.o);
        bxx.a(parcel, 12, this.p, false);
        bxx.b(parcel, 13, this.h);
        bxx.b(parcel, 14, this.q);
        bxx.a(parcel, 15, this.r, false);
        bxx.b(parcel, 16, this.i);
        bxx.b(parcel, 17, this.j, false);
        bxx.a(parcel, 18, this.k);
        bxx.a(parcel, 19, (Parcelable) this.t, i2, false);
        bxx.a(parcel, 20, (Parcelable) this.u, i2, false);
        bxx.b(parcel, a2);
    }
}
