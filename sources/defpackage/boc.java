...
public final class boc extends bxw {
    public static final Creator<boc> CREATOR = new bru();
    ...
    boc(List<bwu> list, Bundle bundle, int i) {
        this.a = list;
        this.d = bundle;
        this.e = i;
    }
                            ...
                            if (obj2 != null) {
                                ...
                                if (b2 != 1) {
                                    if (b2 != 2) {
                                        ...
                                        } else if ((obj2 instanceof String) && eiv.a((String) obj2) != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        boc boc = (boc) obj;
        return a(this.d, boc.d) && this.a.equals(boc.a);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        bxx.b(parcel, 2, this.a, false);
        bxx.a(parcel, 3, this.d, false);
