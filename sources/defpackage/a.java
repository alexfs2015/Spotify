...
public final class a extends LinearLayout {
    ...
    public a(Context context, AttributeSet attributeSet, int i2) {
        ...
        setId(0);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, defpackage.utr.a.f, i2, 0);
        int color = obtainStyledAttributes.getColor(defpackage.utr.a.g, -16777216);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(defpackage.utr.a.h, 0);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(defpackage.utr.a.i, 0);
        int color2 = obtainStyledAttributes.getColor(defpackage.utr.a.j, -1);
        int color3 = obtainStyledAttributes.getColor(defpackage.utr.a.k, -16711936);
        int dimensionPixelSize3 = obtainStyledAttributes.getDimensionPixelSize(defpackage.utr.a.l, 2);
