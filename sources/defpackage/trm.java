...
final class trm {
    ...
    trm(TextPaint textPaint, int i2, int i3) {
        this.b = i3;
        this.a = textPaint;
        this.i = i2;
    }
    ...
    public void a() {
        if (a(this.h) && !TextUtils.isEmpty(this.f)) {
            if (VERSION.SDK_INT >= 23) {
                ...
                this.g = Builder.obtain(charSequence, 0, ((CharSequence) fay.a(charSequence)).length(), this.a, this.e).setAlignment(Alignment.ALIGN_NORMAL).setLineSpacing(0.0f, 0.9f).setIncludePad(false).build();
            } else {
