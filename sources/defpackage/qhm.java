...
public final class qhm implements sio, sip {
    public final hcm a(SearchHistoryItem searchHistoryItem, int i, String str) {
        ...
        a a = builder.a(sb.toString()).a((hck) create).a(hcy.builder().a(searchHistoryItem.getTitle()).b(searchHistoryItem.getSubtitle())).a(hcw.builder().a(hal.a(hcz.builder().a(searchHistoryItem.getImageUri()).a(), searchHistoryItem.getTargetUri()))).a("click", qez.a(str, searchHistoryItem.getOriginUri(), i));
        return a.a("rightAccessoryClick", qfb.a(searchHistoryItem.getOriginUri(), i)).c("secondary_icon", SpotifyIconV2.X.toString()).f(gyg.a(false)).a();
    }
