...
public final class bdw {
    ...
    public static ExecutorService a(String str) {
        return Executors.newSingleThreadExecutor(new $$Lambda$bdw$Kpd2ZtI9R5LLMAkSjClz8A1kXGM(str));
    }

    public static void a(bbn bbn) {
        if (bbn != null) {
            try {
                bbn.c();
    ...
    public static long a(long j, aqs aqs, long j2, long j3) {
        aqs aqs2 = aqs;
        if (aqs.a.equals(aqs)) {
            return j;
        }
    ...
    public static boolean a(bdj bdj, bdj bdj2, Inflater inflater) {
        if (bdj.b() <= 0) {
            return false;
        }
        byte[] bArr = bdj2.a;
        if (bArr.length < bdj.b()) {
            bArr = new byte[(bdj.b() * 2)];
        }
        if (inflater == null) {
            inflater = new Inflater();
        }
        inflater.setInput(bdj.a, bdj.b, bdj.b());
        int i2 = 0;
        while (true) {
            try {
