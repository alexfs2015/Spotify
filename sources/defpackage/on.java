...
public final class on<T> {
    ...
    /* renamed from: on$b */
    public static abstract class b<T2> implements Comparator<T2>, of {
    ...
    public on(Class<T> cls, b<T> bVar) {
        this(cls, bVar, 10);
    }

    private on(Class<T> cls, b<T> bVar, int i2) {
        this.i = cls;
