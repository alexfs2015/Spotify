...
public final class cpc {
    ...
    private static final String c = bfj.class.getName();
    private static final String d = PublisherAdView.class.getName();
    private static final String e = bfo.class.getName();
    private static final String f = SearchAdView.class.getName();
    private static final String g = bfg.class.getName();
    ...
    public static void a(Context context, String str, String str2, Bundle bundle, boolean z, cpf cpf) {
        if (z) {
        ...
        Builder appendQueryParameter = new Builder().scheme("https").path("http://=").appendQueryParameter("id", str2);
        for (String str3 : bundle.keySet()) {
            appendQueryParameter.appendQueryParameter(str3, bundle.getString(str3));
        }
        cpf.a(appendQueryParameter.toString());
    }

    static void a(ViewGroup viewGroup, dpt dpt, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            int a2 = a(context, 3);
            frameLayout.addView(textView, new LayoutParams(dpt.f - a2, dpt.c - a2, 17));
            viewGroup.addView(frameLayout, dpt.f, dpt.c);
        }
    }
    ...
    public static boolean b(String str) {
        ...
        if (str.startsWith((String) dqe.f().a(dtg.e))) {
            return true;
        }
        try {
            return Class.forName(str).isAnnotationPresent(cfp.class);
    ...
    public static boolean c(Context context) {
        return bsp.b().b(context, bsq.GOOGLE_PLAY_SERVICES_VERSION_CODE) == 0;
    }
    ...
    public static boolean f(Context context) {
        int b2 = bsp.b().b(context, bsq.GOOGLE_PLAY_SERVICES_VERSION_CODE);
        return b2 == 0 || b2 == 2;
    }
    ...
    public final void a(Context context, String str, Bundle bundle) {
        a(context, null, str, bundle, true, new cpd());
    }

    public final void a(ViewGroup viewGroup, dpt dpt, String str, String str2) {
        cpn.a(5);
        a(viewGroup, dpt, str, -65536, -16777216);
    }
}
