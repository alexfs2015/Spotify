...
public final class dls {
    ...
    private ArrayList<dmd> p = new ArrayList<>();

    public dls(int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        String str = "";
        this.f = str;
        this.g = str;
        this.h = str;
    ...
    private final void c(String str, boolean z, float f2, float f3, float f4, float f5) {
        if (str != null && str.length() >= this.k) {
            synchronized (this.a) {
                ...
                if (z) {
                    this.o.add(str);
                    ArrayList<dmd> arrayList = this.p;
                    dmd dmd = new dmd(f2, f3, f4, f5, this.o.size() - 1);
                    arrayList.add(dmd);
                }
            }
        }
