...
public class als {
    private static final String a = als.class.getCanonicalName();
    ...
    public static boolean a(final String str) {
        ...
        final String format = String.format("%s_%s_%s", new Object[]{"fbsdk", String.format("%s-%s", new Object[]{"android", akc.i().replace('.', '|')}), str});
        NsdServiceInfo nsdServiceInfo = new NsdServiceInfo();
        nsdServiceInfo.setServiceType("_fb._tcp.");
        nsdServiceInfo.setServiceName(format);
        nsdServiceInfo.setPort(80);
        NsdManager nsdManager = (NsdManager) akc.g().getSystemService("servicediscovery");
    ...
    public static boolean b() {
        return VERSION.SDK_INT >= 16 && FetchedAppSettingsManager.a(akc.k()).f.contains(SmartLoginOption.Enabled);
    }
    ...
    public static Bitmap b(String str) {
        ...
        try {
            flo a2 = new fld().a(str, BarcodeFormat.QR_CODE, 200, 200, enumMap);
            int i = a2.b;
            int i2 = a2.a;
    ...
    public static void c(String str) {
        ...
        if (registrationListener != null) {
            try {
                ((NsdManager) akc.g().getSystemService("servicediscovery")).unregisterService(registrationListener);
