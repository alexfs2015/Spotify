...
public final class xoa {
    private static final xoa a = new xoa();
    private static xnw g = new xnw() {
    };
    private final AtomicReference<xnw> b = new AtomicReference<>();
    private final AtomicReference<xny> c = new AtomicReference<>();
    private final AtomicReference<xoc> d = new AtomicReference<>();
    private final AtomicReference<xnv> e = new AtomicReference<>();
    private final AtomicReference<xob> f = new AtomicReference<>();
    ...
    private static java.lang.Object a(java.lang.Class<?> r10, java.util.Properties r11) {
        ...
        L_0x0133:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.xoa.a(java.lang.Class, java.util.Properties):java.lang.Object");
    }
    ...
    public final xnw b() {
        if (this.b.get() == null) {
            Object a2 = a(xnw.class, g());
            if (a2 == null) {
                this.b.compareAndSet(null, g);
            } else {
                this.b.compareAndSet(null, (xnw) a2);
            }
        }
        return (xnw) this.b.get();
    }

    public final xny c() {
        if (this.c.get() == null) {
            Object a2 = a(xny.class, g());
            if (a2 == null) {
                this.c.compareAndSet(null, xnz.a());
            } else {
                this.c.compareAndSet(null, (xny) a2);
            }
        }
        return (xny) this.c.get();
    }

    public final xoc d() {
        if (this.d.get() == null) {
            Object a2 = a(xoc.class, g());
            if (a2 == null) {
                this.d.compareAndSet(null, xod.a());
            } else {
                this.d.compareAndSet(null, (xoc) a2);
            }
        }
        return (xoc) this.d.get();
    }

    public final xnv e() {
        if (this.e.get() == null) {
            Object a2 = a(xnv.class, g());
            if (a2 == null) {
                this.e.compareAndSet(null, new xnv() {
                });
            } else {
                this.e.compareAndSet(null, (xnv) a2);
            }
        }
        return (xnv) this.e.get();
    }

    public final xob f() {
        if (this.f.get() == null) {
            Object a2 = a(xob.class, g());
            if (a2 == null) {
                this.f.compareAndSet(null, xob.d());
            } else {
                this.f.compareAndSet(null, (xob) a2);
            }
        }
        return (xob) this.f.get();
    }
}
