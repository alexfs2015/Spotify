...
public final class rpg {
    ...
    /* renamed from: rpg$1 reason: invalid class name */
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0071:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.rpg.AnonymousClass1.<clinit>():void");
        }
    }

    public rpg(jjf jjf, jrf jrf) {
        this.a = jjf;
        this.b = jrf;
    }

    public final void a(int i) {
        ai aiVar = new ai(null, i == 1 ? "connect-volume-hardware-button/volume-up" : "connect-volume-hardware-button/volume-down", null, "update-volume", PageIdentifiers.CONNECT_DEVICEPICKER.mPageIdentifier, ViewUris.bp.toString());
        this.a.a(aiVar);
    ...
    public final void a(State state, String str, String str2) {
        ...
        sb.append(a(state));
        ai aiVar = new ai(null, sb.toString(), null, InteractionIntent.NAVIGATE.mInteractionIntent, str, str2);
        this.a.a(aiVar);
        Logger.b(aiVar.a(), new Object[0]);
    }
    ...
    public final void a() {
        jrf jrf = this.b;
        bf bfVar = new bf(null, "com.spotify.service.connectui", "spotify:connect-access-button", null, 0, null, "connect-access-button-visible", null, (double) System.currentTimeMillis());
        this.a.a(bfVar);
