...
public final class fmw {
    ...
    public static String a(String str, SymbolShapeHint symbolShapeHint, flw flw, flw flw2) {
        int i = 0;
        fmt[] fmtArr = {new fmn(), new fmp(), new fmy(), new fmz(), new fms(), new fmo()};
        fmu fmu = new fmu(str);
        fmu.b = symbolShapeHint;
        fmu.c = flw;
        fmu.d = flw2;
        String str2 = "\u001e\u0004";
        ...
        int length = fmu.e.length();
        fmu.d();
        int i2 = fmu.h.a;
        if (!(length >= i2 || i == 0 || i == 5)) {
            fmu.a(254);
        }
        StringBuilder sb = fmu.e;
        if (sb.length() < i2) {
            sb.append(129);
        }
        while (sb.length() < i2) {
