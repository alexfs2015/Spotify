...
public final class bav extends baa {
    ...
    public bav(List<byte[]> list) {
        ...
        this.d = true;
        String a = ben.a((byte[]) list.get(0));
        bdl.a(a.startsWith("Format: "));
        a(a);
        a(new bea((byte[]) list.get(1)));
    }

    private static void a(bea bea) {
        String r;
        do {
            r = bea.r();
            if (r == null) {
    ...
    private void a(bea bea, List<azz> list, bdv bdv) {
        long j;
        while (true) {
            String r = bea.r();
            if (r == null) {
                ...
                if (this.e == 0) {
                    ...
                    if (split.length != this.e) {
                        ...
                        if (b == -9223372036854775807L) {
                            ...
                            String str4 = "\n";
                            list.add(new azz(replaceAll.replaceAll("\\\\N", str4).replaceAll("\\\\n", str4)));
                            bdv.a(b);
                            if (j != -9223372036854775807L) {
                                list.add(null);
                                bdv.a(j);
    ...
    private void a(java.lang.String r9) {
        ...
        L_0x0018:
            ...
            java.lang.String r3 = defpackage.ben.d(r3)
            int r4 = r3.hashCode()
        ...
        L_0x007b:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.bav.a(java.lang.String):void");
    }
