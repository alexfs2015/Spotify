...
public final class dak {
    ...
    public static KeyPair a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) dan.d.a("EC");
    ...
    public static ECPublicKey a(zzayv zzayv, byte[] bArr, byte[] bArr2) {
        ...
        return (ECPublicKey) ((KeyFactory) dan.e.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, a));
    }
    ...
    public static byte[] a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        ...
        KeyAgreement keyAgreement = (KeyAgreement) dan.c.a("ECDH");
