...
public final class gqx {
    public static Observable<gsd> a(ConnectManager connectManager) {
        return Observable.a(connectManager.g().c((Function<? super T, ? extends R>) $$Lambda$mZ9LFNADZu_WPDiBz80peLQVbQ.INSTANCE).e(Optional.e()), connectManager.h().e(Optional.e()), connectManager.e(), connectManager.f().e(ConnectState.UNKNOWN), $$Lambda$gqx$4bJ3kMhg4iY6cgAeY1anS4CVAo.INSTANCE);
    }
    ...
    public static /* synthetic */ defpackage.gsd a(com.google.common.base.Optional r3, com.google.common.base.Optional r4, java.util.List<com.spotify.mobile.android.connect.model.GaiaDevice> r5, com.spotify.mobile.android.connect.ConnectManager.ConnectState r6) {
        /*
        ...
        L_0x0024:
            ...
            gsd r3 = defpackage.gsd.a(r6, r0, r3, r4)
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gqx.a(com.google.common.base.Optional, com.google.common.base.Optional, java.util.List, com.spotify.mobile.android.connect.ConnectManager$ConnectState):gsd");
    }
}
