...
public final class wp {
    ...
    wp(vt vtVar, wa waVar, ActivityState activityState, wx wxVar, long j2) {
        this.b = j2;
        this.c = waVar;
        this.d = vtVar;
    ...
    static String a(vu vuVar) {
        return xa.a("'%s'", vuVar.a);
    }
    ...
    private Map<String, String> b() {
        ...
        a((Map<String, String>) hashMap, "fire_adid", xa.a(contentResolver));
        a((Map<String, String>) hashMap, "fire_tracking_enabled", xa.b(contentResolver));
    ...
    private Map<String, String> b(String str) {
        ...
        a((Map<String, String>) hashMap, "connectivity_type", (long) xa.e(this.d.c));
        ...
        a((Map<String, String>) hashMap, "mcc", xa.g(this.d.c));
        a((Map<String, String>) hashMap, "mnc", xa.h(this.d.c));
        a((Map<String, String>) hashMap, "needs_response_details", Boolean.TRUE);
        a((Map<String, String>) hashMap, "network_type", (long) xa.f(this.d.c));
