...
public final class jso {
    ...
    private static Button a(Context context, ViewGroup viewGroup, SpotifyIconV2 spotifyIconV2, String str) {
        Button c = gat.c(context);
        LayoutParams a = gas.a(context, viewGroup);
        if (a != null) {
            c.setLayoutParams(a);
        }
        int a2 = vfj.a(48.0f, context.getResources());
        c.setPadding(a2, 0, a2, 0);
        c.setCompoundDrawablePadding(vfj.a(8.0f, context.getResources()));
    ...
    public static void a(Context context, Button button, SpotifyIconV2 spotifyIconV2, String str) {
        ...
        if (spotifyIconV2 != null) {
            float b = (float) vfj.b(18.0f, context.getResources());
