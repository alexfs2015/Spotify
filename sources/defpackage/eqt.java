...
final class eqt extends SQLiteOpenHelper {
    private final /* synthetic */ eqs a;

    eqt(eqs eqs, Context context, String str) {
        this.a = eqs;
    ...
    public final void onOpen(android.database.sqlite.SQLiteDatabase r8) {
        ...
        L_0x001d:
            ...
            r2 = r8
            defpackage.ewd.a(r1, r2, r3, r4, r5, r6)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eqt.onOpen(android.database.sqlite.SQLiteDatabase):void");
    }
