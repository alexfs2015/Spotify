...
public final class cyq extends ddp<cyq, a> implements des {
    private static volatile dfc<cyq> zzakh;
    /* access modifiers changed from: private */
    public static final cyq zzdiz = new cyq();
    /* access modifiers changed from: 0000 */
    public int zzdih;
    zzbah zzdip = zzbah.a;

    /* renamed from: cyq$a */
    public static final class a extends defpackage.ddp.a<cyq, a> implements des {
        private a() {
            super(cyq.zzdiz);
        }
        ...
        public final a a(zzbah zzbah) {
            d();
            cyq.a((cyq) this.a, zzbah);
            return this;
        }
    }

    static {
        ddp.a(cyq.class, zzdiz);
    }
    ...
    public static a a() {
        return (a) ((defpackage.ddp.a) zzdiz.a(e.e));
    }

    public static cyq a(zzbah zzbah) {
        return (cyq) ddp.a(zzdiz, zzbah);
    }

    static /* synthetic */ void a(cyq cyq, zzbah zzbah) {
        if (zzbah != null) {
            cyq.zzdip = zzbah;
            return;
        }
    ...
    /* JADX WARNING: type inference failed for: r4v9, types: [dfc<cyq>] */
    /* JADX WARNING: type inference failed for: r4v10, types: [java.lang.Object] */
    /* JADX WARNING: type inference failed for: r4v12, types: [dfc<cyq>] */
    /* JADX WARNING: type inference failed for: r4v13 */
    /* JADX WARNING: type inference failed for: r4v14, types: [dfc<cyq>, ddp$b] */
    ...
    public final java.lang.Object a(int r4) {
        ...
        L_0x0017:
            ...
            monitor-enter(r0)
            dfc<cyq> r4 = zzakh     // Catch:{ all -> 0x002d }
            if (r4 != 0) goto L_0x002b
            ddp$b r4 = new ddp$b     // Catch:{ all -> 0x002d }
            cyq r1 = zzdiz     // Catch:{ all -> 0x002d }
