...
public class aln {
    ...
    public static final String a = aln.class.getCanonicalName();

    /* renamed from: aln$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.aln.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static class a extends AccessibilityDelegate {
        ...
        public final void sendAccessibilityEvent(View view, int i) {
            if (i == -1) {
                Log.e(aln.a, "Unsupported action type");
            }
            if (i == this.e) {
