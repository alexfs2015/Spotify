...
public final class ckp {
    ...
    static Bundle a(String str, boolean z) {
        ...
        try {
            ...
            clu.a(valueOf.length() != 0 ? str2.concat(valueOf) : new String(str2), e2);
        }
        if (z) {
            bundle.putInt("_r", 1);
        }
    ...
    public final boolean b(Context context) {
        return ((Boolean) dpn.f().a(dsp.ak)).booleanValue() && a(context);
    }
    ...
    public final boolean c(Context context) {
        return ((Boolean) dpn.f().a(dsp.al)).booleanValue() && a(context);
    }
    ...
    public final boolean d(Context context) {
        return ((Boolean) dpn.f().a(dsp.am)).booleanValue() && a(context);
    }
    ...
    public final boolean e(Context context) {
        return ((Boolean) dpn.f().a(dsp.an)).booleanValue() && a(context);
    }
    ...
    public final String h(Context context) {
        ...
        long longValue = ((Long) dpn.f().a(dsp.at)).longValue();
        if (longValue < 0) {
            return (String) a("getAppInstanceId", context);
        }
        if (this.b.get() == null) {
            AtomicReference<ThreadPoolExecutor> atomicReference = this.b;
            ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(((Integer) dpn.f().a(dsp.au)).intValue(), ((Integer) dpn.f().a(dsp.au)).intValue(), 1, TimeUnit.MINUTES, new LinkedBlockingQueue(), new cks());
            atomicReference.compareAndSet(null, threadPoolExecutor);
        }
        Future submit = ((ThreadPoolExecutor) this.b.get()).submit(new ckq(this, context));
        try {
    ...
    public final boolean a(Context context) {
        if (((Boolean) dpn.f().a(dsp.aj)).booleanValue() && !this.e.get()) {
            if (this.f.get() == -1) {
                dpn.a();
                if (!col.c(context)) {
                    dpn.a();
