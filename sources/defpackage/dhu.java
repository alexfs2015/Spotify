...
public abstract class dhu implements dht {
    protected static volatile dil a;
    ...
    private final String a(Context context, String str, boolean z, View view, Activity activity) {
        ...
        return dbr.d() == 0 ? Integer.toString(5) : dha.a(dbr, str);
    }
    ...
    /* access modifiers changed from: protected */
    public abstract dbr a(Context context, View view, Activity activity);

    public final String a(Context context) {
        if (dit.a()) {
            if (((Boolean) dpn.f().a(dsp.bL)).booleanValue()) {
    ...
    /* access modifiers changed from: protected */
    public abstract dbr b(Context context);

    /* access modifiers changed from: protected */
    public abstract dis b(MotionEvent motionEvent);
}
