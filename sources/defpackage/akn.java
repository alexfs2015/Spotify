...
public abstract class akn extends Button {
    ...
    protected akn(Context context, AttributeSet attributeSet, int i, int i2, String str, String str2) {
                        ...
                        try {
                            ...
                            super.setOnClickListener(new OnClickListener() {
                                public final void onClick(View view) {
                                    akn akn = akn.this;
                                    new alk(akn.getContext()).a(akn.c);
                                    if (akn.this.a != null) {
                                        akn.this.a.onClick(view);
                                        return;
                                    }
                                    if (akn.this.d != null) {
                                        akn.this.d.onClick(view);
                                    }
                                }
                            });
                        } catch (Throwable th) {
    ...
    public final android.app.Activity c() {
        ...
        L_0x0021:
            goto L_0x0020
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.akn.c():android.app.Activity");
    }
