...
public final class vdd {
    public static Drawable a(Context context) {
        return a((Context) fbp.a(context), 16, 1, 0.6f);
    }

    public static Drawable a(Context context, Drawable drawable) {
        Drawable drawable2 = (Drawable) fbp.a(fr.a((Context) fbp.a(context), (int) R.drawable.selected_icon_indicator_dot));
        int intrinsicWidth = (drawable.getIntrinsicWidth() - drawable2.getIntrinsicWidth()) / 2;
        int intrinsicHeight = drawable.getIntrinsicHeight() + vfj.b(6.0f, context.getResources());
    ...
    public static Drawable a(Context context, SpotifyIcon spotifyIcon, int i) {
        return a((Context) fbp.a(context), spotifyIcon, i, fr.b(context, (int) R.color.btn_now_playing_white));
    }

    public static Drawable a(Context context, SpotifyIcon spotifyIcon, int i, int i2, int i3) {
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable((Context) fbp.a(context), spotifyIcon, (float) i);
    ...
    public static Drawable a(Context context, SpotifyIconV2 spotifyIconV2) {
        float dimensionPixelSize = (float) ((Context) fbp.a(context)).getResources().getDimensionPixelSize(R.dimen.player_side_action_button_drawable_size);
    ...
    public static vgr a(Context context, int i, int i2, float f) {
        return a((Context) fbp.a(context), i, i2, SpotifyIcon.PLAY_32, f);
    }

    private static vgr a(Context context, int i, int i2, SpotifyIcon spotifyIcon, float f) {
        return a(context, i, i2, spotifyIcon, R.color.btn_now_playing_white, f);
    }

    public static vgr a(Context context, int i, int i2, SpotifyIcon spotifyIcon, int i3, float f) {
        return a((Context) fbp.a(context), i, i2, spotifyIcon, i3, i3, f);
    }

    private static vgr a(Context context, int i, int i2, SpotifyIcon spotifyIcon, int i3, int i4, float f) {
        ColorStateList b = fr.b((Context) fbp.a(context), i3);
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(context, spotifyIcon, (float) vfj.b((float) i, context.getResources()));
        spotifyIconDrawable.a(b);
        return a(context, i2, fr.b(context, i4), (Drawable) spotifyIconDrawable, f);
    }

    private static vgr a(Context context, int i, ColorStateList colorStateList, Drawable drawable, float f) {
        vgr vgr = new vgr(drawable, f);
        vgr.a((float) vfj.b((float) i, ((Context) fbp.a(context)).getResources()));
        vgr.b(colorStateList);
        vgr.a(fr.c(context, R.color.pasteTransparent));
        return vgr;
    }

    public static Drawable b(Context context) {
        return b((Context) fbp.a(context), 16, 1, 0.6f);
    }

    public static Drawable b(Context context, SpotifyIcon spotifyIcon, int i) {
        return a((Context) fbp.a(context), spotifyIcon, i, fr.b(context, (int) R.color.btn_now_playing_gray_disabled));
    }

    public static vgr b(Context context, int i, int i2, float f) {
        return a((Context) fbp.a(context), i, i2, SpotifyIcon.PAUSE_32, f);
    }

    public static Drawable c(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.CHEVRON_UP_24, context.getResources().getDimensionPixelSize(R.dimen.player_side_action_button_drawable_size));
    }

    public static Drawable d(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.SKIP_BACK_32, vfj.b(24.0f, context.getResources()));
    }

    public static Drawable e(Context context) {
        return b((Context) fbp.a(context), SpotifyIcon.SKIP_BACK_32, vfj.b(24.0f, context.getResources()));
    }

    public static Drawable f(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.SKIP_FORWARD_32, vfj.b(24.0f, context.getResources()));
    }

    public static Drawable g(Context context) {
        return b((Context) fbp.a(context), SpotifyIcon.SKIP_FORWARD_32, vfj.b(24.0f, context.getResources()));
    }

    public static Drawable h(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.SHUFFLE_32, s(context), (int) R.color.cat_white, (int) R.color.cat_white_70);
    }

    public static Drawable i(Context context) {
        return a(context, a((Context) fbp.a(context), SpotifyIcon.SHUFFLE_32, s(context), (int) R.color.cat_medium_green, (int) R.color.cat_light_green));
    }

    public static Drawable j(Context context) {
        return b((Context) fbp.a(context), SpotifyIcon.SHUFFLE_32, s(context));
    }

    public static Drawable k(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.REPEAT_32, s(context), (int) R.color.cat_white, (int) R.color.cat_white_70);
    }

    public static Drawable l(Context context) {
        return a(context, a((Context) fbp.a(context), SpotifyIcon.REPEAT_32, s(context), (int) R.color.cat_medium_green, (int) R.color.cat_light_green));
    }

    public static Drawable m(Context context) {
        return a(context, a((Context) fbp.a(context), SpotifyIcon.REPEATONCE_32, s(context), (int) R.color.cat_medium_green, (int) R.color.cat_light_green));
    }

    public static Drawable n(Context context) {
        return b((Context) fbp.a(context), SpotifyIcon.REPEAT_32, s(context));
    }

    public static Drawable o(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.QUEUE_24, vfj.b(24.0f, context.getResources()));
    }

    public static Drawable p(Context context) {
        return a((Context) fbp.a(context), SpotifyIcon.SLEEPTIMER_32, s(context), (int) R.color.cat_white, (int) R.color.cat_white_70);
    }
    ...
    public static int s(Context context) {
        return ((Context) fbp.a(context)).getResources().getDimensionPixelSize(R.dimen.player_side_action_button_drawable_size);
    }
}
