...
public final class jqb extends BaseAdapter {
    public jqc a;
    ...
    public final void a(ListAdapter listAdapter, String str, int i2, View view, View view2) {
        ...
        if (i3 != Integer.MIN_VALUE) {
            fay.a(this.e.get(i2, null) == null, "Section id %s is already in use!", (Object) Integer.toString(i2));
        }
    ...
    public a b(int i2) {
        fay.a(i2 != Integer.MIN_VALUE, (Object) "Invalid section id: SECTION_ID_NONE");
    ...
    public final View getView(int i2, View view, ViewGroup viewGroup) {
        ...
        if (d2.a(d3)) {
            ...
            return (View) fay.a(d2.i);
        } else {
            if (d2.c(d3)) {
                return (View) fay.a(d2.j);
            }
            return (View) fay.a(d2.a.getView(d2.e(i2), view, viewGroup));
        }
    }
