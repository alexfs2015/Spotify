...
final class kc extends kr implements e {
    final kl a;
    int b = -1;
    private boolean t;
    ...
    public final kr a(Fragment fragment) {
    ...
    public final kr a(Fragment fragment, State state) {
    ...
    public final void a(boolean z) {
        ...
        if (!this.r && z) {
            kl klVar = this.a;
            klVar.a(klVar.i, true);
        }
    }

    /* access modifiers changed from: 0000 */
    public final boolean a(ArrayList<kc> arrayList, int i, int i2) {
        if (i2 == i) {
            return false;
        }
        int size = this.c.size();
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    int size2 = kcVar.c.size();
                    for (int i7 = 0; i7 < size2; i7++) {
                        a aVar2 = (a) kcVar.c.get(i7);
    ...
    public final kr b(Fragment fragment) {
        if (fragment.t == null || fragment.t == this.a) {
