...
final class eos<T> implements epe<T> {
    private static final int[] a = new int[0];
    private static final Unsafe b = eqb.c();
    private final int[] c;
    ...
    private eos(int[] iArr, Object[] objArr, int i2, int i3, eoo eoo, boolean z, int[] iArr2, int i4, int i5, eov eov, eoa eoa, epv<?, ?> epv, end<?> end, eoj eoj) {
        this.c = iArr;
        this.d = objArr;
        this.e = i2;
        this.f = i3;
        this.i = eoo instanceof enn;
        this.j = z;
        this.h = end != null && end.a(eoo);
        this.k = false;
        this.l = iArr2;
        this.m = i4;
        this.n = i5;
    ...
    private static <UT, UB> int a(epv<UT, UB> epv, T t) {
        return epv.f(epv.b(t));
    }

    static <T> eos<T> a(eom eom, eov eov, eoa eoa, epv<?, ?> epv, end<?> end, eoj eoj) {
        int i2;
        int i3;
        int i4;
        int i5;
        ...
        char charAt14;
        eom eom2 = eom;
        if (eom2 instanceof epc) {
            epc epc2 = (epc) eom2;
            int i30 = 0;
            boolean z = epc2.a() == e.i;
            String str2 = epc2.b;
            ...
            Unsafe unsafe = b;
            Object[] objArr = epc2.c;
            Class cls = epc2.a.getClass();
            int i60 = i8;
            ...
            boolean z3 = z;
            int i103 = i7;
            eos eos = new eos(iArr4, objArr2, i10, i9, epc2.a, z, iArr, i7, i61, eov, eoa, epv, end, eoj);
            return eos;
        }
        epr epr = (epr) eom2;
    ...
    private final epe a(int i2) {
        int i3 = (i2 / 3) << 1;
        epe epe = (epe) this.d[i3];
        if (epe != null) {
            return epe;
        }
        epe a2 = epa.a().a((Class) this.d[i3 + 1]);
        this.d[i3] = a2;
        return a2;
    }

    private final <K, V, UT, UB> UB a(int i2, int i3, Map<K, V> map, ens ens, UB ub, epv<UT, UB> epv) {
        eoi b2 = this.s.b();
        Iterator it = map.entrySet().iterator();
        while (it.hasNext()) {
            Entry entry = (Entry) it.next();
            if (!ens.a(((Integer) entry.getValue()).intValue())) {
                if (ub == null) {
                    ub = epv.a();
                }
                emr d2 = zzun.d(eoh.a(b2, entry.getKey(), entry.getValue()));
                try {
                    eoh.a(d2.a, b2, entry.getKey(), entry.getValue());
                    epv.a(ub, i3, d2.a());
                    it.remove();
    ...
    private final <UT, UB> UB a(Object obj, int i2, UB ub, epv<UT, UB> epv) {
        int i3 = this.c[i2];
        Object f2 = eqb.f(obj, (long) (c(i2) & 1048575));
        if (f2 == null) {
            return ub;
        }
        ens b2 = b(i2);
        ...
        return a(i2, i3, this.s.a(f2), b2, ub, epv);
    }
    ...
    private static <E> List<E> a(Object obj, long j2) {
        return (List) eqb.f(obj, j2);
    }

    private static void a(int i2, Object obj, eqi eqi) {
    ...
    private static <UT, UB> void a(epv<UT, UB> epv, T t, eqi eqi) {
        epv.a(epv.b(t), eqi);
    }

    private final <K, V> void a(eqi eqi, int i2, Object obj, int i3) {
        if (obj != null) {
            eqi.a(i2, this.s.b(), this.s.b(obj));
        }
    }

    private final void a(Object obj, int i2, epd epd) {
        if (e(i2)) {
            eqb.a(obj, (long) (i2 & 1048575), (Object) epd.m());
        } else if (this.i) {
            eqb.a(obj, (long) (i2 & 1048575), (Object) epd.l());
        } else {
            eqb.a(obj, (long) (i2 & 1048575), (Object) epd.n());
        }
    }
    ...
    private final void a(T t, T t2, int i2) {
        ...
        if (a(t2, i2)) {
            Object f2 = eqb.f(t, c2);
            Object f3 = eqb.f(t2, c2);
            if (f2 == null || f3 == null) {
                if (f3 != null) {
                    eqb.a((Object) t, c2, f3);
                    b(t, i2);
                }
                return;
            }
            eqb.a((Object) t, c2, enp.a(f2, f3));
            b(t, i2);
        }
    }
    ...
    private final boolean a(T t, int i2) {
        if (this.j) {
            ...
            switch ((c2 & 267386880) >>> 20) {
                case 0:
                    return eqb.e(t, j2) != 0.0d;
                case 1:
                    return eqb.d(t, j2) != 0.0f;
                case 2:
                    return eqb.b(t, j2) != 0;
                case 3:
                    return eqb.b(t, j2) != 0;
                case 4:
                    return eqb.a((Object) t, j2) != 0;
                case 5:
                    return eqb.b(t, j2) != 0;
                case 6:
                    return eqb.a((Object) t, j2) != 0;
                ...
                case 9:
                    return eqb.f(t, j2) != null;
                case 10:
                    return !zzun.a.equals(eqb.f(t, j2));
                case 11:
                    return eqb.a((Object) t, j2) != 0;
                case 12:
                    return eqb.a((Object) t, j2) != 0;
            ...
            int d2 = d(i2);
            return (eqb.a((Object) t, (long) (d2 & 1048575)) & (1 << (d2 >>> 20))) != 0;
        }
    }

    private final boolean a(T t, int i2, int i3) {
        return eqb.a((Object) t, (long) (d(i3) & 1048575)) == i2;
    }
    ...
    private static boolean a(Object obj, int i2, epe epe) {
        return epe.d(eqb.f(obj, (long) (i2 & 1048575)));
    }

    private static <T> double b(T t, long j2) {
        return ((Double) eqb.f(t, j2)).doubleValue();
    }

    private final ens b(int i2) {
        return (ens) this.d[((i2 / 3) << 1) + 1];
    }
    ...
    private final void b(T t, int i2) {
        if (!this.j) {
            ...
            eqb.a((Object) t, j2, eqb.a((Object) t, j2) | (1 << (d2 >>> 20)));
        }
    }

    private final void b(T t, int i2, int i3) {
        eqb.a((Object) t, (long) (d(i3) & 1048575), i2);
    }

    /* JADX WARNING: Removed duplicated region for block: B:172:0x04b3  */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0030  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void b(T r19, defpackage.eqi r20) {
        /*
            r18 = this;
            r0 = r18
            r1 = r19
            ...
            eng r3 = r3.a(r1)
            eph<FieldDescriptorType, java.lang.Object> r5 = r3.a
        ...
        L_0x0442:
            ...
            r4 = r11 & r9
            if (r4 == 0) goto L_0x04a9
            boolean r4 = defpackage.eqb.c(r1, r12)
            r2.a(r14, r4)
            goto L_0x04a9
        L_0x044f:
            r15 = 0
        ...
        L_0x0490:
            ...
            r4 = r11 & r9
            if (r4 == 0) goto L_0x04a9
            float r4 = defpackage.eqb.d(r1, r12)
            r2.a(r14, r4)
            goto L_0x04a9
        L_0x049d:
            r15 = 0
            r4 = r11 & r9
            if (r4 == 0) goto L_0x04a9
            double r12 = defpackage.eqb.e(r1, r12)
            r2.a(r14, r12)
        L_0x04a9:
            int r5 = r5 + 3
            goto L_0x002e
        ...
        L_0x04c7:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eos.b(java.lang.Object, eqi):void");
    }
    ...
    private final void b(T t, T t2, int i2) {
        ...
        if (a(t2, i3, i2)) {
            Object f2 = eqb.f(t, j2);
            Object f3 = eqb.f(t2, j2);
            if (f2 == null || f3 == null) {
                if (f3 != null) {
                    eqb.a((Object) t, j2, f3);
                    b(t, i3, i2);
                }
                return;
            }
            eqb.a((Object) t, j2, enp.a(f2, f3));
            b(t, i3, i2);
        }
    }

    private static <T> float c(T t, long j2) {
        return ((Float) eqb.f(t, j2)).floatValue();
    }
    ...
    private static <T> int d(T t, long j2) {
        return ((Integer) eqb.f(t, j2)).intValue();
    }

    private static <T> long e(T t, long j2) {
        return ((Long) eqb.f(t, j2)).longValue();
    }
    ...
    private static <T> boolean f(T t, long j2) {
        return ((Boolean) eqb.f(t, j2)).booleanValue();
    }
    ...
    public final int a(T r9) {
        ...
        L_0x0020:
            ...
            java.lang.Object r3 = defpackage.eqb.f(r9, r5)
            int r2 = r2 * 53
            int r3 = r3.hashCode()
            goto L_0x0227
        L_0x0032:
        ...
        L_0x0175:
            int r2 = r2 * 53
            long r3 = defpackage.eqb.b(r9, r5)
            int r3 = defpackage.enp.a(r3)
            goto L_0x0227
        L_0x0181:
            int r2 = r2 * 53
            int r3 = defpackage.eqb.a(r9, r5)
            goto L_0x0227
        L_0x0189:
            int r2 = r2 * 53
            long r3 = defpackage.eqb.b(r9, r5)
        ...
        L_0x01d4:
            int r2 = r2 * 53
            boolean r3 = defpackage.eqb.c(r9, r5)
            int r3 = defpackage.enp.a(r3)
            goto L_0x0227
        L_0x01df:
            int r2 = r2 * 53
        ...
        L_0x020e:
            int r2 = r2 * 53
            float r3 = defpackage.eqb.d(r9, r5)
            int r3 = java.lang.Float.floatToIntBits(r3)
            goto L_0x0227
        L_0x0219:
            int r2 = r2 * 53
            double r3 = defpackage.eqb.e(r9, r5)
            long r3 = java.lang.Double.doubleToLongBits(r3)
            int r3 = defpackage.enp.a(r3)
        L_0x0227:
            int r2 = r2 + r3
        ...
        L_0x024a:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eos.a(java.lang.Object):int");
    }
                ...
                try {
                    ...
                    if (i2 >= 0) {
                        ...
                        switch ((267386880 & c2) >>> 20) {
                            case 0:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.d());
                                b(t, i2);
                                break;
                            case 1:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.e());
                                b(t, i2);
                                break;
                            case 2:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.g());
                                b(t, i2);
                                break;
                            case 3:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.f());
                                b(t, i2);
                                break;
                            case 4:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.h());
                                b(t, i2);
                                break;
                            case 5:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.i());
                                b(t, i2);
                                break;
                            case 6:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.j());
                                b(t, i2);
                                break;
                            case 7:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.k());
                                b(t, i2);
                                break;
                            case 8:
                                a((Object) t, c2, epd);
                            ...
                            case 9:
                                if (!a(t, i2)) {
                                    eqb.a((Object) t, (long) (c2 & 1048575), epd.a(a(i2), enc));
                                    b(t, i2);
                                    break;
                                } else {
                                    long j2 = (long) (c2 & 1048575);
                                    eqb.a((Object) t, j2, enp.a(eqb.f(t, j2), epd.a(a(i2), enc)));
                                    break;
                                }
                            case 10:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) epd.n());
                                b(t, i2);
                                break;
                            case 11:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.o());
                                b(t, i2);
                                break;
                            case 12:
                                int p2 = epd.p();
                                ...
                                if (b2 != null) {
                                    if (!b2.a(p2)) {
                                        obj = epg.a(a2, p2, obj, epv);
                                        break;
                                    }
                                }
                                eqb.a((Object) t, (long) (c2 & 1048575), p2);
                                b(t, i2);
                                break;
                            case 13:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.q());
                                b(t, i2);
                                break;
                            case 14:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.r());
                                b(t, i2);
                                break;
                            case 15:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.s());
                                b(t, i2);
                                break;
                            case 16:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.t());
                                b(t, i2);
                                break;
                            case 17:
                                if (!a(t, i2)) {
                                    eqb.a((Object) t, (long) (c2 & 1048575), epd.b(a(i2), enc));
                                    b(t, i2);
                                    break;
                                } else {
                                    long j3 = (long) (c2 & 1048575);
                                    eqb.a((Object) t, j3, enp.a(eqb.f(t, j3), epd.b(a(i2), enc)));
                                    break;
                                }
                            case 18:
                                epd.a(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 19:
                                epd.b(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 20:
                                epd.d(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 21:
                                epd.c(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 22:
                                epd.e(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 23:
                                epd.f(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 24:
                                epd.g(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 25:
                                epd.h(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 26:
                                if (!e(c2)) {
                                    epd.i(this.p.a(t, (long) (c2 & 1048575)));
                                    break;
                                } else {
                                    epd.j(this.p.a(t, (long) (c2 & 1048575)));
                                    break;
                                }
                            case 27:
                                epd.a(this.p.a(t, (long) (c2 & 1048575)), a(i2), enc);
                                break;
                            case 28:
                                epd.k(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 29:
                                epd.l(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 30:
                                List a3 = this.p.a(t, (long) (c2 & 1048575));
                                epd.m(a3);
                                obj = epg.a(a2, a3, b(i2), obj, epv);
                                break;
                            case 31:
                                epd.n(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 32:
                                epd.o(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 33:
                                epd.p(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 34:
                                epd.q(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            case 35:
                                epd.a(this.p.a(t, (long) (c2 & 1048575)));
                                break;
                            ...
                            case 48:
                                ...
                                break;
                            case 49:
                                epd.b(this.p.a(t, (long) (c2 & 1048575)), a(i2), enc);
                                break;
                            case 50:
                                long c3 = (long) (c(i2) & 1048575);
                                Object f2 = eqb.f(t, c3);
                                if (f2 == null) {
                                    f2 = this.s.a();
                                    eqb.a((Object) t, c3, f2);
                                } else if (this.s.c(f2)) {
                                    Object a5 = this.s.a();
                                    this.s.a(a5, f2);
                                    eqb.a((Object) t, c3, a5);
                                    f2 = a5;
                                }
                                epd.a(this.s.a(f2), this.s.b(), enc);
                                break;
                            case 51:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Double.valueOf(epd.d()));
                                b(t, a2, i2);
                                break;
                            case 52:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Float.valueOf(epd.e()));
                                b(t, a2, i2);
                                break;
                            case 53:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Long.valueOf(epd.g()));
                                b(t, a2, i2);
                                break;
                            case 54:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Long.valueOf(epd.f()));
                                b(t, a2, i2);
                                break;
                            case 55:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Integer.valueOf(epd.h()));
                                b(t, a2, i2);
                                break;
                            case 56:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Long.valueOf(epd.i()));
                                b(t, a2, i2);
                                break;
                            case 57:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Integer.valueOf(epd.j()));
                                b(t, a2, i2);
                                break;
                            case 58:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Boolean.valueOf(epd.k()));
                                b(t, a2, i2);
                                break;
                            case 59:
                                a((Object) t, c2, epd);
                            ...
                            case b.bo /*60*/:
                                if (a(t, a2, i2)) {
                                    ...
                                    eqb.a((Object) t, j4, enp.a(eqb.f(t, j4), epd.a(a(i2), enc)));
                                } else {
                                    eqb.a((Object) t, (long) (c2 & 1048575), epd.a(a(i2), enc));
                                    b(t, i2);
                                }
                            ...
                            case b.bp /*61*/:
                                ...
                                break;
                            case b.bq /*62*/:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Integer.valueOf(epd.o()));
                                b(t, a2, i2);
                                break;
                            case b.br /*63*/:
                                int p3 = epd.p();
                                ...
                                if (b3 != null) {
                                    if (!b3.a(p3)) {
                                        obj = epg.a(a2, p3, obj, epv);
                                        break;
                                    }
                                }
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Integer.valueOf(p3));
                                b(t, a2, i2);
                                break;
                            case b.bs /*64*/:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Integer.valueOf(epd.q()));
                                b(t, a2, i2);
                                break;
                            case b.bt /*65*/:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Long.valueOf(epd.r()));
                                b(t, a2, i2);
                                break;
                            case b.bu /*66*/:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Integer.valueOf(epd.s()));
                                b(t, a2, i2);
                                break;
                            case b.bv /*67*/:
                                eqb.a((Object) t, (long) (c2 & 1048575), (Object) Long.valueOf(epd.t()));
                                b(t, a2, i2);
                                break;
                            case b.bw /*68*/:
                                eqb.a((Object) t, (long) (c2 & 1048575), epd.b(a(i2), enc));
                            ...
                            default:
                                ...
                                if (epv.a(obj, epd)) {
                                    ...
                                    for (int i7 = this.m; i7 < this.n; i7++) {
                                        obj = a((Object) t, this.l[i7], (UB) obj, epv);
                                    }
                                    if (obj != null) {
                                        epv.b((Object) t, obj);
                                    }
                        ...
                        for (int i8 = this.m; i8 < this.n; i8++) {
                            obj = a((Object) t, this.l[i8], (UB) obj, epv);
                        }
                        if (obj != null) {
                            epv.b((Object) t, obj);
                        }
                        ...
                        if ((!this.h ? null : end.a(enc, this.g, a2)) != null) {
                            if (eng == null) {
                                eng = end.b((Object) t);
                            }
                            obj = end.a();
                            ...
                            if (!epv.a(obj, epd)) {
                                for (int i9 = this.m; i9 < this.n; i9++) {
                                    obj = a((Object) t, this.l[i9], (UB) obj, epv);
                                }
                                if (obj != null) {
                                    epv.b((Object) t, obj);
                                }
                    ...
                    if (!epv.a(obj, epd)) {
                        for (int i10 = this.m; i10 < this.n; i10++) {
                            obj = a((Object) t, this.l[i10], (UB) obj, epv);
                        }
                        if (obj != null) {
                            epv.b((Object) t, obj);
                        }
                    ...
                    for (int i11 = this.m; i11 < this.n; i11++) {
                        obj = a((Object) t, this.l[i11], (UB) obj, epv);
                    }
                    if (obj != null) {
                        epv.b((Object) t, obj);
                    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void a(T r14, defpackage.eqi r15) {
        /*
            r13 = this;
            int r0 = r15.a()
            int r1 = defpackage.enn.e.k
            ...
            eng r0 = r0.a(r14)
            eph<FieldDescriptorType, java.lang.Object> r1 = r0.a
            boolean r1 = r1.isEmpty()
            if (r1 != 0) goto L_0x004d
            boolean r1 = r0.c
            if (r1 == 0) goto L_0x003c
            enw r1 = new enw
            eph<FieldDescriptorType, java.lang.Object> r0 = r0.a
        ...
        L_0x0085:
            ...
            r8 = r8 & r6
            long r10 = (long) r8
            java.lang.Object r8 = defpackage.eqb.f(r14, r10)
            epe r10 = r13.a(r7)
            r15.b(r9, r8, r10)
            goto L_0x0528
        L_0x009a:
        ...
        L_0x01cc:
            ...
            epe r10 = r13.a(r7)
            defpackage.epg.b(r9, r8, r15, r10)
            goto L_0x0528
        L_0x01e1:
            int[] r9 = r13.c
            r9 = r9[r7]
        ...
        L_0x0346:
            ...
            java.util.List r8 = (java.util.List) r8
            epe r10 = r13.a(r7)
            defpackage.epg.a(r9, r8, r15, r10)
            goto L_0x0528
        L_0x035b:
            int[] r9 = r13.c
            r9 = r9[r7]
        ...
        L_0x0409:
            ...
            r8 = r8 & r6
            long r10 = (long) r8
            long r10 = defpackage.eqb.b(r14, r10)
            r15.e(r9, r10)
            goto L_0x0528
        L_0x041a:
            boolean r10 = r13.a((T) r14, r7)
            ...
            r8 = r8 & r6
            long r10 = (long) r8
            int r8 = defpackage.eqb.a(r14, r10)
            r15.f(r9, r8)
            goto L_0x0528
        L_0x042b:
            boolean r10 = r13.a((T) r14, r7)
        ...
        L_0x04a8:
            ...
            r8 = r8 & r6
            long r10 = (long) r8
            boolean r8 = defpackage.eqb.c(r14, r10)
            r15.a(r9, r8)
            goto L_0x0528
        L_0x04b9:
            boolean r10 = r13.a((T) r14, r7)
        ...
        L_0x0509:
            ...
            r8 = r8 & r6
            long r10 = (long) r8
            float r8 = defpackage.eqb.d(r14, r10)
            r15.a(r9, r8)
            goto L_0x0528
        L_0x0519:
            boolean r10 = r13.a((T) r14, r7)
            ...
            r8 = r8 & r6
            long r10 = (long) r8
            double r10 = defpackage.eqb.e(r14, r10)
            r15.a(r9, r10)
        L_0x0528:
            int r7 = r7 + -3
            goto L_0x0054
        ...
        L_0x059d:
            ...
            r9 = r9 & r6
            long r11 = (long) r9
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            epe r11 = r13.a(r1)
            r15.b(r10, r9, r11)
            goto L_0x0a40
        L_0x05b2:
        ...
        L_0x06e4:
            ...
            java.util.List r9 = (java.util.List) r9
            epe r11 = r13.a(r1)
            defpackage.epg.b(r10, r9, r15, r11)
            goto L_0x0a40
        L_0x06f9:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.e(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x070a:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.j(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x071b:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.g(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x072c:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.l(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x073d:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.m(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x074e:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.i(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x075f:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.n(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x0770:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.k(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x0781:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.f(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x0792:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.h(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x07a3:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.d(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x07b4:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.c(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x07c5:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.b(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x07d6:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.a(r10, r9, r15, r4)
            goto L_0x0a40
        L_0x07e7:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.e(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x07f8:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.j(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x0809:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.g(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x081a:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.l(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x082b:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.m(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x083c:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.i(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x084d:
            int[] r10 = r13.c
            r10 = r10[r1]
        ...
        L_0x085e:
            ...
            java.util.List r9 = (java.util.List) r9
            epe r11 = r13.a(r1)
            defpackage.epg.a(r10, r9, r15, r11)
            goto L_0x0a40
        L_0x0873:
            int[] r10 = r13.c
            r10 = r10[r1]
        ...
        L_0x0884:
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.n(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x0895:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.k(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x08a6:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.f(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x08b7:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.h(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x08c8:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.d(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x08d9:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.c(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x08ea:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.b(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x08fb:
            int[] r10 = r13.c
            r10 = r10[r1]
            ...
            java.lang.Object r9 = defpackage.eqb.f(r14, r11)
            java.util.List r9 = (java.util.List) r9
            defpackage.epg.a(r10, r9, r15, r5)
            goto L_0x0a40
        L_0x090c:
        ...
        L_0x0921:
            ...
            r9 = r9 & r6
            long r11 = (long) r9
            long r11 = defpackage.eqb.b(r14, r11)
            r15.e(r10, r11)
            goto L_0x0a40
        L_0x0932:
            boolean r11 = r13.a((T) r14, r1)
            ...
            r9 = r9 & r6
            long r11 = (long) r9
            int r9 = defpackage.eqb.a(r14, r11)
            r15.f(r10, r9)
            goto L_0x0a40
        L_0x0943:
            boolean r11 = r13.a((T) r14, r1)
        ...
        L_0x09c0:
            ...
            r9 = r9 & r6
            long r11 = (long) r9
            boolean r9 = defpackage.eqb.c(r14, r11)
            r15.a(r10, r9)
            goto L_0x0a40
        L_0x09d1:
            boolean r11 = r13.a((T) r14, r1)
        ...
        L_0x0a21:
            ...
            r9 = r9 & r6
            long r11 = (long) r9
            float r9 = defpackage.eqb.d(r14, r11)
            r15.a(r10, r9)
            goto L_0x0a40
        L_0x0a31:
            boolean r11 = r13.a((T) r14, r1)
            ...
            r9 = r9 & r6
            long r11 = (long) r9
            double r11 = defpackage.eqb.e(r14, r11)
            r15.a(r10, r11)
        L_0x0a40:
            int r1 = r1 + 3
            goto L_0x056c
        ...
        L_0x0a61:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eos.a(java.lang.Object, eqi):void");
    }

    /* JADX INFO: used method not loaded: epg.a(java.lang.Object, java.lang.Object):null, types can be incorrect */
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x006a, code lost:
        if (defpackage.epg.a(defpackage.eqb.f(r10, r6), defpackage.eqb.f(r11, r6)) != false) goto L_0x01c2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x007e, code lost:
        if (defpackage.eqb.b(r10, r6) == defpackage.eqb.b(r11, r6)) goto L_0x01c2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0090, code lost:
        if (defpackage.eqb.a((java.lang.Object) r10, r6) == defpackage.eqb.a((java.lang.Object) r11, r6)) goto L_0x01c2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:54:0x012e, code lost:
        if (defpackage.eqb.c(r10, r6) == defpackage.eqb.c(r11, r6)) goto L_0x01c2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:78:0x01a4, code lost:
        if (java.lang.Float.floatToIntBits(defpackage.eqb.d(r10, r6)) == java.lang.Float.floatToIntBits(defpackage.eqb.d(r11, r6))) goto L_0x01c2;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:82:0x01bf, code lost:
        if (java.lang.Double.doubleToLongBits(defpackage.eqb.e(r10, r6)) == java.lang.Double.doubleToLongBits(defpackage.eqb.e(r11, r6))) goto L_0x01c2;
     */
    ...
    public final boolean a(T r10, T r11) {
        ...
        L_0x001c:
            ...
            r4 = r4 & r5
            long r4 = (long) r4
            int r8 = defpackage.eqb.a(r10, r4)
            int r4 = defpackage.eqb.a(r11, r4)
            if (r8 != r4) goto L_0x01c1
            java.lang.Object r4 = defpackage.eqb.f(r10, r6)
            java.lang.Object r5 = defpackage.eqb.f(r11, r6)
            boolean r4 = defpackage.epg.a(r4, r5)
            if (r4 != 0) goto L_0x01c2
            goto L_0x01c1
        L_0x003c:
            java.lang.Object r3 = defpackage.eqb.f(r10, r6)
            java.lang.Object r4 = defpackage.eqb.f(r11, r6)
            boolean r3 = defpackage.epg.a(r3, r4)
            goto L_0x01c2
        L_0x004a:
            java.lang.Object r3 = defpackage.eqb.f(r10, r6)
            java.lang.Object r4 = defpackage.eqb.f(r11, r6)
        ...
        L_0x006e:
            boolean r4 = r9.c(r10, r11, r2)
            if (r4 == 0) goto L_0x01c1
            long r4 = defpackage.eqb.b(r10, r6)
            long r6 = defpackage.eqb.b(r11, r6)
        ...
        L_0x0082:
            boolean r4 = r9.c(r10, r11, r2)
            if (r4 == 0) goto L_0x01c1
            int r4 = defpackage.eqb.a(r10, r6)
            int r5 = defpackage.eqb.a(r11, r6)
        ...
        L_0x0120:
            boolean r4 = r9.c(r10, r11, r2)
            if (r4 == 0) goto L_0x01c1
            boolean r4 = defpackage.eqb.c(r10, r6)
            boolean r5 = defpackage.eqb.c(r11, r6)
            if (r4 == r5) goto L_0x01c2
            goto L_0x01c1
        L_0x0132:
            boolean r4 = r9.c(r10, r11, r2)
        ...
        L_0x018e:
            boolean r4 = r9.c(r10, r11, r2)
            if (r4 == 0) goto L_0x01c1
            float r4 = defpackage.eqb.d(r10, r6)
            int r4 = java.lang.Float.floatToIntBits(r4)
            float r5 = defpackage.eqb.d(r11, r6)
        ...
        L_0x01a7:
            boolean r4 = r9.c(r10, r11, r2)
            if (r4 == 0) goto L_0x01c1
            double r4 = defpackage.eqb.e(r10, r6)
            long r4 = java.lang.Double.doubleToLongBits(r4)
            double r6 = defpackage.eqb.e(r11, r6)
        ...
        L_0x01f1:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eos.a(java.lang.Object, java.lang.Object):boolean");
    }
    ...
    public final int b(T r15) {
        ...
        L_0x002d:
            ...
            java.lang.Object r5 = defpackage.eqb.f(r15, r8)
            eoo r5 = (defpackage.eoo) r5
            epe r6 = r14.a(r3)
        ...
        L_0x00ad:
            ...
            java.lang.Object r5 = defpackage.eqb.f(r15, r8)
            epe r6 = r14.a(r3)
            int r5 = defpackage.epg.a(r7, r5, r6)
            goto L_0x0338
        L_0x00c1:
            boolean r5 = r14.a((T) r15, r7, r3)
            if (r5 == 0) goto L_0x0451
        ...
        L_0x014b:
            eoj r5 = r14.s
            java.lang.Object r6 = defpackage.eqb.f(r15, r8)
            int r5 = r5.e(r6)
            goto L_0x0338
        L_0x0157:
            java.util.List r5 = a(r15, r8)
            epe r6 = r14.a(r3)
            int r5 = defpackage.epg.b(r7, r5, r6)
            goto L_0x0338
        L_0x0165:
            java.lang.Object r5 = r0.getObject(r15, r8)
            java.util.List r5 = (java.util.List) r5
            int r5 = defpackage.epg.c(r5)
            if (r5 <= 0) goto L_0x0451
        ...
        L_0x0297:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.c(r7, r5)
            goto L_0x0338
        L_0x02a1:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.g(r7, r5)
            goto L_0x0338
        L_0x02ab:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.i(r7, r5)
            goto L_0x0338
        L_0x02b5:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.h(r7, r5)
            goto L_0x0338
        L_0x02bf:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.d(r7, r5)
            goto L_0x0338
        L_0x02c9:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.f(r7, r5)
            goto L_0x0338
        L_0x02d2:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.l(r7, r5)
            goto L_0x0338
        L_0x02db:
            java.util.List r5 = a(r15, r8)
            epe r6 = r14.a(r3)
        ...
        L_0x02e8:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.k(r7, r5)
            goto L_0x0338
        L_0x02f1:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.j(r7, r5)
            goto L_0x0338
        L_0x02fa:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.h(r7, r5)
        ...
        L_0x030c:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.e(r7, r5)
            goto L_0x0338
        L_0x0315:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.b(r7, r5)
            goto L_0x0338
        L_0x031e:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.a(r7, r5)
            goto L_0x0338
        L_0x0327:
            java.util.List r5 = a(r15, r8)
            int r5 = defpackage.epg.h(r7, r5)
        ...
        L_0x0350:
            boolean r5 = r14.a((T) r15, r3)
            if (r5 == 0) goto L_0x0451
            long r5 = defpackage.eqb.b(r15, r8)
            int r5 = com.google.android.gms.internal.measurement.zzve.f(r7, r5)
            goto L_0x0338
        L_0x035f:
            boolean r5 = r14.a((T) r15, r3)
            if (r5 == 0) goto L_0x0451
            int r5 = defpackage.eqb.a(r15, r8)
            int r5 = com.google.android.gms.internal.measurement.zzve.h(r7, r5)
            goto L_0x0338
        L_0x036e:
            boolean r5 = r14.a((T) r15, r3)
        ...
        L_0x0516:
            ...
            java.lang.Object r8 = r0.getObject(r15, r12)
            epe r9 = r14.a(r4)
            int r8 = defpackage.epg.a(r10, r8, r9)
            goto L_0x07c7
        L_0x052a:
            boolean r8 = r14.a((T) r15, r10, r4)
            if (r8 == 0) goto L_0x08bb
        ...
        L_0x05c0:
            ...
            java.util.List r8 = (java.util.List) r8
            epe r9 = r14.a(r4)
            int r8 = defpackage.epg.b(r10, r8, r9)
            goto L_0x07c7
        L_0x05d0:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.c(r8)
            if (r8 <= 0) goto L_0x08bb
        ...
        L_0x0702:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.c(r10, r8)
            goto L_0x07c7
        L_0x070e:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.g(r10, r8)
            goto L_0x07c7
        L_0x071a:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.i(r10, r8)
            goto L_0x07c7
        L_0x0726:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.h(r10, r8)
            goto L_0x07c7
        L_0x0732:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.d(r10, r8)
            goto L_0x07c7
        L_0x073e:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.f(r10, r8)
            goto L_0x07c7
        L_0x074a:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.l(r10, r8)
            goto L_0x07c7
        L_0x0756:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
        ...
        L_0x0765:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.k(r10, r8)
            goto L_0x07c7
        L_0x0770:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.j(r10, r8)
            goto L_0x07c7
        L_0x077b:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
        ...
        L_0x0791:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.e(r10, r8)
            goto L_0x07c7
        L_0x079c:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.b(r10, r8)
            goto L_0x07c7
        L_0x07a7:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
            int r8 = defpackage.epg.a(r10, r8)
            goto L_0x07c7
        L_0x07b2:
            java.lang.Object r8 = r0.getObject(r15, r12)
            java.util.List r8 = (java.util.List) r8
        ...
        L_0x08bf:
            ...
            r0 = 0
        L_0x08d1:
            eph<FieldDescriptorType, java.lang.Object> r1 = r15.a
            int r1 = r1.b()
            if (r3 >= r1) goto L_0x08f1
            eph<FieldDescriptorType, java.lang.Object> r1 = r15.a
            java.util.Map$Entry r1 = r1.b(r3)
            java.lang.Object r2 = r1.getKey()
            eni r2 = (defpackage.eni) r2
            java.lang.Object r1 = r1.getValue()
            int r1 = defpackage.eng.a(r2, r1)
            int r0 = r0 + r1
            int r3 = r3 + 1
            goto L_0x08d1
        L_0x08f1:
            eph<FieldDescriptorType, java.lang.Object> r15 = r15.a
        ...
        L_0x0918:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eos.b(java.lang.Object):int");
    }
                ...
                switch ((c2 & 267386880) >>> 20) {
                    ...
                    case 4:
                        if (!a(t2, i2)) {
                            ...
                            eqb.a((Object) t, j2, eqb.a((Object) t2, j2));
                            b(t, i2);
                            break;
                        }
                    case 5:
    ...
    public final boolean d(T t) {
        ...
        while (true) {
            ...
            if (i10 != 9 && i10 != 17) {
                if (i10 != 27) {
                    if (i10 == 60 || i10 == 68) {
                        ...
                        if (i10 != 50) {
                            ...
                            Map b2 = this.s.b(eqb.f(t, (long) (c2 & 1048575)));
                ...
                List list = (List) eqb.f(t, (long) (c2 & 1048575));
                if (!list.isEmpty()) {
                    epe a2 = a(i6);
                    int i11 = 0;
                    while (true) {
