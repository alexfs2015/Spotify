...
public final class xkp<T> implements defpackage.xii.b<T, xii<? extends T>> {
    private boolean a;

    /* renamed from: xkp$a */
    static final class a {
        static final xkp<Object> a = new xkp<>(false);
    }
    ...
    /* renamed from: xkp$c */
    static final class c<T> extends xio<xii<? extends T>> {
        ...
        c(xio<? super T> xio, boolean z) {
            this.a = xio;
            this.h = z;
            this.c = new AtomicLong();
            this.d = new xme<>(xlx.b);
        }

        private boolean a(boolean z, boolean z2, Throwable th, xme<Object> xme, xio<? super T> xio, boolean z3) {
            if (this.h) {
                if (z && !z2 && z3) {
                    if (th != null) {
                        xio.onError(th);
        ...
        public final void a() {
            ...
            L_0x0022:
                monitor-exit(r19)     // Catch:{ all -> 0x00c8 }
                xme<java.lang.Object> r9 = r8.d
                java.util.concurrent.atomic.AtomicLong r10 = r8.c
                xio<? super T> r11 = r8.a
                boolean r4 = r8.k
                r15 = r0
                r13 = r1
                r0 = r3
            ...
            L_0x00cc:
                goto L_0x00cb
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.xkp.c.a():void");
        }
    ...
    public static <T> xkp<T> a(boolean z) {
        return a.a;
    }

    public final /* synthetic */ Object call(Object obj) {
        xio xio = (xio) obj;
        c cVar = new c(xio, this.a);
        xio.add(cVar);
        cVar.a.add(cVar.b);
        cVar.a.add(xon.a((xir) new xir() {
