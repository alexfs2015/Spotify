...
final class akv {
    private static final String a = akv.class.getSimpleName();
    private String b;
    ...
    private akv(Context context, String str) {
    ...
    public static AccessTokenSource c(Bundle bundle) {
        ...
        return bundle.containsKey(str) ? (AccessTokenSource) bundle.getSerializable(str) : bundle.getBoolean("com.facebook.TokenCachingStrategy.IsSSO") ? AccessTokenSource.FACEBOOK_APPLICATION_WEB : AccessTokenSource.WEB_VIEW;
    }
    ...
    public final Bundle a() {
        ...
        for (String str : this.c.getAll().keySet()) {
            try {
                ...
                sb.append("' -- ");
                sb.append(e);
                and.a(loggingBehavior, 5, str2, sb.toString());
                return null;
            }
        }
        return bundle;
