        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            for (ConstraintWidget constraintWidget : hashSet) {
                if (constraintWidget.W) {
                    int i5 = i << 1;
                    ConstraintAnchor constraintAnchor = constraintWidget.A[i5];
                    ConstraintAnchor constraintAnchor2 = constraintWidget.A[i5 + 1];
                    if ((constraintAnchor.d == null || constraintAnchor2.d == null) ? false : true) {
                        ...
                        int i7 = (int) constraintWidget.A[i5].a.d;
                        int i8 = i7 + a;
    ...
    private static int a(ConstraintWidget constraintWidget) {
        ...
        if (constraintWidget.y() == DimensionBehaviour.MATCH_CONSTRAINT) {
            if (constraintWidget.H == 0) {
                f2 = ((float) constraintWidget.n()) * constraintWidget.G;
            } else {
                f2 = ((float) constraintWidget.n()) / constraintWidget.G;
            }
            int i = (int) f2;
            constraintWidget.e(i);
            return i;
        } else if (constraintWidget.z() != DimensionBehaviour.MATCH_CONSTRAINT) {
            return -1;
        } else {
            if (constraintWidget.H == 1) {
                f = ((float) constraintWidget.m()) * constraintWidget.G;
            } else {
                f = ((float) constraintWidget.m()) / constraintWidget.G;
            }
            int i2 = (int) f;
