...
public final class oe extends h implements j {
    ...
    private final l D = new l() {
        ...
        public final boolean a(MotionEvent motionEvent) {
            oe.this.r.a(motionEvent);
            int actionMasked = motionEvent.getActionMasked();
            c cVar = null;
            if (actionMasked == 0) {
                oe.this.i = motionEvent.getPointerId(0);
                oe.this.c = motionEvent.getX();
                oe.this.d = motionEvent.getY();
                oe.this.a();
                if (oe.this.b == null) {
                    oe oeVar = oe.this;
                    if (!oeVar.l.isEmpty()) {
                        View a2 = oeVar.a(motionEvent);
                        int size = oeVar.l.size() - 1;
                        while (true) {
                            if (size < 0) {
                                break;
                            }
                            c cVar2 = (c) oeVar.l.get(size);
                            if (cVar2.e.o == a2) {
                                cVar = cVar2;
                                break;
                            }
                    ...
                    if (cVar != null) {
                        oe.this.c -= cVar.i;
                        oe.this.d -= cVar.j;
                        oe.this.a(cVar.e, true);
                        if (oe.this.a.remove(cVar.e.o)) {
                            oe.this.j.c(oe.this.m, cVar.e);
                        }
                        oe.this.a(cVar.e, cVar.f);
                        oe oeVar2 = oe.this;
                        oeVar2.a(motionEvent, oeVar2.k, 0);
                    }
                }
                ...
                int findPointerIndex = motionEvent.findPointerIndex(oe.this.i);
                if (findPointerIndex >= 0) {
                    oe.this.a(actionMasked, motionEvent, findPointerIndex);
                }
            }
            if (oe.this.o != null) {
                oe.this.o.addMovement(motionEvent);
            }
            return oe.this.b != null;
        }
                        ...
                        if (actionMasked != 2) {
                            if (actionMasked != 3) {
                                if (actionMasked == 6) {
                                    ...
                                    if (motionEvent.getPointerId(actionIndex) == oe.this.i) {
                                        if (actionIndex == 0) {
                                            i = 1;
                                        }
                                        oe.this.i = motionEvent.getPointerId(i);
                                        oe oeVar = oe.this;
                                        oeVar.a(motionEvent, oeVar.k, actionIndex);
                                    }
                                }
                            } else if (oe.this.o != null) {
                                oe.this.o.clear();
                            }
                        } else if (findPointerIndex >= 0) {
                            oe oeVar2 = oe.this;
                            oeVar2.a(motionEvent, oeVar2.k, findPointerIndex);
                            oe.this.a(uVar);
                            oe.this.m.removeCallbacks(oe.this.n);
                            oe.this.n.run();
                            oe.this.m.invalidate();
                        }
                        return;
                    }
                    oe.this.a((u) null, 0);
    ...
    final Runnable n = new Runnable() {
        ...
        public final void run() {
            ...
            L_0x013d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.oe.AnonymousClass1.run():void");
        }
    };
    VelocityTracker o;
    View p = null;
    ...
    public static abstract class a {
        ...
        public static long a(RecyclerView recyclerView, int i) {
            ...
            return fVar == null ? i == 8 ? 200 : 250 : i == 8 ? fVar.i : fVar.f();
        }
        ...
        public static void a(Canvas canvas, RecyclerView recyclerView, u uVar, float f, float f2, int i, boolean z) {
            og.a.a(recyclerView, uVar.o, f, f2, z);
        }
    ...
    class b extends SimpleOnGestureListener {
        ...
        public final void onLongPress(MotionEvent motionEvent) {
            if (this.a) {
                View a2 = oe.this.a(motionEvent);
                if (a2 != null) {
                    u b2 = oe.this.m.b(a2);
                    if (b2 != null && oe.this.j.b(oe.this.m, b2) && motionEvent.getPointerId(0) == oe.this.i) {
                        int findPointerIndex = motionEvent.findPointerIndex(oe.this.i);
    ...
    public final void a(androidx.recyclerview.widget.RecyclerView.u r20, int r21) {
        ...
        L_0x0045:
            ...
            int r2 = defpackage.oe.a.c(r0, r2)
            int r2 = r2 >> r1
            ...
            int r0 = defpackage.oe.a.a(r3, r0)
            goto L_0x00a3
        L_0x009d:
            int r0 = r11.c(r10, r2)
        ...
        L_0x00ad:
            ...
            androidx.recyclerview.widget.RecyclerView r0 = r11.m
            int r0 = defpackage.ip.f(r0)
            int r0 = defpackage.oe.a.a(r2, r0)
            goto L_0x00a3
        L_0x00c1:
            r8 = r2
            goto L_0x00c4
        ...
        L_0x010a:
            ...
            androidx.recyclerview.widget.RecyclerView r0 = r11.m
            long r0 = defpackage.oe.a.a(r0, r15)
            android.animation.ValueAnimator r2 = r14.g
            r2.setDuration(r0)
            java.util.List<oe$c> r0 = r11.l
            r0.add(r14)
        ...
        L_0x01a8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.oe.a(androidx.recyclerview.widget.RecyclerView$u, int):void");
    }
