...
public final class dlu implements ActivityLifecycleCallbacks, OnAttachStateChangeListener, OnGlobalLayoutListener, OnScrollChangedListener {
    private static final long a = ((Long) dqe.f().a(dtg.bl)).longValue();
    ...
    private dlz j;
    private cos k = new cos(a);
    private boolean l = false;
    private int m = -1;
    private final HashSet<dly> n = new HashSet<>();
    private final DisplayMetrics o;
    private final Rect p;

    public dlu(Context context, View view) {
        ...
        if (context2 instanceof Application) {
            ...
            this.j = new dlz((Application) context2, this);
        }
    ...
    private final void a(View view) {
        ...
        if (this.g == null) {
            ...
            this.g = new dlw(this);
            bkc.E().a(this.b, this.g, intentFilter);
        }
        ...
        if (application != null) {
            try {
                ...
                cml.a("Error registering activity lifecycle callbacks.", e2);
            }
        }
    }
    ...
    private final void b(View view) {
        try {
            ...
            cml.a("Error while unregistering listeners from the last ViewTreeObserver.", e2);
        }
        try {
            ...
            cml.a("Error while unregistering listeners from the ViewTreeObserver.", e3);
        }
        if (this.g != null) {
            try {
                bkc.E().a(this.b, this.g);
            } catch (IllegalStateException e4) {
                cml.a("Failed trying to unregister the receiver", e4);
            } catch (Exception e5) {
                bkc.i().a((Throwable) e5, "ActiveViewUnit.stopScreenStatusMonitoring");
            }
            this.g = null;
        }
        Application application = this.c;
        if (application != null) {
            try {
                ...
                cml.a("Error registering activity lifecycle callbacks.", e6);
            }
        }
    }
    ...
    public final void a(int r31) {
        ...
        L_0x008c:
            ...
            boolean r7 = defpackage.cmu.a(r3, r7, r13)
            if (r7 == 0) goto L_0x00a3
        ...
        L_0x011e:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.dlu.a(int):void");
    }

    public final void a(dly dly) {
        this.n.add(dly);
        a(3);
    }

    public final void b(dly dly) {
        this.n.remove(dly);
    }
