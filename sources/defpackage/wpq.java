...
public final class wpq extends GeneratorBase {
    private static ThreadLocal<wpn> a = new ThreadLocal<>();
    ...
    public wpq(int i, ObjectCodec objectCodec, OutputStream outputStream) {
        super(i, objectCodec);
        wpn wpn = (wpn) a.get();
        ...
        if (wpn == null) {
            wpn = new wpn(outputStreamBufferOutput);
        } else {
            MessageBufferOutput messageBufferOutput = (MessageBufferOutput) wpp.a(outputStreamBufferOutput, (Object) "MessageBufferOutput is null");
            MessageBufferOutput messageBufferOutput2 = wpn.b;
            wpn.b = messageBufferOutput;
            wpn.d = 0;
            wpn.e = 0;
        }
        a.set(wpn);
