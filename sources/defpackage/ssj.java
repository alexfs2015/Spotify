...
public final class ssj implements ssn {
    private final fpt a;

    /* renamed from: ssj$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0040:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ssj.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public final ImmutableList<Type> a() {
        int i = AnonymousClass1.a[((NowPlayingWidgetDebugDataSourceFlag) this.a.a(ssv.a)).ordinal()];
        if (i == 1) {
            return ImmutableList.a(Type.BEHIND_THE_LYRICS);
        }
        if (i == 2) {
            return ImmutableList.a(Type.BEHIND_THE_LYRICS, Type.EXAMPLE);
        }
        if (i == 3) {
            return ImmutableList.a(Type.STORYLINES);
        }
        if (i == 4) {
            return ImmutableList.a(Type.LYRICS);
        }
        if (i != 5) {
            return ImmutableList.d();
        }
        return ImmutableList.a(Type.PIVOTS_PODCAST, Type.PIVOTS_MUSIC);
    }
}
