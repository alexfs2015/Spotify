...
final class wnp implements Closeable {
    static final Logger a = Logger.getLogger(wnm.class.getName());
    final wom b;
    final boolean c;
    ...
    /* renamed from: wnp$a */
    static final class a implements wpa {
        int a;
        byte b;
        int c;
        int d;
        ...
        public final long a(wok wok, long j) {
            ...
            do {
                ...
                if (i2 == 0) {
                    ...
                    if (wnp.a.isLoggable(Level.FINE)) {
                        wnp.a.fine(wnm.a(true, this.c, this.a, f2, this.b));
                    }
                    this.c = this.f.h() & Integer.MAX_VALUE;
                    if (f2 != 9) {
                        throw wnm.b("%s != TYPE_CONTINUATION", Byte.valueOf(f2));
                    }
                } else {
                    long a3 = this.f.a(wok, Math.min(j, (long) i2));
                    if (a3 == -1) {
                        return -1;
                    }
            ...
            throw wnm.b("TYPE_CONTINUATION streamId changed", new Object[0]);
        }
    ...
    interface b {
        ...
        void a(boolean z, int i, List<wnk> list);

        void a(boolean z, int i, wom wom, int i2);

        void a(boolean z, wnu wnu);
    }

    wnp(wom wom, boolean z) {
        this.b = wom;
        this.c = z;
    }
    ...
    public final boolean a(boolean r11, defpackage.wnp.b r12) {
        /*
            r10 = this;
            r0 = 0
            wom r1 = r10.b     // Catch:{ IOException -> 0x02ba }
            r2 = 9
        ...
        L_0x0022:
            ...
            java.io.IOException r11 = defpackage.wnm.b(r12, r11)
            throw r11
        L_0x0031:
            wom r11 = r10.b
            byte r11 = r11.f()
            ...
            java.util.logging.Logger r8 = a
            java.lang.String r9 = defpackage.wnm.a(r2, r6, r1, r4, r11)
            r8.fine(r9)
        L_0x0055:
            r8 = 5
            r9 = 8
        ...
        L_0x01ed:
            ...
            java.io.IOException r11 = defpackage.wnm.b(r11, r12)
            throw r11
        L_0x01fc:
            java.lang.Object[] r11 = new java.lang.Object[r0]
        ...
        L_0x02ba:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wnp.a(boolean, wnp$b):boolean");
    }

    private List<wnk> a(int i, short s, byte b2, int i2) {
        a aVar = this.d;
        aVar.d = i;
        aVar.a = i;
        aVar.e = s;
    ...
    static int a(wom wom) {
        return (wom.f() & 255) | ((wom.f() & 255) << 16) | ((wom.f() & 255) << 8);
    }
    ...
    private static int a(int i, byte b2, short s) {
        ...
        throw wnm.b("PROTOCOL_ERROR padding %s > remaining length %s", Short.valueOf(s), Integer.valueOf(i));
    }
}
