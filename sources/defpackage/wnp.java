...
public final class wnp {
    private static final wyc e = wyd.a(wnp.class);
    ...
    /* renamed from: wnp$2 reason: invalid class name */
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.wnp.AnonymousClass2.<clinit>():void");
        }
    }

    /* renamed from: wnp$a */
    public static abstract class a<T> {
        private static final Recycler<C0088a> e = new Recycler<C0088a>() {
            public final /* synthetic */ Object a(io.netty.util.Recycler.b bVar) {
                return new C0088a(bVar);
            }
        };
        public final Queue<C0088a<T>> a = PlatformDependent.c(this.b);
        private final int b;
        private final SizeClass c;
        private int d;

        /* renamed from: wnp$a$a reason: collision with other inner class name */
        public static final class C0088a<T> {
            wnl<T> a;
            long b = -1;
            private io.netty.util.Recycler.b<C0088a<?>> c;

            C0088a(io.netty.util.Recycler.b<C0088a<?>> bVar) {
                this.c = bVar;
            }
        ...
        public static C0088a a(wnl<?> wnl, long j) {
            C0088a aVar = (C0088a) e.a();
            aVar.a = wnl;
            aVar.b = j;
            return aVar;
        }

        private void a(C0088a aVar) {
            wnl<T> wnl = aVar.a;
            long j = aVar.b;
            aVar.a();
            wnl.a.a(wnl, j, this.c);
        }
        ...
        public int a(int i) {
            int i2 = 0;
            while (i2 < i) {
                C0088a aVar = (C0088a) this.a.poll();
                if (aVar == null) {
                    break;
                }
                a(aVar);
        ...
        public abstract void a(wnl<T> wnl, long j, wnq<T> wnq, int i);

        public final boolean a(wnq<T> wnq, int i) {
            C0088a aVar = (C0088a) this.a.poll();
            if (aVar == null) {
                return false;
            }
            a(aVar.a, aVar.b, wnq, i);
            aVar.a();
            this.d++;
            return true;
        }
    ...
    static final class b<T> extends a<T> {
        ...
        /* access modifiers changed from: protected */
        public final void a(wnl<T> wnl, long j, wnq<T> wnq, int i) {
            wnl.a(wnq, j, i);
        }
    }
    ...
    wnp(PoolArena<byte[]> poolArena, PoolArena<ByteBuffer> poolArena2, int i2, int i3, int i4, int i5, int i6) {
        if (i5 < 0) {
    ...
    private boolean a(a<?> aVar, wnq wnq, int i2) {
        if (aVar == null) {
            return false;
        }
        boolean a2 = aVar.a(wnq, i2);
        int i3 = this.o + 1;
        this.o = i3;
        if (i3 >= this.n) {
            this.o = 0;
    ...
    public a<?> a(PoolArena<?> poolArena, int i2) {
        ...
        return poolArena.a() ? a((a<T>[]) this.h, a2) : a((a<T>[]) this.f, a2);
    }
    ...
    public final boolean a(PoolArena<?> poolArena, wnq<?> wnq, int i2, int i3) {
        return a(a(poolArena, i3), (wnq) wnq, i2);
    }

    public a<?> b(PoolArena<?> poolArena, int i2) {
        int b2 = PoolArena.b(i2);
        return poolArena.a() ? a((a<T>[]) this.i, b2) : a((a<T>[]) this.g, b2);
    }

    public final boolean b(PoolArena<?> poolArena, wnq<?> wnq, int i2, int i3) {
        return a(b(poolArena, i3), (wnq) wnq, i2);
    }
    ...
    public final boolean c(PoolArena<?> poolArena, wnq<?> wnq, int i2, int i3) {
        return a(c(poolArena, i3), (wnq) wnq, i2);
    }
}
