...
public final class vtl extends AndroidLibsPlaylistEntityConfigurationProperties {
    ...
    public static final class a extends com.spotify.remoteconfig.AndroidLibsPlaylistEntityConfigurationProperties.a {
        ...
        public final AndroidLibsPlaylistEntityConfigurationProperties a() {
            ...
            if (str.isEmpty()) {
                vtl vtl = new vtl(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d.booleanValue(), this.e, this.f.booleanValue(), this.g, 0);
                return vtl;
            }
    ...
    private vtl(boolean z, boolean z2, boolean z3, boolean z4, StupidFlag2 stupidFlag2, boolean z5, StupidFlag4 stupidFlag4) {
        this.a = z;
        this.b = z2;
        this.c = z3;
        this.d = z4;
    ...
    /* synthetic */ vtl(boolean z, boolean z2, boolean z3, boolean z4, StupidFlag2 stupidFlag2, boolean z5, StupidFlag4 stupidFlag4, byte b2) {
