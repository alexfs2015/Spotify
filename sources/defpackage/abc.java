...
public final class abc {
    public static void a(JsonReader jsonReader, xa xaVar, List<Layer> list, ds<Layer> dsVar) {
        jsonReader.beginArray();
        int i = 0;
        while (jsonReader.hasNext()) {
            Layer a = abb.a(jsonReader, xaVar);
    ...
    public static void a(JsonReader jsonReader, xa xaVar, Map<String, List<Layer>> map, Map<String, xd> map2) {
        jsonReader.beginArray();
        while (jsonReader.hasNext()) {
            ...
            if (str2 != null) {
                xd xdVar = new xd(i, i2, str, str2, str3);
                map2.put(xdVar.a, xdVar);
            } else {
                Map<String, xd> map3 = map2;
    ...
    public static void a(android.util.JsonReader r11, java.util.Map<java.lang.String, defpackage.yx> r12) {
        /*
            r11.beginObject()
        L_0x0003:
        ...
        L_0x00ad:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.abc.a(android.util.JsonReader, java.util.Map):void");
    }

    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void a(android.util.JsonReader r16, defpackage.xa r17, defpackage.dw<defpackage.yy> r18) {
        /*
            r16.beginArray()
        L_0x0003:
        ...
        L_0x0096:
            ...
            zs r0 = defpackage.aar.a(r16, r17)
        ...
        L_0x00e9:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.abc.a(android.util.JsonReader, xa, dw):void");
    }
}
