...
public final class ngo {
    ...
    public ngo(nfs nfs, irb irb, Policy policy, String str) {
        this.a = nfs;
        this.b = irb;
        this.c = policy;
        this.d = str;
    ...
    public /* synthetic */ ObservableSource a(Observable observable) {
        return observable.h(new $$Lambda$ngo$bMgVX5RGm0EyXgShsRql8cmSjlg(this));
    }

    /* access modifiers changed from: private */
    public /* synthetic */ ObservableSource a(c cVar) {
        return Observable.b((ObservableSource<? extends T1>) this.a.a(this.d).d(), (ObservableSource<? extends T2>) this.b.a(this.c).c(e), (BiFunction<? super T1, ? super T2, ? extends R>) $$Lambda$ngo$hmD1fYQXLtHIIk3JEHWRw99Vs.INSTANCE).e((Function<? super Throwable, ? extends T>) $$Lambda$ngo$TNKcccg_8fZX8BdFPfVqsGg96Y.INSTANCE);
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ nge a(GetStoryViewResponse getStoryViewResponse, iri iri) {
        Optional optional;
        ...
        if (!k.g.isEmpty()) {
            ...
            while (true) {
                ...
                if (ChapterCase.a(chapter.d) != ChapterCase.VIDEO_CHAPTER && ChapterCase.a(chapter.d) != ChapterCase.TRACK_CHAPTER) {
                    optional = Optional.b(nge.a((ngd) new a(k)));
                    break;
                }
            }
        } else {
            optional = Optional.b(nge.a((ngd) new b(k)));
        }
        if (optional.b()) {
            return (nge) optional.c();
        }
        e<Chapter> eVar = k.g;
        ArrayList arrayList = new ArrayList(eVar.size());
        a j = ImmutableSet.j();
        for (vlf uri : (vlf[]) iri.getItems()) {
            j.b(uri.getUri());
        }
        ImmutableSet b2 = j.a();
    ...
    public final ObservableTransformer<c, nge> a() {
        return new $$Lambda$ngo$YeO3z7r6112jhKqMSY9MZfgapJc(this);
    }
}
