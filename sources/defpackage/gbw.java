...
/* renamed from: gbw reason: default package */
public final class gbw implements gbv {
    private final hit a;
    private PublicKey b;
    private final WeakReference<Context> c;

    public gbw(Context context, hit hit) {
    ...
    private boolean a(Uri uri, long j) {
        ...
        try {
            byte[] decode = Base64.decode(queryParameter.getBytes(fbi.c), 0);
            Signature instance = Signature.getInstance("SHA1withRSA");
            instance.initVerify(this.b);
            instance.update(sb2.getBytes(fbi.c));
    ...
    public final void a(com.google.common.base.Optional<java.lang.Long> r6, android.net.Uri r7) {
        ...
        L_0x0086:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.gbw.a(com.google.common.base.Optional, android.net.Uri):void");
    }
}
