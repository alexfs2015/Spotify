...
public final class oyq implements wig<PlayOrigin> {
    private final wzi<uqm> a;
    private final wzi<String> b;
    private final wzi<sso> c;
    private final wzi<gkm> d;

    private oyq(wzi<uqm> wzi, wzi<String> wzi2, wzi<sso> wzi3, wzi<gkm> wzi4) {
        this.a = wzi;
        this.b = wzi2;
        this.c = wzi3;
        this.d = wzi4;
    ...
    public static oyq a(wzi<uqm> wzi, wzi<String> wzi2, wzi<sso> wzi3, wzi<gkm> wzi4) {
        return new oyq(wzi, wzi2, wzi3, wzi4);
    }
