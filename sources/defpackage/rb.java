...
public final class rb {
    ...
    public static Animator a(View view, qz qzVar, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator) {
        float f5;
        float f6;
        View view2 = view;
        qz qzVar2 = qzVar;
        ...
        int[] iArr = (int[]) qzVar2.b.getTag(R.id.transition_position);
        if (iArr != null) {
        ...
        a aVar = new a(view, qzVar2.b, round, round2, translationX, translationY);
        ofPropertyValuesHolder.addListener(aVar);
        qf.a(ofPropertyValuesHolder, aVar);
