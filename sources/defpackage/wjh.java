...
public final class wjh {
    private static final wjw a = wjx.a(wjh.class);
    private static final String b;
    private static final File c;

    static {
        String str = "";
        b = wjo.a("os.name", str).toLowerCase(Locale.US).replaceAll("[^a-z0-9]+", str);
        String b2 = wjo.b("io.netty.native.workdir");
    ...
    public static void a(java.lang.ClassLoader r12, java.lang.String... r13) {
        ...
        L_0x013a:
            goto L_0x0139
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.wjh.a(java.lang.ClassLoader, java.lang.String[]):void");
    }
    ...
    private static void a(ClassLoader classLoader, String str, boolean z) {
        ...
        try {
            a(a(classLoader, wji.class), str, z);
