...
public final class ezf {
    ...
    public static void a(View view, float f) {
        ...
        long j = (long) integer;
        stateListAnimator.addState(new int[]{16842766, R.attr.state_liftable, -2130969426}, ObjectAnimator.ofFloat(view, str, new float[]{0.0f}).setDuration(j));
    ...
    public static void a(View view, AttributeSet attributeSet, int i, int i2) {
        ...
        TypedArray a2 = faj.a(context, attributeSet, a, 0, i2, new int[0]);
        try {
            if (a2.hasValue(0)) {
