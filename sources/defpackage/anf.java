...
public final class anf {
    ...
    static abstract class e {
        ...
        public synchronized void a(boolean r1) {
            ...
            L_0x000f:
                java.util.TreeSet r1 = defpackage.anf.b(r0)     // Catch:{ all -> 0x0017 }
            ...
            L_0x0017:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.anf.e.a(boolean):void");
        }
    ...
    public static Intent a(Context context) {
        ...
        do {
            ...
            if (addCategory != null) {
                ...
                if (resolveService != null && amr.a(context, resolveService.serviceInfo.packageName)) {
                    intent = addCategory;
                    continue;
                }
            }
    ...
    private static Intent a(Context context, Intent intent) {
        ...
        if (resolveActivity != null && amr.a(context, resolveActivity.activityInfo.packageName)) {
            return intent;
        }
        return null;
    }
    ...
    private static Intent a(e eVar, String str, Collection<String> collection, String str2, boolean z, DefaultAudience defaultAudience, String str3, String str4) {
        ...
        putExtra.putExtra("facebook_sdk_version", akq.i());
        if (!ank.a(collection)) {
        ...
        putExtra.putExtra("legacy_override", akq.h());
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.TreeSet<java.lang.Integer> b(defpackage.anf.e r10) {
        /*
            java.lang.String r0 = "Failed to query content resolver."
            java.util.TreeSet r1 = new java.util.TreeSet
            r1.<init>()
            android.content.Context r2 = defpackage.akq.g()
            ...
            r9 = 0
            android.content.Context r7 = defpackage.akq.g()     // Catch:{ all -> 0x008c }
        ...
        L_0x0094:
            goto L_0x0093
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.anf.b(anf$e):java.util.TreeSet");
    }
    ...
    public static Bundle d(Intent intent) {
        ...
        if (!(e2 != null ? e2.containsKey(str) : intent.hasExtra("com.facebook.platform.status.ERROR_TYPE"))) {
            return null;
        }
        Bundle e3 = e(intent);
        return e3 != null ? e3.getBundle(str) : intent.getExtras();
    }
