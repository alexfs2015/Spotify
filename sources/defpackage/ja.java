...
public final class ja {
    ...
    public static class a {
        ...
        private final Class<? extends defpackage.jc.a> g;
        private jc h;
        ...
        private a(int i, CharSequence charSequence, Class<? extends defpackage.jc.a> cls) {
            this(null, i, null, null, cls);
        }

        private a(Object obj, int i, CharSequence charSequence, jc jcVar, Class<? extends defpackage.jc.a> cls) {
            this.e = i;
            this.f = charSequence;
            this.h = null;
            if (VERSION.SDK_INT < 21 || obj != null) {
                ...
                this.d = new AccessibilityAction(i, charSequence);
            }
            this.g = cls;
        }
    ...
    public final void a(a aVar) {
        if (VERSION.SDK_INT >= 21) {
            this.a.addAction((AccessibilityAction) aVar.d);
        }
    }

    public final boolean b(a aVar) {
        if (VERSION.SDK_INT >= 21) {
            return this.a.removeAction((AccessibilityAction) aVar.d);
        }
        return false;
    }
