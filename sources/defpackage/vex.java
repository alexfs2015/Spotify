...
public final class vex {
    ...
    /* JADX WARNING: type inference failed for: r4v3, types: [vex$a, java.lang.Object] */
    /* JADX WARNING: type inference failed for: r3v1, types: [java.lang.Object[]] */
    /* JADX WARNING: type inference failed for: r4v4, types: [vex$a] */
    /* JADX WARNING: type inference failed for: r4v5 */
    /* JADX WARNING: type inference failed for: r10v0, types: [java.util.Set] */
    /* JADX WARNING: type inference failed for: r5v3, types: [vex$a] */
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r4v2
      assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], ?[OBJECT, ARRAY], java.util.HashSet, vex$a]
      uses: [?[OBJECT, ARRAY], ?[int, boolean, OBJECT, ARRAY, byte, short, char], vex$a, java.lang.Object]
      mth insns count: 58
    ...
    private java.util.Map<java.lang.String, java.util.ArrayList<defpackage.vex.a>> a(android.content.res.XmlResourceParser r12) {
        /*
            r11 = this;
        ...
        L_0x000a:
            ...
            boolean r5 = defpackage.fbo.a(r2)     // Catch:{ XmlPullParserException -> 0x0094, IOException -> 0x0092 }
        ...
        L_0x0045:
            ...
            vex$a r2 = new vex$a     // Catch:{ XmlPullParserException -> 0x0094, IOException -> 0x0092 }
            r5 = r2
        ...
        L_0x005a:
            ...
            vex$a r4 = b(r12)     // Catch:{ XmlPullParserException -> 0x0094, IOException -> 0x0092 }
        L_0x006a:
        ...
        L_0x009c:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vex.a(android.content.res.XmlResourceParser):java.util.Map");
    }
    ...
    private static a b(XmlResourceParser xmlResourceParser) {
        ...
        Set a2 = !fbo.a(attributeValue3) ? Sets.a((E[]) attributeValue3.split(",")) : null;
