...
abstract class iwj extends iws {
    final PlayerTrack a;
    ...
    iwj(PlayerTrack playerTrack, List<PlayerTrack> list, List<PlayerTrack> list2, PlayerRestrictions playerRestrictions, String str, String str2, boolean z, boolean z2, long j2, long j3, float f2) {
        this.a = playerTrack;
        if (list != null) {
            this.b = list;
            if (list2 != null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof iws) {
            ...
            if (playerTrack != null ? playerTrack.equals(iws.a()) : iws.a() == null) {
                return this.b.equals(iws.b()) && this.c.equals(iws.c()) && this.d.equals(iws.d()) && this.e.equals(iws.e()) && this.f.equals(iws.f()) && this.g == iws.g() && this.h == iws.h() && this.i == iws.i() && this.j == iws.j() && Float.floatToIntBits(this.k) == Float.floatToIntBits(iws.k());
            }
        }
    }
