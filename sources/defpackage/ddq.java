...
final class ddq extends dck<Integer> implements ddu<Integer>, RandomAccess {
    private int[] b;
    private int c;
    ...
    public final /* synthetic */ ddu a(int i) {
        if (i >= this.c) {
            return new ddq(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        c();
        ddr.a(collection);
        if (!(collection instanceof ddq)) {
            return super.addAll(collection);
        }
        ddq ddq = (ddq) collection;
        int i = ddq.c;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(ddq.b, 0, this.b, this.c, ddq.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
