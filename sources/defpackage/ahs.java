...
final class ahs {
    ...
    public JSONArray a(String str) {
        ...
        try {
            ...
            vuu.a().b("CrashlyticsCore", "Unable to parse proc maps string", e);
            return jSONArray;
        }
    }
            ...
            if ((a2.c.indexOf(120) == -1 || a2.d.indexOf(47) == -1) ? false : true) {
                ...
                try {
                    ...
                    try {
                        ...
                        vuu.a().a(str2, "Could not create a binary image json string", (Throwable) e);
                        return null;
                    }
    ...
    private File a(File file) {
        ...
        if (file.getAbsolutePath().startsWith("/data")) {
            try {
                ...
                vuu.a().c("CrashlyticsCore", "Error getting ApplicationInfo", e);
            }
        }
        return file;
    }
    ...
    static byte[] a(JSONArray jSONArray) {
        ...
        try {
            ...
            vuu.a().b("CrashlyticsCore", "Binary images string is null", e);
            return new byte[0];
        }
    }
