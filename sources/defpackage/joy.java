...
public final class joy {
    ...
    public joy(ContextMenuHelper contextMenuHelper, jbr jbr) {
        ...
        if (this.b.a(appShareDestination2)) {
            switch (appShareDestination) {
                ...
                default:
                    ...
                    if (a10 && a11) {
                        a b3 = iyz.b(appShareDestination2.mPackageNameSpace);
                        if (b3 != null) {
    ...
    public final izk a(AppShareDestination appShareDestination) {
        return new $$Lambda$joy$8pESmURt3UCTf1Nee2UTEOlwHY(this, appShareDestination);
    }
}
