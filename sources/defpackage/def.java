...
final class def extends dck<Long> implements ddu<Long>, RandomAccess {
    private long[] b;
    private int c;
    ...
    public final /* synthetic */ ddu a(int i) {
        if (i >= this.c) {
            return new def(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        c();
        ddr.a(collection);
        if (!(collection instanceof def)) {
            return super.addAll(collection);
        }
        def def = (def) collection;
        int i = def.c;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(def.b, 0, this.b, this.c, def.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
