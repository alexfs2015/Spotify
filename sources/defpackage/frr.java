...
public final class frr {
    public static Drawable a(Context context) {
        return a(context, (float) vfj.b(12.0f, context.getResources()));
    }
    ...
    public static Drawable a(Context context, float f) {
        ...
        int b = vfj.b(2.0f, context.getResources());
        layerDrawable.setLayerInset(1, b, 0, b, 0);
        return layerDrawable;
    }

    public static Drawable b(Context context) {
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(context, SpotifyIconV2.DOWNLOADED, (float) vfj.b(12.0f, context.getResources()));
