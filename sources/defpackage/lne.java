...
public final class lne {
    ...
    public final wlc<lmz> j;
    public final wlc<lmx> k;
    public final wlc<lnk> l;
    public final wlc<lnm> m;

    public lne(wlc<lnp> wlc, wlc<uxc> wlc2, wlc<uxh> wlc3, wlc<uxn> wlc4, wlc<AddToPlaylistLogger> wlc5, wlc<Scheduler> wlc6, wlc<hbj> wlc7, wlc<hbc> wlc8, wlc<lmy> wlc9, wlc<lmz> wlc10, wlc<lmx> wlc11, wlc<lnk> wlc12, wlc<lnm> wlc13) {
        this.a = (wlc) a(wlc, 1);
        this.b = (wlc) a(wlc2, 2);
        this.c = (wlc) a(wlc3, 3);
        this.d = (wlc) a(wlc4, 4);
