...
public final class jyz {
    public static View a(Context context, SpotifyIconV2 spotifyIconV2) {
        ...
        spotifyIconView.a.a((float) vfj.b(24.0f, context.getResources()));
    ...
    public static Drawable b(Context context, SpotifyIconV2 spotifyIconV2, ColorStateList colorStateList) {
        SpotifyIconDrawable spotifyIconDrawable = new SpotifyIconDrawable(context, spotifyIconV2, (float) vfj.b(24.0f, context.getResources()));
        spotifyIconDrawable.a(colorStateList);
        spotifyIconDrawable.a((float) vfj.b(24.0f, context.getResources()));
        return spotifyIconDrawable;
    }

    public static ImageButton b(Context context, SpotifyIconV2 spotifyIconV2) {
        return a(context, spotifyIconV2, vgl.d(context, R.attr.pasteColorAccessory));
    }

    public static Drawable c(Context context, SpotifyIconV2 spotifyIconV2) {
        return b(context, spotifyIconV2, vgl.d(context, R.attr.pasteColorAccessory));
    }
}
