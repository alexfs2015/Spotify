...
public final class wpn implements Closeable {
    public final b a;
    ...
    public wpn(MessageBufferOutput messageBufferOutput) {
        this(messageBufferOutput, wpm.b);
    }

    private wpn(MessageBufferOutput messageBufferOutput, b bVar) {
        this.a = (b) wpp.a(bVar, (Object) "config is null");
        this.b = (MessageBufferOutput) wpp.a(messageBufferOutput, (Object) "MessageBufferOutput is null");
        this.d = 0;
        this.e = 0;
    }
    ...
    public final wpn a(BigInteger bigInteger) {
    ...
    public final wpn a(String str) {
        ...
        if (this.g == null) {
            this.g = wpm.a.newEncoder().onMalformedInput(this.a.c).onUnmappableCharacter(this.a.c);
        }
        b();
        a();
        MessageBuffer messageBuffer = this.c;
