...
public final class fhj {
    ...
    private final fil c;
    private final Map<String, fim> d;

    public fhj(Context context) {
        this(context, new fil());
    }

    private fhj(Context context, fil fil) {
        this.d = new dp();
        this.b = context;
    ...
    public final synchronized fhk a(String str, String str2, String str3) {
        return fhk.a(this.a.getString(b(str, str2, str3), null));
    }
    ...
    public final synchronized void a(String str, String str2, String str3, String str4, String str5) {
        String a2 = fhk.a(str4, str5, System.currentTimeMillis());
        if (a2 != null) {
    ...
    /* JADX INFO: used method not loaded: fil.a(android.content.Context, java.lang.String):null, types can be incorrect */
    ...
    public final synchronized defpackage.fim b(java.lang.String r4) {
        /*
            r3 = this;
            monitor-enter(r3)
            java.util.Map<java.lang.String, fim> r0 = r3.d     // Catch:{ all -> 0x0033 }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ all -> 0x0033 }
            fim r0 = (defpackage.fim) r0     // Catch:{ all -> 0x0033 }
            if (r0 == 0) goto L_0x000d
            monitor-exit(r3)
            return r0
        L_0x000d:
            fil r0 = r3.c     // Catch:{ zzaa -> 0x001d }
            android.content.Context r1 = r3.b     // Catch:{ zzaa -> 0x001d }
            fim r2 = r0.b(r1, r4)     // Catch:{ zzaa -> 0x001d }
            if (r2 == 0) goto L_0x0018
            goto L_0x002c
        L_0x0018:
            fim r2 = r0.a(r1, r4)     // Catch:{ zzaa -> 0x001d }
            goto L_0x002c
        L_0x001d:
            ...
            fil r0 = r3.c     // Catch:{ all -> 0x0033 }
            android.content.Context r1 = r3.b     // Catch:{ all -> 0x0033 }
            fim r2 = r0.a(r1, r4)     // Catch:{ all -> 0x0033 }
        L_0x002c:
            java.util.Map<java.lang.String, fim> r0 = r3.d     // Catch:{ all -> 0x0033 }
        ...
        L_0x0033:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fhj.b(java.lang.String):fim");
    }

    public final synchronized void b() {
        File[] listFiles;
        this.d.clear();
        for (File file : fil.a(this.b).listFiles()) {
