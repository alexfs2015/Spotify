...
public final class cmd {
    public static final Handler a = new clv(Looper.getMainLooper());
    ...
    public static WebResourceResponse a(HttpURLConnection httpURLConnection) {
        ...
        return bjl.g().a(trim, str3, httpURLConnection.getResponseCode(), httpURLConnection.getResponseMessage(), hashMap, httpURLConnection.getInputStream());
    }
    ...
    public static void a(Context context, Throwable th) {
        if (context != null) {
            boolean z = false;
            try {
                z = ((Boolean) dpn.f().a(dsp.c)).booleanValue();
    ...
    public static boolean a(Activity activity, Configuration configuration) {
        dpn.a();
        int a2 = col.a((Context) activity, configuration.screenHeightDp);
        int a3 = col.a((Context) activity, configuration.screenWidthDp);
        ...
        Double.isNaN(d2);
        int round = ((int) Math.round(d2 + 0.5d)) * ((Integer) dpn.f().a(dsp.cV)).intValue();
    ...
    public static boolean a(View view, PowerManager powerManager, KeyguardManager keyguardManager) {
        ...
        if (!bjl.e().d) {
            if (keyguardManager == null ? false : keyguardManager.inKeyguardRestrictedInputMode()) {
                if (!((Boolean) dpn.f().a(dsp.bm)).booleanValue() || !c(view)) {
                    z = false;
                    if (view.getVisibility() == 0 && view.isShown()) {
                        if ((powerManager != null || powerManager.isScreenOn()) && z) {
                            if (((Boolean) dpn.f().a(dsp.bk)).booleanValue() || view.getLocalVisibleRect(new Rect()) || view.getGlobalVisibleRect(new Rect())) {
                                return true;
                            }
                        }
                    }
        ...
        z = true;
        if (((Boolean) dpn.f().a(dsp.bk)).booleanValue()) {
        }
        return true;
    }
    ...
    public static void b(Context context, String str, String str2) {
        try {
            ...
            clu.a("Error writing to file in internal storage.", e2);
        }
    }
    ...
    public static int[] b(Activity activity) {
        ...
        dpn.a();
        dpn.a();
        return new int[]{col.b((Context) activity, a2[0]), col.b((Context) activity, a2[1])};
    }
    ...
    public static boolean c(android.view.View r2) {
        ...
        L_0x002d:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cmd.c(android.view.View):boolean");
    }
    ...
    public static dsa e(Context context) {
    ...
    private static Bitmap f(View view) {
        ...
        try {
            ...
            clu.a("Fail to capture the web view", e2);
        }
        return bitmap;
    }
    ...
    public static Bitmap g(Context context) {
        ...
        try {
            ...
            clu.a("Fail to capture screen shot", e2);
        }
        return bitmap;
    }
    ...
    public static boolean j(Context context) {
        try {
            ...
            clu.a("Error loading class.", th);
            bjl.i().a(th, "AdUtil.isLiteSdk");
            return false;
        }
    }
    ...
    public final JSONObject a(Bundle bundle) {
        if (bundle != null) {
            try {
                ...
                clu.a("Error converting Bundle to JSON", e2);
            }
        }
        return null;
    }
    ...
    public final void a(Context context, String str, String str2, Bundle bundle, boolean z) {
        if (z) {
            ...
            bundle.putString("eids", TextUtils.join(",", dsp.a()));
        }
        dpn.a();
        col.a(context, str, str2, bundle, z, new cmg(context, str));
    }
    ...
    public final boolean b(Context context) {
        ...
        context.getApplicationContext().registerReceiver(new cmh(this), intentFilter);
        this.f = true;
        return true;
    }

    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0023, code lost:
        if (((java.lang.String) defpackage.dpn.f().a(defpackage.dsp.ao)).equals(r3.g.pattern()) == false) goto L_0x0025;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean d(java.lang.String r4) {
        ...
        L_0x0008:
            ...
            dsf<java.lang.String> r0 = defpackage.dsp.ao     // Catch:{ all -> 0x0043 }
            dsn r2 = defpackage.dpn.f()     // Catch:{ all -> 0x0043 }
        ...
        L_0x0046:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cmd.d(java.lang.String):boolean");
    }

    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0023, code lost:
        if (((java.lang.String) defpackage.dpn.f().a(defpackage.dsp.ap)).equals(r3.h.pattern()) == false) goto L_0x0025;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final boolean e(java.lang.String r4) {
        ...
        L_0x0008:
            ...
            if (r0 == 0) goto L_0x0025
            dsf<java.lang.String> r0 = defpackage.dsp.ap     // Catch:{ all -> 0x0043 }
            dsn r2 = defpackage.dpn.f()     // Catch:{ all -> 0x0043 }
            java.lang.Object r0 = r2.a(r0)     // Catch:{ all -> 0x0043 }
            java.lang.String r0 = (java.lang.String) r0     // Catch:{ all -> 0x0043 }
        ...
        L_0x0046:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cmd.e(java.lang.String):boolean");
    }
    ...
    public static boolean a(Context context) {
        ...
        try {
            ...
            cow.a(5);
            bjl.i().a((Throwable) e2, "AdUtil.hasAdActivity");
            return false;
        }
    }

    public static boolean a(Context context, String str) {
        return cab.a(context).a.getPackageManager().checkPermission(str, context.getPackageName()) == 0;
    }

    public final void a(Context context, List<String> list) {
        if (context instanceof Activity) {
            Activity activity = (Activity) context;
            if (!TextUtils.isEmpty(dgt.a(activity))) {
                if (list == null) {
                    clu.a();
                } else if (!dtk.a(context)) {
                    clu.a();
                } else {
                    dtk dtk = new dtk();
                    dtk.d = new cme(list, dtk, context);
                    dtk.a(activity);
                }
            }
        }
    ...
    public final java.lang.String b(android.content.Context r5, java.lang.String r6) {
        ...
        L_0x000b:
            ...
            return r5
        L_0x0013:
            cmj r1 = defpackage.bjl.g()     // Catch:{ Exception -> 0x001d }
        ...
        L_0x001d:
            ...
            defpackage.dpn.a()     // Catch:{ all -> 0x00d1 }
            boolean r1 = defpackage.col.b()     // Catch:{ all -> 0x00d1 }
            if (r1 != 0) goto L_0x0067
            r1 = 0
            r4.e = r1     // Catch:{ all -> 0x00d1 }
            android.os.Handler r1 = a     // Catch:{ all -> 0x00d1 }
            cmf r2 = new cmf     // Catch:{ all -> 0x00d1 }
        ...
        L_0x0062:
            r1 = 5
            defpackage.cow.a(r1)     // Catch:{ all -> 0x00d1 }
            goto L_0x003b
        L_0x0067:
        ...
        L_0x006d:
            ...
            caa r5 = defpackage.cab.a(r5)     // Catch:{ Exception -> 0x00b5 }
        ...
        L_0x00b5:
            r5 = move-exception
            cle r6 = defpackage.bjl.i()     // Catch:{ all -> 0x00d1 }
        ...
        L_0x00d5:
            goto L_0x00d4
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.cmd.b(android.content.Context, java.lang.String):java.lang.String");
    }
    ...
    public static int[] c(Activity activity) {
        ...
        if (window != null) {
            ...
            if (findViewById != null) {
                ...
                dpn.a();
                dpn.a();
                return new int[]{col.b((Context) activity, iArr[0]), col.b((Context) activity, iArr[1])};
            }
        }
        iArr = new int[]{0, 0};
        dpn.a();
    ...
    public static String a(Context context, View view, dpc dpc) {
        if (!((Boolean) dpn.f().a(dsp.ai)).booleanValue()) {
            return null;
        }
        try {
            JSONObject jSONObject = new JSONObject();
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("width", dpc.e);
            jSONObject2.put("height", dpc.b);
    ...
    private static Bitmap e(View view) {
        try {
            ...
            clu.a("Fail to capture the webview", e2);
            return null;
        }
    }
    ...
    public static Bundle c() {
        ...
        try {
            if (((Boolean) dpn.f().a(dsp.C)).booleanValue()) {
            ...
            bundle.putInt("web_view_count", bjl.i().h.get());
        } catch (Exception unused) {
            cow.a(5);
        }
        return bundle;
    ...
    public static void a(Context context, Uri uri) {
        try {
            ...
            if (((Boolean) dpn.f().a(dsp.cJ)).booleanValue()) {
                b(context, intent);
            }
    ...
    public static String c(Context context, String str) {
        try {
            ...
            bzm.a(openFileInput, byteArrayOutputStream, true, 1024);
    ...
    public static Bundle a(dly dly) {
        String str;
        String str2;
        String str3;
        if (dly == null) {
        ...
        if (!((Boolean) dpn.f().a(dsp.W)).booleanValue()) {
            if (!((Boolean) dpn.f().a(dsp.Y)).booleanValue()) {
                return null;
            }
        }
        if (bjl.i().g().d() && bjl.i().g().f()) {
            return null;
        }
        if (dly.b) {
            synchronized (dly.c) {
        ...
        if (str != null) {
            if (((Boolean) dpn.f().a(dsp.Y)).booleanValue() && !bjl.i().g().f()) {
    ...
    public static WebResourceResponse c(Context context, String str, String str2) {
        ...
        try {
            HashMap hashMap = new HashMap();
            hashMap.put("User-Agent", bjl.e().b(context, str));
            hashMap.put("Cache-Control", "max-stale=3600");
            String str4 = (String) new cnl(context).a(str2, (Map<String, String>) hashMap).get(60, TimeUnit.SECONDS);
            if (str4 != null) {
