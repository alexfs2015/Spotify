...
public final class dbb {
    static BigInteger a(EllipticCurve ellipticCurve) {
    ...
    public static KeyPair a(ECParameterSpec eCParameterSpec) {
        KeyPairGenerator keyPairGenerator = (KeyPairGenerator) dbe.d.a("EC");
    ...
    public static ECPublicKey a(zzayv zzayv, byte[] bArr, byte[] bArr2) {
        ...
        return (ECPublicKey) ((KeyFactory) dbe.e.a("EC")).generatePublic(new ECPublicKeySpec(eCPoint, a));
    }
    ...
    public static byte[] a(ECPrivateKey eCPrivateKey, ECPoint eCPoint) {
        ...
        KeyAgreement keyAgreement = (KeyAgreement) dbe.c.a("ECDH");
        keyAgreement.init(eCPrivateKey);
        keyAgreement.doPhase(generatePublic, true);
        byte[] generateSecret = keyAgreement.generateSecret();
        EllipticCurve curve = eCPrivateKey.getParams().getCurve();
        BigInteger bigInteger2 = new BigInteger(1, generateSecret);
        if (bigInteger2.signum() == -1 || bigInteger2.compareTo(a(curve)) != -1) {
