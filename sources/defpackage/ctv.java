...
public final class ctv extends cjq {
    private final cuw a;
    ...
    private static List<dql> a(Map<String, List<String>> map) {
        ArrayList arrayList = new ArrayList(map.size());
        for (Entry entry : map.entrySet()) {
            if (entry.getKey() != null) {
                for (String dql : (List) entry.getValue()) {
                    arrayList.add(new dql((String) entry.getKey(), dql));
                }
            }
        }
        return arrayList;
    ...
    private static void a(HttpURLConnection httpURLConnection, dwe<?> dwe) {
        byte[] a2 = dwe.a();
        if (a2 != null) {
    ...
    public final defpackage.cru a(defpackage.dwe<?> r7, java.util.Map<java.lang.String, java.lang.String> r8) {
        /*
            r6 = this;
        ...
        L_0x00d3:
            goto L_0x00d2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ctv.a(dwe, java.util.Map):cru");
    }
}
