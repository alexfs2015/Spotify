...
public final class rew extends MusicPagesModel {
    private final rgq a;
    private final Optional<vca> b;
    ...
    public static final class a extends com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a {
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a a(Optional<vca> optional) {
            if (optional != null) {
                this.b = optional;
                return this;
            }
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a a(rdc rdc) {
            if (rdc != null) {
                this.h = rdc;
                return this;
            }
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a a(rfa rfa) {
            if (rfa != null) {
                this.v = rfa;
                return this;
            }
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a a(rgq rgq) {
            if (rgq != null) {
                this.a = rgq;
                return this;
            }
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a a(vbl vbl) {
            if (vbl != null) {
                this.t = vbl;
                return this;
            }
        ...
        public final com.spotify.music.features.yourlibrary.musicpages.domain.MusicPagesModel.a a(vbz vbz) {
            if (vbz != null) {
                this.u = vbz;
                return this;
            }
        ...
        public final MusicPagesModel a() {
            ...
            if (str.isEmpty()) {
                rew rew = new rew(this.a, this.b, this.c, this.d, this.e, this.f.intValue(), this.g.intValue(), this.h, this.i, this.j, this.k, this.l, this.m, this.n, this.o.booleanValue(), this.p.booleanValue(), this.q.booleanValue(), this.r.booleanValue(), this.s.booleanValue(), this.t, this.u, this.v, 0);
                return rew;
            }
    ...
    private rew(rgq rgq, Optional<vca> optional, Optional<ImmutableMap<String, Boolean>> optional2, Optional<PagePrefs> optional3, String str, int i2, int i3, rdc rdc, Optional<Boolean> optional4, Optional<Boolean> optional5, Optional<Boolean> optional6, Optional<Boolean> optional7, Optional<Boolean> optional8, LoadingState loadingState, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, vbl vbl, vbz vbz, rfa rfa) {
        this.a = rgq;
        this.b = optional;
        this.c = optional2;
        this.d = optional3;
    ...
    /* synthetic */ rew(rgq rgq, Optional optional, Optional optional2, Optional optional3, String str, int i2, int i3, rdc rdc, Optional optional4, Optional optional5, Optional optional6, Optional optional7, Optional optional8, LoadingState loadingState, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, vbl vbl, vbz vbz, rfa rfa, byte b2) {
        this(rgq, optional, optional2, optional3, str, i2, i3, rdc, optional4, optional5, optional6, optional7, optional8, loadingState, z, z2, z3, z4, z5, vbl, vbz, rfa);
    }
