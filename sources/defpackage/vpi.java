...
public final class vpi implements vpr {
    ...
    public vpi(Context context, NotificationManager notificationManager, jty jty, vpq vpq, vqf vqf, vpn vpn, jtz jtz, ObjectMapper objectMapper) {
        this.a = context;
    ...
    private List<QuickAction> a(String str, String str2, String str3) {
        ...
        try {
            ...
            String format = String.format("Unable to parse quick actions: %s", new Object[]{e2.getMessage()});
    ...
    private void a(String str, String str2, String str3, String str4, String str5, String str6, List<a> list) {
        int a2 = a(str4);
        c b2 = new c(this.a, str6).a((CharSequence) str).b((CharSequence) str2).a((e) new b().a((CharSequence) str2)).a(this.d.a()).a(this.g.f().getTimeInMillis()).b(true);
    ...
    private PushkaMetadata b(String str) {
        ...
        try {
            ...
            String format = String.format("Unable to parse Pushka metadata: %s", new Object[]{e2.getMessage()});
            Logger.e(format, new Object[0]);
    ...
    public final void a(java.util.Map<java.lang.String, java.lang.String> r22) {
        ...
        L_0x0074:
            ...
            r7 = 0
        L_0x0076:
            java.lang.String r3 = "quickActions"
            java.lang.Object r0 = r0.get(r3)
            java.lang.String r0 = (java.lang.String) r0
            java.util.List r0 = r8.a(r7, r5, r0)
            int r3 = a(r7)
        ...
        L_0x0174:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vpi.a(java.util.Map):void");
    }
}
