...
public final class pmq implements PlayerStateObserver {
    private final Player a;
    private final pmg b;
    private final pms c;

    public pmq(Player player, pmg pmg, pms pms) {
        this.a = (Player) fay.a(player);
        this.b = (pmg) fay.a(pmg);
        this.c = (pms) fay.a(pms);
    }
    ...
    public final void c() {
        ...
        L_0x002a:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.pmq.c():void");
    }
    ...
    public final void b() {
        ...
        if (d != null) {
            pmg pmg = this.b;
            pmg.a(PlayerStateUtil.getTrackUri(pmg.a()), SectionId.PLAY_BUTTON, d.isPaused() ? UserIntent.PLAY : UserIntent.PAUSE, InteractionType.HIT);
        }
        PlayerState d2 = d();
        if (d2 != null) {
            if (d2.isPaused()) {
