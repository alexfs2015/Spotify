...
public final class cyz extends ddp<cyz, a> implements des {
    private static volatile dfc<cyz> zzakh;
    /* access modifiers changed from: private */
    public static final cyz zzdjk = new cyz();
    private czb zzdjj;

    /* renamed from: cyz$a */
    public static final class a extends defpackage.ddp.a<cyz, a> implements des {
        private a() {
            super(cyz.zzdjk);
        }
    ...
    static {
        ddp.a(cyz.class, zzdjk);
    }

    private cyz() {
    }

    public static cyz a(zzbah zzbah) {
        return (cyz) ddp.a(zzdjk, zzbah);
    }
    ...
    /* JADX WARNING: type inference failed for: r3v8, types: [dfc<cyz>] */
    /* JADX WARNING: type inference failed for: r3v9, types: [java.lang.Object] */
    /* JADX WARNING: type inference failed for: r3v11, types: [dfc<cyz>] */
    /* JADX WARNING: type inference failed for: r3v12 */
    /* JADX WARNING: type inference failed for: r3v13, types: [ddp$b, dfc<cyz>] */
    ...
    public final java.lang.Object a(int r3) {
        ...
        L_0x0017:
            ...
            monitor-enter(r0)
            dfc<cyz> r3 = zzakh     // Catch:{ all -> 0x002d }
            if (r3 != 0) goto L_0x002b
            ddp$b r3 = new ddp$b     // Catch:{ all -> 0x002d }
            cyz r1 = zzdjk     // Catch:{ all -> 0x002d }
