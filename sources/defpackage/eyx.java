...
public final class eyx extends Drawable implements Callback, gn {
    ...
    public static defpackage.eyx a(android.content.Context r7, android.util.AttributeSet r8, int r9, int r10) {
        /*
            eyx r0 = new eyx
            r0.<init>(r7)
            android.content.Context r1 = r0.J
            int[] r3 = defpackage.eyc.a.H
            r7 = 0
            int[] r6 = new int[r7]
            r2 = r8
            r4 = r9
            r5 = r10
            android.content.res.TypedArray r9 = defpackage.ezs.a(r1, r2, r3, r4, r5, r6)
            android.content.Context r10 = r0.J
            int r1 = defpackage.eyc.a.Q
            android.content.res.ColorStateList r10 = defpackage.ezv.a(r10, r9, r1)
        ...
        L_0x004e:
            android.content.Context r10 = r0.J
            int r2 = defpackage.eyc.a.aa
            android.content.res.ColorStateList r10 = defpackage.ezv.a(r10, r9, r2)
        ...
        L_0x0079:
            ...
            r0.onStateChange(r10)
        L_0x0091:
            int r10 = defpackage.eyc.a.L
            java.lang.CharSequence r10 = r9.getText(r10)
            r0.a(r10)
            android.content.Context r10 = r0.J
            int r2 = defpackage.eyc.a.I
        ...
        L_0x00d3:
            ...
            java.lang.String r2 = r8.getAttributeValue(r10, r2)
            if (r2 != 0) goto L_0x00f9
            int r2 = defpackage.eyc.a.U
            boolean r2 = r9.getBoolean(r2, r7)
            r0.b(r2)
        L_0x00f9:
            android.content.Context r2 = r0.J
            int r3 = defpackage.eyc.a.T
            android.graphics.drawable.Drawable r2 = defpackage.ezv.b(r2, r9, r3)
        ...
        L_0x0135:
            android.content.Context r2 = r0.J
            int r3 = defpackage.eyc.a.W
            android.content.res.ColorStateList r2 = defpackage.ezv.a(r2, r9, r3)
        ...
        L_0x0175:
            ...
            java.lang.String r2 = r8.getAttributeValue(r10, r2)
            if (r2 != 0) goto L_0x0199
            int r2 = defpackage.eyc.a.ad
            boolean r2 = r9.getBoolean(r2, r7)
            r0.c(r2)
        L_0x0199:
            android.content.Context r2 = r0.J
            int r3 = defpackage.eyc.a.ac
            android.graphics.drawable.Drawable r2 = defpackage.ezv.b(r2, r9, r3)
        ...
        L_0x0233:
            ...
            if (r8 != 0) goto L_0x0257
            int r8 = defpackage.eyc.a.O
            boolean r7 = r9.getBoolean(r8, r7)
            r0.d(r7)
        L_0x0257:
            android.content.Context r7 = r0.J
            int r8 = defpackage.eyc.a.N
            android.graphics.drawable.Drawable r7 = defpackage.ezv.b(r7, r9, r8)
        ...
        L_0x0281:
            android.content.Context r7 = r0.J
            int r8 = defpackage.eyc.a.an
            eyk r7 = defpackage.eyk.a(r7, r9, r8)
            r0.H = r7
            android.content.Context r7 = r0.J
            int r8 = defpackage.eyc.a.aj
            eyk r7 = defpackage.eyk.a(r7, r9, r8)
            r0.I = r7
            int r7 = defpackage.eyc.a.Z
        ...
        L_0x0359:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eyx.a(android.content.Context, android.util.AttributeSet, int, int):eyx");
    }
        ...
        if (!bounds.isEmpty() && getAlpha() != 0) {
            if (this.W < 255) {
                ...
                if (VERSION.SDK_INT > 21) {
                    i4 = canvas.saveLayerAlpha(f2, f3, f4, f5, i5);
                } else {
                    i4 = canvas.saveLayerAlpha(f2, f3, f4, f5, i5, 31);
                }
                i2 = i4;
            } else {
                i2 = 0;
            ...
            if (this.u && this.C != null) {
                ...
                if (this.C != null) {
                    ...
                    float i6 = this.s + i() + this.p;
                    if (gm.h(this) == 0) {
                        rectF3.left = ((float) bounds.left) + b3;
                        rectF3.right = ((float) bounds.right) - i6;
                    } else {
                        rectF3.left = ((float) bounds.left) + i6;
    ...
    public final boolean isStateful() {
        if (!a(this.x) && !a(this.A) && (!this.ac || !a(this.ad))) {
            ezw ezw = this.c;
            if (!((ezw == null || ezw.a == null || !ezw.a.isStateful()) ? false : true)) {
                if ((this.j && this.k != null && this.i) || a(this.E) || a(this.k) || a(this.Z)) {
                    return true;
                }
                return false;
            }
    ...
    private boolean a(int[] r6, int[] r7) {
        ...
        L_0x0097:
            ...
            android.graphics.PorterDuffColorFilter r0 = defpackage.ezb.a(r5, r0, r2)
            r5.Y = r0
            r0 = 1
        L_0x00a8:
        ...
        L_0x00df:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eyx.a(int[], int[]):boolean");
    }
    ...
    private void k() {
        this.ad = this.ac ? ezx.a(this.a) : null;
    }
    ...
    private void a(ezw ezw) {
        if (this.c != ezw) {
            this.c = ezw;
            if (ezw != null) {
                ezw.b(this.J, this.K, this.D);
                this.af = true;
            }
            onStateChange(getState());
            a();
