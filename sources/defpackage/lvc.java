...
public final class lvc extends Drawable {
    int a;
    int b;
    boolean c;
    private Drawable d;
    ...
    private final Callback o = new Callback() {
        public final void invalidateDrawable(Drawable drawable) {
            Callback callback = lvc.this.getCallback();
            if (callback != null) {
                callback.invalidateDrawable(lvc.this);
            }
        }
        ...
        public final void scheduleDrawable(Drawable drawable, Runnable runnable, long j) {
            Callback callback = lvc.this.getCallback();
            if (callback != null) {
                callback.scheduleDrawable(lvc.this, runnable, j);
            }
        }
        ...
        public final void unscheduleDrawable(Drawable drawable, Runnable runnable) {
            Callback callback = lvc.this.getCallback();
            if (callback != null) {
                callback.unscheduleDrawable(lvc.this, runnable);
            }
        }
    };

    public lvc(Context context) {
        this.h = (float) uts.b(4.0f, context.getResources());
        a();
    }
    ...
    public final void a(Drawable drawable, boolean z) {
        ...
        if (!z || !z2) {
            ...
            this.n.setDuration(300).addUpdateListener(new $$Lambda$lvc$nmHjOkvpEhTuDLmbgcpryOXVuyQ(this));
            this.n.start();
        }
        invalidateSelf();
    }
    ...
    public final void draw(Canvas canvas) {
        ...
        if (drawable != null) {
            ...
            if (!this.i) {
                ...
                float height = ((-rectF2.top) + ((float) bounds2.height())) - (rectF2.height() * 0.88528216f);
                if (this.c) {
                    f2 = (-rectF2.left) - (width * 0.33603835f);
                } else {
                    f2 = ((-rectF2.left) + ((float) bounds2.width())) - (width * 0.66396165f);
                }
                this.j.set(f2, height);
                this.i = true;
            }
            canvas.save();
            ...
            float f4 = -((((float) this.l.width()) * 0.05882353f) + (((float) this.l.width()) * 0.029411765f));
            canvas.drawBitmap(this.m, f4, f4, this.f);
