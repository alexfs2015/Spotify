...
final class uvm extends Drawable {
    ...
    /* renamed from: uvm$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.uvm.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    static void a(ImageView imageView, Drawable drawable, LoadedFrom loadedFrom, boolean z) {
        ...
        uvm uvm = new uvm(imageView.getContext(), drawable, drawable2, loadedFrom, z);
        imageView.setImageDrawable(uvm);
    }
    ...
    private uvm(Context context, Drawable drawable, Drawable drawable2, LoadedFrom loadedFrom, boolean z) {
        this.c = drawable;
        this.g = z;
