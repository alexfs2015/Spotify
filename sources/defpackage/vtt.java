...
public final class vtt extends AndroidMusicLibsPlaylistProperties {
    ...
    public static final class a extends com.spotify.remoteconfig.AndroidMusicLibsPlaylistProperties.a {
        ...
        public final AndroidMusicLibsPlaylistProperties a() {
            ...
            if (str.isEmpty()) {
                vtt vtt = new vtt(this.a.booleanValue(), this.b.booleanValue(), this.c, this.d, this.e, 0);
                return vtt;
            }
    ...
    private vtt(boolean z, boolean z2, StupidFlag2 stupidFlag2, StupidFlag3 stupidFlag3, StupidFlag4 stupidFlag4) {
        this.a = z;
        this.b = z2;
        this.c = stupidFlag2;
        this.d = stupidFlag3;
    ...
    /* synthetic */ vtt(boolean z, boolean z2, StupidFlag2 stupidFlag2, StupidFlag3 stupidFlag3, StupidFlag4 stupidFlag4, byte b2) {
