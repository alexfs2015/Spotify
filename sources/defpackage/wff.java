...
public class wff extends wgd {
    private static final wjw a = wjx.a(wff.class);
    ...
    /* renamed from: wff$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0081:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.wff.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    wff(SSLContext sSLContext, boolean z, Iterable<String> iterable, wev wev, wez wez, ClientAuth clientAuth, boolean z2) {
        super(z2);
        this.i = (wez) wjk.a(wez, "apn");
        this.j = (ClientAuth) wjk.a(clientAuth, "clientAuth");
        this.e = ((wev) wjk.a(wev, "cipherFilter")).a(iterable, c, d);
        this.k = (SSLContext) wjk.a(sSLContext, "sslContext");
        this.l = z;
    }
    ...
    static wez a(ApplicationProtocolConfig applicationProtocolConfig, boolean z) {
        ...
        if (i2 != 2) {
            if (i2 != 3) {
                ...
                if (i3 == 1) {
                    return new wfc(false, applicationProtocolConfig.a);
                }
                if (i3 == 2) {
                    return new wfc(true, applicationProtocolConfig.a);
                }
            ...
            if (i5 == 1) {
                return new wex(true, applicationProtocolConfig.a);
            }
            if (i5 == 2) {
                return new wex(false, applicationProtocolConfig.a);
            }
