...
public final class vsh implements Downloader {
    private final OkHttpClient a;

    public vsh(Context context) {
        this(vsv.b(context));
    }

    private vsh(File file) {
        this(file, vsv.a(file));
    }

    private vsh(OkHttpClient okHttpClient) {
        this.a = okHttpClient;
    }
