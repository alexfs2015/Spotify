...
public final class vhe implements Downloader {
    ...
    private vhe(String str, ContentResolver contentResolver) {
        this.a = str;
    ...
    public final com.squareup.picasso.Downloader.a a(android.net.Uri r6, int r7) {
        /*
            ...
            java.nio.charset.Charset r0 = defpackage.fbi.c
        ...
        L_0x008c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vhe.a(android.net.Uri, int):com.squareup.picasso.Downloader$a");
    }
}
