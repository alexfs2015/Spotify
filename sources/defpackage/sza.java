...
final class sza extends b {
    ...
    /* renamed from: sza$a */
    static final class a extends defpackage.sze.b.a {
        private Boolean a;
        private Boolean b;
        private Boolean c;
        private Boolean d;
        ...
        public final defpackage.sze.b.a a(boolean z) {
            this.a = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.b.a b(boolean z) {
            this.b = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.b.a c(boolean z) {
            this.c = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.b.a d(boolean z) {
            this.d = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.b.a e(boolean z) {
            this.e = Boolean.valueOf(z);
            return this;
        }

        public final defpackage.sze.b.a f(boolean z) {
            this.f = Boolean.TRUE;
            return this;
        }

        public final defpackage.sze.b.a g(boolean z) {
        ...
        public final b a() {
            ...
            if (str.isEmpty()) {
                sza sza = new sza(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d.booleanValue(), this.e.booleanValue(), this.f.booleanValue(), this.g.booleanValue(), 0);
                return sza;
            }
    ...
    /* synthetic */ sza(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7, byte b2) {
        this(z, z2, z3, z4, z5, z6, z7);
    }

    private sza(boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, boolean z7) {
        this.b = z;
        this.c = z2;
        this.d = z3;
        this.e = z4;
