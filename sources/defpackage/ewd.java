...
public final class ewd extends etm {
    ...
    static boolean a(Context context) {
        bxo.a(context);
        return VERSION.SDK_INT >= 24 ? b(context, "com.google.android.gms.measurement.AppMeasurementJobService") : b(context, "com.google.android.gms.measurement.AppMeasurementService");
    }
    ...
    private final boolean c(Context context, String str) {
        ...
        try {
            PackageInfo b2 = cas.a(context).b(str, 64);
    ...
    public final long a(Context context, String str) {
        ...
        if (packageManager != null) {
            try {
                if (!c(context, str)) {
                    PackageInfo b2 = cas.a(context).b(m().getPackageName(), 64);
    ...
    public final android.os.Bundle a(java.lang.String r19, java.lang.String r20, android.os.Bundle r21, java.util.List<java.lang.String> r22, boolean r23, boolean r24) {
        ...
        L_0x00c2:
            ewn r0 = r18.s()
            erd$a<java.lang.Boolean> r1 = defpackage.erd.S
            r4 = r19
        ...
        L_0x016f:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ewd.a(java.lang.String, java.lang.String, android.os.Bundle, java.util.List, boolean, boolean):android.os.Bundle");
    }

    /* access modifiers changed from: 0000 */
    public final erb a(String str, String str2, Bundle bundle, String str3, long j) {
        Bundle bundle2;
        if (TextUtils.isEmpty(str2)) {
            return null;
        }
        if (b(str2) == 0) {
            ...
            String str5 = str2;
            erb erb = new erb(str5, new eqy(a(a(str, str2, bundle3, Collections.singletonList(str4), false, false))), str3, j);
            return erb;
        }
        ...
        if (!TextUtils.isEmpty(str)) {
            if (!g(str)) {
                if (TextUtils.isEmpty(this.r.a)) {
                    q().c.a("Invalid google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI. provided id", ern.a(str));
                }
                return false;
            }
            ...
            q().c.a("Invalid admob_app_id. Analytics disabled.", ern.a(str2));
            return false;
        }
        return true;
    }
