...
public class vvy implements Closeable {
    private static final Logger a = Logger.getLogger(vvy.class.getName());
    ...
    final class b extends InputStream {
        ...
        /* synthetic */ b(vvy vvy, a aVar, byte b2) {
            this(aVar);
        }

        private b(a aVar) {
            this.a = vvy.this.b(aVar.b + 4);
            this.b = aVar.c;
        }
        ...
        public final int read(byte[] bArr, int i, int i2) {
            ...
            vvy.this.b(this.a, bArr, i, i2);
            this.a = vvy.this.b(this.a + i2);
            this.b -= i2;
            return i2;
        }
        ...
        public final int read() {
            ...
            vvy.this.b.seek((long) this.a);
            int read = vvy.this.b.read();
            this.a = vvy.this.b(this.a + 1);
            this.b--;
            return read;
        }
    }
