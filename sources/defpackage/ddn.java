...
final class ddn extends dck<Float> implements ddu<Float>, RandomAccess {
    private float[] b;
    private int c;
    ...
    public final /* synthetic */ ddu a(int i) {
        if (i >= this.c) {
            return new ddn(Arrays.copyOf(this.b, i), this.c);
        }
    ...
    public final boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(ddn.b, 0, this.b, this.c, ddn.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
