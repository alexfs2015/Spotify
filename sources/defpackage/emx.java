...
final class emx extends elq<Integer> implements enc<Integer>, eoi, RandomAccess {
    private int[] b;
    private int c;
    ...
    public final boolean addAll(Collection<? extends Integer> collection) {
        c();
        emy.a(collection);
        if (!(collection instanceof emx)) {
            return super.addAll(collection);
        }
        emx emx = (emx) collection;
        int i = emx.c;
        if (i == 0) {
            return false;
        }
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(emx.b, 0, this.b, this.c, emx.c);
            this.c = i3;
            this.modCount++;
            return true;
        }
    ...
    public final /* synthetic */ enc a(int i) {
        if (i >= this.c) {
            return new emx(Arrays.copyOf(this.b, i), this.c);
        }
