...
public final class rt implements Interpolator {
    ...
    public rt(Context context, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        this(context.getResources(), context.getTheme(), attributeSet, xmlPullParser);
    }

    private rt(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray a2 = gc.a(resources, theme, attributeSet, rn.l);
        String str = "pathData";
