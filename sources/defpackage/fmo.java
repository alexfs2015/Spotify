...
public final class fmo extends fmw {
    ...
    public final boolean[] a(String str) {
        if (str.length() == 13) {
            try {
                if (fmv.a(str)) {
                    int i = fmn.a[Integer.parseInt(str.substring(0, 1))];
                    boolean[] zArr = new boolean[95];
                    int a = a(zArr, 0, fmv.b, true) + 0;
                    int i2 = 1;
                    while (i2 <= 6) {
                        int i3 = i2 + 1;
                        ...
                        a += a(zArr, a, fmv.f[parseInt], false);
                        i2 = i3;
                    }
                    int a2 = a + a(zArr, a, fmv.c, false);
                    int i4 = 7;
                    while (i4 <= 12) {
                        int i5 = i4 + 1;
                        a2 += a(zArr, a2, fmv.e[Integer.parseInt(str.substring(i4, i5))], true);
                        i4 = i5;
                    }
                    a(zArr, a2, fmv.b, true);
                    return zArr;
                }
