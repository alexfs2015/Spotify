...
public final class xlh extends xil implements xln {
    static final c a;
    ...
    static final class a {
        ...
        a(final ThreadFactory threadFactory, long j, TimeUnit timeUnit) {
            ...
            if (timeUnit != null) {
                ...
                xll.a(scheduledExecutorService);
    ...
    /* renamed from: xlh$b */
    static final class b extends defpackage.xil.a implements xir {
        private final xok a = new xok();
        private final a b;
        private final c c;
        ...
        public final xip a(final xir xir, long j, TimeUnit timeUnit) {
            ...
            ScheduledAction b2 = this.c.b(new xir() {
    ...
    public xlh(ThreadFactory threadFactory) {
