...
public final class pj {
    ...
    public pj(String str, Map<String, a> map, Set<b> set, Set<d> set2) {
        Set<d> set3;
        this.a = str;
    ...
    public final boolean equals(Object obj) {
        ...
        pj pjVar = (pj) obj;
        String str = this.a;
        if (str == null ? pjVar.a != null : !str.equals(pjVar.a)) {
            return false;
        }
        Map<String, a> map = this.b;
        if (map == null ? pjVar.b != null : !map.equals(pjVar.b)) {
            return false;
        }
        Set<b> set = this.c;
        if (set == null ? pjVar.c != null : !set.equals(pjVar.c)) {
            return false;
        }
        Set<d> set2 = this.d;
        if (set2 != null) {
    ...
    public static pj a(po poVar, String str) {
        return new pj(str, c(poVar, str), b(poVar, str), d(poVar, str));
    }

    private static Set<b> b(po poVar, String str) {
        HashSet hashSet = new HashSet();
        StringBuilder sb = new StringBuilder("PRAGMA foreign_key_list(`");
        sb.append(str);
        sb.append("`)");
        Cursor b2 = poVar.b(sb.toString());
        try {
    ...
    private static Map<String, a> c(po poVar, String str) {
    ...
    private static Set<d> d(po poVar, String str) {
    ...
    private static d a(po poVar, String str, boolean z) {
