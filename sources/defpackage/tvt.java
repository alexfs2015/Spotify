...
public final class tvt extends ItemConfiguration {
    ...
    public static final class a implements com.spotify.music.playlist.ui.ItemConfiguration.a {
        ...
        public final ItemConfiguration a() {
            ...
            if (str.isEmpty()) {
                tvt tvt = new tvt(this.a.booleanValue(), this.b.booleanValue(), this.c.booleanValue(), this.d, this.e, this.f.booleanValue(), this.g.booleanValue(), this.h.booleanValue(), this.i.booleanValue(), this.j.booleanValue(), this.k.booleanValue(), this.l.booleanValue(), this.m.booleanValue(), this.n.booleanValue(), this.o.booleanValue(), this.p.booleanValue(), 0);
                return tvt;
            }
    ...
    private tvt(boolean z, boolean z2, boolean z3, HeartAndBan heartAndBan, LongClickAction longClickAction, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14) {
        this.a = z;
        this.b = z2;
        this.c = z3;
        this.d = heartAndBan;
    ...
    /* synthetic */ tvt(boolean z, boolean z2, boolean z3, HeartAndBan heartAndBan, LongClickAction longClickAction, boolean z4, boolean z5, boolean z6, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, byte b2) {
