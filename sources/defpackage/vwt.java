...
final class vwt implements a {
    ...
    vwt(Path path, ScheduledExecutorService scheduledExecutorService, Random random, jtz jtz, boolean z) {
    ...
    public final void a() {
        ...
        L_0x004a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vwt.a():void");
    }

    public final void a(Context context, Intent intent, String str, Object... objArr) {
        String format;
        if (this.j == null) {
            this.j = this.e.scheduleWithFixedDelay(new $$Lambda$lZ5xMmndJ2wkQX2uevv_aj3zGcQ(this), 20, 300, TimeUnit.SECONDS);
        }
        long c2 = this.f.c();
        ...
        synchronized (this.g) {
            while (true) {
                ...
                if (!this.h.containsKey(format)) {
                    ...
                    this.k = c2;
                    ScheduledFuture schedule = this.e.schedule(new $$Lambda$vwt$wV_0JVco7oCgvvbpzpaRPDmXFls(this, format, str, objArr), 2, TimeUnit.SECONDS);
                    this.h.put(format, ho.a(schedule, this.e.schedule(new $$Lambda$vwt$v3Po7i_HVdJ12ZHUWK_GXZ8yDeg(this, schedule), 8, TimeUnit.SECONDS)));
                } else {
    ...
    public final void a(Intent intent) {
        ...
        if (intent != null) {
            ...
            if (stringExtra != null && !stringExtra.isEmpty()) {
                ...
                this.e.execute(new $$Lambda$vwt$LK45YCFFiZOZprd_D0RCUA8eBJs(this, stringExtra));
            }
        }
    }
}
