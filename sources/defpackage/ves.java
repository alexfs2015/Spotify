...
public final class ves {
    ...
    /* renamed from: ves$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ves.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public static Drawable a(ShuffleState shuffleState, Context context) {
        ...
        if (i == 1) {
            return vdd.h(context);
        }
        if (i == 2) {
            return vdd.i(context);
        }
        if (i == 3) {
            return vdd.j(context);
        }
