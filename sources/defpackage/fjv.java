...
public class fjv implements Closeable {
    ...
    static {
        fix.a = new fix() {
            public final void a(fjv fjv) {
                if (fjv instanceof fjg) {
                    fjg fjg = (fjg) fjv;
                    fjg.a(JsonToken.NAME);
                    Entry entry = (Entry) ((Iterator) fjg.g()).next();
                    fjg.a(entry.getValue());
                    fjg.a((Object) new fil((String) entry.getKey()));
                    return;
                }
                int i = fjv.b;
                if (i == 0) {
    ...
    private java.lang.String t() {
        ...
        L_0x0095:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fjv.t():java.lang.String");
    }
