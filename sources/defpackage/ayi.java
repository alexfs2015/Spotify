...
public final class ayi {
    ...
    public ayi() {
        ...
        this.h = new int[i2];
        this.g = new int[i2];
        this.j = new defpackage.atu.a[i2];
        this.k = new aqv[i2];
    ...
    public final synchronized int a(long r9, boolean r11, boolean r12) {
        ...
        L_0x0039:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ayi.a(long, boolean, boolean):int");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized int a(defpackage.aqw r5, defpackage.asm r6, boolean r7, boolean r8, defpackage.aqv r9, defpackage.ayi.a r10) {
        /*
            r4 = this;
            monitor-enter(r4)
        ...
        L_0x0042:
            ...
            atu$a[] r5 = r4.j     // Catch:{ all -> 0x006f }
            r5 = r5[r8]     // Catch:{ all -> 0x006f }
        ...
        L_0x006f:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ayi.a(aqw, asm, boolean, boolean, aqv, ayi$a):int");
    }

    public final long a(int i2) {
        int a2 = a() - i2;
        bdl.a(a2 >= 0 && a2 <= this.l - this.c);
        this.l -= a2;
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void a(long r6, int r8, long r9, int r11, defpackage.atu.a r12) {
        /*
            r5 = this;
            monitor-enter(r5)
        ...
        L_0x0015:
            r0 = 0
        L_0x0016:
            defpackage.bdl.b(r0)     // Catch:{ all -> 0x00d2 }
            ...
            atu$a[] r6 = r5.j     // Catch:{ all -> 0x00d2 }
            r6[r0] = r12     // Catch:{ all -> 0x00d2 }
            aqv[] r6 = r5.k     // Catch:{ all -> 0x00d2 }
            aqv r7 = r5.r     // Catch:{ all -> 0x00d2 }
            ...
            atu$a[] r12 = new defpackage.atu.a[r6]     // Catch:{ all -> 0x00d2 }
            aqv[] r0 = new defpackage.aqv[r6]     // Catch:{ all -> 0x00d2 }
        ...
        L_0x00d2:
            ...
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ayi.a(long, int, long, int, atu$a):void");
    }
    ...
    public final synchronized boolean a(long r8) {
        ...
        L_0x004e:
            goto L_0x004d
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ayi.a(long):boolean");
    }

    public final synchronized boolean a(aqv aqv) {
        if (aqv == null) {
            this.q = true;
            return false;
        }
        this.q = false;
        if (ben.a((Object) aqv, (Object) this.r)) {
            return false;
        }
        this.r = aqv;
        return true;
    ...
    public final synchronized long b(long r10, boolean r12, boolean r13) {
        ...
        L_0x0038:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.ayi.b(long, boolean, boolean):long");
    }
    ...
    public final synchronized aqv d() {
        if (this.q) {
            return null;
        }
        return this.r;
