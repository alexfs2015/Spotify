...
public final class twl implements twk {
    ...
    private final uwe m = new uwe((ViewGroup) this.a.findViewById(R.id.accessory));
    private final int n;

    public twl(View view) {
        this.a = view;
        uui.c(this.h).b(this.h).a();
        uui.c(this.i).b(this.i).a();
        Context context = view.getContext();
        uuu.b(context, this.d, R.attr.pasteTextAppearanceBodySmall);
        this.d.setTextColor(fr.c(context, R.color.glue_row_subtitle_color));
        if (jtc.c(this.a.getContext())) {
            this.n = 400;
        } else {
            this.n = 160;
        }
