...
public final class xac<T> extends xae<T, T> {
    public final SubjectSubscriptionManager<T> a;

    public static <T> xac<T> e() {
        return a(null, false);
    }

    public static <T> xac<T> a(T t, boolean z) {
        final SubjectSubscriptionManager subjectSubscriptionManager = new SubjectSubscriptionManager();
        if (z) {
            subjectSubscriptionManager.latest = NotificationLite.a(t);
        }
        subjectSubscriptionManager.onAdded = new wun<b<T>>() {
            ...
            public final /* synthetic */ void call(java.lang.Object r3) {
                /*
                    ...
                    boolean r1 = r3.c     // Catch:{ all -> 0x0022 }
                ...
                L_0x0022:
                    ...
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: defpackage.xac.AnonymousClass1.call(java.lang.Object):void");
            }
        };
        subjectSubscriptionManager.onTerminated = subjectSubscriptionManager.onAdded;
        return new xac<>(subjectSubscriptionManager, subjectSubscriptionManager);
    }

    private xac(a<T> aVar, SubjectSubscriptionManager<T> subjectSubscriptionManager) {
        super(aVar);
