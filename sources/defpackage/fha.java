...
public final class fha implements ServiceConnection {
    private final Context a;
    private final Intent b;
    private final ScheduledExecutorService c;
    private final Queue<fgw> d;
    private fgy e;
    private boolean f;

    public fha(Context context, String str) {
        this(context, str, new ScheduledThreadPoolExecutor(0, new bzu("Firebase-FirebaseInstanceIdServiceConnection")));
    }

    private fha(Context context, String str, ScheduledExecutorService scheduledExecutorService) {
    ...
    public final synchronized void a(Intent intent, PendingResult pendingResult) {
        ...
        this.d.add(new fgw(intent, pendingResult, this.c));
        a();
    }
    ...
    private final synchronized void a() {
        ...
        L_0x0007:
            java.util.Queue<fgw> r0 = r5.d     // Catch:{ all -> 0x00b7 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00b7 }
            if (r0 != 0) goto L_0x00b5
            java.lang.String r0 = "EnhancedIntentService"
            android.util.Log.isLoggable(r0, r1)     // Catch:{ all -> 0x00b7 }
            fgy r0 = r5.e     // Catch:{ all -> 0x00b7 }
            ...
            fgw r0 = (defpackage.fgw) r0     // Catch:{ all -> 0x00b7 }
            fgy r2 = r5.e     // Catch:{ all -> 0x00b7 }
        ...
        L_0x004c:
            ...
            fgz r4 = new fgz     // Catch:{ all -> 0x00b7 }
        ...
        L_0x0086:
            ...
            bzb r0 = defpackage.bzb.a()     // Catch:{ SecurityException -> 0x00a6 }
        ...
        L_0x00bb:
            goto L_0x00ba
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.fha.a():void");
    }
