...
public final class eqs extends eur {
    private final eqt a = new eqt(this, m(), "google_app_measurement_local.db");
    private boolean b;
    ...
    public final boolean a(int r18, byte[] r19) {
        ...
        L_0x005f:
            ...
            eqw r5 = r17.q()     // Catch:{ SQLiteFullException -> 0x005b, SQLiteDatabaseLockedException -> 0x00b8, SQLiteException -> 0x0059, all -> 0x0056 }
            eqy r5 = r5.c     // Catch:{ SQLiteFullException -> 0x005b, SQLiteDatabaseLockedException -> 0x00b8, SQLiteException -> 0x0059, all -> 0x0056 }
        ...
        L_0x00dd:
            eqw r3 = r17.q()     // Catch:{ all -> 0x00f4 }
            eqy r3 = r3.c     // Catch:{ all -> 0x00f4 }
        ...
        L_0x010a:
            ...
            r10 = r8
        L_0x010d:
            eqw r3 = r17.q()     // Catch:{ all -> 0x0129 }
            eqy r3 = r3.c     // Catch:{ all -> 0x0129 }
        ...
        L_0x0136:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eqs.a(int, byte[]):boolean");
    }

    /* JADX WARNING: type inference failed for: r3v0 */
    /* JADX WARNING: type inference failed for: r3v1, types: [java.util.List<bxf>] */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List<defpackage.bxf> v() {
        /*
            r20 = this;
            r1 = r20
        ...
        L_0x0075:
            ...
            android.os.Parcelable$Creator<eqk> r0 = defpackage.eqk.CREATOR     // Catch:{ ParseException -> 0x00a7 }
            java.lang.Object r0 = r0.createFromParcel(r14)     // Catch:{ ParseException -> 0x00a7 }
            eqk r0 = (defpackage.eqk) r0     // Catch:{ ParseException -> 0x00a7 }
        ...
        L_0x00a5:
            ...
            goto L_0x00b6
        L_0x00a7:
            eqw r0 = r20.q()     // Catch:{ all -> 0x00a5 }
            eqy r0 = r0.c     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00ba:
            ...
            android.os.Parcelable$Creator<evj> r0 = defpackage.evj.CREATOR     // Catch:{ ParseException -> 0x00d7 }
            java.lang.Object r0 = r0.createFromParcel(r15)     // Catch:{ ParseException -> 0x00d7 }
            evj r0 = (defpackage.evj) r0     // Catch:{ ParseException -> 0x00d7 }
        ...
        L_0x00d5:
            ...
            goto L_0x00ea
        L_0x00d7:
            eqw r0 = r20.q()     // Catch:{ all -> 0x00d5 }
            eqy r0 = r0.c     // Catch:{ all -> 0x00d5 }
        ...
        L_0x00ee:
            ...
            android.os.Parcelable$Creator<evu> r0 = defpackage.evu.CREATOR     // Catch:{ ParseException -> 0x0109 }
            java.lang.Object r0 = r0.createFromParcel(r15)     // Catch:{ ParseException -> 0x0109 }
            evu r0 = (defpackage.evu) r0     // Catch:{ ParseException -> 0x0109 }
            r15.recycle()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            goto L_0x0116
        L_0x0107:
            r0 = move-exception
            goto L_0x011d
        L_0x0109:
            eqw r0 = r20.q()     // Catch:{ all -> 0x0107 }
            eqy r0 = r0.c     // Catch:{ all -> 0x0107 }
        ...
        L_0x011d:
            ...
            throw r0     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
        L_0x0121:
            eqw r0 = r20.q()     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
            eqy r0 = r0.c     // Catch:{ SQLiteFullException -> 0x0165, SQLiteDatabaseLockedException -> 0x0162, SQLiteException -> 0x0160 }
        ...
        L_0x0191:
            eqw r5 = r20.q()     // Catch:{ all -> 0x01a7 }
            eqy r5 = r5.c     // Catch:{ all -> 0x01a7 }
        ...
        L_0x01c0:
            ...
            r15 = 0
        L_0x01c3:
            eqw r5 = r20.q()     // Catch:{ all -> 0x01de }
            eqy r5 = r5.c     // Catch:{ all -> 0x01de }
        ...
        L_0x01ec:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.eqs.v():java.util.List");
    }
