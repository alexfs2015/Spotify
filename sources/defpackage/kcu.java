...
public final class kcu extends WazeBannerModel {
    ...
    public static final class a extends com.spotify.mobile.android.waze.model.WazeBannerModel.a {
        ...
        public final WazeBannerModel a() {
            ...
            if (str.isEmpty()) {
                kcu kcu = new kcu(this.a, this.b.intValue(), this.c.intValue(), this.d, this.e, this.f, this.g, this.h, this.i, 0);
                return kcu;
            }
    ...
    /* synthetic */ kcu(Type type, int i2, int i3, String str, String str2, String str3, String str4, String str5, String str6, byte b2) {
        this(type, i2, i3, str, str2, str3, str4, str5, str6);
    }

    private kcu(Type type, int i2, int i3, String str, String str2, String str3, String str4, String str5, String str6) {
        this.a = type;
        this.b = i2;
        this.c = i3;
        this.d = str;
