...
public final class udy {
    ...
    private final defpackage.uea.a e;
    ...
    public static class a {
        ...
        public static udy a(TextView textView, String str, defpackage.uea.a aVar) {
            return new udy((TextView) a(textView, 1), (String) a(str, 2), (defpackage.uea.a) a(aVar, 3));
        }
    }

    public udy(TextView textView, String str, defpackage.uea.a aVar) {
        this.b = textView;
        this.c = str;
    ...
    private void a(CharSequence charSequence, SpannableStringBuilder spannableStringBuilder) {
        ...
        spannableStringBuilder.setSpan(new uea(this.e, charSequence), spannableStringBuilder.length() - this.c.length(), spannableStringBuilder.length(), 33);
    }
