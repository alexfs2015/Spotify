...
public final class ilk {
    ...
    /* renamed from: ilk$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.ilk.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    /* renamed from: ilk$b */
    public final class b implements wgx {
        final Uri a;
        final int b;
        final int c;
        ...
        public final void a() {
            if (this.h) {
                ...
                this.g = true;
                this.f.b();
                synchronized (ilk.this.b) {
                    ilk.this.b.remove(this);
                }
            }
        }
    ...
    public /* synthetic */ void a(Uri uri, b bVar, a aVar) {
        try {
            ...
            ilk.this.a.a(bVar.a).a((wgz) new c(bVar.c, bVar.b)).a((wgx) bVar);
        } catch (Exception e) {
    ...
    public final void a(Uri uri, ImageFormat imageFormat, int i, int i2, boolean z, a aVar) {
        ...
        this.d.post(new $$Lambda$ilk$72Z87zozqrvfH7nRNN8bB7MlDsw(this, uri, bVar, aVar));
    }
}
