...
public final class amw {
    ...
    public static int a(java.io.InputStream r6, java.io.OutputStream r7) {
        ...
        L_0x0031:
            goto L_0x0030
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.amw.a(java.io.InputStream, java.io.OutputStream):int");
    }
    ...
    public static boolean b(android.net.Uri r2) {
        ...
        L_0x0028:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.amw.b(android.net.Uri):boolean");
    }
    ...
    public static long e(Uri uri) {
        Cursor cursor = null;
        try {
            cursor = akc.g().getContentResolver().query(uri, null, null, null, null);
    ...
    public static boolean a(aju aju) {
        return aju != null && aju.equals(aju.a());
    }

    public static void a(final String str, final a aVar) {
        JSONObject a2 = amt.a(str);
        if (a2 != null) {
            aVar.a(a2);
            return;
        }
        AnonymousClass1 r0 = new defpackage.akd.b() {
    ...
    private static akd f(String str) {
        Bundle bundle = new Bundle();
        bundle.putString("fields", "id,name,first_name,middle_name,last_name,link");
        bundle.putString("access_token", str);
        akd akd = new akd(null, "me", bundle, HttpMethod.GET, null);
        return akd;
    }
    ...
    public static Locale a() {
        try {
            return akc.g().getResources().getConfiguration().locale;
        } catch (Exception unused) {
            return Locale.getDefault();
        }
    }

    public static void a(JSONObject jSONObject, alu alu, String str, boolean z) {
        if (!(alu == null || alu.a == null)) {
            jSONObject.put("attribution", alu.a);
        }
        if (!(alu == null || alu.a() == null)) {
            jSONObject.put(Ad.METADATA_ADVERTISER_ID, alu.a());
            jSONObject.put("advertiser_tracking_enabled", !alu.c);
        }
        if (!(alu == null || alu.b == null)) {
            jSONObject.put("installer_package", alu.b);
        }
