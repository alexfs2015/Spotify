...
public final class gaa {
    private static final wfy a = new vhi(new wgl(3276801));
    ...
    private static Drawable a(Context context, Drawable drawable, SpotifyIconV2 spotifyIconV2, float f, boolean z, boolean z2) {
        int b = z ? 0 : vgl.b(context, R.attr.pasteColorPlaceholderBackground);
        switch (spotifyIconV2) {
            case ARTIST:
            case USER:
                if (z2) {
                    return new vgu(drawable, a(f, 0.66f), b);
                }
                vgr vgr = new vgr(drawable, a(f, 0.6f));
                vgr.a(b);
                return vgr;
            case TRACK:
            case STAR:
            ...
            case MIX:
            case PODCASTS:
                return new vgu(drawable, a(f, 0.75f), b);
            case VIDEO:
                return new vgu(drawable, a(f, 0.33f), b);
            default:
                return Float.isNaN(f) ? drawable : new vgu(drawable, f, b);
        }
    }
    ...
    private static Drawable a(Context context, SpotifyIcon spotifyIcon, float f, boolean z, boolean z2) {
        return b(context, spotifyIcon.mIconV2, f, z, z2, (float) vfj.b((float) spotifyIcon.mDefaultSize, context.getResources()));
    }
    ...
    public static Drawable a(Context context, SpotifyIconV2 spotifyIconV2) {
        return a(context, (Drawable) b(context, spotifyIconV2, (float) vfj.b(32.0f, context.getResources())), spotifyIconV2, Float.NaN, true, false);
    }
    ...
    private static SpotifyIconDrawable c(Context context, SpotifyIcon spotifyIcon) {
        return b(context, spotifyIcon.mIconV2, (float) vfj.b((float) spotifyIcon.mDefaultSize, context.getResources()));
    }
