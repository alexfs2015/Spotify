...
public final class eke {
    ...
    private static volatile ekg d = ekf.a;
    private final JobScheduler a;

    private eke(JobScheduler jobScheduler) {
        this.a = jobScheduler;
    }
    ...
    public static int a(Context context, JobInfo jobInfo, String str, String str2) {
        ...
        return (b == null || !d.a() || context.checkSelfPermission("android.permission.UPDATE_DEVICE_STATS") != 0) ? jobScheduler.schedule(jobInfo) : new eke(jobScheduler).a(jobInfo, str, d(), str2);
    }
