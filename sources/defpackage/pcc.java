...
public final class pcc extends pci {
    private final int a;
    ...
    public pcc(int i2, String str, String str2, int i3, int i4, String str3, String str4, String str5, String str6, String str7, boolean z, String str8, Map<String, String> map, int i5, boolean z2) {
        this.a = i2;
        if (str != null) {
            this.b = str;
            if (str2 != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof pci) {
            pci pci = (pci) obj;
            if (this.a == pci.a() && this.b.equals(pci.b()) && this.c.equals(pci.c()) && this.d == pci.d() && this.e == pci.e() && this.f.equals(pci.f()) && this.g.equals(pci.g())) {
                String str = this.h;
                if (str != null ? str.equals(pci.h()) : pci.h() == null) {
                    return this.i.equals(pci.i()) && this.j.equals(pci.j()) && this.k == pci.k() && this.l.equals(pci.l()) && this.m.equals(pci.m()) && this.n == pci.n() && this.o == pci.o();
                }
            }
        }
    }
