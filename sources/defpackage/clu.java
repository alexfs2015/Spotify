...
public final class clu {
    public final long a;
    public final Map<String, ecq> b = new HashMap();
    public String c;
    public String d;
    public boolean e;
    ...
    public clu(String str, long j) {
        ...
        if (!TextUtils.isEmpty(str)) {
            try {
                            ...
                            if (!TextUtils.isEmpty(optString2)) {
                                if ("interstitial".equalsIgnoreCase(optString)) {
                                    ...
                                    if (optJSONObject != null) {
                                        this.b.put(optString2, new ecq(optJSONObject));
                                    }
                                }
                            }
                        }
                ...
                cpn.a(5);
                bkc.i().a((Throwable) e2, "AppSettings.parseAppSettingsJson");
            }
        }
    }
}
