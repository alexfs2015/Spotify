...
public final class jzb {
    public static CharSequence a(Context context, CharSequence charSequence, String str, int i) {
        fbp.a(i == 0 || i <= charSequence.length(), (Object) "Label position is outside of text bounds");
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder();
        CharSequence b = jun.b(charSequence.subSequence(0, i));
        CharSequence b2 = jun.b(charSequence.subSequence(i, charSequence.length()));
        ...
        spannableStringBuilder.setSpan(new fzx(context, vfj.b(3.0f, context.getResources())), i, str.length() + i, 33);
