...
public final class ink {
    ...
    private final gmm<Response> b;
    private final String c;
    private final xil d;

    public ink(Context context, gmm<Response> gmm, xil xil) {
        this.b = gmm;
    ...
    public final xii<Queue<ContentItem>> a() {
        xii c2 = this.b.resolve(RequestBuilder.get(new Builder().scheme("hm").authority("webapi-browse").path("v1/browse/featured-playlists").appendQueryParameter("timestamp", ((SimpleDateFormat) a.get()).format(new Date())).build().toString()).build()).e((xiy<? super T, ? extends R>) new $$Lambda$ink$2e9iww3ppgVeUw5EbWdfbzTPUQ<Object,Object>(this)).c();
        hhs hhs = new hhs(20, 3, 1000, this.d);
        return c2.a((c<? super T, ? extends R>) hhs);
    }
}
