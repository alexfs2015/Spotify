...
public final class nck implements wig<JacksonResponseParser<HubsJsonViewModel>> {
    private final wzi<ObjectMapper> a;
    private final wzi<Scheduler> b;

    private nck(wzi<ObjectMapper> wzi, wzi<Scheduler> wzi2) {
        this.a = wzi;
        this.b = wzi2;
    }

    public static nck a(wzi<ObjectMapper> wzi, wzi<Scheduler> wzi2) {
        return new nck(wzi, wzi2);
    }
