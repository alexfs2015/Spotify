    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.jgx.AnonymousClass1.<clinit>():void");
        }
    }

    private jgx(AuthorizationRequest authorizationRequest) {
        this.a = authorizationRequest;
    }

    public jgx(String str, ResponseType responseType, String str2, ClientIdentity clientIdentity, String str3, String[] strArr, boolean z) {
        this.a = AuthorizationRequest.a(str, responseType, str2, clientIdentity, null, strArr, false);
    }

    public static jgx a(AuthorizationRequest authorizationRequest) {
        return new jgx(authorizationRequest);
    }

    public final Uri a() {
        Builder builder = new Builder();
        Builder appendQueryParameter = builder.scheme("https").authority(jgu.a()).appendPath(gor.a(Locale.getDefault())).appendPath("authorize").appendQueryParameter("client_id", this.a.c());
        ...
        if (this.a.f() != null) {
            ClientIdentity clientIdentity = (ClientIdentity) fbp.a(this.a.f());
            builder.appendQueryParameter("client_app_id", String.format("%s:%s", new Object[]{clientIdentity.a, clientIdentity.b}));
        }
        String[] a2 = this.a.a();
        if (a2.length > 0) {
            builder.appendQueryParameter("scope", fbl.a(" ").a((Object[]) a2));
        }
