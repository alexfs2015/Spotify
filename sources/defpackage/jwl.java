...
public final class jwl {
    private static final List<jwk> a = new ArrayList();
    ...
    static {
        ...
        a.add(new a("wrapped_data_stories").a("spotify:datastories:wrapped").b("^([Ss][Pp][Oo][Tt][Ii][Ff][Yy]:datastories:wrapped)$").a(LinkType.WRAPPED_DATA_STORIES).a(false).c("soma").d("Native integration for Wrapped Datastories marketing campaign").a());
        ...
        b.addURI(str12, "datastories/wrapped", LinkType.WRAPPED_DATA_STORIES.ordinal());
    ...
    public static jwk a(LinkType linkType) {
        for (jwk jwk : a) {
            if (linkType == jwk.b) {
                return jwk;
            }
