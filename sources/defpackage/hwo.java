...
final class hwo extends hwq {
    ...
    hwo(String str, CharSequence charSequence, Map<String, String> map, hwu hwu, Uri uri, PlayOrigin playOrigin, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, boolean z6, ThumbState thumbState, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, boolean z12, boolean z13) {
        String str2 = str;
        Uri uri2 = uri;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof hwq) {
            hwq hwq = (hwq) obj;
            if (this.a.equals(hwq.a())) {
                CharSequence charSequence = this.b;
                if (charSequence != null ? charSequence.equals(hwq.b()) : hwq.b() == null) {
                    Map<String, String> map = this.c;
                    if (map != null ? map.equals(hwq.c()) : hwq.c() == null) {
                        return this.d.equals(hwq.d()) && this.e.equals(hwq.e()) && this.f.equals(hwq.f()) && this.g == hwq.g() && this.h == hwq.h() && this.i == hwq.i() && this.j == hwq.j() && this.k == hwq.k() && this.l == hwq.l() && this.m.equals(hwq.m()) && this.n == hwq.n() && this.o == hwq.o() && this.p == hwq.p() && this.q == hwq.q() && this.r == hwq.r() && this.s == hwq.s() && this.t == hwq.t();
                    }
                }
            }
        }
