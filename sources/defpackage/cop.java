...
public final class cop {
                ...
                if (!e.contains(str)) {
                    ...
                    if (!(entry.getValue() instanceof List)) {
                        if (!(entry.getValue() instanceof String)) {
                            cow.a("Connection headers should be either Map<String, String> or Map<String, List<String>>");
                            break;
                        }
    ...
    private final void a(String str, cov cov) {
    ...
    static final /* synthetic */ void a(String str, String str2, Map map, byte[] bArr, JsonWriter jsonWriter) {
        ...
        a(jsonWriter, map);
        if (bArr != null) {
            jsonWriter.name("body").value(bze.a(bArr));
        }
        jsonWriter.endObject();
    }
    ...
    private final void b(String str, String str2, Map<String, ?> map, byte[] bArr) {
        a("onNetworkRequest", (cov) new coq(str, str2, map, bArr));
    }
    ...
    public final void a(Map<String, ?> map, int i) {
        a("onNetworkResponse", (cov) new cos(i, map));
    }

    public final void a(byte[] bArr) {
        a("onNetworkResponseBody", (cov) new cot(bArr));
    }

    /* access modifiers changed from: 0000 */
    public final void b(String str) {
        a("onNetworkRequestError", (cov) new cou(str));
    }
