...
public final class jgq {
    public static jgp a(Uri uri) {
        ...
        if (queryParameter2 != null) {
            return "access_denied".equals(queryParameter2) ? jgp.a(ErrorMessage.ACCOUNTS_USER_DENIED, null, queryParameter) : jgp.a(ErrorMessage.ACCOUNTS_SERVICE_ERROR, queryParameter2, queryParameter);
        }
        ...
        if (encodedFragment != null && !encodedFragment.isEmpty()) {
            ...
            if (!(str == null || str2 == null)) {
                try {
                    ...
                    return jgp.a(ErrorMessage.UNKNOWN_RESPONSE_TYPE_ERROR, str3, queryParameter);
                }
            }
        }
