...
public class xdt implements Closeable {
    public static final MessageBuffer a = MessageBuffer.wrap(new byte[0]);
    private static /* synthetic */ boolean j = (!xdt.class.desiredAssertionStatus());
    ...
    /* renamed from: xdt$1 reason: invalid class name */
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0215:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: defpackage.xdt.AnonymousClass1.<clinit>():void");
        }
    }

    public xdt(MessageBufferInput messageBufferInput) {
        this(messageBufferInput, xdr.b);
    }

    private xdt(MessageBufferInput messageBufferInput, b bVar) {
        this.c = a;
        this.f = null;
        this.i = MessageBuffer.wrap(new byte[24]);
        this.g = false;
        this.b = (MessageBufferInput) xdu.a(messageBufferInput, (Object) "MessageBufferInput is null");
        this.h = (b) xdu.a(bVar, (Object) "Config");
    }
    ...
    private xeo q() {
        ...
        switch (b().a()) {
            ...
            case BOOLEAN:
                return xew.a(d());
            case INTEGER:
                return AnonymousClass1.a[b().ordinal()] != 16 ? xew.a(r()) : xew.a(s());
            case FLOAT:
                return xew.a(t());
            case STRING:
                return xew.b(c(v()));
            ...
            case ARRAY:
                int e2 = e();
                xev[] xevArr = new xev[e2];
                while (i2 < e2) {
                    xevArr[i2] = q();
                    i2++;
                }
                return xevArr.length == 0 ? xez.I() : new xez((xev[]) Arrays.copyOf(xevArr, xevArr.length));
            case MAP:
                int f2 = f() << 1;
                xev[] xevArr2 = new xev[f2];
                while (i2 < f2) {
                    xevArr2[i2] = q();
                    int i3 = i2 + 1;
                    xevArr2[i3] = q();
                ...
                return xew.a(xevArr2);
            case EXTENSION:
                xdq u = u();
                return xew.a(u.a, c(u.b));
            default:
    ...
    private BigInteger s() {
        ...
        switch (j2) {
            ...
            case -50:
                int m = m();
                return m < 0 ? BigInteger.valueOf(((long) (m & Integer.MAX_VALUE)) + 2147483648L) : BigInteger.valueOf((long) m);
            case -49:
                long o = o();
