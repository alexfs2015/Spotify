...
public class ArrayBufferInput implements MessageBufferInput {
    ...
    public ArrayBufferInput(MessageBuffer messageBuffer) {
        this.isRead = false;
        this.buffer = (MessageBuffer) xdu.a(messageBuffer, (Object) "input buffer is null");
    }
    ...
    public ArrayBufferInput(byte[] bArr, int i, int i2) {
        ...
        xdu.a(z);
        this.buffer = MessageBuffer.wrap((byte[]) xdu.a(bArr, (Object) "input array is null")).slice(i, i2);
    }
    ...
    public void reset(byte[] bArr) {
        reset(MessageBuffer.wrap((byte[]) xdu.a(bArr, (Object) "input array is null")));
    }

    public void reset(byte[] bArr, int i, int i2) {
        reset(MessageBuffer.wrap((byte[]) xdu.a(bArr, (Object) "input array is null")).slice(i, i2));
    }
}
