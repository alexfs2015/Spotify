...
public final class PublicSuffixDatabase {
    ...
    private java.lang.String[] a(java.lang.String[] r8) {
        ...
        L_0x0022:
            r3 = move-exception
            wob r4 = defpackage.wob.c()     // Catch:{ all -> 0x0020 }
            r5 = 5
        ...
        L_0x0056:
            ...
            r4 = r8[r3]
            java.nio.charset.Charset r5 = defpackage.wmk.d
        ...
        while (i4 < length) {
            ...
            if (i3 >= 0) {
                if (i3 <= 0) {
                    ...
                    if (length2 >= i12) {
                        if (length2 <= i12) {
                            return new String(bArr, i6, i8, wmk.d);
                        }
                    }
                }
                i4 = i2 + 1;
    ...
    private void b() {
        ...
        if (resourceAsStream != null) {
            wom a2 = wou.a((wpa) new wos(wou.a(resourceAsStream)));
            try {
