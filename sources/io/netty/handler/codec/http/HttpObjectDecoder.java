...
public abstract class HttpObjectDecoder extends wcw {
    ...
    static class a implements wha {
        ...
        public wiy a(vyv vyv) {
            int i = this.a;
            this.b.b = 0;
            int a2 = vyv.a((wha) this);
            if (a2 == -1) {
                this.a = i;
                return null;
            }
    ...
    /* access modifiers changed from: protected */
    public abstract wec a(String[] strArr);
    ...
    /* JADX INFO: used method not loaded: wea.a(java.lang.CharSequence, java.lang.Object):null, types can be incorrect */
    /* JADX INFO: used method not loaded: wem.a(wec, boolean):null, types can be incorrect */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:120:0x022c, code lost:
        if (defpackage.wem.a(r13) == false) goto L_0x0231;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:53:0x00e5, code lost:
        r0 = new defpackage.wdk(r14.v(r13));
        r12.k -= (long) r13;
        r15.add(r0);
     */
    ...
    public void a(defpackage.wav r13, defpackage.vyv r14, java.util.List<java.lang.Object> r15) {
        /*
            r12 = this;
            boolean r13 = r12.m
        ...
        L_0x002a:
            ...
            return
        L_0x0032:
            weo r13 = r12.a(r14)     // Catch:{ Exception -> 0x0040 }
        ...
        L_0x009e:
            ...
            wiy r13 = r13.a(r14)     // Catch:{ Exception -> 0x0122 }
        ...
        L_0x0158:
            ...
            wiy r13 = r13.a(r14)     // Catch:{ Exception -> 0x02b2 }
        ...
        L_0x0191:
            ...
            wec r13 = r12.a(r11)     // Catch:{ Exception -> 0x02b2 }
        ...
        L_0x019d:
            wec r13 = r12.j     // Catch:{ Exception -> 0x02a9 }
            wea r5 = r13.d()     // Catch:{ Exception -> 0x02a9 }
            io.netty.handler.codec.http.HttpObjectDecoder$a r6 = r12.h     // Catch:{ Exception -> 0x02a9 }
            wiy r6 = r6.a(r14)     // Catch:{ Exception -> 0x02a9 }
            r7 = 0
        ...
        L_0x0217:
            ...
            defpackage.wem.a(r13, r3)     // Catch:{ Exception -> 0x02a9 }
        ...
        L_0x0226:
            ...
            goto L_0x023f
        L_0x0228:
            boolean r13 = defpackage.wem.a(r13)     // Catch:{ Exception -> 0x02a9 }
        ...
        L_0x027b:
            wec r13 = r12.j     // Catch:{ Exception -> 0x02a9 }
            r15.add(r13)     // Catch:{ Exception -> 0x02a9 }
            weo r13 = defpackage.weo.a     // Catch:{ Exception -> 0x02a9 }
            r15.add(r13)     // Catch:{ Exception -> 0x02a9 }
        ...
        L_0x02ba:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.netty.handler.codec.http.HttpObjectDecoder.a(wav, vyv, java.util.List):void");
    }

    public final void b(wav wav, vyv vyv, List<Object> list) {
        super.b(wav, vyv, list);
        if (this.m) {
            f();
        }
        wec wec = this.j;
        if (wec != null) {
            boolean a2 = wem.a(wec);
            if (this.q == State.READ_VARIABLE_LENGTH_CONTENT && !vyv.f() && !a2) {
                list.add(weo.a);
                f();
            } else if (this.q == State.READ_HEADER) {
                list.add(a(vzw.a, (Exception) new PrematureChannelClosureException("Connection closed before received headers")));
                f();
            } else {
                boolean z = true;
                if (!a2 && g() <= 0) {
    ...
    /* access modifiers changed from: protected */
    public boolean a(wec wec) {
        if (wec instanceof wej) {
            wej wej = (wej) wec;
            int i2 = wej.f().b;
            if (i2 < 100 || i2 >= 200) {
            ...
            } else if (i2 != 101 || wej.d().d((CharSequence) wdy.i) || !wej.d().a((CharSequence) wdy.l, (CharSequence) wdz.c, true)) {
                return true;
            } else {
                return false;
            }
    ...
    private wec a(vyv vyv, Exception exc) {
    ...
    private wdw b(vyv vyv, Exception exc) {
        this.q = State.BAD_MESSAGE;
        vyv.w(vyv.g());
        wdq wdq = new wdq(vzw.a);
        wdq.a(wcz.a(exc));
        this.j = null;
        this.p = null;
        return wdq;
    ...
    private long g() {
        if (this.l == Long.MIN_VALUE) {
            this.l = wem.a(this.j, -1);
        }
        return this.l;
    }

    private weo a(vyv vyv) {
        wiy a2 = this.h.a(vyv);
        if (a2 == null) {
            return null;
        }
        ...
        do {
            ...
            if (charSequence == null || !(charAt == ' ' || charAt == 9)) {
                ...
                if (!wdy.b.a(charSequence2) && !wdy.k.a(charSequence2) && !wdy.j.a(charSequence2)) {
                    weo2.c().a(charSequence2, (Object) this.o);
                }
    ...
    private void a(wiy wiy) {
        int length = wiy.length();
        int a2 = a(wiy, 0);
        int i2 = a2;
        while (i2 < length) {
            char charAt = wiy.charAt(i2);
        ...
        if (a3 == length) {
            ...
            this.o = wiy.a(a3, b(wiy));
        }
    }

    private static int a(wiy wiy, int i2) {
        while (i2 < wiy.length()) {
            if (!Character.isWhitespace(wiy.a[i2])) {
                return i2;
            }
            i2++;
        }
    ...
    private static int b(wiy wiy, int i2) {
        while (i2 < wiy.length()) {
            if (Character.isWhitespace(wiy.a[i2])) {
                return i2;
            }
    ...
    private static int b(wiy wiy) {
        for (int length = wiy.length() - 1; length > 0; length--) {
            if (!Character.isWhitespace(wiy.a[length])) {
                return length + 1;
            }
        }
        return 0;
