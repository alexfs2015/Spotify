...
public final class PemX509Certificate extends X509Certificate implements wfx {
    ...
    public static defpackage.wfx a(defpackage.vyw r7, boolean r8, java.security.cert.X509Certificate... r9) {
        /*
            ...
            r8 = r9[r0]
            boolean r2 = r8 instanceof defpackage.wfx
            if (r2 == 0) goto L_0x0017
            wfx r8 = (defpackage.wfx) r8
            wfx r7 = r8.c()
            return r7
        L_0x0017:
            r8 = 0
        ...
        L_0x001b:
            ...
            boolean r5 = r4 instanceof defpackage.wfx     // Catch:{ all -> 0x0069 }
            if (r5 == 0) goto L_0x0043
            wfx r4 = (defpackage.wfx) r4     // Catch:{ all -> 0x0069 }
            int r5 = r9.length     // Catch:{ all -> 0x0069 }
            vyv r4 = r4.a()     // Catch:{ all -> 0x0069 }
            if (r3 != 0) goto L_0x0039
            int r6 = r4.g()     // Catch:{ all -> 0x0069 }
            int r6 = r6 * r5
            vyv r5 = a(r7, r1, r6)     // Catch:{ all -> 0x0069 }
            goto L_0x003a
        L_0x0039:
            r5 = r3
        L_0x003a:
            vyv r4 = r4.t()     // Catch:{ all -> 0x0069 }
            r5.a(r4)     // Catch:{ all -> 0x0069 }
            r3 = r5
            goto L_0x0048
        L_0x0043:
            int r5 = r9.length     // Catch:{ all -> 0x0069 }
            vyv r3 = a(r7, r1, r4, r5, r3)     // Catch:{ all -> 0x0069 }
        L_0x0048:
            int r8 = r8 + 1
            goto L_0x001b
        L_0x004b:
        ...
        L_0x0063:
            wfz r7 = new wfz     // Catch:{ all -> 0x0069 }
        ...
        L_0x007c:
            goto L_0x007b
        */
        throw new UnsupportedOperationException("Method not decompiled: io.netty.handler.ssl.PemX509Certificate.a(vyw, boolean, java.security.cert.X509Certificate[]):wfx");
    }
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static defpackage.vyv a(defpackage.vyw r2, boolean r3, java.security.cert.X509Certificate r4, int r5, defpackage.vyv r6) {
        /*
            byte[] r4 = r4.getEncoded()
            vyv r4 = defpackage.vzw.a(r4)
            vyv r0 = defpackage.wgh.a(r2, r4)     // Catch:{ all -> 0x0039 }
            ...
            int r6 = r6 + r1
            int r6 = r6 * r5
            vyv r6 = a(r2, r3, r6)     // Catch:{ all -> 0x0034 }
        L_0x0020:
        ...
        L_0x0039:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: io.netty.handler.ssl.PemX509Certificate.a(vyw, boolean, java.security.cert.X509Certificate, int, vyv):vyv");
    }

    private static vyv a(vyw vyw, boolean z, int i) {
        return z ? vyw.d(i) : vyw.a(i);
    }
