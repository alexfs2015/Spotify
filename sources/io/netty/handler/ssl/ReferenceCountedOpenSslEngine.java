...
public class ReferenceCountedOpenSslEngine extends SSLEngine implements wvo {
    ...
    private static final long n = Buffer.address(woc.a.v());
    ...
    final class a implements SSLSession {
        ...
        private void b() {
            ...
            if (peerCertChain == null || peerCertChain.length == 0) {
                ...
                this.b[0] = new wtx(peerCertificate);
        ...
        public final String[] getValueNames() {
            Map<String, Object> map = this.i;
            return (map == null || map.isEmpty()) ? wxg.e : (String[]) map.keySet().toArray(new String[map.size()]);
        }
    ...
    static {
        ...
        b = (SSLException) wxv.a(new SSLException(str), cls, str2);
        c = (SSLException) wxv.a(new SSLException(str), cls, "handshake()");
        d = (SSLException) wxv.a(new SSLException("renegotiation unsupported"), cls, str2);
        e = (SSLException) wxv.a(new SSLException("encrypted packet oversized"), cls, "unwrap(...)");
        l = wvq.a().a(cls);
    ...
    public ReferenceCountedOpenSslEngine(wuh wuh, wnc wnc, String str, int i2, boolean z2) {
        super(str, i2);
        wtp.b();
        this.z = z2 ? l.a(this) : null;
        this.K = (wnc) wxq.a(wnc, "alloc");
        this.M = wuh.b;
        this.t = SSL.newSSL(wuh.a, !wuh.a());
        this.O = new a(wuh.b());
        ...
        this.N = wuh.f;
        this.P = wuh.c;
        a(this.J ? ClientAuth.NONE : wuh.d);
        if (this.J && str != null) {
    ...
    private int a(ByteBuffer byteBuffer, int i2) {
        ...
        if (!byteBuffer.isDirect() || byteBuffer.remaining() < i2) {
            wnb d2 = this.K.d(i2);
            try {
                i3 = SSL.readFromBIO(this.u, wtp.a(d2), i2);
                if (i3 > 0) {
                    int limit = byteBuffer.limit();
    ...
    public String b(String str) {
        ...
        return wta.a(str, c(SSL.getVersion(this.t)));
    }
    ...
    private int c(ByteBuffer byteBuffer) {
        ...
        wnb d2 = this.K.d(min);
        try {
            int readFromSSL2 = SSL.readFromSSL(this.t, wtp.a(d2), min);
            if (readFromSSL2 > 0) {
    ...
    public final java.lang.String[] getEnabledCipherSuites() {
        /*
            ...
            java.lang.String[] r0 = defpackage.wxg.e
            return r0
        L_0x0013:
            monitor-enter(r3)
            r1 = 0
        ...
        L_0x0027:
            ...
            throw r0
        L_0x002a:
            java.lang.String[] r0 = defpackage.wxg.e     // Catch:{ all -> 0x002e }
            monitor-exit(r3)     // Catch:{ all -> 0x002e }
            return r0
        L_0x002e:
            r0 = move-exception
    ...
    public final String[] getSupportedCipherSuites() {
        Set<String> set = wtp.a;
        return (String[]) set.toArray(new String[set.size()]);
    }

    public final String[] getSupportedProtocols() {
        Set<String> set = wtp.b;
        return (String[]) set.toArray(new String[set.size()]);
    }
