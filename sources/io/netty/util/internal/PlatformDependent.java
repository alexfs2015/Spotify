...
public final class PlatformDependent {
    ...
    private static final boolean k = (!i && !wjo.a("io.netty.noPreferDirect", false));
    private static final long l = t();
    private static final long m = wjl.e();
    ...
    static final class AtomicLongCounter extends AtomicLong implements wje {
    ...
    static final class a {
        ...
        static <T> Queue<T> a(int i) {
            if (a) {
                return new wkl(1024, Math.max(Math.min(i, 1073741824), 2048), true);
            }
            return new wkx();
        }
    }
    ...
    static {
        /*
            ...
            java.lang.String r1 = defpackage.wjo.a(r1, r0)
        ...
        L_0x0047:
            ...
            boolean r3 = defpackage.wjo.a(r3, r1)
            wjw r4 = b
        ...
        L_0x0076:
            ...
            boolean r4 = defpackage.wjo.a(r3)
            if (r4 == 0) goto L_0x0083
            boolean r3 = defpackage.wjo.a(r3, r2)
            goto L_0x0089
        L_0x0083:
        ...
        L_0x00b8:
            ...
            long r3 = t()
            l = r3
            long r3 = defpackage.wjl.e()
            m = r3
            boolean r3 = u()
            n = r3
            v()
            java.lang.String r3 = "io.netty.bitMode"
            int r3 = defpackage.wjo.a(r3, r1)
        ...
        L_0x010e:
            ...
            java.lang.String r4 = defpackage.wjo.a(r4, r0)
        ...
        L_0x0161:
            ...
            java.lang.String r0 = defpackage.wjo.a(r3, r0)
            java.util.Locale r3 = java.util.Locale.US
        ...
        L_0x01c2:
            ...
            long r3 = defpackage.wjo.a(r0, r3)
            r0 = 0
            r5 = 0
    ...
    public static void a(byte[] bArr, int i2, long j2, long j3) {
        wjl.a((Object) bArr, m + ((long) i2), (Object) null, j2, j3);
    }

    public static void a(long j2, byte[] bArr, int i2, long j3) {
        wjl.a((Object) null, j2, (Object) bArr, m + ((long) i2), j3);
    }

    public static void a(byte[] bArr, int i2, long j2, byte b2) {
        wjl.a(bArr, m + ((long) i2), j2, 0);
    }
    ...
    private static File v() {
        File file;
        try {
            File a2 = a(wjo.b("io.netty.tmpdir"));
            if (a2 != null) {
                b.b("-Dio.netty.tmpdir: {}", (Object) a2);
                return a2;
            }
            File a3 = a(wjo.b("java.io.tmpdir"));
            if (a3 != null) {
        ...
        if (!i || !wjl.c()) {
            ...
            switch (i8) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    i5 = ((i7 * 461845907) + wjl.a(bArr2[i2])) * 461845907;
                    i6 = wjl.a(f(bArr2, i2 + 1));
                    break;
                case 4:
                    i5 = i7 * 461845907;
                    i6 = wjl.b(e(bArr, i2));
                ...
                case 5:
                    i5 = ((i7 * 461845907) + wjl.a(bArr2[i2])) * 461845907;
                    i6 = wjl.b(e(bArr2, i2 + 1));
                    break;
                case 6:
                    i5 = ((i7 * 461845907) + wjl.a(f(bArr, i2))) * 461845907;
                    i6 = wjl.b(e(bArr2, i2 + 2));
                    break;
                case 7:
                    i5 = ((((i7 * 461845907) + wjl.a(bArr2[i2])) * 461845907) + wjl.a(f(bArr2, i2 + 1))) * 461845907;
                    i6 = wjl.b(e(bArr2, i2 + 3));
                    break;
                default:
                    return i7;
            }
    ...
    public static <T> Queue<T> c(int i2) {
        return i ? new wke(i2) : new wkw(i2);
    }

    private static boolean q() {
        boolean z = false;
        try {
            Class.forName("android.app.Application", false, wjl.g());
            z = true;
        } catch (Throwable unused) {
        }
        if (z) {
    ...
    private static long t() {
        /*
            ...
            java.lang.ClassLoader r6 = defpackage.wjl.g()     // Catch:{ all -> 0x0024 }
        ...
        L_0x002a:
            ...
            java.lang.ClassLoader r8 = defpackage.wjl.g()     // Catch:{ all -> 0x00ad }
            ...
            java.lang.ClassLoader r9 = defpackage.wjl.g()     // Catch:{ all -> 0x00ad }
    ...
    private static boolean u() {
        ...
        boolean a2 = wjo.a("io.netty.noJavassist", false);
        ...
        try {
            wjd.a(Object.class, wjl.a(PlatformDependent.class));
