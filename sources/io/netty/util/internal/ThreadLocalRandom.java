...
public final class ThreadLocalRandom extends Random {
    ...
    public static final wjw a = wjx.a(ThreadLocalRandom.class);
    ...
    private static long e() {
        ...
        } while (!b.compareAndSet(j, j3));
        if (j == f && a.b()) {
            if (g != f) {
                a.b(String.format("-Dio.netty.initialSeedUniquifier: 0x%016x (took %d ms)", new Object[]{Long.valueOf(j2), Long.valueOf(TimeUnit.NANOSECONDS.toMillis(g - f))}));
            } else {
                a.b(String.format("-Dio.netty.initialSeedUniquifier: 0x%016x", new Object[]{Long.valueOf(j2)}));
            }
        }
