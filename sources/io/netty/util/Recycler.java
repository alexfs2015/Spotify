...
public abstract class Recycler<T> {
    private static final wyc a = wyd.a(Recycler.class);
    ...
    private static final int g = Math.max(2, wxu.a("io.netty.recycler.maxSharedCapacityFactor", 2));
    private static final int h = Math.max(0, wxu.a("io.netty.recycler.maxDelayedQueuesPerThread", Runtime.getRuntime().availableProcessors() << 1));
    /* access modifiers changed from: private */
    public static final int i = wxm.b(Math.max(wxu.a("io.netty.recycler.linkCapacity", 16), 16));
    private static final int j = wxm.b(wxu.a("io.netty.recycler.ratio", 8));
    /* access modifiers changed from: private */
    public static final wwg<Map<c<?>, WeakOrderQueue>> p = new wwg<Map<c<?>, WeakOrderQueue>>() {
    ...
    static final class a<T> implements b<T> {
        ...
        public final void a(java.lang.Object r5) {
            ...
            L_0x004b:
                ...
                throw r5
            L_0x0053:
                wwg r1 = io.netty.util.Recycler.p
    ...
    static {
        ...
        int i2 = 32768;
        int a2 = wxu.a("io.netty.recycler.maxCapacityPerThread", wxu.a("io.netty.recycler.maxCapacity", 32768));
        if (a2 >= 0) {
            i2 = a2;
        }
        e = i2;
    ...
    public final T a() {
        /*
            ...
            return r0
        L_0x000b:
            wwg<io.netty.util.Recycler$c<T>> r0 = r10.o
