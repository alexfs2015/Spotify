...
public class ResourceLeakDetector<T> {
    ...
    private static final wyc d = wyd.a(ResourceLeakDetector.class);
    ...
    final class a extends PhantomReference<Object> implements wvp {
    ...
    static {
        ...
        String upperCase = wxu.a(str2, wxu.a("io.netty.leakDetectionLevel", (z ? Level.DISABLED : a).name()).trim().toUpperCase()).trim().toUpperCase();
        Level level = a;
    ...
    private void a(String str) {
        d.c("LEAK: {}.release() was not called before it's garbage-collected. Enable advanced leak reporting to find out where the leak occurred. To enable advanced leak reporting, specify the JVM option '-D{}={}' or call {}.setLevel() See http://netty.io/wiki/reference-counted-objects.html for more information.", str, "io.netty.leakDetection.level", Level.ADVANCED.name().toLowerCase(), wxt.a((Object) this));
    }
