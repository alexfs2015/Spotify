...
public final class DefaultChannelId implements ChannelId {
    ...
    static {
        ...
        a = wjx.a(cls);
        String b2 = wjo.b("io.netty.processId");
        int i2 = -1;
        if (b2 != null) {
            try {
        ...
        d = i2;
        byte[] bArr2 = null;
        String b3 = wjo.b("io.netty.machineId");
        if (b3 != null) {
        ...
        if (bArr == null) {
            ...
            if (bArr == null) {
                ...
                a.c("Failed to find a usable hardware address from the network interfaces; using random bytes: {}", (Object) wjf.a(bArr));
            }
            if (a.b()) {
                a.b("-Dio.netty.machineId: {} (auto-detected)", (Object) wjf.a(bArr));
            }
        }
        c = bArr;
    }
    ...
    private static int c() {
        ...
        try {
            ...
            str = (String) cls2.getMethod("getName", wja.d).invoke(cls.getMethod("getRuntimeMXBean", wja.d).invoke(null, wja.c), wja.c);
        } catch (Exception e2) {
            a.b("Could not invoke ManagementFactory.getRuntimeMXBean().getName(); Android?", (Throwable) e2);
            try {
                str = Class.forName("android.os.Process", true, a2).getMethod("myPid", wja.d).invoke(null, wja.c).toString();
            } catch (Exception e3) {
    ...
    public final String a() {
        ...
        String a2 = vza.a(this.data, 24, 4);
        this.f = a2;
        return a2;
    }
