...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    private static <T> Observable<T> b(ObservableSource<? extends T> observableSource, ObservableSource<? extends T> observableSource2) {
        ObjectHelper.a(observableSource, "source1 is null");
        ObjectHelper.a(observableSource2, "source2 is null");
        return b((ObservableSource<? extends T>[]) new ObservableSource[]{observableSource, observableSource2});
    }

    private static <T> Observable<T> b(ObservableSource<? extends T>... observableSourceArr) {
    ...
    private static <T> Observable<T> a(T... tArr) {
        ...
        return RxJavaPlugins.a((Observable<T>) new ObservableFromArray<T>(tArr));
    }
    ...
    public static <T> Observable<T> b(ObservableSource<T> observableSource) {
        ...
        return RxJavaPlugins.a((Observable<T>) new ObservableFromUnsafeSource<T>(observableSource));
    }
    ...
    public final Observable<T> c(ObservableSource<? extends T> observableSource) {
        ...
        return b((ObservableSource<? extends T>) this, observableSource);
    }
    ...
    public final Observable<T> b(long j) {
        ...
        return RxJavaPlugins.a((Observable<T>) new ObservableSkip<T>(this, j));
    }
    ...
    public final Observable<T> b(Predicate<? super T> predicate) {
        ObjectHelper.a(predicate, "predicate is null");
        return RxJavaPlugins.a((Observable<T>) new ObservableSkipWhile<T>(this, predicate));
    }

    public final Observable<T> f(ObservableSource<? extends T> observableSource) {
        ObjectHelper.a(observableSource, "other is null");
        return b((ObservableSource<? extends T>[]) new ObservableSource[]{observableSource, this});
    }

    public final Observable<T> e(T t) {
        ObjectHelper.a(t, "item is null");
        return b((ObservableSource<? extends T>[]) new ObservableSource[]{b(t), this});
    }
    ...
    public final <R> R i(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> a(BackpressureStrategy backpressureStrategy) {
        ...
        if (i == 1) {
            return flowableFromObservable.f();
        }
        if (i == 2) {
            return flowableFromObservable.g();
        }
        if (i == 3) {
        ...
        return RxJavaPlugins.a((Flowable<T>) new FlowableOnBackpressureError<T>(flowableFromObservable));
    }
