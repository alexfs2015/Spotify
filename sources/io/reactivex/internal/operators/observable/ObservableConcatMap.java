            ...
            public final void onError(Throwable th) {
                ...
                if (ExceptionHelper.a((AtomicReference<Throwable>) concatMapDelayErrorObserver.error, th)) {
                    if (!concatMapDelayErrorObserver.tillTheEnd) {
                        concatMapDelayErrorObserver.upstream.bf_();
                    }
                        ...
                        if (this.cancelled) {
                            ...
                            try {
                                ...
                                if (z && z2) {
                                    ...
                                    try {
                                        ObservableSource observableSource = (ObservableSource) ObjectHelper.a(this.mapper.apply(bc_), "The mapper returned a null ObservableSource");
