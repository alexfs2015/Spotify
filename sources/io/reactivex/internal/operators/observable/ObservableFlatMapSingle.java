        ...
        final class InnerObserver extends AtomicReference<Disposable> implements SingleObserver<R>, Disposable {
            ...
            public final void c_(R r5) {
                ...
                L_0x0086:
                    goto L_0x0085
                */
                throw new UnsupportedOperationException("Method not decompiled: io.reactivex.internal.operators.observable.ObservableFlatMapSingle.FlatMapSingleObserver.InnerObserver.c_(java.lang.Object):void");
            }

            public final void onError(Throwable th) {
                FlatMapSingleObserver flatMapSingleObserver = FlatMapSingleObserver.this;
                flatMapSingleObserver.set.c(this);
                if (ExceptionHelper.a((AtomicReference<Throwable>) flatMapSingleObserver.errors, th)) {
                    if (!flatMapSingleObserver.delayErrors) {
                        flatMapSingleObserver.upstream.bd_();
                        flatMapSingleObserver.set.bd_();
                    }
