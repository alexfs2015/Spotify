...
public final class FlowableRefCount<T> extends Flowable<T> {
    ...
    static final class RefCountSubscriber<T> extends AtomicBoolean implements FlowableSubscriber<T>, wrh {
        ...
        RefCountSubscriber(wrg<? super T> wrg, FlowableRefCount<T> flowableRefCount, RefConnection refConnection) {
            this.downstream = wrg;
            this.parent = flowableRefCount;
    ...
    public final void a(wrg<? super T> wrg) {
        ...
        this.b.a((FlowableSubscriber<? super T>) new RefCountSubscriber<Object>(wrg, this, refConnection));
        if (z) {
