...
public final class FlowableFlattenIterable<T, R> extends AbstractFlowableWithUpstream<T, R> {
    ...
    static final class FlattenIterableSubscriber<T, R> extends BasicIntQueueSubscription<R> implements FlowableSubscriber<T> {
        ...
        FlattenIterableSubscriber(xfl<? super R> xfl, Function<? super T, ? extends Iterable<? extends R>> function, int i) {
            this.downstream = xfl;
        ...
        private boolean a(boolean z, boolean z2, xfl<?> xfl, SimpleQueue<?> simpleQueue) {
            if (this.cancelled) {
                this.current = null;
                simpleQueue.e();
                return true;
        ...
        private void b() {
            ...
            L_0x001a:
                ...
                boolean r9 = r1.done
                java.lang.Object r10 = r3.ba_()     // Catch:{ all -> 0x0062 }
        ...
        public final R ba_() {
            ...
            while (true) {
                ...
                if (ba_ != null) {
                    it = ((Iterable) this.mapper.apply(ba_)).iterator();
                    if (it.hasNext()) {
                        this.current = it;
                        break;
                    }
    ...
    public final void a(xfl<? super R> xfl) {
        if (this.b instanceof Callable) {
            try {
                ...
                try {
                    FlowableFromIterable.a(xfl, ((Iterable) this.c.apply(call)).iterator());
                } catch (Throwable th) {
                    Exceptions.b(th);
            ...
            this.b.a((FlowableSubscriber<? super T>) new FlattenIterableSubscriber<Object>(xfl, this.c, this.d));
        }
    }
}
