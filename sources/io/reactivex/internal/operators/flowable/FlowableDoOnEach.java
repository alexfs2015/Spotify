...
public final class FlowableDoOnEach<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class DoOnEachSubscriber<T> extends BasicFuseableSubscriber<T, T> {
        ...
        DoOnEachSubscriber(xfl<? super T> xfl, Consumer<? super T> consumer, Consumer<? super Throwable> consumer2, Action action, Action action2) {
            super(xfl);
            this.f = consumer;
            this.g = consumer2;
            this.h = action;
    ...
    public final void a(xfl<? super T> xfl) {
        if (xfl instanceof ConditionalSubscriber) {
            ...
            DoOnEachConditionalSubscriber doOnEachConditionalSubscriber = new DoOnEachConditionalSubscriber((ConditionalSubscriber) xfl, this.c, this.d, this.e, this.f);
            flowable.a((FlowableSubscriber<? super T>) doOnEachConditionalSubscriber);
            return;
        }
        Flowable flowable2 = this.b;
        DoOnEachSubscriber doOnEachSubscriber = new DoOnEachSubscriber(xfl, this.c, this.d, this.e, this.f);
