...
public final class FlowableBuffer<T, C extends Collection<? super T>> extends AbstractFlowableWithUpstream<T, C> {
    ...
    static final class PublisherBufferExactSubscriber<T, C extends Collection<? super T>> implements FlowableSubscriber<T>, xfm {
        private xfl<? super C> a;
        ...
        PublisherBufferExactSubscriber(xfl<? super C> xfl, int i, Callable<C> callable) {
            this.a = xfl;
            this.c = i;
            this.b = callable;
        }
    ...
    static final class PublisherBufferOverlappingSubscriber<T, C extends Collection<? super T>> extends AtomicLong implements FlowableSubscriber<T>, BooleanSupplier, xfm {
        private static final long serialVersionUID = -7370244972039324525L;
        final Callable<C> bufferSupplier;
        final ArrayDeque<C> buffers = new ArrayDeque<>();
        volatile boolean cancelled;
        boolean done;
        final xfl<? super C> downstream;
        int index;
        ...
        PublisherBufferOverlappingSubscriber(xfl<? super C> xfl, int i, int i2, Callable<C> callable) {
            this.downstream = xfl;
            this.size = i;
            this.skip = i2;
    ...
    static final class PublisherBufferSkipSubscriber<T, C extends Collection<? super T>> extends AtomicInteger implements FlowableSubscriber<T>, xfm {
        ...
        PublisherBufferSkipSubscriber(xfl<? super C> xfl, int i, int i2, Callable<C> callable) {
            this.downstream = xfl;
            this.size = i;
            this.skip = i2;
            this.bufferSupplier = callable;
    ...
    public final void a(xfl<? super C> xfl) {
        int i = this.c;
        int i2 = this.d;
        if (i == i2) {
            this.b.a((FlowableSubscriber<? super T>) new PublisherBufferExactSubscriber<Object>(xfl, this.c, this.e));
        } else if (i2 > i) {
            this.b.a((FlowableSubscriber<? super T>) new PublisherBufferSkipSubscriber<Object>(xfl, this.c, this.d, this.e));
        } else {
            this.b.a((FlowableSubscriber<? super T>) new PublisherBufferOverlappingSubscriber<Object>(xfl, this.c, this.d, this.e));
        }
    }
}
