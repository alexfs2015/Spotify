...
public final class UnicastProcessor<T> extends FlowableProcessor<T> {
    ...
    final AtomicReference<xfl<? super T>> c;
    volatile boolean d;
    ...
    final class UnicastQueueSubscription extends BasicIntQueueSubscription<T> {
        ...
        public final T ba_() {
            return UnicastProcessor.this.b.ba_();
        }
    ...
    private boolean a(boolean z, boolean z2, boolean z3, xfl<? super T> xfl, SpscLinkedArrayQueue<T> spscLinkedArrayQueue) {
        if (this.d) {
    ...
    public final void a(xfl<? super T> xfl) {
        if (this.l.get() || !this.l.compareAndSet(false, true)) {
            EmptySubscription.a(new IllegalStateException("This processor allows only a single Subscriber"), xfl);
            return;
        }
        xfl.a(this.e);
        this.c.set(xfl);
    ...
    public final void n() {
        /*
            ...
            return
        L_0x000b:
            java.util.concurrent.atomic.AtomicReference<xfl<? super T>> r0 = r6.c
            java.lang.Object r0 = r0.get()
            xfl r0 = (defpackage.xfl) r0
            r7 = 1
            r8 = r0
            r0 = 1
        L_0x0016:
        ...
        L_0x00dd:
            ...
            java.util.concurrent.atomic.AtomicReference<xfl<? super T>> r1 = r6.c
            java.lang.Object r1 = r1.get()
            r8 = r1
            xfl r8 = (defpackage.xfl) r8
            r7 = 1
            goto L_0x0016
        L_0x00f2:
            return
