...
public final class PublishProcessor<T> extends FlowableProcessor<T> {
    ...
    static final class PublishSubscription<T> extends AtomicLong implements xfm {
        private static final long serialVersionUID = 3562861878281475070L;
        final xfl<? super T> downstream;
        final PublishProcessor<T> parent;

        PublishSubscription(xfl<? super T> xfl, PublishProcessor<T> publishProcessor) {
            this.downstream = xfl;
    ...
    public final void a(xfl<? super T> xfl) {
        boolean z;
        boolean z2;
        PublishSubscription publishSubscription = new PublishSubscription(xfl, this);
        xfl.a(publishSubscription);
        while (true) {
