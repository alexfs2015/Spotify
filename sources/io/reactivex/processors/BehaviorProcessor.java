...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    static final class BehaviorSubscription<T> extends AtomicLong implements NonThrowingPredicate<Object>, xfm {
        ...
        BehaviorSubscription(xfl<? super T> xfl, BehaviorProcessor<T> behaviorProcessor) {
            this.downstream = xfl;
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final void a(defpackage.xfl<? super T> r8) {
        /*
            r7 = this;
        ...
        L_0x0085:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.reactivex.processors.BehaviorProcessor.a(xfl):void");
    }
