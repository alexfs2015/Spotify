...
public final class SerializedSubscriber<T> implements FlowableSubscriber<T>, xfm {
    ...
    public SerializedSubscriber(xfl<? super T> xfl) {
        this(xfl, false);
    }

    private SerializedSubscriber(xfl<? super T> xfl, boolean z) {
        this.a = xfl;
        this.b = false;
    }
