...
public abstract class Completable implements CompletableSource {
    ...
    public static Completable a(CompletableSource... completableSourceArr) {
        ...
        if (completableSourceArr.length == 1) {
            return d(completableSourceArr[0]);
        }
        return RxJavaPlugins.a((Completable) new CompletableConcatArray(completableSourceArr));
    }
    ...
    public static <T> Completable a(wrf<T> wrf) {
        ObjectHelper.a(wrf, "publisher is null");
        return RxJavaPlugins.a((Completable) new CompletableFromPublisher(wrf));
    }
    ...
    public static Completable b(CompletableSource... completableSourceArr) {
        ...
        return RxJavaPlugins.a((Completable) new CompletableMergeArray(completableSourceArr));
    }
    ...
    private static Completable d(CompletableSource completableSource) {
        ...
        if (completableSource instanceof Completable) {
            return RxJavaPlugins.a((Completable) completableSource);
        }
        return RxJavaPlugins.a((Completable) new CompletableFromUnsafeSource(completableSource));
    }
    ...
    public final <T> Observable<T> e() {
        ...
        return RxJavaPlugins.a((Observable<T>) new CompletableToObservable<T>(this));
    }
