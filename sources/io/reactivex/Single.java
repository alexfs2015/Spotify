...
public abstract class Single<T> implements SingleSource<T> {
    ...
    private static <T> Single<T> a(SingleSource<T> singleSource) {
        ...
        return singleSource instanceof Single ? RxJavaPlugins.a((Single) singleSource) : RxJavaPlugins.a((Single<T>) new SingleFromUnsafeSource<T>(singleSource));
    }
    ...
    private static <T, R> Single<R> a(Function<? super Object[], ? extends R> function, SingleSource<? extends T>... singleSourceArr) {
        ...
        return singleSourceArr.length == 0 ? a((Throwable) new NoSuchElementException()) : RxJavaPlugins.a((Single<T>) new SingleZipArray<T>(singleSourceArr, function));
    }
    ...
    public final <R> Single<R> a(SingleTransformer<? super T, ? extends R> singleTransformer) {
        return a(((SingleTransformer) ObjectHelper.a(singleTransformer, "transformer is null")).apply(this));
    }
    ...
    @Deprecated
    public final Completable bb_() {
        return RxJavaPlugins.a((Completable) new CompletableFromSingle(this));
    }

    public final Flowable<T> c() {
        return this instanceof FuseToFlowable ? ((FuseToFlowable) this).bc_() : RxJavaPlugins.a((Flowable<T>) new SingleToFlowable<T>(this));
    }
    ...
    public final Observable<T> d() {
        return this instanceof FuseToObservable ? ((FuseToObservable) this).be_() : RxJavaPlugins.a((Observable<T>) new SingleToObservable<T>(this));
    }
