...
public final class CommonUtils {
    ...
    enum Architecture {
        ...
        static Architecture a() {
            ...
            if (TextUtils.isEmpty(str)) {
                vuu.a().a("Fabric", "Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
    ...
    private static String a(InputStream inputStream, String str) {
        try {
            ...
            vuu.a().c("Fabric", "Could not calculate hash for app icon.", e);
            return "";
        }
    }
